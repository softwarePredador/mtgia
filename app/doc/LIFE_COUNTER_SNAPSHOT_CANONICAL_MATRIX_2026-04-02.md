...
- a borda da shell agora tambem rejeita superfices nativas de jogador sem `targetPlayerIndex`, evitando normalizacao implicita de alvo na abertura da sheet fallback
...
- o host agora tambem tem prova direta do round-trip `persist_snapshot Lotus -> stores canonicas -> fallback bootstrap`, mostrando que o payload valido do Lotus consegue atravessar o espelhamento canonico e voltar ao bundle sem depender do snapshot original salvo
