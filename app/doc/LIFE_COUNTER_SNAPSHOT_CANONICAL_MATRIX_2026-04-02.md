...
- quando o fluxo de `player state` parte de `player_option_card_presented`, o host agora tambem reseta a superficie do Lotus apos apply sem `reload`, evitando deixar takeover stale mesmo quando o estado foi aplicado de forma canonicamente segura
