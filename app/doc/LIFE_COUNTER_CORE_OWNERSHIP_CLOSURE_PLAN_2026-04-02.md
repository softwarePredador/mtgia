...
- quando a origem do fluxo e `player_option_card_presented`, o evento de apply agora tambem expõe `surface_reset_required`, e o host sempre reabre o bundle apos o apply para fechar corretamente a superficie takeover do Lotus
