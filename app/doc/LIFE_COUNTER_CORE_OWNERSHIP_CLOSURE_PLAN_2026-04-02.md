...
- o atalho direto de `set life` agora tambem pode fechar por `live_runtime` sem rebootar o bundle quando a mudanca fica limitada a um delta curto de vida no jogador alvo e o runtime real do Lotus confirma os controles da mesa; deltas maiores, jogador previamente inativo ou mudanca estrutural fora desse contrato continuam em `reload_fallback`
