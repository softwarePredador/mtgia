...
void main() {
  ...
  testWidgets(
    'reopens from persisted Lotus snapshot after canonical bootstrap',
    (tester) async {
      ...
      await _pumpUntilCanonicalStateAvailable(
        tester,
        sessionStore,
        settingsStore,
      );
      ...
      expect(restoredSession.playerSpecialStates, const [
        LifeCounterPlayerSpecialState.none,
        LifeCounterPlayerSpecialState.none,
        LifeCounterPlayerSpecialState.none,
        LifeCounterPlayerSpecialState.answerLeft,
