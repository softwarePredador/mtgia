...
Future<Map<String, dynamic>> _readAppearanceHubState(
  ...
  const storageKey = '__manaloom_test_player_state_appearance_hub';
  const nonceKey = '__manaloom_test_player_state_appearance_hub_nonce';
...
(() => {
  try {
    localStorage.setItem('$storageKey', JSON.stringify({
      probe: window.__manaloomPlayerStateAppearanceHubProbe ?? null
    }));
...
(() => {
  window.__manaloomPlayerStateAppearanceHubProbe = 'alive';
})()
''');
