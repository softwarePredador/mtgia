...
void main() {
  ...
  testWidgets(
    'round-trips partner commander damage detail through the live Lotus snapshot',
    (tester) async {
      ...
      expect(
        (playerOneCommanderDamage.first as Map<String, dynamic>)['damage'],
        {'commander1': 4, 'commander2': 3},
      );
      expect(
        (playerThreeCommanderDamage.first as Map<String, dynamic>)['damage'],
        {'commander1': 2, 'commander2': 3},
      );
      ...
      expect(
        restoredSession.resolvedCommanderDamageDetails[2][1],
        const LifeCounterCommanderDamageDetail(
          commanderOneDamage: 2,
          commanderTwoDamage: 3,
        ),
      );
      expect(restoredSession.commanderDamage[0][1], 7);
      expect(restoredSession.commanderDamage[2][1], 5);
    },
  );
}
