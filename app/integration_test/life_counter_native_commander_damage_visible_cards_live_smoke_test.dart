...
Future<Map<String, dynamic>> _readCommanderDamageState(
  ...
  const storageKey = '__manaloom_test_commander_damage_visible_cards_live';
  const nonceKey = '__manaloom_test_commander_damage_visible_cards_live_nonce';
...
(() => {
  try {
    localStorage.setItem('$storageKey', JSON.stringify({
      probe: window.__manaloomCommanderDamageVisibleCardsLiveProbe ?? null
    }));
...
(() => {
  window.__manaloomCommanderDamageVisibleCardsLiveProbe = 'alive';
})()
''');
