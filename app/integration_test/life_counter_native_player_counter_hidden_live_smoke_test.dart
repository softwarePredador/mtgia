...
Future<Map<String, dynamic>> _readPlayerCounterState(
  ...
  const storageKey = '__manaloom_test_player_counter_hidden_live';
  const nonceKey = '__manaloom_test_player_counter_hidden_live_nonce';
...
(() => {
  try {
    localStorage.setItem('$storageKey', JSON.stringify({
      probe: window.__manaloomPlayerCounterHiddenLiveProbe ?? null
    }));
...
(() => {
  window.__manaloomPlayerCounterHiddenLiveProbe = 'alive';
})()
''');
