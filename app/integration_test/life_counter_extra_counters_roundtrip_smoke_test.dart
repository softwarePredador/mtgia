...
void main() {
  ...
  testWidgets(
    'round-trips extra custom counters through the live Lotus snapshot',
    (tester) async {
      ...
      expect((players[0] as Map<String, dynamic>)['counters'], {
        'charge': 3,
        'rad': 1,
      });
      expect((players[2] as Map<String, dynamic>)['counters'], {'tickets': 2});
      expect((players[3] as Map<String, dynamic>)['counters'], {'quest': 5});
      ...
      expect(restoredSession!.playerExtraCounters, const [
        {'charge': 3, 'rad': 1},
        {},
        {'tickets': 2},
        {'quest': 5},
