...
Future<Map<String, dynamic>> _readOverlayState(
  ...
  const storageKey = '__manaloom_test_overlay_state';
  const nonceKey = '__manaloom_test_overlay_state_nonce';
...
(() => {
  try {
    localStorage.setItem('$storageKey', JSON.stringify({
      ...
      search_overlay_open: !!document.querySelector('.search-overlay'),
...
void main() {
  ...
  testWidgets('opens Lotus menu and history overlay', (tester) async {
    ...
    final historyState = await _readOverlayState(
      tester,
      snapshotStore,
      screenState,
    );
