...
void main() {
  ...
  testWidgets(
    'applies hidden regular counter through player state hub with visible player cards',
    (tester) async {
      ...
      final counters = Map<String, dynamic>.from(players[0]['counters'] as Map);
      expect(counters['poison'], 1);
    },
  );
}
