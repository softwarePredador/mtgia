...
Future<Map<String, dynamic>> _readCommanderDamageHubState(
  ...
  const storageKey =
      '__manaloom_test_player_state_hidden_commander_damage_visible_cards_lifeloss_fallback';
  const nonceKey =
      '__manaloom_test_player_state_hidden_commander_damage_visible_cards_lifeloss_fallback_nonce';
...
(() => {
  try {
    localStorage.setItem('$storageKey', JSON.stringify({
      probe: window.__manaloomPlayerStateHiddenCommanderDamageVisibleCardsLifeLossProbe ?? null
    }));
...
void main() {
  ...
  testWidgets(
    'falls back on mixed hidden commander damage through player state when life loss on commander damage stays enabled',
    (tester) async {
...
(() => {
  window.__manaloomPlayerStateHiddenCommanderDamageVisibleCardsLifeLossProbe = 'alive';
})()
''');
