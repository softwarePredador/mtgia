...
Future<Map<String, dynamic>> _readTurnTrackerState(
  ...
  const storageKey = '__manaloom_test_turn_tracker_live_next';
  const nonceKey = '__manaloom_test_turn_tracker_live_next_nonce';
...
Future<void> _pumpUntilTurnTrackerAdvance(
  WidgetTester tester,
...
void main() {
  ...
  testWidgets('advances active turn tracker live on the WebView path', (
    tester,
  ) async {
    ...
    await _pumpUntilTurnTrackerAdvance(tester, sessionStore);
