...
Future<LifeCounterSession?> _pumpUntilAppearanceApplied(
  ...
  for (
    ...
    attempt < 20 &&
        (session == null ||
            session.resolvedPlayerAppearances[2].background != '#CF7AEF');
    attempt += 1
  ) {
...
Future<Map<String, dynamic>> _readPlayerAppearanceState(
  ...
  const storageKey = '__manaloom_test_player_appearance_color_card_live';
  const nonceKey = '__manaloom_test_player_appearance_color_card_live_nonce';
