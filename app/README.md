...
- quando `player state` nasce de takeover do option-card do Lotus, o host agora tambem reseta a superficie do board apos apply sem `reload`, evitando deixar o overlay visual stale mesmo quando a mutacao fechou por `canonical_store_sync` ou `live_runtime`
