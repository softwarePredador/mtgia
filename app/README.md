...
- `table state` agora tambem evita `reload` no recorte seguro de `monarch/initiative`, reaplicando moedas e ownership visual direto no DOM do Lotus; `storm` continua em fallback
