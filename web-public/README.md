...
- `https://brewtact.com/*`: Next.js público canônico para SEO, descoberta, compartilhamento e conversão.
- `https://brewtact.com/app/*`: Flutter Web logado para deck builder, IA, coleção, pós-jogo, comunidade, trade e notificações.
...
- Flutter autenticado: `https://brewtact.com/app/`
