...
grep -Fq -- '--dart-define="ENABLE_INTERACTIVE_BATTLE=false"' "$ROOT_DIR/scripts/manaloom_build_android_release.sh"
grep -Fq -- '--dart-define="ENABLE_INTERACTIVE_BATTLE=false"' "$ROOT_DIR/scripts/manaloom_deploy_flutter_web.sh"
...
grep -Fq -- '--env-add INTERACTIVE_BATTLE_ENABLED=false' "$ROOT_DIR/scripts/manaloom_deploy_backend_image.sh"
