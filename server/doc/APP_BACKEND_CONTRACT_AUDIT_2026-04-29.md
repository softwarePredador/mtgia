...
| P1 | `PUT /trades/:id/respond` write latency | `POST /trades` e `PUT /trades/:id/status` foram reduzidos; `PUT /trades/:id/respond` ainda aparece em `~3203ms` no runtime | Proximo risco de UX/performance antes de release social/trades amplo |
