...
void main() {
  ...
  test('backend deploy proves migrations 038-058 before remote mutation', () {
    final source =
        File('../scripts/manaloom_deploy_backend_image.sh').readAsStringSync();
    final guard =
    ...
    final migration041To058Definition = source.indexOf(
      'require_migrations_041_058_contract() {',
    );
    ...
    expect(migration041To058Call, greaterThan(migration041To058Definition));
    expect(migration041To058Call, greaterThan(migration040Call));
    ...
    expect(mutationStart, greaterThan(migration041To058Call));
    expect(firstServiceUpdate, greaterThan(migration041To058Call));
    expect(firstRemoteFilesystemMutation, greaterThan(migration041To058Call));
    expect(
      source,
    ...
    expect(
      source,
      contains('.checks.release_schema.required_range == "038-058"'),
    );
    expect(
      source,
      contains('.checks.release_schema.latest_migration == "058"'),
    );
