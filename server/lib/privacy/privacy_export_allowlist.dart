...
const privacyExportSections = <PrivacyExportSection>[
  ...
  PrivacyExportSection(
    path: 'data.deck_change_events',
    table: 'deck_change_events',
    alias: 'change_event',
    where: 'change_event.user_id = CAST(@userId AS uuid)',
    orderBy: 'change_event.deck_id, change_event.revision_after',
    fields: {
      'cards_after': PrivacyExportField.include,
      'cards_before': PrivacyExportField.include,
      'created_at': PrivacyExportField.include,
      'deck_id': PrivacyExportField.deckRef,
      'id': PrivacyExportField.include,
      'metadata_after': PrivacyExportField.include,
      'metadata_before': PrivacyExportField.include,
      'operation': PrivacyExportField.include,
      'revision_after': PrivacyExportField.include,
      'revision_before': PrivacyExportField.include,
      'undo_of_event_id': PrivacyExportField.include,
      'user_id': PrivacyExportField.personRef,
    },
  ),
  PrivacyExportSection(
