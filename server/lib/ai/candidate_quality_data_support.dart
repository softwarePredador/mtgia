...
/// As tabelas, os índices e as views de candidate quality nascem da migration
/// 022 (as views são refeitas pelas 025, 028, 029 e 032). BT-DB-004: os CLIs
/// não criam nem alteram schema; conferem que existe e param se faltar.
const candidateQualitySchemaRequirements = SchemaRequirements(
  tables: {
    'card_function_tags',
    'card_role_scores',
  ...
  indexes: {
    'idx_card_function_tags_tag',
    'idx_card_function_tags_card_name',
    'idx_card_role_scores_lookup',
    'idx_card_role_scores_budget',
    'idx_commander_card_synergy_lookup',
    'idx_optimize_rejection_penalties_lookup',
    'idx_card_semantic_tags_v2_flags',
    'idx_card_semantic_tags_v2_card_name',
  },
  views: {'optimize_candidate_quality_summary', 'card_intelligence_snapshot'},
);
