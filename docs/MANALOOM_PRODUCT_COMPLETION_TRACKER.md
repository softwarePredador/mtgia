...
| S8-02 | `IN_PROGRESS` | S4, S6 | `/root` | `PerformanceService`; harness core Web/device; budgets p50/p95; evidência Sprint 8 | p50/p95 benchmark | evidência Sprint 8 — startup Web Chrome 150 revalidado em 7 amostras (cold p50/p95 622/660 ms; warm 222/238 ms), harness 4/4 + Flutter 32/32; faltam startup Android, oito superfícies autenticadas Web+device e integração no gate |
