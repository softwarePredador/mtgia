...
| S8-04 | `IN_PROGRESS` | S4-04, S6 | `/root` | `server/routes/ai/generate/index.dart`; lifecycle de jobs; teste de timeout do provider; contrato API; evidência Sprint 8 | AI failure injection | evidência Sprint 8 — timeout falha fechado em HTTP 504; retry terminal agora limpa job/request key, preserva retomada apenas para transitório e passou 57/57 com widget real; faltam abort HTTP físico/propagado e matriz externa completa |
