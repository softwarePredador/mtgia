...
| --- | --- | --- | --- | --- | --- |
| `BT-GOV-001` | P0 CORE | IMPLEMENTED_LOCAL_PENDING_FULL_GATE | Publicar decisão corrente única: beta gratuita, público, plataformas, domínio, oferta, flags, IA, Battle e módulos adiados. | — | Documento curto, datado e sem conflito com UI/API/deploy. |
