...
- **Segurança (D-19).** Os quatro buracos foram fechados em produção em 2026-09-23
  (`166aaed57`), dentro de `BT-AUTH-003`, `BT-AUTH-004` e `DCK-P0-06`; resta o tempo da
  recuperação de senha (`BT-AUTH-003`).
- **E-mail verificado (D-56, 2026-09-23).** Escrever deck, importar e mexer no fichário
  exigem e-mail verificado; aceitar o convite da coorte conta como verificação.
