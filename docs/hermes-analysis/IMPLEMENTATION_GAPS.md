...
| `server/lib/ai/optimize_runtime_support.dart` | 1179 | ⚠️ Split iniciado | Cache, quality ranking, role/scoring funcional, utilitários de filler, seleção determinística de remoções e swap building foram movidos para support dedicado; ainda falta extrair fallback/recovery estrutural |
