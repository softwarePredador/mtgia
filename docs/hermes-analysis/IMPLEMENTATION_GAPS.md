...
| `server/routes/ai/optimize/index.dart` | 2781 | ⚠️ Split iniciado | Response/cache, envelope async, request parsing, payload final, warnings finais e diagnostics finais foram movidos; manter rota como orquestração fina e mover fallback/retry para support services |
