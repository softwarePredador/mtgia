...
| `server/routes/ai/optimize/index.dart` | 2790 | ⚠️ Split iniciado | Response/cache/diagnostics, envelope async, request parsing, payload final e warnings finais foram movidos; manter rota como orquestração fina e mover fallback/retry para support services |
