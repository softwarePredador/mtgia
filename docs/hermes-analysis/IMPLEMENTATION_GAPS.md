...
| `server/routes/ai/optimize/index.dart` | 2752 | ⚠️ Split iniciado | Response/cache, envelope async, request parsing, payload final, warnings finais, diagnostics finais e fallback vazio foram movidos; manter rota como orquestração fina e mover retry/quality gate para support services |
