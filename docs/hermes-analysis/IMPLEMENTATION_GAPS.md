...
| `docs/hermes-analysis/manaloom-knowledge/scripts/test_battle_analyst_v10_3.py` | 3514 | ⚠️ Split em andamento | Regras 2026 e combate extraídos; continuar com replacement/commander |
