...
3. A allowlist dry-run dos 27 low-risk está versionada em
   ...
   Hermes AWS; ainda não é autorização de apply. O próximo passo antes de
   qualquer escrita é stale cleanup + transaction dry-run.
