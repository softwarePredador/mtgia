...
| `docs/hermes-analysis/manaloom-knowledge/scripts/test_battle_analyst_v10_3.py` | 808 | ⚠️ Split em andamento | Regras 2026, combate, replacement, commander, mana, stack/casting, card-specific, targeting, summoning sickness, zone transitions, card import/oracle, turn flow, SBA/zone metadata, permanents complexos, continuous effects e engine metrics extraídos; continuar com conformance, loss taxonomy, token/land recursion e triggers |
