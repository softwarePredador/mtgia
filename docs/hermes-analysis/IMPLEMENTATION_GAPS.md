...
| `docs/hermes-analysis/manaloom-knowledge/scripts/test_battle_analyst_v10_3.py` | 1246 | ⚠️ Split em andamento | Regras 2026, combate, replacement, commander, mana, stack/casting, card-specific, targeting, summoning sickness, zone transitions, card import/oracle, turn flow e SBA/zone metadata extraídos; continuar com permanents complexos, continuous effects, planeswalker/battle e DFC/adventure |
