...
| `docs/hermes-analysis/manaloom-knowledge/scripts/test_battle_analyst_v10_3.py` | 3245 | ⚠️ Split em andamento | Regras 2026, combate, replacement e commander extraídos; continuar com stack/mana/card-specific |
