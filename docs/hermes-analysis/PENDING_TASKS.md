...
| 6 | Próximo split da rota optimize: proteção de remoção de lands em decks com baixa contagem | 1-2 dias | Médio | `optimize_route_complete_top_up_support.dart` verde |
