#!/usr/bin/env python3
"""Update INDEX.md with Teysa Karlov content"""
import os

content = r'''# ManaLoom Commander Knowledge — Indice Cumulativo
...
with open('/opt/data/workspace/mtgia/docs/hermes-analysis/manaloom-knowledge/INDEX.md', 'w') as f:
    f.write(content)

print("INDEX.md written successfully")