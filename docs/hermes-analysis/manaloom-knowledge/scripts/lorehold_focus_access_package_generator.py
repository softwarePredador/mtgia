...
DEFAULT_RUNTIME_GAP_QUEUE = (
    REPORT_DIR / "lorehold_runtime_gap_family_queue_20260630_post_pg279_possibility_storm.json"
)
...
def next_command_for_work(work_key: str) -> str:
    commands = {
        ...
        "runtime_rule_gap_batch": (
            ...
            "lorehold_runtime_gap_family_queue_20260630_post_pg279_possibility_storm"
        ),
    }
