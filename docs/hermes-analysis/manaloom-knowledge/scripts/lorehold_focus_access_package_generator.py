...
DEFAULT_PLANNER = REPORT_DIR / "lorehold_next_action_planner_20260628_v13_brass_rejection_integrated.json"
        ...
        "required_work": [
            {
                ...
                "reason": (modes.get("squee_graveyard_entry_route") or {}).get("next_action"),
                "target_seeds": (modes.get("squee_graveyard_entry_route") or {}).get("target_seeds", []),
            },
            {
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stem", default="lorehold_focus_access_package_generator_20260628_v1")
