    ...
    with tempfile.TemporaryDirectory() as tmp_name:
        ...
        write_events(
            ...
            [
                ...
                {"event": "damage_each_opponent_resolved", "turn": 3, "player": "A"},
                {"event": "damage_prevention_reflect_created", "turn": 3, "player": "A"},
                {"event": "damage_reflected", "turn": 3, "player": "A"},
                ...
                {"event": "dies_draw_resolved", "turn": 4, "player": "A"},
                {"event": "dig_to_hand_resolved", "turn": 5, "player": "A"},
                {"event": "pile_selection_draw_resolved", "turn": 5, "player": "A"},
                {"event": "tutor_life_loss_resolved", "turn": 5, "player": "A"},
                {"event": "spell_shuffled_into_library_on_resolution", "turn": 5, "player": "A"},
                {"event": "etb_land_ramp_skipped", "player": "A"},
                {"event": "class_level_gained", "turn": 6, "player": "A"},
                {"event": "class_level_trigger_resolved", "turn": 6, "player": "A"},
                {"event": "class_level_trigger_skipped", "player": "A"},
                {"event": "discard_modal_trigger_resolved", "turn": 6, "player": "A"},
                {"event": "etb_recursion_resolved", "turn": 6, "player": "A"},
                {"event": "etb_removal_resolved", "turn": 6, "player": "A"},
                {"event": "etb_removal_skipped", "player": "A"},
                {"event": "invoke_calamity_free_cast", "turn": 7, "player": "A"},
                {"event": "invoke_calamity_resolved", "turn": 7, "player": "A"},
                {"event": "modal_spell_resolved", "turn": 7, "player": "A"},
                {"event": "noncombat_damage_modified", "turn": 7, "player": "A"},
                {"event": "powerbalance_trigger_resolved", "turn": 7, "player": "A"},
                {"event": "targeted_protection_granted", "turn": 7, "player": "A"},
                {"event": "rebound_cast", "turn": 8, "player": "A"},
                {"event": "rebound_exiled", "player": "A"},
                {"event": "rebound_skipped", "player": "A"},
                {"event": "replacement_exiled_on_resolution", "player": "A"},
                {"event": "steal_all_creatures_resolved", "turn": 8, "player": "A"},
                {"event": "surge_to_victory_resolved", "turn": 8, "player": "A"},
                {"event": "tokens_created", "player": "A"},
            ],
        )
