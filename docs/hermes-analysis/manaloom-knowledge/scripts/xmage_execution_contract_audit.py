...
XMAGE_PATCH_PIN = "991948742f840cd88493a4ea8cb3f4ed192e4742"
...
def build_report() -> dict[str, object]:
    ...
    checks = [
        ...
        source_check(
            ...
            [
                "manaloom_release_identity.sh",
                'worktree add --detach "$SOURCE_WORKTREE" "$sha"',
                'git archive "$sha"',
                ...
                "upsert_env \"$backend_env\" NATIVE_BATTLE_SIDECAR_URL",
        ...
        source_check(
            ...
            [
                ...
                "--update-order stop-first",
                "MANALOOM_RELEASE_CAPABILITIES_FILE=/app/server/config/release_capabilities.json",
        ...
        source_absence_check(
            "server.no_legacy_native_fallback",
            SERVER / "routes/ai/simulate/index.dart",
            ["BattleSimulator(", "manaloom_native_legacy", "experimental_advisory"],
        ),
        source_check(
            "server.strict_native_client",
            SERVER / "lib/ai/native_battle_client.dart",
            [
                "class NativeBattleCoverageIncomplete",
                "class NativeBattleServiceException",
                "manaloom_native_reviewed",
                "native_reviewed_rules_execution",
                "untrusted engine contract",
            ],
        ),
        source_check(
            "server.reviewed_native_sidecar",
            SERVER / "bin/native_battle_sidecar.py",
            [
                "native_reviewed_rules_execution",
                "required_rule_cards is required",
        ...
        source_check(
            ...
            [
                "isExternalCanonicalExecution",
                "isReviewedNativeExecution",
                "canonical_rules_execution",
                "canonical_rules_execution_secondary",
                "native_reviewed_rules_execution",
        ...
        source_check(
            ...
            [
                ...
                "native requires the reviewed native sidecar",
                "auto refuses the legacy in-process native fallback",
            ],
        ),
        source_check(
            "tests.sidecar",
        ...
        source_check(
            ...
            [
                ...
                "global_residual_terminal_dispositions_v1",
        ...
        source_check(
            ...
            [
                ...
                "33,268",
                "1,063",
                "zero conventional-rules or digital-only cards",
                "global_residual_terminal_dispositions_v1",
            ],
        ),
    ]
