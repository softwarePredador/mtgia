...
DEFAULT_SYNTHESIS = REPORT_DIR / "lorehold_failure_targeted_synergy_hypotheses_20260630_after_profiled_gate.json"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--stem", default="lorehold_failure_targeted_trace_audit_20260630_after_profiled_gate")
