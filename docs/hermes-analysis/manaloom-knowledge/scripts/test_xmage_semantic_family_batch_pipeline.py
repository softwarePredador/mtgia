...
class XMageSemanticFamilyBatchPipelineTests(unittest.TestCase):
    ...
    def test_classifier_marks_ghoulcallers_bell_each_player_mill_scope_batch_safe(self) -> None:
        report = classifier.build_family_report(
            {
                "cards": [
                    {
                        "card_name": "Ghoulcaller's Bell",
                        "severity": "medium",
                        "oracle_hash": "be79f523c3a5cd11de81a0dfdf0d1c2c",
                        "status": "ready_for_structured_xmage_pull_review_required",
                        "ready_for_structured_pull": True,
                        "valid_xmage_source": True,
                        "coherence_findings": ["review_only_or_needs_review_rule"],
                        "checks": {"focused_test_scenario_count": 1},
                        "xmage": {
                            "class_name": "GhoulcallersBell",
                            "path": "/xmage/GhoulcallersBell.java",
                            "types": ["ARTIFACT"],
                            "ability_classes": ["SimpleActivatedAbility"],
            ...
            "cards": [
                {
                    ...
                    "xmage": {
                        ...
                        "primary_effect": {
                            "effect": "copy_spell",
                            "battle_model_scope": "copy_target_instant_or_sorcery_stack_spell_choose_new_targets_runtime_v1",
                            "instant": True,
    ...
    def test_classifier_marks_utvara_hellkite_exact_scope_as_batch_safe(self) -> None:
        report = classifier.build_family_report(
            {
                "cards": [
                    {
                        ...
                        "severity": "high",
                        "oracle_hash": "utvarahellkitehash",
                        "status": "ready_for_structured_xmage_pull_review_required",
                        "ready_for_structured_pull": True,
                        "valid_xmage_source": True,
                        "coherence_findings": ["review_only_or_needs_review_rule"],
                        "checks": {"focused_test_scenario_count": 1},
                        "xmage": {
                            "class_name": "UtvaraHellkite",
                            "path": "/xmage/UtvaraHellkite.java",
                            "types": ["CREATURE"],
                            "effect_classes": ["CreateTokenEffect"],
                            "ability_classes": [
    ...
    def test_classifier_marks_blaze_commando_exact_scope_as_batch_safe(self) -> None:
        report = classifier.build_family_report(
            {
                "cards": [
                    {
                        "card_name": "Blaze Commando",
                        "severity": "high",
                        "oracle_hash": "blazecommandohash",
                        "status": "ready_for_structured_xmage_pull_review_required",
                        "ready_for_structured_pull": True,
                        "valid_xmage_source": True,
                        "coherence_findings": ["review_only_or_needs_review_rule"],
                        "checks": {"focused_test_scenario_count": 1},
                        "xmage": {
                            "class_name": "BlazeCommando",
                            "path": "/xmage/BlazeCommando.java",
                            "types": ["CREATURE"],
                            "effect_classes": ["CreateTokenEffect"],
    ...
    def test_classifier_and_generator_mark_terror_of_the_peaks_exact_scope_as_batch_safe(self) -> None:
            ...
            "cards": [
                {
                    ...
                    "checks": {"focused_test_scenario_count": 2},
                    "xmage": {
                        "class_name": "TerrorOfThePeaks",
                        "path": "/xmage/TerrorOfThePeaks.java",
                        "types": ["CREATURE"],
                        "effect_classes": [
                            "DamageTargetEffect",
        ...
        self.assertTrue(proposal["safe_for_batch_pg_package"])
        self.assertEqual(proposal["deck_role_json"]["category"], "burn_engine")
        self.assertEqual(proposal["deck_role_json"]["effect"], "etb_power_damage")
        self.assertEqual(
            proposal["deck_role_json"]["subtype"],
