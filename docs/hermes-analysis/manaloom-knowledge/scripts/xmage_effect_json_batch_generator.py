...
DECK_ROLE_BY_FAMILY: dict[str, dict[str, Any]] = {
    ...
    "free_cast": {"category": "combo_value", "effect": "free_cast", "subtype": "cast_without_paying_mana", "timing": "triggered_or_resolution"},
    ...
    "topdeck_play": {"category": "ramp", "effect": "topdeck_play", "subtype": "play_lands_from_library", "timing": "static"},
...
def deck_role_for(card: dict[str, Any]) -> dict[str, Any]:
    ...
    if effect_json.get("battle_model_scope") == "source_dealt_damage_reflect_to_any_target_v1":
        return {
            "category": "burn_engine",
            "effect": "damage_reflection",
            "subtype": "source_damaged_reflect_any_target",
            "timing": "triggered",
        }
    ...
    if effect_json.get("battle_model_scope") == "red_instant_sorcery_lifelink_white_lifegain_damage_v1":
        return {
            "category": "burn_lifegain_engine",
            "effect": "instant_sorcery_lifelink_lifegain_damage",
