...
GLOBAL_COMMANDER_PROFILE_REPAIR_CUT_PAIR_REVIEWER = (
    SCRIPT_DIR / "global_commander_profile_repair_cut_pair_reviewer.py"
)
...
GLOBAL_COMMANDER_LAND_FLOOR_PACKAGE_PROFILE_BLOCKER_REPAIR_REPORT = (
    REPO_ROOT
...
def build_audit() -> dict[str, Any]:
    ...
    checks.append(
        check_contains(
            ...
            [
                ...
                "role_confirms_mana_ramp_foundation",
                "blocked_not_mana_ramp_foundation_role",
                "core_removal_floor",
                "reanimation_plan_b",
    ...
    checks.append(
        check_contains(
            ...
            [
                "global_commander_profile_repair_cut_pair_reviewer",
                "profile_repair_cut_pair_review_blocks_candidate_copy",
                ...
                "reorder_or_expand_profile_repair_cut_pairs_before_candidate_copy",
                "pair_needs_manual_land_curve_review",
                "pair_blocked_cross_lane_protected_anchor_cut",
                "battle_or_optimization_performed",
                "candidate_copy_allowed_now",
            ],
        )
    ...
    checks.append(
        check_contains(
            GLOBAL_COMMANDER_PROFILE_REPAIR_CUT_PAIR_REVIEWER_TEST,
            [
                "test_blocks_land_curve_and_cross_lane_protected_anchor_pairs",
                "test_same_lane_protected_anchor_pair_still_keeps_copy_closed_to_later_gate",
                "protected_anchor_pair_lacks_same_lane_overlap",
            ],
        )
    )
    checks.append(
        check_contains(
            ...
            [
                "global_commander_profile_repair_cut_pair_reorderer",
                "profile_repair_cut_pair_reorder_ready_for_land_curve_review",
                "profile_repair_cut_pair_reorder_ready_for_candidate_copy",
                "reordered_protected_anchor_same_lane_pair",
                "reordered_land_floor_pair_needs_curve_review",
                "best_non_overlapping_cut",
                "reordered_profile_floor_repair_pair",
                "profile_floor_repair_uses_over_target_cut_after_reorder",
                "review_land_floor_cut_role_loss_before_candidate_copy",
                "protected_anchor_boundary",
                "land_floor_boundary",
                "battle_or_optimization_performed",
    ...
    checks.append(
        check_contains(
            ...
            [
                ...
                "test_nonland_floor_repair_add_uses_over_target_cut_before_land_pairs",
                "protected_anchor_pair_lacks_same_lane_overlap",
                "review_land_floor_cut_role_loss_before_candidate_copy",
            ],
        )
