...
CHALLENGER_PLANS: dict[str, dict[str, Any]] = {
    ...
    "miracle_pressure_conversion": {
        ...
        "candidate_name": "Lorehold From-Scratch Miracle Pressure Conversion v1",
        "candidate_archetype": "from-scratch-miracle-pressure-conversion",
        "intent": (
            "Preserve the protected 607 mana, topdeck, miracle, protection, and "
            "big-spell floor while replacing redundant high-cost payoffs with a "
            "compact conversion package: Squee/Faithless/Wheel/Underworld for "
            "rummage value, Birgi for spell-chain mana, Aetherflux as a compact "
            "closer, and Boros Charm/Silence for the closing window."
        ),
        "required_cards": [
            "Approach of the Second Sun",
            "Arcane Signet",
    ...
    "spell_pressure_topdeck": {
        ...
        "candidate_name": "Lorehold From-Scratch Spell Pressure Topdeck v1",
        "candidate_archetype": "from-scratch-spell-pressure-topdeck",
        "intent": (
            "Test the smallest pressure signal that current evidence actually saw: "
            "Guttersnipe plus Young Pyromancer, while preserving the 607 topdeck, "
            "miracle, opponent-turn mana, protection, and deterministic finisher "
            "floor. This is a full-shell pressure contract, not a one-for-one cut."
        ),
        "required_cards": [
            "Approach of the Second Sun",
            "Arcane Signet",
        ...
        "package_weights": {
            "topdeck_miracle_setup": 10.0,
            "spell_chain_conversion": 10.0,
            "pressure_absorber": 10.0,
            "protection_window": 9.0,
            "deterministic_finisher": 8.0,
            "hand_filter": 8.0,
            "early_plan": 6.0,
    ...
    "spell_pressure_mana_conversion": {
        ...
        "candidate_name": "Lorehold From-Scratch Spell Pressure Mana Conversion v1",
        "candidate_archetype": "from-scratch-spell-pressure-mana-conversion",
        "intent": (
            "Repair the first spell-pressure shell by demoting unproven token "
            "pressure and testing mana-conversion pressure instead: Guttersnipe "
            "plus Storm-Kiln Artist, with the 607 topdeck, miracle, opponent-turn "
            "mana, protection, and deterministic finisher floor preserved."
        ),
        "required_cards": [
            "Approach of the Second Sun",
            "Arcane Signet",
...
def build_lands(
    ...
    *,
    ...
    for name in plan.get("land_priority") or LAND_PRIORITY:
