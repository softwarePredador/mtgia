...
DIRECT_RECURRING_RUN_PATHS = {
    ...
    "docs/hermes-analysis/manaloom-knowledge/scripts/battle_target_deck_identity_guard.py",
    ...
    "docs/hermes-analysis/manaloom-knowledge/scripts/test_battle_seed_high_regressions.py",
    "docs/hermes-analysis/manaloom-knowledge/scripts/test_battle_forensic_audit_supported_effects.py",
    "docs/hermes-analysis/manaloom-knowledge/scripts/test_hazels_brewmaster_runtime.py",
    "docs/hermes-analysis/manaloom-knowledge/scripts/test_priority_lorehold_card_runtime.py",
    "docs/hermes-analysis/manaloom-knowledge/scripts/test_lorehold_variant_battle_gate.py",
    ...
    "docs/hermes-analysis/manaloom-knowledge/scripts/test_battle_target_deck_identity_guard.py",
...
RECURRING_GATE_BASENAMES = {
    ...
    "test_battle_pending_runtime_closure.py",
    "test_battle_seed_high_regressions.py",
    ...
    "test_battle_target_deck_identity_guard.py",
