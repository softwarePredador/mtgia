    ...
    checks = [
        ...
        contains_all(
            ...
            [
                ...
                "historical",
                "GLOBAL_BATTLE_RULES_AND_LEARNING_CLOSURE_2026-07-15.md",
                "ter supersedido os planos de 2026-06-23/24",
            ],
            check_name="docs.status_index_marks_definitive_flow_historical",
        ),
        contains_all(
    ...
    return [
        contains_all(
            ...
            [
                ...
                "global_residual_terminal_dispositions.py",
                "terminal_dispositions.json",
            ],
