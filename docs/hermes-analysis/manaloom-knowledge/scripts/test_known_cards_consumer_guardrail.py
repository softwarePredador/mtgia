...
class KnownCardsConsumerGuardrailTests(unittest.TestCase):
    ...
    def test_battle_runtime_keeps_registry_then_snapshot_and_no_legacy_generated(self) -> None:
        ...
        canonical_idx = source.index("in CANONICAL_FALLBACK_KNOWN_CARDS", handcrafted_idx)
        functional_idx = source.index("for tag in card_functional_tags(card):", canonical_idx)
