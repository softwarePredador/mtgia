...
- **P1/P2 — Imports quebrados e ciclo local fora do recorte do auditor base**: rodada `broken-imports-and-circular-dependencies` em 2026-05-29 11:00 UTC confirmou que o auditor base ainda reporta `Imports quebrados: 0` apenas para `server/lib` + `server/routes`, mas um resolvedor focado em 721 arquivos Dart encontrou 3 imports locais quebrados: `app/lib/features/decks/widgets/deck_analysis_tab.dart:5` -> `../../../../core/utils/mana_helper.dart`, `app/lib/features/home/life_counter_screen.dart:7` -> `../../../core/theme/app_theme.dart`, e `server/bin/local_test_server.dart:3` -> `../.dart_frog/server.dart`. O mesmo grafo encontrou 1 ciclo direto no app: `community_deck_detail_screen.dart` <-> `user_profile_screen.dart`; nao encontrou ciclos locais no backend.
