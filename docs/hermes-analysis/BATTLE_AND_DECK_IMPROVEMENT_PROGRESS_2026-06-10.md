...
**Status:** em andamento, com quinze extrações concluídas.

**Arquivos que precisam split dedicado:**
- `docs/hermes-analysis/manaloom-knowledge/scripts/battle_analyst_v9.py` — 7869 linhas.
- `docs/hermes-analysis/manaloom-knowledge/scripts/test_battle_analyst_v10_3.py` — 910 linhas após quinze extrações.
...
1. Separar mais suites Hermes por domínio, priorizando regressões remanescentes
   de métricas do engine, conformance, loss taxonomy e triggers que ainda estão
   inline no runner.
