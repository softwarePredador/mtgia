...
**Status:** em andamento, com dezenove extrações de testes e um primeiro split
do engine concluídos.

**Arquivos que precisam split dedicado:**
- `docs/hermes-analysis/manaloom-knowledge/scripts/battle_analyst_v9.py` — 7792 linhas após o primeiro split do engine.
