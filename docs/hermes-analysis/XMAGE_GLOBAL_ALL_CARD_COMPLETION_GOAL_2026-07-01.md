...
thread goal remains active, but execution must use the current post-PG326
...
- all-card readiness `battle_and_oracle_ready`: `2335`
- all-card readiness `battle_family_mapper_required`: `30212`
- target battle-gap identities in authoritative queue: `27289`
- XMage authoritative source resolved: `26975`
- XMage missing-source exceptions: `314`
- parser gaps after XMage source resolution: `0`
- XMage authoritative adapter required: `26975`
...
Use the post-PG326 authoritative queue unless a newer queue exists:
...
runtime-backed subpattern. The post-PG326 supported splitter recheck has
