...
thread goal remains active, but execution must use the current post-PG343
...
- all-card readiness `battle_and_oracle_ready`: `2421`
- all-card readiness `battle_family_mapper_required`: `30126`
- all-card readiness `snapshot_has_verified_rule`: `3569`
- target battle-gap identities in authoritative queue: `27203`
- XMage authoritative source resolved: `26889`
- XMage missing-source exceptions: `314`
- parser gaps after XMage source resolution: `0`
- XMage authoritative adapter required: `26889`
...
Use the post-PG343 authoritative queue unless a newer queue exists:
...
Immediate checkpoint after PG343:
...
9. PG336 is applied, synced, and E2E validated. The package evidence is in
...
10. PG337 is applied, synced, and E2E validated. The package evidence is in
...
11. PG338 is applied, synced, and E2E validated. The package evidence is in
...
12. PG339 is applied, synced, and E2E validated. The package evidence is in
...
13. PG340 is applied, synced, and E2E validated. The package evidence is in
...
14. PG341 is applied, synced, and E2E validated. The package evidence is in
...
15. PG342 is applied, synced, and E2E validated. The package evidence is in
...
16. PG343 is applied, synced, and E2E validated. The package evidence is in
...
17. The post-PG343 supported splitter recheck returned `proposal_count=0` over
    `7928` considered supported rows. Current evidence:
...
18. Continue from the fresh post-PG343 queue. The top reusable work unit remains
   `recursion::xmage_graveyard_return_variant_review_v1`, now at `1899`, so
