...
- Generated at: `2026-06-28T01:33:16Z`
...
- Promotion lanes: `{"batch_metadata_candidate_requires_pg_precheck": 1, "mapper_metadata_or_test_scenario_required": 52, "runtime_family_implementation_required": 1, "split_family_scope_review_required": 7}`
- Family count: `5`
...
| 2 | `targeted_interaction` | 6 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 5, "finisher_or_big_spell": 1}` | `{"split_family_scope_review_required": 6}` | target legality, resolution, zone transition, and event provenance |
| 3 | `free_cast` | 1 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 1}` | `{"split_family_scope_review_required": 1}` | cast-without-paying resolvers with source-zone, timing-bypass, and replacement-destination bookkeeping |
| 4 | `static_damage_modifier` | 1 | `runtime_family_required` | `implement_family_before_metadata_batch` | `{"finisher_or_big_spell": 1}` | `{"runtime_family_implementation_required": 1}` | continuous replacement effects that modify damage amounts by source controller and target ownership |
| 5 | `topdeck_play` | 1 | `runtime_family_required` | `implement_family_before_metadata_batch` | `{"hand_filter": 1}` | `{"batch_metadata_candidate_requires_pg_precheck": 1}` | top-of-library visibility and permission to play cards from library under board-state conditions |
...
| Card | Score | Variant decks | Lane | Promotion | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- |
| `Boros Reckoner` | 0 | `612, 616` | `contextual` | `split_family_scope_review_required` | `direct_damage` | `targeted_damage_variant_v1` | `BorosReckoner` |
| `Terror of the Peaks` | 0 | `608, 612` | `contextual` | `split_family_scope_review_required` | `direct_damage` | `targeted_damage_variant_v1` | `TerrorOfThePeaks` |
| `Balefire Liege` | -10 | `616` | `contextual` | `split_family_scope_review_required` | `direct_damage` | `targeted_damage_variant_v1` | `BalefireLiege` |
| `Firesong and Sunspeaker` | -10 | `616` | `finisher_or_big_spell` | `split_family_scope_review_required` | `direct_damage` | `targeted_damage_variant_v1` | `FiresongAndSunspeaker` |
| `Repercussion` | -10 | `612` | `contextual` | `split_family_scope_review_required` | `direct_damage` | `targeted_damage_variant_v1` | `Repercussion` |
| `Toralf, God of Fury // Toralf's Hammer` | -10 | `612` | `contextual` | `split_family_scope_review_required` | `direct_damage` | `targeted_damage_variant_v1` | `ToralfGodOfFury` |
...
| Card | Score | Variant decks | Lane | Promotion | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- |
| `Goliath Daydreamer` | 10 | `613, 614, 615` | `contextual` | `split_family_scope_review_required` | `free_cast` | `instant_sorcery_from_hand_exile_dream_counter_attack_free_cast_v1` | `GoliathDaydreamer` |
...
| Card | Score | Variant decks | Lane | Promotion | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- |
| `Twinflame Tyrant` | 10 | `608, 611, 615` | `finisher_or_big_spell` | `runtime_family_implementation_required` | `damage_modifier` | `controlled_source_damage_to_opponent_or_opponent_permanent_doubled_v1` | `TwinflameTyrant` |
...
| Card | Score | Variant decks | Lane | Promotion | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- |
| `Verge Rangers` | 10 | `609, 611, 613` | `hand_filter` | `batch_metadata_candidate_requires_pg_precheck` | `topdeck_play` | `look_top_library_play_lands_from_top_if_opponent_more_lands_v1` | `VergeRangers` |
