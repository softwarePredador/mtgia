...
- Generated at: `2026-07-05T01:03:54.946621+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5612 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4347 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4525 | 265 |
| `battle_family_mapper_required` | 29348 | 98 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7103 |
| `triggered_or_static_ability` | 3897 |
| `damage_or_life_total_change` | 3849 |
| `token_creation` | 3609 |
| `draw_selection_topdeck` | 3431 |
| `graveyard_recursion` | 1902 |
| `targeted_removal` | 1061 |
| `mana_generation_or_ritual` | 863 |
| `tutor_search_library` | 772 |
| `modal_or_choice_effect` | 699 |
| `alternate_or_free_cast` | 509 |
| `recursion_or_bounce` | 492 |
...
| `battle_family::manual_model_review` | 7103 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3849 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3431 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
...
| `battle_family::mana_generation_or_ritual` | 863 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Aetheric Amplifier`, `Agility Bobblehead` |
| `battle_family::tutor_search_library` | 772 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A.I.M. Scientists`, `Aang's Journey`, `Absorb Vis`, `Abzan Monument`, `Academy Rector`, `Aerial Surveyor`, `Agency Outfitter`, `Ainok Guide`, `Ajani's Aid`, `Alabaster Host Intercessor` |
...
| `battle_family::alternate_or_free_cast` | 509 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abundant Maw`, `Acid-Spewer Dragon`, `Adventurous Eater // Have a Bite`, `Aerie Bowmasters`, `Aether Meltdown`, `Aether Searcher`, `Aether Web`, `Affa Guard Hound`, `Ainok Tracker`, `Alley Assailant` |
...
| `battle_family::recursion_or_bounce` | 492 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
