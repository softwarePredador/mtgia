...
- generated_at: `2026-06-28T18:02:06Z`
- registry: `/tmp/lorehold-runner-registry-3419-force-20260628.json`
- execute: `True`
- max_candidates: `1`
- status: `warning`
...
| --- | --- | --- | --- | --- |
| `candidate_607_birgi_v1` | P1 | `executed_battle_prior_warning` | `birgi_v1` | matching executable research plan found |
