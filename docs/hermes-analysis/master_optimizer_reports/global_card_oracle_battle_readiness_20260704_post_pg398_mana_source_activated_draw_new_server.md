...
- Generated at: `2026-07-04T09:54:28.741270+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5275 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4002 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4137 | 250 |
| `battle_family_mapper_required` | 29693 | 100 |
...
| `battle_family::damage_or_life_total_change` | 3892 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::mana_generation_or_ritual` | 895 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Aetheric Amplifier`, `Agent of Stromgald` |
