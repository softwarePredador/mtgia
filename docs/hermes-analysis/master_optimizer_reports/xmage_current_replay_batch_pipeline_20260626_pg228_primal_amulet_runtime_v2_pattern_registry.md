...
- `proposal_count`: `402`
- `pattern_count`: `28`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 330, "package_already_prepared": 1, "package_ready_unprepared": 1, "runtime_family_backlog": 4, "split_scope_backlog": 62}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 3, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 9, "runtime_observation_requires_taxonomy": 1}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 3, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 330, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 52, "runtime_observation_requires_taxonomy": 1}`
...
| `static_cost_reducer/static_cost_reduction/artifact_instant_sorcery_cost_reduction_charge_transform_to_any_color_spell_copy_land_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `targeted_interaction/draw_cards/source_controller_draw_variant_v1` | `split_scope_backlog` | `requires_subpattern_split_before_promotion` | 12 | 5 | Split by ability kind, target constraints, triggers, costs, and secondary effects before promotion. |
| `targeted_interaction/add_counters/source_add_counters_variant_v1` | `split_scope_backlog` | `requires_subpattern_split_before_promotion` | 9 | 7 | Split by ability kind, target constraints, triggers, costs, and secondary effects before promotion. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 329 | 53 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### static_cost_reducer / static_cost_reduction / artifact_instant_sorcery_cost_reduction_charge_transform_to_any_color_spell_copy_land_v1

- Pattern id: `xmage_pattern:3d41d9326a1bfa140865`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Primal Amulet // Primal Wellspring)
- Subpatterns: `1`
...
- Lane: `split_scope_backlog`
- Status: `requires_subpattern_split_before_promotion`
- Cards: `12` (Arcane Denial, Archivist of Oghma, Blood Sun, Kefka, Court Mage // Kefka, Ruler of Ruin, Morbid Opportunist, Phyrexian Arena, Psychic Frog, Puresteel Paladin, Solemn Simulacrum, Sram, Senior Edificer)
- Subpatterns: `5`
- Required evidence: `["subpattern split", "focused ManaLoom tests per subpattern", "package generation only for exact supported subpatterns"]`
...
- Lane: `split_scope_backlog`
- Status: `requires_subpattern_split_before_promotion`
- Cards: `9` (Bloodchief Ascension, Brallin, Skyshark Rider, Nightshade Harvester, Palantír of Orthanc, Solphim, Mayhem Dominus, Séance Board, Tezzeret, Cruel Captain, The Haunt of Hightower, Vivi Ornitier)
- Subpatterns: `7`
- Required evidence: `["subpattern split", "focused ManaLoom tests per subpattern", "package generation only for exact supported subpatterns"]`
