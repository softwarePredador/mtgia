...
- Generated at: `2026-07-01T09:06:05.959576+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 3697 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 2353 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1210 | 389 |
| `battle_family_mapper_required` | 31342 | 230 |
...
| `battle_family::manual_model_review` | 7970 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
