...
- Generated at: `2026-07-07T09:04:30.151882+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6861 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5646 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5824 | 270 |
| `battle_family_mapper_required` | 28049 | 93 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6609 |
| `triggered_or_static_ability` | 3841 |
| `damage_or_life_total_change` | 3743 |
| `token_creation` | 3490 |
| `draw_selection_topdeck` | 3340 |
...
| `battle_family::manual_model_review` | 6609 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3743 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3340 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
