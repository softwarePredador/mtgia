...
- Generated at: `2026-07-02T00:11:13.517573+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4858 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3556 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2408 | 183 |
| `battle_family_mapper_required` | 30139 | 100 |
...
| `token_creation` | 3641 |
| `draw_selection_topdeck` | 3544 |
| `graveyard_recursion` | 1970 |
...
| `battle_family::draw_selection_topdeck` | 3544 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
| `battle_family::graveyard_recursion` | 1970 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Abhorrent Oculus`, `Abomination of Llanowar`, `Aboshan's Desire` |
