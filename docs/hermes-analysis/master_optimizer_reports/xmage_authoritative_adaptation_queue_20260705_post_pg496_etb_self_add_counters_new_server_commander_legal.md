...
- Generated at: `2026-07-05T09:09:35+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 26111 |
| `xmage_authoritative_source_count` | 25797 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 25797 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.988 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 25797 |
...
| `removal_destroy::targeted_destroy_variant_v1` | 583 |
| `add_counters::targeted_add_counters_variant_v1` | 454 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11596 |
| `token_maker` | 2401 |
| `recursion` | 1799 |
| `draw_engine` | 1593 |
| `add_counters` | 1225 |
...
| --- | ---: |
| `targeting` | 13729 |
| `triggered_ability` | 11752 |
| `static_ability` | 5529 |
| `activated_ability` | 5441 |
| `counter` | 3824 |
| `condition` | 3288 |
| `token` | 2453 |
| `draw` | 2128 |
