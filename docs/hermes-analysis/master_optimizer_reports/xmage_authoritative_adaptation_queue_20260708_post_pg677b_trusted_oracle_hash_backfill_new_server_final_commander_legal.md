...
- Generated at: `2026-07-08T23:36:56+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24853 |
| `xmage_authoritative_source_count` | 24540 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24540 |
| `manual_semantic_decision_units_remaining` | 313 |
| `authoritative_source_coverage_ratio` | 0.9874 |
| `adapter_work_unit_count` | 11315 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24540 |
...
| `draw_cards::xmage_draw_card_variant_review_v1` | 566 |
...
| `untap_target::xmage_targeted_untap_variant_review_v1` | 227 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11123 |
| `token_maker` | 2306 |
| `recursion` | 1792 |
| `draw_engine` | 1572 |
| `add_counters` | 1208 |
