...
- Generated at: `2026-06-30T06:48:46Z`
...
- Design contract: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_focus_access_package_design_20260628_v1.md`
...
- Access model: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_access_cut_model_20260628_v3_runtime_overlay.json`
- Runtime gap queue: `docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg268_cloud_key.json`
...
- `squee_access_density_model`: failure `squee_graveyard_entry_route`, seeds `7, 20260625`; Squee discard/return is modeled when accessed; Hidden Retreat is modeled through a read-only runtime proposal, but access model found 0 preflight-ready access swaps. Remaining blockers are approved PG apply/sync for product truth and a seed-safe cut model. Hidden Retreat package status: prepared_read_only_pending_apply_approval.
...
| ---: | --- | ---: | ---: | ---: | --- | --- |
| 1 | `runtime_rule_gap_batch` | 72 | 0 | 22 | `false` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_runtime_gap_family_queue.py --output-prefix docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg264_gisela` |
| 2 | `hand_filter_non_core_cut_search` | 66 | 23 | 0 | `false` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_hand_filter_cut_model.py --stem lorehold_hand_filter_cut_model_20260630_after_profiled_gate` |
...
- Evidence inputs: `docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg268_cloud_key.json`
...
- Runtime families:
  - `manual_model`: 12 cards, support `manual_model_required`, samples `Ancient Gold Dragon, Blood Moon, Chandra's Ignition, Ghoulcaller's Bell, Karn, the Great Creator, Kayla's Music Box`
  - `draw_engine`: 3 cards, support `runtime_family_partially_supported_review_required`, samples `Alhammarret's Archive, Currency Converter, Naktamun Lorespinner // Wheel of Fortune`
  - `recursion`: 3 cards, support `runtime_family_partially_supported_review_required`, samples `Charmbreaker Devils, Codex Shredder, Perpetual Timepiece`
  - `free_cast`: 2 cards, support `runtime_family_partially_supported_review_required`, samples `Assemble the Players, Chaos Wand`
  - `tutor`: 1 cards, support `runtime_family_partially_supported_review_required`, samples `Deathbellow War Cry`

### 2. hand_filter_non_core_cut_search
...
- Reason: Squee discard/return is modeled when accessed; Hidden Retreat is modeled through a read-only runtime proposal, but access model found 0 preflight-ready access swaps. Remaining blockers are approved PG apply/sync for product truth and a seed-safe cut model. Hidden Retreat package status: prepared_read_only_pending_apply_approval.
- Evidence inputs: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_access_cut_model_20260628_v3_runtime_overlay.json, /Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_squee_graveyard_entry_probe_20260628_v1.json`
