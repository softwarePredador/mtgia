...
- Generated at: `2026-07-04T21:33:48+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 26793 |
| `xmage_authoritative_source_count` | 26479 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 26479 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.9883 |
| `adapter_work_unit_count` | 11406 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 26479 |
...
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1137 |
| `direct_damage::targeted_damage_variant_v1` | 873 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11779 |
| `token_maker` | 2435 |
| `recursion` | 1819 |
| `draw_engine` | 1634 |
| `add_counters` | 1254 |
| `grant_protection_from_chosen_color` | 1143 |
| `direct_damage` | 878 |
| `life_gain` | 735 |
| `ramp_permanent` | 696 |
| `draw_cards` | 654 |
...
| --- | ---: |
| `targeting` | 14034 |
| `triggered_ability` | 11916 |
| `activated_ability` | 5613 |
| `static_ability` | 5545 |
| `counter` | 3871 |
| `condition` | 3295 |
| `token` | 2487 |
