...
- Generated at: `2026-07-01T09:39:22.609978+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4146 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 2804 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1656 | 389 |
| `battle_family_mapper_required` | 30891 | 230 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7571 |
| `damage_or_life_total_change` | 4071 |
| `triggered_or_static_ability` | 3907 |
| `token_creation` | 3695 |
| `draw_selection_topdeck` | 3624 |
| `graveyard_recursion` | 2016 |
...
| `battle_family::manual_model_review` | 7571 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
| `battle_family::damage_or_life_total_change` | 4071 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Acceptable Losses` |
