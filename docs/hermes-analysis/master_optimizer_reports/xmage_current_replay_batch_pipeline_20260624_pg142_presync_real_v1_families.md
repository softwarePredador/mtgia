...
- Summary: `{"batch_metadata_candidate_count": 3, "card_count": 253, "family_count": 3, "family_counts": {"copy_creature_token": 4, "manual_model": 240, "token_maker": 9}, "manual_or_blocked_count": 241, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 3, "blocked_missing_xmage_source": 3, "mapper_metadata_or_test_scenario_required": 237, "runtime_family_implementation_required": 9, "split_family_scope_review_required": 1}, "runtime_family_required_count": 9}`

| Family | Cards | Support | Lane counts | Implementation unit |
| --- | ---: | --- | --- | --- |
| `copy_creature_token` | 4 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 3, "split_family_scope_review_required": 1}` | copy-target token creation with haste and end-step cleanup |
...
- Family tests: `[]`
- Cards: `["Jaxis, the Troublemaker", "Rionya, Fire Dancer", "Kindle the Inner Flame", "The Jolly Balloon Man"]`
