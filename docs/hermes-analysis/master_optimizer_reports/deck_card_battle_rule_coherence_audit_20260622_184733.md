...
Generated at: `2026-06-22T18:47:33+00:00`
...
## Top 137 Actionable Cards

| Severity | Impact | Priority | Card | Decks | Qty | Findings | Effects |
| --- | --- | ---: | --- | ---: | ---: | --- | --- |
| `high` | `battle_critical` | 7102 | `Austere Command` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `board_wipe` |
| `high` | `battle_critical` | 7102 | `Blasphemous Act` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `board_wipe` |
| `high` | `battle_critical` | 7102 | `Boros Charm` | 2 | 2 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `indestructible`, `modal_boros_charm` |
...
| `high` | `battle_critical` | 7051 | `Aetherflux Reservoir` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `aetherflux_reservoir`, `finisher` |
...
| `medium` | `battle_critical` | 4051 | `Brainstone` | 1 | 1 | `trusted_rule_without_oracle_hash` | `topdeck_manipulation` |
