...
- Generated at: `2026-07-07T10:12:27.981087+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6890 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5675 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5853 | 270 |
| `battle_family_mapper_required` | 28020 | 93 |
...
| `damage_or_life_total_change` | 3733 |
| `token_creation` | 3490 |
| `draw_selection_topdeck` | 3331 |
| `graveyard_recursion` | 1890 |
| `targeted_removal` | 950 |
...
| `battle_family::damage_or_life_total_change` | 3733 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3331 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
...
| `battle_family::targeted_removal` | 950 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aftershock`, `Against All Odds`, `Agate Assault`, `Agent of Erebos` |
