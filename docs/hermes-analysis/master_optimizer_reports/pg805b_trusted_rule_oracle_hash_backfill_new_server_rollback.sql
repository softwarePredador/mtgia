\echo 'PG805B trusted rule oracle_hash backfill rollback'
...
WITH restored AS (
  ...
  SET
    ...
    notes = CONCAT_WS(
      E'\n',
      NULLIF(br.notes, ''),
      'PG805B rollback: oracle_hash restored from verified-rule backup.'
    )
  FROM manaloom_deploy_audit.pg805b_trusted_rule_oracle_hash_backfill_new_server_20260712 b
