...
- generated_at: `2026-06-27T19:38:03Z`
...
| 2 |  | Lorehold synergy package: ghostly_prison_pressure_cut_promise (`synergy_ghostly_prison_pressure_cut_promise`) | synergy-package | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 2 | 1 | 1 | 0 | 0 | 0 | 0 | 3 | none |
...
### 2. Lorehold synergy package: ghostly_prison_pressure_cut_promise (`synergy_ghostly_prison_pressure_cut_promise`)
...
**Strategic event counts:** lorehold_cost_paid=31, lorehold_spell_cast=24, lorehold_upkeep_rummage=20, miracle_cast=4, topdeck_manipulation_activated=1, discard_to_top_replacement=1, lorehold_rummage_discard_to_top=1
