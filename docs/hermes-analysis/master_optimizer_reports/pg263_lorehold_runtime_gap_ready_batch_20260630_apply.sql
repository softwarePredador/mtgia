...
CREATE TABLE manaloom_deploy_audit.pg263_lorehold_runtime_gap_ready_batch_20260630_20260630 AS
SELECT *
...
BEGIN
  ...
  VALUES
    ...
    ('twinflame tyrant', 'Twinflame Tyrant', 'e4ca0585f743b1c34c36649bfbb1fff6', 'battle_rule_v1:2b4bda8e443bbbf48e1654884d61355c', '{"ability_kind":"static","battle_model_scope":"controlled_source_damage_to_opponent_or_opponent_permanent_doubled_v1","damage_modifier_applies_to":"sources_you_control","damage_modifier_duration":"while_on_battlefield","damage_modifier_targets":["opponents","opponent_permanents"],"damage_multiplier":2,"effect":"damage_modifier","flying":true,"power":3,"toughness":5}'::jsonb, '{"category":"wincon","effect":"damage_modifier","subtype":"damage_doubler","timing":"static"}'::jsonb, 'curated', 0.94, 'verified', 'auto', 'XMage batch proposal: exact local XMage class TwinflameTyrant mapped to family static_damage_modifier; requires Oracle/hash precheck, ManaLoom review, and approved PG apply before product use.', 'deprecate_nonmatching_rows'),
    ...
    ('balefire liege', 'Balefire Liege', '467dd11263f2854e2d9fc487a127ced6', 'battle_rule_v1:4b0fa54a51902d1376423ffc131a34f0', '{"ability_kind":"triggered","battle_model_scope":"red_spell_damage_white_spell_lifegain_static_creature_boost_v1","effect":"creature","power":2,"red_spell_trigger_damage":3,"red_spell_trigger_damage_target":"player_or_planeswalker","static_boost_other_red_creatures_you_control":{"power":1,"toughness":1},"static_boost_other_white_creatures_you_control":{"power":1,"toughness":1},"target_constraints":{"card_types":["creature"],"zone":"stack"},"toughness":4,"trigger":"spell_cast","trigger_effect":"spell_color_damage_life","white_spell_trigger_gain_life":3}'::jsonb, '{"category":"burn_lifegain_engine","effect":"spell_color_damage_life","subtype":"red_spell_damage_white_spell_lifegain","timing":"static_and_triggered"}'::jsonb, 'curated', 0.94, 'verified', 'auto', 'XMage batch proposal: exact local XMage class BalefireLiege mapped to family targeted_interaction; requires Oracle/hash precheck, ManaLoom review, and approved PG apply before product use.', 'deprecate_nonmatching_rows'),
    ...
    ('repercussion', 'Repercussion', '8e1ed4f8063ab89dd8906878a6232862', 'battle_rule_v1:9eb5bda15d554b0e5a97637322f4969c', '{"ability_kind":"triggered_static_enchantment","battle_model_scope":"creature_damage_controller_reflect_global_v1","damage_amount_source":"damage_dealt_to_creature","effect":"passive","global_creature_damage_reflect_to_controller":true,"trigger":"creature_dealt_damage","trigger_effect":"damage_creature_controller"}'::jsonb, '{"category":"burn_engine","effect":"damage_reflection","subtype":"creature_damage_controller_reflect","timing":"triggered"}'::jsonb, 'curated', 0.94, 'verified', 'auto', 'XMage batch proposal: exact local XMage class Repercussion mapped to family targeted_interaction; requires Oracle/hash precheck, ManaLoom review, and approved PG apply before product use.', 'deprecate_nonmatching_rows')
),
  counts AS (
    SELECT
      p.card_name,
