...
- Generated at: `2026-07-01T08:04:39.274538+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 3647 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 2296 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1153 | 388 |
| `battle_family_mapper_required` | 31399 | 231 |
...
| `battle_family::recursion_or_bounce` | 600 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Adun Oakenshield`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe` |
...
| `battle_family::counterspell_or_stack_interaction` | 412 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abjure`, `Absorb`, `Abstruse Interference`, `Access Denied`, `Admiral's Order`, `Adric, Mathematical Genius`, `Amazing Acrobatics`, `Annul`, `Anticognition`, `Archmage's Charm` |
