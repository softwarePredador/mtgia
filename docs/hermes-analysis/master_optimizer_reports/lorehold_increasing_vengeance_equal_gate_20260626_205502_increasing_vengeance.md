...
- generated_at: `2026-06-26T21:02:21Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_increasing_vengeance_equal_gate_20260626_205502_increasing_vengeance_game_checkpoint.json`
...
| 2 |  | Lorehold 607 Increasing Vengeance equal gate (`candidate_607_increasing_vengeance_equal_gate`) | optimizer-equal-gate | 9 | 2 | 7 | 0 | 22.22% | 15.00 | 4 | 4 | none |
...
### 2. Lorehold 607 Increasing Vengeance equal gate (`candidate_607_increasing_vengeance_equal_gate`)
...
| Sisay, Weatherlight Captain #61 (real) | 1 | 2 | 0 | 33.33% | 13.00 | approach=1 |
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 17.00 | elimination=1 |

**Strategic event counts:** lorehold_cost_paid=98, lorehold_spell_cast=85, topdeck_manipulation_activated=20, miracle_cast=14
