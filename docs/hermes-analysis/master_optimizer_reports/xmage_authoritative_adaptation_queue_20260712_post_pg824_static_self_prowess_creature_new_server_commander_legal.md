...
- Generated at: `2026-07-12T10:00:22+00:00`
...
| `adapter_work_unit_count` | 11234 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 23903 |
...
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1061 |
...
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 232 |
...
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 111 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 10881 |
| `token_maker` | 2266 |
| `recursion` | 1781 |
| `draw_engine` | 1553 |
| `add_counters` | 1189 |
| `grant_protection_from_chosen_color` | 1067 |
| `direct_damage` | 736 |
| `life_gain` | 628 |
| `tutor` | 578 |
| `draw_cards` | 528 |
