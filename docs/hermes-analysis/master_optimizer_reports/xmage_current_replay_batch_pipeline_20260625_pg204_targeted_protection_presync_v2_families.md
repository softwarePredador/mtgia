...
- Summary: `{"batch_metadata_candidate_count": 2, "card_count": 438, "family_count": 11, "family_counts": {"board_wipe_choice": 4, "creature": 4, "manual_model": 343, "mill_spell": 1, "modal_spell": 1, "recursion": 2, "static_cost_reducer": 2, "targeted_interaction": 58, "targeted_protection": 2, "token_maker": 17, "tutor": 4}, "manual_or_blocked_count": 416, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 2, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 340, "runtime_family_implementation_required": 20, "split_family_scope_review_required": 72}, "runtime_family_required_count": 20}`
...
| `manual_model` | 343 | `manual_model_required` | `{"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 339}` | manual Oracle/reference review |
...
| `targeted_protection` | 2 | `runtime_supported_family` | `{"batch_metadata_candidate_requires_pg_precheck": 2}` | targeted own-creature protection grant and cleanup-aware target legality |
