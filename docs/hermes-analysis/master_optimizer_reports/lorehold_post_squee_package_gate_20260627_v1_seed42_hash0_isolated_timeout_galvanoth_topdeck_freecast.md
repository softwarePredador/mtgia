...
- generated_at: `2026-06-27T15:57:06Z`
...
| 2 |  | Lorehold synergy package: galvanoth_topdeck_freecast (`synergy_galvanoth_topdeck_freecast`) | synergy-package | 9 | 4 | 5 | 0 | 44.44% | 15.00 | 7 | 5 | 2 | 1 | 1 | 0 | 9 | none |
...
### 2. Lorehold synergy package: galvanoth_topdeck_freecast (`synergy_galvanoth_topdeck_freecast`)
...
| Opponent | W | L | S | WR | Avg Win Turn | Reasons |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Vivi Ornitier #99 (real) | 2 | 1 | 0 | 66.67% | 15.00 | elimination=2 |
| Sisay, Weatherlight Captain #61 (real) | 2 | 1 | 0 | 66.67% | 15.00 | approach=1, elimination=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=133, lorehold_spell_cast=112, lorehold_upkeep_rummage=35, miracle_cast=27, lorehold_spell_rummage=8, topdeck_manipulation_activated=30, squee_to_graveyard=2, graveyard_upkeep_return_self_to_hand=1, squee_upkeep_return=1, squee_return_after_known_graveyard_entry=1
