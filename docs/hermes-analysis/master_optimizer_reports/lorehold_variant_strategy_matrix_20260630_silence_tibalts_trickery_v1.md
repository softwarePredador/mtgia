...
- Generated at: `2026-06-30T03:25:14.722379+00:00`
- Strategy profile: `lorehold_strategy_profile_v3_2026_06_26`
- Scope: decks `607, 614, 615, 616` plus candidate v7 when available.
- Best structural deck before equal battle gate: `candidate_607_silence_tibalts_trickery_v1`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| 1 | Lorehold 607 + Silence over Tibalt's Trickery v1 (`candidate_607_silence_tibalts_trickery_v1`) | 607-silence-tibalts-trickery | 141.0 | 100.0 | 34 | 97.9% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | recursion_role, tutor_role |
...
## 1. Lorehold 607 + Silence over Tibalt's Trickery v1 (`candidate_607_silence_tibalts_trickery_v1`)
