...
- Generated at: `2026-07-04T10:47:38.466405+00:00`
- Status: `pass`
...
| `sqlite_rows.card_oracle_cache` | `pass` | rows=6207 |
...
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=6207 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=6207 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=6207 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=7793 |
