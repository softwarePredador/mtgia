...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pgc066_cant_block_runtime_20260629') IS NULL THEN
    RAISE EXCEPTION 'PGC066 backup table is missing';
  END IF;
END $$;
...
SET
  ...
  updated_at = now()
FROM manaloom_deploy_audit.pgc066_cant_block_runtime_20260629 b
