...
- `proposal_count`: `363`
- `pattern_count`: `44`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 260, "package_ready_unprepared": 2, "runtime_family_backlog": 22, "split_scope_backlog": 75}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 18, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 10, "runtime_template_candidate_requires_executor_tests": 2}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 18, "manual_model_observation_only": 260, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 66, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `creature/creature/sand_scout_etb_desert_if_behind_lands_land_graveyard_token_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
| `token_maker/composite_resolution/create_four_birds_gift_phase_all_life_lock_protection_exile_self_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### creature / creature / sand_scout_etb_desert_if_behind_lands_land_graveyard_token_v1

- Pattern id: `xmage_pattern:1eeb22f3ce740b0a2e38`
...
### token_maker / composite_resolution / create_four_birds_gift_phase_all_life_lock_protection_exile_self_v1

- Pattern id: `xmage_pattern:1d78483478d6b45ed16a`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Perch Protection)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`
