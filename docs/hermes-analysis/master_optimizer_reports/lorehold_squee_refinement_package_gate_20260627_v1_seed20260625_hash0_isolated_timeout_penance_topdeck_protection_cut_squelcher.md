...
- generated_at: `2026-06-27T16:10:05Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: penance_topdeck_protection_cut_squelcher (`synergy_penance_topdeck_protection_cut_squelcher`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 10.50 | 6 | 5 | 1 | 1 | 1 | 0 | 5 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 2 | 1 | 0 | 0 | 0 | 0 | 8 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: penance_topdeck_protection_cut_squelcher (`synergy_penance_topdeck_protection_cut_squelcher`)
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Vivi Ornitier #99 (real) | 1 | 2 | 0 | 33.33% | 6.00 | approach=1 |
| Sisay, Weatherlight Captain #61 (real) | 1 | 2 | 0 | 33.33% | 15.00 | approach=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=81, lorehold_spell_cast=64, lorehold_upkeep_rummage=28, topdeck_manipulation_activated=13, miracle_cast=13, squee_to_graveyard=1, graveyard_upkeep_return_self_to_hand=1, squee_upkeep_return=1, squee_return_after_known_graveyard_entry=1
