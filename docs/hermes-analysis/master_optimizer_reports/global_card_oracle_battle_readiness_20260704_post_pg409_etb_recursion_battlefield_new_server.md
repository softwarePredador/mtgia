...
- Generated at: `2026-07-04T14:28:58.824240+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5372 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4108 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4243 | 252 |
| `battle_family_mapper_required` | 29587 | 98 |
...
| `battle_family::mana_generation_or_ritual` | 882 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Aetheric Amplifier`, `Agility Bobblehead` |
