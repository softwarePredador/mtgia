...
- generated_at: `2026-06-27T16:09:34Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: birgi_spellchain_cut_squelcher (`synergy_birgi_spellchain_cut_squelcher`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 14.50 | 2 | 2 | 1 | 0 | 0 | 0 | 7 | none |
...
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 10.00 | approach=1 |

**Strategic event counts:** lorehold_cost_paid=65, lorehold_spell_cast=48, lorehold_upkeep_rummage=22, topdeck_manipulation_activated=5, squee_to_graveyard=1, spell_cast_mana_trigger=5, birgi_spell_cast_mana=5, lorehold_spell_rummage=5, miracle_cast=2
