...
- Generated at: `2026-07-06T12:28:13.624101+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6585 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5362 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5540 | 269 |
| `battle_family_mapper_required` | 28333 | 94 |
...
| `counterspell_or_stack_interaction` | 364 |
...
| `battle_family::counterspell_or_stack_interaction` | 364 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abjure`, `Abstruse Interference`, `Access Denied`, `Admiral's Order`, `Adric, Mathematical Genius`, `Amazing Acrobatics`, `Anticognition`, `Archmage's Charm`, `Arenson's Aura`, `Artistic Refusal` |
