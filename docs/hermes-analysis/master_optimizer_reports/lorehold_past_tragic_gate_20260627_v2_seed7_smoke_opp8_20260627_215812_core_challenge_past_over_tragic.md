...
- generated_at: `2026-06-27T21:58:25Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: core_challenge_past_over_tragic (`synergy_core_challenge_past_over_tragic`) | synergy-package | 8 | 2 | 5 | 1 | 25.00% | 16.00 | 5 | 2 | 2 | 2 | 2 | 2 | 0 | 6 | none |
...
| Sisay, Weatherlight Captain #61 (real) | 1 | 0 | 0 | 100.00% | 13.00 | elimination=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 1 | 0 | 0.00% | 0.00 |  |
| Kenrith, the Returned King #113 (real) | 0 | 0 | 1 | 0.00% | 0.00 |  |
...
**Strategic event counts:** lorehold_cost_paid=101, lorehold_spell_cast=79, lorehold_upkeep_rummage=28, miracle_cast=16, topdeck_manipulation_activated=26, thor_cost_paid=1, thor_spell_cast=1, squee_to_graveyard=5, graveyard_upkeep_return_self_to_hand=4, squee_upkeep_return=4, squee_return_after_known_graveyard_entry=4, lorehold_spell_rummage=2, discard_to_top_replacement=13, lorehold_rummage_discard_to_top=13
