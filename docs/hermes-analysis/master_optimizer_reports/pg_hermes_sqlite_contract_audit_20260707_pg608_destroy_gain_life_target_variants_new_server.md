...
- Generated at: `2026-07-07T10:10:43.632049+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=6693 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=6693 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=7803 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=7803 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=7803 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=5781 pg_runtime_keys=8293 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9456 |
