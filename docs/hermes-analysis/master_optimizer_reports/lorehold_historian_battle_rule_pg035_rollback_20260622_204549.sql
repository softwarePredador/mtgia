...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pg035_lorehold_historian_battle_rule_20260622_204549') IS NULL THEN
    RAISE EXCEPTION 'PG035 rollback backup table is missing';
  END IF;
END $$;
...
WHERE normalized_name = 'lorehold, the historian'
  AND (
    ...
    OR logical_rule_key IN (
      ...
      FROM manaloom_deploy_audit.pg035_lorehold_historian_battle_rule_20260622_204549
...
SELECT
  'pg035_rollback_result' AS check_name,
  card_name,
  logical_rule_key,
  effect_json,
  source,
