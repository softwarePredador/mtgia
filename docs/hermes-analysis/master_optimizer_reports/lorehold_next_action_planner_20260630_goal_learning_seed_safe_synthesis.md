...
- Generated at: `2026-06-30T23:01:01Z`
...
| ---: | --- | --- | --- | --- | --- | --- |
| -5 | `rework_from_scratch_shell_after_current_shells_rejected` | `from_scratch_shells_not_promotable` | `multi_card_shell` | challenger_lorehold_miracle_pressure_conversion_v1, challenger_lorehold_recursion_discard_engine_v1, challenger_lorehold_recursion_discard_pressure_repair_v1 | none | Current from-scratch shells already tested against fixed 607 do not beat the protected baseline. The pressure-repair shell improves Squee telemetry, but still loses the 8x3 gate, so the next shell must repair conversion/pressure without discarding the 607 floor. |
