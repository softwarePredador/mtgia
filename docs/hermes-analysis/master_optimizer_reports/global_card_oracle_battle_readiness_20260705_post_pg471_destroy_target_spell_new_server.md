...
- Generated at: `2026-07-05T02:15:39.609365+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5661 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4397 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4575 | 265 |
| `battle_family_mapper_required` | 29298 | 98 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7094 |
| `triggered_or_static_ability` | 3897 |
| `damage_or_life_total_change` | 3845 |
| `token_creation` | 3609 |
| `draw_selection_topdeck` | 3415 |
...
| `battle_family::manual_model_review` | 7094 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3845 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3415 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
