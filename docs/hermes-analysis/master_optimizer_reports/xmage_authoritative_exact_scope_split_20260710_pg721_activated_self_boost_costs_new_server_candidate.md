...
- `activated_self_boost_oracle_cost_not_supported`: `["Cutthroat Centurion", "Dai Li Censor", "Llanowar Behemoth", "Moltensteel Dragon", "Topan Ascetic", "Vampire Aristocrat"]`
...
- `activated_self_keyword_source_discard_cost_not_supported`: `["Face of Fear"]`
...
- `mana_source_effect_class_not_simple`: `["Animal Attendant", "Avid Reclaimer", "Biophagus", "Carnelian Orb of Dragonkind", "Doubling Cube // Doubling Cube", "Heritage Druid", "Ilysian Caryatid", "Leafkin Druid", "Raucous Audience", "Sacellum Godspeaker", "Selvala, Explorer Returned", "Seton, Krosan Protector"]`
