...
- Package manifests scanned: `67`
- Cards covered by package manifests: `186`

## Effective Lanes

- `package_already_prepared`: `0`
- `package_ready_unprepared`: `0`
- `split_scope_backlog`: `77`
...
- `P1` After the PG-ready lane shrinks, batch the biggest split-scope cluster. Reason: The partially supported backlog is 77 cards. Top exact cluster: targeted_damage_variant_v1 (20)
