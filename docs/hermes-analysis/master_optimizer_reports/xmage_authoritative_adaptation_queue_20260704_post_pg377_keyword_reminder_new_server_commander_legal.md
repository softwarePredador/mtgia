...
- Generated at: `2026-07-04T01:43:17+00:00`
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 26681 |
...
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1130 |
...
| `draw_cards::xmage_draw_card_variant_review_v1` | 636 |
...
| `draw_engine` | 1634 |
| `add_counters` | 1254 |
| `grant_protection_from_chosen_color` | 1136 |
| `direct_damage` | 911 |
| `ramp_permanent` | 740 |
| `life_gain` | 735 |
| `tutor` | 638 |
...
| --- | ---: |
| `targeting` | 14054 |
| `triggered_ability` | 11919 |
| `activated_ability` | 5649 |
| `static_ability` | 5545 |
| `counter` | 3865 |
| `condition` | 3295 |
| `token` | 2487 |
