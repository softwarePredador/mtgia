...
- Generated at: `2026-06-30T16:13:11.662544+00:00`
- Status: `pass`
...
| `sqlite_rows.battle_card_rules` | `pass` | rows=5388 |
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=5388 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=5388 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=4868 pg_runtime_keys=4865 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=5704 |
