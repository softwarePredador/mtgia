...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 446, "family_count": 9, "family_counts": {"board_wipe_choice": 4, "creature": 5, "manual_model": 349, "mill_spell": 1, "modal_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 62, "token_maker": 18, "tutor": 4}, "manual_or_blocked_count": 424, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 346, "runtime_family_implementation_required": 21, "split_family_scope_review_required": 74}, "runtime_family_required_count": 21}`
...
| `manual_model` | 349 | `manual_model_required` | `{"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 345}` | manual Oracle/reference review |
...
| `token_maker` | 18 | `runtime_family_required` | `{"mapper_metadata_or_test_scenario_required": 1, "runtime_family_implementation_required": 17}` | token creation with stats, abilities, duration, and zone cleanup |
...
- Family tests: `[]`
- Cards: `["Razaketh, the Foulblooded", "Rune-Scarred Demon", "Goldspan Dragon", "Blood Artist", "Starfield Shepherd"]`
...
- Batch strategy: `implement_family_before_metadata_batch`
- Family tests: `[]`
- Cards: `["Bone Miser", "Maskwood Nexus", "Monastery Mentor", "Spiked Corridor // Torture Pit", "The Locust God", "Utvara Hellkite", "Waste Not", "Surly Badgersaur"]`
