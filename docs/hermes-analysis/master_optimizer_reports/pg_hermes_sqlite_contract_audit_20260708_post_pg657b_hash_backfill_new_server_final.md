...
- Generated at: `2026-07-08T13:29:40.469518+00:00`
- Status: `pass`
...
| `sqlite_rows.card_oracle_cache` | `pass` | rows=7937 |
...
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=7937 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=7937 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=7937 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=5928 pg_runtime_keys=8431 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9604 |
