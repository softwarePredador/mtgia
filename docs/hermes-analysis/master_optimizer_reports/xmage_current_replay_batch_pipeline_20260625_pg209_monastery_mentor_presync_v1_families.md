...
| `token_maker` | 17 | `runtime_family_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "mapper_metadata_or_test_scenario_required": 1, "runtime_family_implementation_required": 15}` | token creation with stats, abilities, duration, and zone cleanup |
