...
- Generated at: `2026-06-30T11:31:09Z`
...
- Promotion lanes: `{"split_family_scope_review_required": 16}`
...
| 8 | `mill_spell` | 1 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 1}` | `{"split_family_scope_review_required": 1}` | target-player library milling, storm copy counting, and activated mill engines |
| 9 | `tutor` | 1 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 1}` | `{"split_family_scope_review_required": 1}` | library search, constrained target selection, and zone movement to hand, top, graveyard, or battlefield |
...
| Card | Score | Variant decks | Lane | Promotion | Subfamily | Next step | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| `Ghoulcaller's Bell` | -10 | `610` | `contextual` | `split_family_scope_review_required` | `` |  | `mill_engine` | `xmage_artifact_tap_each_player_mill_one_review_v1` | `GhoulcallersBell` |
