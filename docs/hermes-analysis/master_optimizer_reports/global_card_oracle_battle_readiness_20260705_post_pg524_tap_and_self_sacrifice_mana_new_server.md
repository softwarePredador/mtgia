...
- Generated at: `2026-07-05T19:08:47.422084+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6057 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4814 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4992 | 266 |
| `battle_family_mapper_required` | 28881 | 97 |
...
| `battle_family::mana_generation_or_ritual` | 848 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Aetheric Amplifier`, `Agility Bobblehead` |
