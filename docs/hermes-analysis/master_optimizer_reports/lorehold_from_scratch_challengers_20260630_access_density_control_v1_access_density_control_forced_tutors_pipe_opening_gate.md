...
- generated_at: `2026-06-30T20:33:14Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_from_scratch_challengers_20260630_access_density_control_v1_access_density_control_forced_tutors_pipe_opening_gate_game_checkpoint.json`
...
| 2 | 4 | Lorehold From-Scratch Access Density Control v1 (`challenger_lorehold_access_density_control_v1`) | from-scratch-access-density-control | 4 | 0 | 4 | 0 | 0.00% | 0.00 | 2 | 1 | 0 | 1 | 1 | 1 | 0 | 2 | 31 | 0 | Crawlspace: events=1, restricted=1, tax=0, Silent Arbiter: events=17, restricted=30, tax=0 | recursion_role, tutor_role |
...
- construction_valid: `True`
- deck shape: size `100`, lands `34`, ramp `19`, removal `13`
...
**Strategic event counts:** birgi_spell_cast_mana=5, graveyard_upkeep_return_self_to_hand=3, lorehold_cost_paid=30, lorehold_rummage_discards_squee=4, lorehold_spell_cast=24, lorehold_upkeep_rummage=7, miracle_cast=2, spell_cast_mana_trigger=5, squee_return_after_known_graveyard_entry=3, squee_to_graveyard=4, squee_upkeep_return=3, static_cost_reduction_casts=1, static_cost_reduction_total=1, topdeck_manipulation_activated=2

**Lorehold attack restriction telemetry:** events=18, attackers_before=50, attackers_after=19, attackers_restricted=31, tax_paid=0, sources=Crawlspace: events=1, restricted=1, tax=0, Silent Arbiter: events=17, restricted=30, tax=0
