...
- `matrix`: `docs/hermes-analysis/master_optimizer_reports/lorehold_miracle_access_structure_matrix_contract_20260705_post_authorized_full_validation.json`
...
| --- | --- | --- | --- |
| Brain in a Jar | `topdeck_miracle_access` | `topdeck_miracle_access, turn_cycle_miracle_mana` | `matrix_contract_blockers_not_cleared, named_safe_cut_missing` |
