...
- Generated at: `2026-07-05T08:05:08.083260+00:00`
- Status: `pass`
...
| `sqlite_rows.card_oracle_cache` | `pass` | rows=6810 |
...
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=6810 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=6810 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=6810 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=4745 pg_runtime_keys=7338 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=8420 |
