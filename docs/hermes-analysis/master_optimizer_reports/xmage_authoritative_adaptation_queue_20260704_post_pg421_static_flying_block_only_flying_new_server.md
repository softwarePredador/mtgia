...
- Generated at: `2026-07-04T18:41:24+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 26450 |
| `xmage_authoritative_source_count` | 26136 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 26136 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.9881 |
| `adapter_work_unit_count` | 11415 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 26136 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11771 |
| `token_maker` | 2411 |
| `recursion` | 1799 |
| `draw_engine` | 1610 |
| `add_counters` | 1254 |
