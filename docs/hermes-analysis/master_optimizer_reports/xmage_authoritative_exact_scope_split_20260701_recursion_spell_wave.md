...
- Generated at: `2026-07-01T08:34:58+00:00`
- Status: `ready`
- Mutations performed: `[]`

## Summary

`{"adapter_work_unit_counts": {"recursion::xmage_graveyard_return_variant_review_v1": 22}, "blocked_reason_counts": {"additional_cost_detected": 126, "bounce_ability_class_not_simple": 28, "bounce_effect_class_not_pure": 44, "bounce_target_not_supported": 20, "counter_ability_class_not_simple": 19, "counter_effect_class_not_pure": 35, "counter_oracle_not_simple": 2, "counter_target_not_supported": 23, "damage_amount_not_fixed": 45, "damage_effect_class_not_pure": 123, "damage_target_not_supported": 24, "destroy_effect_class_not_pure": 138, "destroy_target_not_supported": 74, "draw_effect_class_not_pure": 562, "exile_effect_class_not_pure": 42, "exile_oracle_not_simple": 9, "exile_target_not_supported": 29, "life_gain_amount_not_fixed": 19, "life_gain_effect_class_not_pure": 166, "life_gain_oracle_not_simple": 11, "mana_source_effect_class_not_simple": 307, "mana_source_oracle_not_simple": 121, "mana_source_safe_ability_missing": 133, "mana_source_spell_not_supported": 1, "mana_source_unsafe_ability_class": 135, "not_instant_or_sorcery_spell": 3538, "not_one_shot_spell_ability": 229, "recursion_ability_class_not_simple": 13, "recursion_effect_class_not_pure": 461, "recursion_oracle_not_simple": 12, "recursion_target_not_supported": 8}, "considered_supported_work_unit_rows": 6519, "family_counts": {"xmage_graveyard_to_hand_spell": 22}, "proposal_count": 22, "proposal_status_counts": {"batch_pg_candidate_after_precheck": 22}, "safe_for_batch_pg_package_count": 22, "scope_counts": {"xmage_return_target_graveyard_card_to_hand_spell_v1": 22}}`

## Selected Proposals

| Card | Family | Scope | Effect | Logical rule key |
| --- | --- | --- | --- | --- |
| `Argivian Find` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:65364d83bdc42005334bdc5e2beb030e` |
| `Auroral Procession` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:88eb859326f7c2ca056b23bbf2ee72e3` |
| `Call to Mind` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:09f4174ea055020453e3a6674fd8851c` |
| `Disentomb` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:a3505b26aba1e7ec386ea80a4e04a8ef` |
| `Dutiful Return` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:038c5d2096ae7ffffaded58f0289ae35` |
| `Déjà Vu` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:00bde5102b35dfc8bedecd71f171db1e` |
| `Elven Cache` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:eb9293e87c407c24527dd473f0a97bba` |
| `Fight On!` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:668fd8c565abb60114683bd434eaa5af` |
| `March of the Returned` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:038c5d2096ae7ffffaded58f0289ae35` |
| `Morbid Plunder` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:038c5d2096ae7ffffaded58f0289ae35` |
| `Nature's Spiral` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:d6d6fac158619d687cdd564ae1e57bdc` |
| `Raise Dead` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:a3505b26aba1e7ec386ea80a4e04a8ef` |
| `Recollect` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:eb9293e87c407c24527dd473f0a97bba` |
| `Reconstruction` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:125148735136c035c5f721fa216282c3` |
| `Regenesis` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:074e4073cc18b1b40fa39a5201df2654` |
| `Regrowth` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:eb9293e87c407c24527dd473f0a97bba` |
| `Relearn` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:09f4174ea055020453e3a6674fd8851c` |
| `Return to Battle` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:a3505b26aba1e7ec386ea80a4e04a8ef` |
| `Ritual of Restoration` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:125148735136c035c5f721fa216282c3` |
| `Sage's Knowledge` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:00bde5102b35dfc8bedecd71f171db1e` |
| `Soul Salvage` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:038c5d2096ae7ffffaded58f0289ae35` |
| `Wildwood Rebirth` | `xmage_graveyard_to_hand_spell` | `xmage_return_target_graveyard_card_to_hand_spell_v1` | `recursion` | `battle_rule_v1:68abeb7ac55d0de86280cc7cbfdae17f` |
...
- `not_instant_or_sorcery_spell`: `["Aang, A Lot to Learn", "Abandoned Sarcophagus", "Aberrant", "Aberrant Mind Sorcerer", "Abhorrent Oculus", "Abiding Grace", "Abomination", "Abomination of Llanowar", "Absolver Thrull", "Absolving Lammasu", "Abyssal Hunter", "Academy Journeymage"]`
- `not_one_shot_spell_ability`: `["Ajani's Response", "Aleatory", "All Hallow's Eve", "Arm with Aether", "Arwen's Gift", "Astral Confrontation", "Back for More", "Balduvian Rage", "Banish from Edoras", "Benefactor's Draught", "Bind", "Bind // Liberate"]`
