...
- Summary: `{"batch_metadata_candidate_count": 0, "card_count": 311, "family_count": 3, "family_counts": {"manual_model": 251, "targeted_interaction": 35, "token_maker": 25}, "manual_or_blocked_count": 286, "promotion_lane_counts": {"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 247, "runtime_family_implementation_required": 25, "split_family_scope_review_required": 35}, "runtime_family_required_count": 25}`
...
| `targeted_interaction` | 35 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 35}` | target legality, resolution, zone transition, and event provenance |
