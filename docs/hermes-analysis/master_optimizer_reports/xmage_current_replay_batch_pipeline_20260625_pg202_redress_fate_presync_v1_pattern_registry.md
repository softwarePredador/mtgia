...
- `proposal_count`: `441`
- `pattern_count`: `42`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 344, "package_already_prepared": 1, "runtime_family_backlog": 20, "split_scope_backlog": 72}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 344, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `recursion/recursion/return_all_artifact_enchantment_cards_from_graveyard_to_battlefield_miracle_v1` | `package_already_prepared` | `governance_only_pending_pg_apply` | 1 | 1 | Do not remodel; move through the existing PostgreSQL approval/apply/sync/audit gate. |
...
### recursion / recursion / return_all_artifact_enchantment_cards_from_graveyard_to_battlefield_miracle_v1

- Pattern id: `xmage_pattern:aa191ded09d204b73074`
- Lane: `package_already_prepared`
- Status: `governance_only_pending_pg_apply`
- Cards: `1` (Redress Fate)
- Subpatterns: `1`
