...
- Generated at: `2026-07-01T21:58:04.153344+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4831 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3520 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2372 | 394 |
| `battle_family_mapper_required` | 30175 | 225 |
...
| `graveyard_recursion` | 1990 |
| `targeted_removal` | 1075 |
...
| `battle_family::graveyard_recursion` | 1990 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Aberrant Return`, `Abhorrent Oculus`, `Abomination of Llanowar` |
| `battle_family::targeted_removal` | 1075 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Acid Web Spider`, `Acidic Slime`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock` |
...
| `battle_family::recursion_or_bounce` | 512 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
