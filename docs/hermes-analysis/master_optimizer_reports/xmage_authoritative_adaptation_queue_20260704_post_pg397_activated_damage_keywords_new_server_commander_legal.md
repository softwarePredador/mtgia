...
- Generated at: `2026-07-04T09:34:33+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 26787 |
| `xmage_authoritative_source_count` | 26473 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 26473 |
...
| `direct_damage::targeted_damage_variant_v1` | 851 |
...
| `draw_cards::xmage_draw_card_variant_review_v1` | 605 |
...
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 352 |
| `parser_gap::unknown_superclass::no_signal` | 314 |
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 295 |
...
| --- | ---: |
| `targeting` | 13944 |
| `triggered_ability` | 11868 |
| `activated_ability` | 5594 |
| `static_ability` | 5545 |
| `counter` | 3865 |
| `condition` | 3295 |
| `token` | 2463 |
