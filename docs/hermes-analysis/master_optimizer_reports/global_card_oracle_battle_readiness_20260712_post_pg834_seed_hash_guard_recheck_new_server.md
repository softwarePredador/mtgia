...
- Generated at: `2026-07-12T17:22:24.860910+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7974 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6825 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6718 | 268 |
| `battle_family_mapper_required` | 27079 | 87 |
| `battle_rule_verification_required` | 67 | 9 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6190 |
| `triggered_or_static_ability` | 3809 |
| `damage_or_life_total_change` | 3638 |
| `token_creation` | 3450 |
| `draw_selection_topdeck` | 3204 |
| `graveyard_recursion` | 1876 |
| `targeted_removal` | 876 |
| `tutor_search_library` | 742 |
| `modal_or_choice_effect` | 697 |
| `mana_generation_or_ritual` | 595 |
...
| --- | ---: | --- | --- |
| `battle_rule_verification_required` | 67 | active executable rule exists, but snapshot has no verified rule; run focused runtime/E2E proof, then promote review_status to verified via PG package | `Aetherflux Reservoir`, `Apex of Power`, `Approach of the Second Sun`, `Arcane Endeavor`, `Archaeomancer's Map`, `Austere Command`, `Basking Broodscale`, `Blind Obedience`, `Boros Charm`, `Breena, the Demagogue` |
| `battle_family::manual_model_review` | 6190 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
| `battle_family::triggered_or_static_ability` | 3809 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ _____ Rocketship`, `Aang, at the Crossroads // Aang, Destined Savior`, `Aang, the Last Airbender`, `Abbot of Keral Keep`, `Aberrant Manawurm`, `Abigale, Poet Laureate // Heroic Stanza`, `Aboleth Spawn`, `Abomination`, `Aboroth`, `Absorbing Man` |
| `battle_family::damage_or_life_total_change` | 3638 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3204 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite`, `Academy Loremaster` |
| `battle_family::graveyard_recursion` | 1876 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Abhorrent Oculus`, `Aboshan's Desire`, `Abstract Performance` |
...
| `battle_family::mana_generation_or_ritual` | 595 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon`, `Altar of Shadows` |
...
| `Soulfire Eruption` | 400 | `battle_rule_verification_required` | `damage_or_life_total_change` | 0 | 13 | `unchecked` |
| `Spelltwine` | 400 | `battle_rule_verification_required` | `targeted_removal` | 0 | 0 | `unchecked` |
| `Sunforger` | 400 | `battle_rule_verification_required` | `tutor_search_library` | 0 | 4 | `unchecked` |
