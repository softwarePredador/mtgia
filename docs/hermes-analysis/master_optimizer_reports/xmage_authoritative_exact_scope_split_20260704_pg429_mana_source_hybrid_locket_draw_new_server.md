...
| `Golgari Locket` | `xmage_simple_mana_source_with_activated_draw` | `xmage_simple_tap_mana_source_with_activated_draw_v1` | `ramp_permanent` | `battle_rule_v1:e411bbfd4c56416618a04987d7e5d9f6` |
| `Gruul Locket` | `xmage_simple_mana_source_with_activated_draw` | `xmage_simple_tap_mana_source_with_activated_draw_v1` | `ramp_permanent` | `battle_rule_v1:d06f756c006c4b20f60b858086ad5ee4` |
| `Izzet Locket` | `xmage_simple_mana_source_with_activated_draw` | `xmage_simple_tap_mana_source_with_activated_draw_v1` | `ramp_permanent` | `battle_rule_v1:afd345e253f781bdcddf5043d1e49996` |
...
| `Orzhov Locket` | `xmage_simple_mana_source_with_activated_draw` | `xmage_simple_tap_mana_source_with_activated_draw_v1` | `ramp_permanent` | `battle_rule_v1:468cb492985ea7211fd3a827e861909f` |
...
| `Rakdos Locket` | `xmage_simple_mana_source_with_activated_draw` | `xmage_simple_tap_mana_source_with_activated_draw_v1` | `ramp_permanent` | `battle_rule_v1:3a4cef6778d44d31440c7e0db392ffca` |
| `Selesnya Locket` | `xmage_simple_mana_source_with_activated_draw` | `xmage_simple_tap_mana_source_with_activated_draw_v1` | `ramp_permanent` | `battle_rule_v1:3d1b977e000b15a16341bc8410e2e46a` |
| `Simic Locket` | `xmage_simple_mana_source_with_activated_draw` | `xmage_simple_tap_mana_source_with_activated_draw_v1` | `ramp_permanent` | `battle_rule_v1:55f824197a71851602bebb649bfdea3d` |
