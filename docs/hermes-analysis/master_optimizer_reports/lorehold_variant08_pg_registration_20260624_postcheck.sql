\pset pager off
-- PG register postcheck for Lorehold Variant 08.
SELECT
  'pg_lorehold_variant08_deck' AS check_name,
...
FROM decks d
WHERE d.id = '6df74eb3-c4a7-5398-bcf5-febb38d80d7a'::uuid;

SELECT
  'pg_lorehold_variant08_deck_cards' AS check_name,
  COUNT(*) AS rows,
...
FROM deck_cards
WHERE deck_id = '6df74eb3-c4a7-5398-bcf5-febb38d80d7a'::uuid;

SELECT
  'pg_lorehold_variant08_learned' AS check_name,
...
SELECT
  'pg_lorehold_variant08_missing_card_rows' AS check_name,
  COUNT(*) AS missing_card_rows
FROM deck_cards dc
LEFT JOIN cards c ON c.id = dc.card_id
WHERE dc.deck_id = '6df74eb3-c4a7-5398-bcf5-febb38d80d7a'::uuid
  AND c.id IS NULL;
