...
- generated_at: `2026-06-27T19:37:36Z`
...
| 2 |  | Lorehold synergy package: storm_kiln_artist_cut_arcane_signet (`synergy_storm_kiln_artist_cut_arcane_signet`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 20.00 | 3 | 2 | 0 | 0 | 0 | 0 | 0 | 1 | none |
...
### 2. Lorehold synergy package: storm_kiln_artist_cut_arcane_signet (`synergy_storm_kiln_artist_cut_arcane_signet`)
...
**Strategic event counts:** lorehold_cost_paid=39, lorehold_spell_cast=29, lorehold_upkeep_rummage=7, topdeck_manipulation_activated=5, miracle_cast=8, lorehold_spell_rummage=5
