\echo 'PG740B trusted rule oracle_hash backfill postcheck'
...
FROM manaloom_deploy_audit.pg740b_trusted_rule_oracle_hash_backfill_new_server_20260711;

SELECT
  COUNT(*) AS backfilled_rows_matching_card_oracle_hash
FROM manaloom_deploy_audit.pg740b_trusted_rule_oracle_hash_backfill_new_server_20260711 backup
