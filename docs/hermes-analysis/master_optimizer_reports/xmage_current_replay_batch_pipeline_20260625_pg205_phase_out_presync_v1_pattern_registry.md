...
- `proposal_count`: `436`
- `pattern_count`: `42`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 339, "package_ready_unprepared": 1, "runtime_family_backlog": 20, "split_scope_backlog": 72}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 339, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `phase_out_protection/phase_out/target_nonland_permanents_you_control_phase_out_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 338 | 54 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### phase_out_protection / phase_out / target_nonland_permanents_you_control_phase_out_v1

- Pattern id: `xmage_pattern:ed8028deb80937eda969`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Clever Concealment)
- Subpatterns: `1`
