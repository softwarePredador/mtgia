...
- Summary: `{"batch_metadata_candidate_count": 2, "card_count": 446, "family_count": 11, "family_counts": {"board_wipe_choice": 4, "copy_spell_engine": 1, "creature": 4, "manual_model": 338, "mill_spell": 2, "modal_spell": 1, "ramp_ritual": 1, "static_cost_reducer": 2, "targeted_interaction": 68, "token_maker": 21, "tutor": 4}, "manual_or_blocked_count": 420, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 2, "blocked_missing_xmage_source": 2, "mapper_metadata_or_test_scenario_required": 337, "runtime_family_implementation_required": 24, "split_family_scope_review_required": 81}, "runtime_family_required_count": 24}`
...
| `manual_model` | 338 | `manual_model_required` | `{"blocked_missing_xmage_source": 2, "mapper_metadata_or_test_scenario_required": 336}` | manual Oracle/reference review |
| `mill_spell` | 2 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 1}` | target-player library milling, storm copy counting, and activated mill engines |
...
- Family tests: `[]`
- Cards: `["Apex of Power", "Formidable Speaker", "Volcanic Vision", "Dance with Calamity", "Force of Negation", "Galvanoth", "Invoke Calamity", "Kinnan, Bonder Prodigy"]`
...
- Cards: `["Brain Freeze", "Grinding Station"]`
...
- Batch strategy: `split_by_scope_before_metadata_batch`
- Family tests: `[]`
- Cards: `["Flusterstorm", "Chain of Vapor", "Vandalblast", "Reprieve", "Bloodchief Ascension", "Cool but Rude", "Glint-Horn Buccaneer", "Tezzeret, Cruel Captain"]`
