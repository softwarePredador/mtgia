...
- Generated at: `2026-07-06T10:31:03.942658+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6504 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5281 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5459 | 269 |
| `battle_family_mapper_required` | 28414 | 94 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6749 |
| `triggered_or_static_ability` | 3870 |
| `damage_or_life_total_change` | 3773 |
| `token_creation` | 3517 |
...
| `battle_family::manual_model_review` | 6749 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3773 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
