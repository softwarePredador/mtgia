...
- Generated at: `2026-07-04T20:37:47+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 29908 |
| `xmage_authoritative_source_count` | 26972 |
| `xmage_missing_source_exception_count` | 2936 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 26972 |
| `manual_semantic_decision_units_remaining` | 2936 |
| `authoritative_source_coverage_ratio` | 0.9018 |
| `adapter_work_unit_count` | 11560 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 26972 |
...
| `recursion::xmage_graveyard_return_variant_review_v1` | 1830 |
| `draw_engine::xmage_draw_card_variant_review_v1` | 1647 |
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1169 |
| `direct_damage::targeted_damage_variant_v1` | 913 |
| `add_counters::source_add_counters_variant_v1` | 803 |
| `life_gain::xmage_life_gain_variant_review_v1` | 736 |
| `draw_cards::xmage_draw_card_variant_review_v1` | 660 |
| `tutor::xmage_library_search_variant_review_v1` | 625 |
| `removal_destroy::targeted_destroy_variant_v1` | 625 |
| `add_counters::targeted_add_counters_variant_v1` | 462 |
| `board_wipe::xmage_mass_removal_or_sacrifice_variant_review_v1` | 439 |
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 364 |
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 307 |
...
| `removal_exile::targeted_exile_variant_v1` | 150 |
...
| `xmage_signature::AttachEffect,BoostEnchantedEffect::EnchantAbility,SimpleStaticAbility::TargetCreaturePermanent,TargetPermanent::no_condition_class::targeting,static_ability` | 37 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 12052 |
| `unparsed` | 2936 |
| `token_maker` | 2463 |
| `recursion` | 1830 |
| `draw_engine` | 1647 |
| `add_counters` | 1265 |
| `grant_protection_from_chosen_color` | 1175 |
| `direct_damage` | 918 |
| `ramp_permanent` | 740 |
| `life_gain` | 736 |
| `draw_cards` | 660 |
...
| --- | ---: |
| `targeting` | 14199 |
| `triggered_ability` | 12036 |
| `activated_ability` | 5688 |
| `static_ability` | 5601 |
| `counter` | 3905 |
| `condition` | 3318 |
| `token` | 2515 |
