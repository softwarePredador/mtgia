...
- Generated at: `2026-07-02T11:28:49.612918+00:00`
- Status: `pass`
- PostgreSQL target: `143.198.230.247:5433/halder`
- SQLite DB: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/manaloom-knowledge/scripts/knowledge.db`
- Summary: `{"check_count": 49, "status_counts": {"pass": 49}}`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=7205 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=7205 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=5947 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=5947 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=5947 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6496 pg_runtime_keys=6493 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=7503 |
