...
- Generated at: `2026-06-24T21:42:04.615647+00:00`
- Status: `ready`
- Active deck id: `6`
- Lorehold deck ids: `[6, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616]`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260624_pg190_cool_but_rude_postsync_v1_proposals.json`
...
- Rows: `395`
- Recommendation lanes: `{"active_low_confidence_review": 13, "core_keep": 87, "low_priority": 43, "needs_rule_before_strategy": 121, "policy_blocked": 2, "priority_benchmark_candidate": 38, "watchlist_candidate": 91}`
- Rule statuses: `{"battle_ready": 274, "blocked_missing_xmage_source": 2, "mapper_manual": 88, "runtime_needed": 11, "split_scope": 20}`
...
| Glint-Horn Buccaneer | 15.5 | draw | split_scope | source_controller_draw_variant_v1 | split_xmage_scope_then_promote_rule_before_swap_testing |
...
| Trouble in Pairs | 13.5 | draw | split_scope | source_controller_draw_variant_v1 | split_xmage_scope_then_promote_rule_before_swap_testing |
| Wake the Past | 13.5 | engine, recursion | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Young Pyromancer | 13.5 | wincon | runtime_needed | xmage_create_token_variant_youngpyromancer_v1 | implement_runtime_family_with_focused_test_before_swap_testing |
| Erode | 13.0 | removal | split_scope | targeted_destroy_variant_v1 | split_xmage_scope_then_promote_rule_before_swap_testing |
| Molten Gatekeeper | 13.0 | engine, recursion | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
...
| Surly Badgersaur | 12.0 | ramp, wincon | runtime_needed | xmage_create_token_variant_surlybadgersaur_v1 | implement_runtime_family_with_focused_test_before_swap_testing |
| Clever Concealment | 11.5 | protection | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
...
| Gods Willing | 11.0 | protection | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
...
| Sejiri Shelter // Sejiri Glacier | 11.0 | protection | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
...
| Redirect Lightning | 48.0 | protection, draw | [607, 608, 611, 613] | battle_ready | run_safe_slot_benchmark_after_baseline_hash_guard |
