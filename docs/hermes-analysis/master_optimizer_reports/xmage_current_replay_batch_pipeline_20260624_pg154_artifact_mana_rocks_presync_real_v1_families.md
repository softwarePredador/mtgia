...
- Summary: `{"batch_metadata_candidate_count": 3, "card_count": 229, "family_count": 2, "family_counts": {"manual_model": 226, "ramp_permanent": 3}, "manual_or_blocked_count": 226, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 3, "mapper_metadata_or_test_scenario_required": 226}, "runtime_family_required_count": 0}`

| Family | Cards | Support | Lane counts | Implementation unit |
| --- | ---: | --- | --- | --- |
| `manual_model` | 226 | `manual_model_required` | `{"mapper_metadata_or_test_scenario_required": 226}` | manual Oracle/reference review |
...
- Family tests: `[]`
- Cards: `["Sol Ring", "Izzet Signet", "Simic Signet"]`
