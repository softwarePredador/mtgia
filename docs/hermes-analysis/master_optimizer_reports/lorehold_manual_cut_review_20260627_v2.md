...
- Generated at: `2026-06-27T23:26:54Z`
...
- Exposure profile: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_card_exposure_profile_20260627_v1.json`
...
- Decision counts: `{"do_not_cut_current_champion_engine": 2, "manual_tradeoff_not_blind_cut": 1, "tutor_lane_probation_needs_seed_safe_cut": 2}`
- Automatic gate-ready count: `0`
- Safe next action: Do not spend a gate on Squee cuts; test Austere over Emeria only as an explicit wipe-over-rebuild tradeoff, not a blind same-lane replacement.
...
| Austere Command | Emeria's Call // Emeria, Shattered Skyclave | `manual_tradeoff_not_blind_cut` | `manual_tradeoff_gate_only` | Emeria has measured token/protection exposure in 193 deduplicated local events.; Austere Command is a board-wipe role, not a same-role replacement for rebuild/protection.; Gate only as an explicit wipe-over-rebuild tradeoff, not as an automatic cut. |
