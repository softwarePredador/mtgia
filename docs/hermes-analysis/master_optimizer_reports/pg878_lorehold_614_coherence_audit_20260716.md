...
Generated at: `2026-07-16T09:21:15+00:00`
...
- `shadow_rule_preserved_for_history`: `85`
...
| --- | --- | ---: | --- | ---: | ---: | --- | --- |
| `medium` | `battle_support` | 4051 | `Helm of Awakening` | 1 | 1 | `generic_effect_without_model_scope` | `ramp_engine`, `ramp_permanent` |
