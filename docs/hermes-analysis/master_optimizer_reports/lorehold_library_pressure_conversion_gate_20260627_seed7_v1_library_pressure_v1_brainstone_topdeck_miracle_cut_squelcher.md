...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: brainstone_topdeck_miracle_cut_squelcher (`synergy_brainstone_topdeck_miracle_cut_squelcher`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 16.00 | 4 | 3 | 2 | 1 | 1 | 1 | 0 | 6 | none |
...
| Sisay, Weatherlight Captain #61 (real) | 1 | 2 | 0 | 33.33% | 19.00 | approach=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=71, lorehold_spell_cast=61, lorehold_upkeep_rummage=28, squee_to_graveyard=1, graveyard_upkeep_return_self_to_hand=1, squee_upkeep_return=1, squee_return_after_known_graveyard_entry=1, miracle_cast=9, discard_to_top_replacement=6, lorehold_rummage_discard_to_top=3, thor_cost_paid=1, thor_spell_cast=1, topdeck_manipulation_activated=7, lorehold_spell_rummage=4, lorehold_spell_rummage_discard_to_top=3
