...
- Generated at: `2026-06-30T14:16:14Z`
- Runtime queue: `/Users/desenvolvimentomobile/.codex/worktrees/solo-consolidation-mtgia/docs/hermes-analysis/master_optimizer_reports/solo_deck_restart_20260630_runtime_gap_family_queue.json`
...
- Cards reviewed: `13`
- Status counts: `{"pg_package_applied_synced": 2, "review_required": 3, "split_scope_review_required": 8}`
- Promotion lanes: `{"access_density_candidate": 5, "split_family_scope_review_required": 8}`
...
| 8 | `Naktamun Lorespinner // Wheel of Fortune` | `split_scope_review_required` | `draw_engine` | `split_family_scope_review_required` | `draw_engine` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 9 | `Brainstone` | `pg_package_applied_synced` | `access_density` | `access_density_candidate` | `` | 0 | Use the synced verified rule and rebuild the queue before any deck gate; do not rerun this package. |
| 10 | `Hidden Retreat` | `pg_package_applied_synced` | `access_density` | `access_density_candidate` | `` | 0 | Use the synced verified rule and rebuild the queue before any deck gate; do not rerun this package. |
| 11 | `Enlightened Tutor` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
| 12 | `Gamble` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
| 13 | `Penance` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
