...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pg032_flawless_maneuver_battle_rule_20260622_200215') IS NULL THEN
    RAISE EXCEPTION 'PG032 rollback backup table is missing';
  END IF;
END $$;
...
WHERE normalized_name = 'flawless maneuver'
  AND (
    ...
    OR logical_rule_key IN (
      ...
      FROM manaloom_deploy_audit.pg032_flawless_maneuver_battle_rule_20260622_200215
...
SELECT
  'pg032_rollback_result' AS check_name,
  card_name,
  logical_rule_key,
  effect_json,
  source,
