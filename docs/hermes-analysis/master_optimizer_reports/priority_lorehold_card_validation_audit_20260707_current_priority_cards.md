...
- Generated at: `2026-07-07T20:47:52.112010+00:00`
- Status: `fail`
- PostgreSQL target: `127.0.0.1:15432/halder`
- SQLite DB: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/manaloom-knowledge/scripts/knowledge.db`
- Snapshot: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/manaloom-knowledge/scripts/known_cards_canonical_snapshot.json`
- Summary: `{"battle_rule_cards_passed": 20, "checks_failed": 12, "checks_total": 81, "functional_classification_cards_passed": 24, "functional_classification_cards_required": 9, "target_card_count": 24, "xmage_source_found_count": 21, "xmage_source_missing_count": 3}`
...
| `Fellwar Stone` | `fail` | `fail` | `fail` | `not_required` | conditional_opponent_color_mana_rock_v1 | - | `found` |
...
| `Library of Leng` | `fail` | `fail` | `fail` | `not_required` | discard_replacement_to_top_v1 | - | `found` |
| `Scroll Rack` | `fail` | `fail` | `fail` | `not_required` | scroll_rack_upkeep_single_exchange_v1 | - | `found` |
| `Swords to Plowshares` | `pass` | `pass` | `pass` | `not_required` | swords_to_plowshares_creature_exile_life_equal_power_v1 | - | `found` |
| `Talisman of Conviction` | `fail` | `fail` | `fail` | `not_required` | pain_talisman_color_pair_partial_v1 | - | `found` |
