...
| `Orcish Bloodpainter` | `xmage_permanent_simple_activated_damage` | `xmage_permanent_simple_activated_damage_v1` | `creature` | `battle_rule_v1:5238e3db54b9c2d828a10683bc423063` |
| `Orcish Mechanics` | `xmage_permanent_simple_activated_damage` | `xmage_permanent_simple_activated_damage_v1` | `creature` | `battle_rule_v1:541bcd87ed6902e049fae61b02fe40e8` |
| `Orcish Vandal` | `xmage_permanent_simple_activated_damage` | `xmage_permanent_simple_activated_damage_v1` | `creature` | `battle_rule_v1:541bcd87ed6902e049fae61b02fe40e8` |
| `Scorched Rusalka` | `xmage_permanent_simple_activated_damage` | `xmage_permanent_simple_activated_damage_v1` | `creature` | `battle_rule_v1:25394e24bd62caa0dcaf160d1cdd8406` |
| `Skirsdag Cultist` | `xmage_permanent_simple_activated_damage` | `xmage_permanent_simple_activated_damage_v1` | `creature` | `battle_rule_v1:caed5a430d19931da153ce154474738a` |
| `Skull Catapult` | `xmage_permanent_simple_activated_damage` | `xmage_permanent_simple_activated_damage_v1` | `artifact` | `battle_rule_v1:32246bddb0296b9bb722c0f9a93e70a8` |
| `Tar Pitcher` | `xmage_permanent_simple_activated_damage` | `xmage_permanent_simple_activated_damage_v1` | `creature` | `battle_rule_v1:d5ec217ecebff1f256812fb52cfbbb4c` |
