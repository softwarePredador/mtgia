WITH proposed(normalized_name, card_name, oracle_hash, logical_rule_key, effect_json, deck_role_json, source, confidence, review_status, execution_status, notes, shadow_handling) AS (
  VALUES ('entreat the angels', 'Entreat the Angels', '30f38db3fe030a6002c9a8120d216ec8', 'battle_rule_v1:0ce4d97cb4f226cd2df5f9bdbdebc04e', '{"ability_kind": "one_shot", "battle_model_scope": "xmage_x_create_creature_tokens_spell_v1", "effect": "token_maker", "miracle": true, "miracle_cost": "{X}{W}{W}", "miracle_x_cost_symbol_count": 1, "native_miracle": true, "native_miracle_cost": "{X}{W}{W}", "native_miracle_runtime_status": "runtime_executor_v1", "normal_mana_cost": "{X}{X}{W}{W}{W}", "sorcery": true, "token_colors": ["W"], "token_count_per_x": 1, "token_count_source": "x_value", "token_flying": true, "token_name": "Angel Token", "token_power": 4, "token_subtype": "Angel", "token_toughness": 4, "x_cost_symbol_count": 2, "x_spell": true, "xmage_ability_class": "MiracleAbility", "xmage_dynamic_value_class": "GetXValue", "xmage_effect_class": "CreateTokenEffect", "xmage_token_class": "AngelToken"}'::jsonb, '{"category": "finisher", "effect": "token_maker", "lane": "miracle_finisher", "subtype": "x_miracle_token_finisher"}'::jsonb, 'curated', 0.96, 'verified', 'auto', 'PG472 generated package: XMage exact class EntreatTheAngels uses CreateTokenEffect, AngelToken, GetXValue, and MiracleAbility. Normal XXWWW X-token runtime and native miracle XWW runtime are covered by focused tests. SQL was generated but not applied.', 'preserve_existing_rows')
)
SELECT
  p.card_name,
