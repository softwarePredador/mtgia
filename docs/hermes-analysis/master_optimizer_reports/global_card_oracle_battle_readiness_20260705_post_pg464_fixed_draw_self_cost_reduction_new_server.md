...
- Generated at: `2026-07-05T01:20:40.500222+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5626 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4361 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4539 | 265 |
| `battle_family_mapper_required` | 29334 | 98 |
...
| `battle_family::draw_selection_topdeck` | 3424 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
