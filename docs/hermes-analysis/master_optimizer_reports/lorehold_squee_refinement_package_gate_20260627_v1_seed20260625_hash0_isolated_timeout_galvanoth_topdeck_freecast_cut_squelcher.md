...
- generated_at: `2026-06-27T16:09:51Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: galvanoth_topdeck_freecast_cut_squelcher (`synergy_galvanoth_topdeck_freecast_cut_squelcher`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 11.50 | 4 | 4 | 0 | 0 | 0 | 0 | 8 | none |
...
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 6.00 | approach=1 |

**Strategic event counts:** lorehold_cost_paid=95, lorehold_spell_cast=78, lorehold_upkeep_rummage=47, topdeck_manipulation_activated=8, lorehold_spell_rummage=1, miracle_cast=13
