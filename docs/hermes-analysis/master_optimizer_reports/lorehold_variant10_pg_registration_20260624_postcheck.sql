\pset pager off
-- PG register postcheck for Lorehold Variant 10.
SELECT
  'pg_lorehold_variant10_deck' AS check_name,
...
FROM decks d
WHERE d.id = '43c026ae-2d92-5049-90fc-1fdad4b04298'::uuid;

SELECT
  'pg_lorehold_variant10_deck_cards' AS check_name,
  COUNT(*) AS rows,
...
FROM deck_cards
WHERE deck_id = '43c026ae-2d92-5049-90fc-1fdad4b04298'::uuid;

SELECT
  'pg_lorehold_variant10_learned' AS check_name,
...
SELECT
  'pg_lorehold_variant10_missing_card_rows' AS check_name,
  COUNT(*) AS missing_card_rows
FROM deck_cards dc
LEFT JOIN cards c ON c.id = dc.card_id
WHERE dc.deck_id = '43c026ae-2d92-5049-90fc-1fdad4b04298'::uuid
  AND c.id IS NULL;
