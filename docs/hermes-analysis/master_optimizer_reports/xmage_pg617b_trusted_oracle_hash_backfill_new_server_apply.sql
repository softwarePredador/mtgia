...
drop table if exists manaloom_deploy_audit.pg617b_trusted_oracle_hash_backfill_backup;

create table manaloom_deploy_audit.pg617b_trusted_oracle_hash_backfill_backup as
select
  cbr.card_id,
  cbr.normalized_name,
