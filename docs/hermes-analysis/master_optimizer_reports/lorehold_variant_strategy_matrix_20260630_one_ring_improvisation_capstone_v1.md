...
- Generated at: `2026-06-30T02:58:17.648673+00:00`
- Strategy profile: `lorehold_strategy_profile_v3_2026_06_26`
- Scope: decks `607, 615` plus candidate v7 when available.
- Best structural deck before equal battle gate: `candidate_607_one_ring_improvisation_capstone_v1`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| 1 | Lorehold 607 + The One Ring over Improvisation Capstone v1 (`candidate_607_one_ring_improvisation_capstone_v1`) | 607-one-ring-improvisation-capstone | 141.2 | 100.0 | 34 | 97.9% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | recursion_role, tutor_role |
...
## 1. Lorehold 607 + The One Ring over Improvisation Capstone v1 (`candidate_607_one_ring_improvisation_capstone_v1`)
