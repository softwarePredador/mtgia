...
- generated_at: `2026-06-27T18:30:01Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: primal_amulet_spell_engine (`synergy_primal_amulet_spell_engine`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 17.00 | 4 | 1 | 0 | 0 | 0 | 0 | 0 | 4 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 4 | 1 | 0 | 0 | 0 | 0 | 0 | 9 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: primal_amulet_spell_engine (`synergy_primal_amulet_spell_engine`)
...
**Strategic event counts:** lorehold_cost_paid=87, lorehold_spell_cast=76, lorehold_upkeep_rummage=22, miracle_cast=7, lorehold_spell_rummage=1, topdeck_manipulation_activated=1, thor_cost_paid=1, thor_spell_cast=1
