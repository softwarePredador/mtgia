...
- `proposal_count`: `434`
- `pattern_count`: `45`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 333, "package_ready_unprepared": 3, "runtime_family_backlog": 20, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 10, "runtime_template_candidate_requires_executor_tests": 2}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 333, "ready_for_pg_package_generation": 3, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `controlled_creature_etb_damage_engine/creature/controlled_creature_enters_damage_each_opponent_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 2 | 2 | Generate a PG package before any runtime work. |
| `controlled_creature_etb_damage_engine/passive/controlled_creature_enters_damage_each_opponent_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
- Pattern id: `xmage_pattern:e3c016f9c06b6115799b`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `2` (Agate Instigator, Molten Gatekeeper)
- Subpatterns: `2`
...
- Pattern id: `xmage_pattern:3592b9d8026912491b06`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Impact Tremors)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`
