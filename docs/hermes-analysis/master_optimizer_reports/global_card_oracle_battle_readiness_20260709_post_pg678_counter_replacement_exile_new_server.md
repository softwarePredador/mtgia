...
- Generated at: `2026-07-09T00:11:07.671368+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7336 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6136 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6108 | 272 |
| `battle_family_mapper_required` | 27768 | 92 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6493 |
| `triggered_or_static_ability` | 3841 |
| `damage_or_life_total_change` | 3689 |
| `token_creation` | 3489 |
| `draw_selection_topdeck` | 3305 |
...
| `counterspell_or_stack_interaction` | 324 |
...
| --- | ---: | --- | --- |
| `battle_family::manual_model_review` | 6493 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3689 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
| `battle_family::token_creation` | 3489 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A Killer Among Us`, `Aang and Katara`, `Aang, Airbending Master`, `Aatchik, Emerald Radian`, `Abby, Merciless Soldier`, `Abdel Adrian, Gorion's Ward`, `Abhorrent Overlord`, `Abyssal Harvester`, `Abzan Ascendancy`, `Academy Manufactor` |
| `battle_family::draw_selection_topdeck` | 3305 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
...
| `battle_family::counterspell_or_stack_interaction` | 324 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abjure`, `Abstruse Interference`, `Access Denied`, `Admiral's Order`, `Adric, Mathematical Genius`, `Amazing Acrobatics`, `Anticognition`, `Archmage's Charm`, `Arenson's Aura`, `Artistic Refusal` |
