...
- Generated at: `2026-07-09T08:22:00+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24737 |
| `xmage_authoritative_source_count` | 24424 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24424 |
...
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1069 |
| `add_counters::source_add_counters_variant_v1` | 771 |
| `direct_damage::targeted_damage_variant_v1` | 756 |
...
| `removal_destroy::targeted_destroy_variant_v1` | 486 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11103 |
| `token_maker` | 2287 |
| `recursion` | 1792 |
| `draw_engine` | 1572 |
| `add_counters` | 1206 |
| `grant_protection_from_chosen_color` | 1075 |
| `direct_damage` | 761 |
| `life_gain` | 663 |
| `tutor` | 578 |
| `draw_cards` | 559 |
