...
| 2 |  | Lorehold synergy package: core_challenge_aetherflux_over_storm (`synergy_core_challenge_aetherflux_over_storm`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 12.00 | 5 | 3 | 1 | 1 | 1 | 0 | 7 | none |
...
### 2. Lorehold synergy package: core_challenge_aetherflux_over_storm (`synergy_core_challenge_aetherflux_over_storm`)
...
| Sisay, Weatherlight Captain #61 (real) | 2 | 1 | 0 | 66.67% | 12.00 | elimination=1, approach=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=95, lorehold_spell_cast=78, lorehold_upkeep_rummage=43, topdeck_manipulation_activated=10, miracle_cast=11, squee_to_graveyard=3, graveyard_upkeep_return_self_to_hand=2, squee_upkeep_return=2, squee_return_after_known_graveyard_entry=2
