...
- Generated at: `2026-07-01T12:01:40+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 27731 |
| `xmage_authoritative_source_count` | 27417 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 27417 |
...
| `draw_engine::xmage_draw_card_variant_review_v1` | 1678 |
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1206 |
| `direct_damage::targeted_damage_variant_v1` | 965 |
...
| `token_maker::xmage_signature::CreateTokenEffect::no_ability_class::no_target_class::no_condition_class::token` | 69 |
...
| `token_maker::xmage_signature::CreateTokenEffect::EntersBattlefieldTriggeredAbility::no_target_class::no_condition_class::token,triggered_ability` | 60 |
