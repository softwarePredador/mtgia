...
- Generated at: `2026-06-30T12:37:19Z`
...
- Filtered current verified/auto rules: `48`
- Blocked runtime cards: `13`
- Candidate lanes: `{"contextual": 10, "finisher_or_big_spell": 1, "hand_filter": 2}`
- Promotion lanes: `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 12}`
...
| ---: | --- | ---: | --- | --- | --- | --- | --- |
| 1 | `free_cast` | 2 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 2}` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 1}` | cast-without-paying resolvers with source-zone, timing-bypass, and replacement-destination bookkeeping |
