...
- Generated at: `2026-07-07T05:40:34.093298+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6805 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5590 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5768 | 270 |
| `battle_family_mapper_required` | 28105 | 93 |
...
| `battle_family::mana_generation_or_ritual` | 667 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon`, `Altar of Shadows` |
