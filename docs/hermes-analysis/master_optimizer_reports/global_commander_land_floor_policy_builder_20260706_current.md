...
| --- | --- | --- | ---: | --- | ---: | ---: | --- | --- | --- |
| `VARIANT Lorehold Variant 07 - Rafael Paste 2026-06-24 (612)` | `Lorehold, the Historian` | `land_floor_policy_ready_for_pair_preflight_no_deck_action` | 7 | `27/34` | 507 | 9 | `Ash Barrens` | `Longshot, Rebel Bowman` | `run_candidate_copy_materializer_for_land_floor_pair_after_commander_source_lane` |
