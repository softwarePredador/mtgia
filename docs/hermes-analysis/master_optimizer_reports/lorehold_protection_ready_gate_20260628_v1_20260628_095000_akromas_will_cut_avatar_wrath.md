...
- generated_at: `2026-06-28T07:39:42Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_protection_ready_gate_20260628_v1_20260628_095000_akromas_will_cut_avatar_wrath_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: akromas_will_cut_avatar_wrath (`synergy_akromas_will_cut_avatar_wrath`) | synergy-package | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 2 | 1 | 2 | 0 | 0 | 0 | 0 | 3 | 0 | 0 | none | none |
...
### 2. Lorehold synergy package: akromas_will_cut_avatar_wrath (`synergy_akromas_will_cut_avatar_wrath`)
...
**Strategic event counts:** discard_to_top_replacement=12, lorehold_cost_paid=26, lorehold_rummage_discard_to_top=12, lorehold_spell_cast=25, lorehold_spell_rummage=2, lorehold_upkeep_rummage=20, miracle_cast=4, topdeck_manipulation_activated=3
