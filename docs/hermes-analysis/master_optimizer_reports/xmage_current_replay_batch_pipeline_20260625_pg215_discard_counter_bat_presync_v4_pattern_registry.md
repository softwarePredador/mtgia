...
- Generated at: `2026-06-25T10:19:20+00:00`
- Status: `ready`
- Mutations performed: `[]`
...
- `proposal_count`: `423`
- `pattern_count`: `37`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 333, "package_ready_unprepared": 2, "runtime_family_backlog": 10, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 9, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 10, "runtime_observation_requires_taxonomy": 1}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 9, "manual_model_observation_only": 333, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 62, "runtime_observation_requires_taxonomy": 1}`
...
| --- | --- | --- | ---: | ---: | --- |
| `creature/creature/controller_discards_nonland_counter_land_treasure_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
| `creature/creature/opponent_discards_land_create_bat_token_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### creature / creature / controller_discards_nonland_counter_land_treasure_v1

- Pattern id: `xmage_pattern:6bc4d68e16c8b2c2ae63`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Green Goblin, Nemesis)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`

### creature / creature / opponent_discards_land_create_bat_token_v1

- Pattern id: `xmage_pattern:5ba69094d244ebe9fb0f`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
