...
- generated_at: `2026-06-27T19:08:02Z`
...
| 2 |  | Lorehold synergy package: boros_charm_pressure_cut_fated (`synergy_boros_charm_pressure_cut_fated`) | synergy-package | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 5 | 2 | 1 | 0 | 0 | 0 | 0 | 9 | none |
...
### 2. Lorehold synergy package: boros_charm_pressure_cut_fated (`synergy_boros_charm_pressure_cut_fated`)
...
**Strategic event counts:** lorehold_cost_paid=77, lorehold_spell_cast=55, lorehold_upkeep_rummage=42, miracle_cast=9, discard_to_top_replacement=9, lorehold_rummage_discard_to_top=9, topdeck_manipulation_activated=6
