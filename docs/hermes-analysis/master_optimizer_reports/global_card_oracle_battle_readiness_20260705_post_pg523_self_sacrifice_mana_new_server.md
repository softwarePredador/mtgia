...
- Generated at: `2026-07-05T18:51:21.433059+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6052 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4809 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4987 | 266 |
| `battle_family_mapper_required` | 28886 | 97 |
...
| `battle_family::mana_generation_or_ritual` | 853 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Aetheric Amplifier`, `Agility Bobblehead` |
