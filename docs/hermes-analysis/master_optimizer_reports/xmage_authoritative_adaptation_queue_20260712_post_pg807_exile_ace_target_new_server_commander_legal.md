...
- Generated at: `2026-07-12T05:06:39+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24274 |
| `xmage_authoritative_source_count` | 23961 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 23961 |
| `manual_semantic_decision_units_remaining` | 313 |
| `authoritative_source_coverage_ratio` | 0.9871 |
| `adapter_work_unit_count` | 11242 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 23961 |
...
| Work Unit | Cards |
| --- | ---: |
| `recursion::xmage_graveyard_return_variant_review_v1` | 1786 |
| `draw_engine::xmage_draw_card_variant_review_v1` | 1553 |
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1062 |
| `add_counters::source_add_counters_variant_v1` | 768 |
| `direct_damage::targeted_damage_variant_v1` | 733 |
| `life_gain::xmage_life_gain_variant_review_v1` | 628 |
| `tutor::xmage_library_search_variant_review_v1` | 567 |
| `draw_cards::xmage_draw_card_variant_review_v1` | 530 |
| `removal_destroy::targeted_destroy_variant_v1` | 476 |
| `add_counters::targeted_add_counters_variant_v1` | 421 |
...
| `bounce::targeted_return_to_hand_variant_v1` | 205 |
| `untap_target::xmage_targeted_untap_variant_review_v1` | 201 |
| `removal_exile::targeted_exile_variant_v1` | 116 |
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 115 |
| `counter_spell::counter_target_stack_object_variant_v1` | 114 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 10903 |
| `token_maker` | 2266 |
| `recursion` | 1786 |
| `draw_engine` | 1553 |
| `add_counters` | 1189 |
| `grant_protection_from_chosen_color` | 1068 |
| `direct_damage` | 738 |
| `life_gain` | 628 |
| `tutor` | 578 |
| `draw_cards` | 530 |
...
| --- | ---: |
| `targeting` | 12856 |
| `triggered_ability` | 11359 |
| `static_ability` | 5236 |
| `activated_ability` | 5015 |
| `counter` | 3689 |
| `condition` | 3226 |
| `token` | 2313 |
| `draw` | 2001 |
