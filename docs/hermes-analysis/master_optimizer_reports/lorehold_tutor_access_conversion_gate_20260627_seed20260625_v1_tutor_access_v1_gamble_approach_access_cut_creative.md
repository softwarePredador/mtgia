...
- generated_at: `2026-06-27T18:40:34Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: gamble_approach_access_cut_creative (`synergy_gamble_approach_access_cut_creative`) | synergy-package | 9 | 3 | 6 | 0 | 33.33% | 17.33 | 6 | 5 | 2 | 3 | 2 | 2 | 0 | 5 | none |
...
| Sisay, Weatherlight Captain #61 (real) | 2 | 1 | 0 | 66.67% | 17.50 | elimination=1, approach=1 |
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 17.00 | approach=1 |

**Strategic event counts:** lorehold_cost_paid=115, lorehold_spell_cast=92, lorehold_upkeep_rummage=30, topdeck_manipulation_activated=20, squee_to_graveyard=6, graveyard_upkeep_return_self_to_hand=4, squee_upkeep_return=4, squee_return_after_known_graveyard_entry=4, discard_to_top_replacement=6, lorehold_rummage_discard_to_top=6, miracle_cast=13, thor_cost_paid=1, thor_spell_cast=1
