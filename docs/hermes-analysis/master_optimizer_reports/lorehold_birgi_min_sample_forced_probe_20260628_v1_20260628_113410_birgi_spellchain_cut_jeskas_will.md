...
- generated_at: `2026-06-28T11:34:16Z`
...
- game_timeout_seconds: `25.0`
- forced_access_mode: `opening_hand`
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_birgi_min_sample_forced_probe_20260628_v1_20260628_113410_birgi_spellchain_cut_jeskas_will_game_checkpoint.json`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 3 | 1 | 2 | 0 | 33.33% | 15.00 | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 1 | 0 | 0 | none | wincon_role |
| 2 |  | Lorehold synergy package: birgi_spellchain_cut_jeskas_will (`synergy_birgi_spellchain_cut_jeskas_will`) | synergy-package | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 3 | 0 | 0 | none | none |
...
**Strategic event counts:** lorehold_cost_paid=32, lorehold_spell_cast=28, lorehold_spell_rummage=1, lorehold_upkeep_rummage=5, miracle_cast=2, thor_cost_paid=1, thor_spell_cast=1, topdeck_manipulation_activated=2
...
**Strategic event counts:** birgi_spell_cast_mana=3, lorehold_cost_paid=20, lorehold_spell_cast=12, lorehold_upkeep_rummage=5, miracle_cast=1, spell_cast_mana_trigger=3
