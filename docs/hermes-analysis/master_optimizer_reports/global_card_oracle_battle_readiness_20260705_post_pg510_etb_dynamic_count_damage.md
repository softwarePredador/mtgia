...
- Generated at: `2026-07-05T14:17:07.438155+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6008 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4760 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4938 | 266 |
| `battle_family_mapper_required` | 28935 | 97 |
...
| `damage_or_life_total_change` | 3801 |
| `token_creation` | 3591 |
...
| `battle_family::damage_or_life_total_change` | 3801 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
