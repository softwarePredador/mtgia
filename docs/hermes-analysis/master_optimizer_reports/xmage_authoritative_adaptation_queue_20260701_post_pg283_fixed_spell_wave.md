...
- Generated at: `2026-07-01T05:44:51+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 28524 |
| `xmage_authoritative_source_count` | 28210 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 28210 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.989 |
| `adapter_work_unit_count` | 11961 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 28210 |
...
| Work Unit | Cards |
| --- | ---: |
| `recursion::xmage_graveyard_return_variant_review_v1` | 2051 |
| `draw_engine::xmage_draw_card_variant_review_v1` | 1726 |
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1242 |
| `direct_damage::targeted_damage_variant_v1` | 979 |
| `life_gain::xmage_life_gain_variant_review_v1` | 823 |
| `add_counters::source_add_counters_variant_v1` | 795 |
| `removal_destroy::targeted_destroy_variant_v1` | 691 |
...
| `board_wipe::xmage_mass_removal_or_sacrifice_variant_review_v1` | 446 |
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 390 |
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 327 |
| `parser_gap::unknown_superclass::no_signal` | 314 |
| `bounce::targeted_return_to_hand_variant_v1` | 271 |
...
| `removal_exile::targeted_exile_variant_v1` | 174 |
| `counter_spell::counter_target_stack_object_variant_v1` | 169 |
| `xmage_signature::no_effect_class::FlyingAbility::no_target_class::no_condition_class::no_signal` | 97 |
| `xmage_signature::BoostSourceEffect::SimpleActivatedAbility::no_target_class::no_condition_class::activated_ability` | 86 |
| `xmage_signature::BoostTargetEffect::no_ability_class::TargetCreaturePermanent::no_condition_class::targeting` | 80 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 12563 |
| `token_maker` | 2497 |
| `recursion` | 2051 |
| `draw_engine` | 1726 |
| `add_counters` | 1268 |
| `grant_protection_from_chosen_color` | 1248 |
| `direct_damage` | 984 |
| `life_gain` | 823 |
| `ramp_permanent` | 785 |
| `removal_destroy` | 691 |
...
| --- | ---: |
| `targeting` | 14656 |
| `triggered_ability` | 12138 |
| `activated_ability` | 5933 |
| `static_ability` | 5597 |
| `counter` | 3901 |
| `condition` | 3303 |
| `token` | 2549 |
