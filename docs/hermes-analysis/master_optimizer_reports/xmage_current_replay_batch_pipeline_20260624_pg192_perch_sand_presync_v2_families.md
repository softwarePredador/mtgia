...
- Summary: `{"batch_metadata_candidate_count": 2, "card_count": 363, "family_count": 8, "family_counts": {"board_wipe_choice": 4, "creature": 5, "manual_model": 263, "mill_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 64, "token_maker": 20, "tutor": 4}, "manual_or_blocked_count": 339, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 2, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 260, "runtime_family_implementation_required": 22, "split_family_scope_review_required": 75}, "runtime_family_required_count": 22}`
...
| `token_maker` | 20 | `runtime_family_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "mapper_metadata_or_test_scenario_required": 1, "runtime_family_implementation_required": 18}` | token creation with stats, abilities, duration, and zone cleanup |
...
- Family tests: `[]`
- Cards: `["Razaketh, the Foulblooded", "Rune-Scarred Demon", "Blood Artist", "Sand Scout", "Starfield Shepherd"]`
