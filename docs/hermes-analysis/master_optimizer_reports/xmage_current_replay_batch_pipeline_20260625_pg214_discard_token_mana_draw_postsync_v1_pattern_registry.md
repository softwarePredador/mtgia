...
- Generated at: `2026-06-25T09:55:01+00:00`
- Status: `ready`
- Mutations performed: `[]`
...
- `proposal_count`: `423`
- `pattern_count`: `37`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 333, "runtime_family_backlog": 12, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 11, "manual_model_observation_only": 2, "requires_subpattern_split_before_promotion": 10, "runtime_observation_requires_taxonomy": 1}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 11, "manual_model_observation_only": 333, "requires_subpattern_split_before_promotion": 62, "runtime_observation_requires_taxonomy": 1}`
