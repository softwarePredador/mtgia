...
- Generated at: `2026-07-07T09:53:06+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 25107 |
| `xmage_authoritative_source_count` | 24793 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24793 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.9875 |
| `adapter_work_unit_count` | 11331 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24793 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11196 |
| `token_maker` | 2306 |
| `recursion` | 1795 |
| `draw_engine` | 1588 |
| `add_counters` | 1211 |
| `grant_protection_from_chosen_color` | 1091 |
| `direct_damage` | 780 |
| `life_gain` | 673 |
| `draw_cards` | 579 |
| `tutor` | 578 |
...
| --- | ---: |
| `targeting` | 13347 |
| `triggered_ability` | 11485 |
| `static_ability` | 5339 |
| `activated_ability` | 5177 |
| `counter` | 3761 |
| `condition` | 3260 |
| `token` | 2354 |
| `draw` | 2082 |
