...
- Decision status: `brain_safe_cut_gap_no_active_rule_no_seed_safe_cut_keep_607`
...
- Runtime route planner status: `miracle_next_route_planner_selected_brain_package_review_keep_607`
...
- Recommended next action: `review_pg_package_then_request_explicit_apply_and_continue_cut_mining`

## Source Reports

- `brain_pg_package`: `docs/hermes-analysis/master_optimizer_reports/lorehold_brain_in_a_jar_pg_package_preflight_20260705_current.json`
- `brain_preflight`: `docs/hermes-analysis/master_optimizer_reports/lorehold_brain_in_a_jar_runtime_cut_preflight_20260705_current.json`
...
| Molecule Man | `prior_rejected_protected_slot` | 102 | `blocked_current_607_hard_stop` | explicit_postgresql_apply_then_postcheck_active_brain_rule, named_same_lane_seed_safe_cut_evidence, new_trace_evidence_reverses_prior_rejected_cut, refresh_candidate_queue_and_strategy_matrix, only_after_matrix_run_materialize_candidate_for_equal_battle_gate |
| Land Tax | `prior_rejected_protected_slot` | 3449 | `blocked_current_607_hard_stop` | explicit_postgresql_apply_then_postcheck_active_brain_rule, named_same_lane_seed_safe_cut_evidence, new_trace_evidence_reverses_prior_rejected_cut, refresh_candidate_queue_and_strategy_matrix, only_after_matrix_run_materialize_candidate_for_equal_battle_gate |
| Library of Leng | `protected_core_topdeck_engine` | 855 | `blocked_current_607_hard_stop` | explicit_postgresql_apply_then_postcheck_active_brain_rule, named_same_lane_seed_safe_cut_evidence, replacement_preserves_topdeck_miracle_anchor_role, refresh_candidate_queue_and_strategy_matrix, only_after_matrix_run_materialize_candidate_for_equal_battle_gate |
| Scroll Rack | `protected_core_topdeck_engine` | 2957 | `blocked_current_607_hard_stop` | explicit_postgresql_apply_then_postcheck_active_brain_rule, named_same_lane_seed_safe_cut_evidence, replacement_preserves_topdeck_miracle_anchor_role, refresh_candidate_queue_and_strategy_matrix, only_after_matrix_run_materialize_candidate_for_equal_battle_gate |
| Sensei's Divining Top | `protected_core_topdeck_engine` | 3816 | `blocked_current_607_hard_stop` | explicit_postgresql_apply_then_postcheck_active_brain_rule, named_same_lane_seed_safe_cut_evidence, replacement_preserves_topdeck_miracle_anchor_role, refresh_candidate_queue_and_strategy_matrix, only_after_matrix_run_materialize_candidate_for_equal_battle_gate |
| The Scarlet Witch | `protected_structural_floor` | 362 | `blocked_current_607_hard_stop` | explicit_postgresql_apply_then_postcheck_active_brain_rule, named_same_lane_seed_safe_cut_evidence, replacement_preserves_mana_or_curve_floor, refresh_candidate_queue_and_strategy_matrix, only_after_matrix_run_materialize_candidate_for_equal_battle_gate |
| The Mind Stone | `protected_structural_floor` | 2312 | `blocked_current_607_hard_stop` | explicit_postgresql_apply_then_postcheck_active_brain_rule, named_same_lane_seed_safe_cut_evidence, replacement_preserves_mana_or_curve_floor, refresh_candidate_queue_and_strategy_matrix, only_after_matrix_run_materialize_candidate_for_equal_battle_gate |
...
- pg_apply_requires_explicit_approval: `true`
- natural_battle_allowed_now: `false`
- promotion_allowed: `false`
- reason: Brain in a Jar is a useful runtime/deckbuilding lesson, but its current external adoption is low-context, all protected-607 same-lane slots are blocked, and no active PostgreSQL-backed Brain rule exists. Deck 607 therefore remains the Lorehold champion.
- next_actions:
