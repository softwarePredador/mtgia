...
- generated_at: `2026-06-28T01:02:46Z`
...
| 2 |  | Lorehold synergy package: plateau_timing_upgrade_cut_radiant_summit (`synergy_plateau_timing_upgrade_cut_radiant_summit`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 15.50 | 7 | 1 | 1 | 4 | 2 | 2 | 0 | 8 | 0 | 0 | none | none |
...
### 2. Lorehold synergy package: plateau_timing_upgrade_cut_radiant_summit (`synergy_plateau_timing_upgrade_cut_radiant_summit`)
...
**Strategic event counts:** lorehold_cost_paid=91, lorehold_spell_cast=67, lorehold_upkeep_rummage=30, squee_to_graveyard=5, graveyard_upkeep_return_self_to_hand=3, squee_upkeep_return=3, squee_return_after_known_graveyard_entry=3, miracle_cast=14, topdeck_manipulation_activated=2, discard_to_top_replacement=3, lorehold_rummage_discard_to_top=3
