...
- Generated at: `2026-07-10T21:10:51.674590+00:00`
- Status: `pass`
...
| `sqlite_rows.card_oracle_cache` | `pass` | rows=8199 |
...
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=8199 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=8199 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=8199 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6255 pg_runtime_keys=8700 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9916 |
