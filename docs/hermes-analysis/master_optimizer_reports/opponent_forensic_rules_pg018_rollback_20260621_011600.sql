...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pg018_opponent_forensic_rules_20260621_011600') IS NULL THEN
    RAISE EXCEPTION 'PG018 rollback backup table is missing';
  END IF;
END $$;
...
FROM manaloom_deploy_audit.pg018_opponent_forensic_rules_20260621_011600
