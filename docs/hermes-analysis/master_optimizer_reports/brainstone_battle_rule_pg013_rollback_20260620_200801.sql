...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pg013_brainstone_battle_rule_20260620_200801') IS NULL THEN
    RAISE EXCEPTION 'PG013 rollback backup table is missing';
  END IF;
END $$;
...
WHERE lower(card_name) = 'brainstone'
  AND (
    ...
    OR logical_rule_key IN (
      ...
      FROM manaloom_deploy_audit.pg013_brainstone_battle_rule_20260620_200801
...
SELECT
  'pg013_rollback_result' AS check_name,
  card_name,
  logical_rule_key,
  effect_json,
  source,
