...
- generated_at: `2026-06-27T18:50:10Z`
...
| 2 |  | Lorehold synergy package: gamble_access_cut_thor (`synergy_gamble_access_cut_thor`) | synergy-package | 9 | 3 | 6 | 0 | 33.33% | 17.67 | 6 | 4 | 1 | 3 | 2 | 2 | 0 | 7 | none |
...
### 2. Lorehold synergy package: gamble_access_cut_thor (`synergy_gamble_access_cut_thor`)
...
**Strategic event counts:** lorehold_cost_paid=105, lorehold_spell_cast=84, lorehold_upkeep_rummage=26, discard_to_top_replacement=7, lorehold_rummage_discard_to_top=7, miracle_cast=17, topdeck_manipulation_activated=9, squee_to_graveyard=6, graveyard_upkeep_return_self_to_hand=4, squee_upkeep_return=4, squee_return_after_known_graveyard_entry=4
