...
- Generated at: `2026-07-09T00:11:23+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24845 |
| `xmage_authoritative_source_count` | 24532 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24532 |
| `manual_semantic_decision_units_remaining` | 313 |
| `authoritative_source_coverage_ratio` | 0.9874 |
| `adapter_work_unit_count` | 11313 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24532 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11115 |
| `token_maker` | 2306 |
| `recursion` | 1792 |
| `draw_engine` | 1572 |
| `add_counters` | 1208 |
