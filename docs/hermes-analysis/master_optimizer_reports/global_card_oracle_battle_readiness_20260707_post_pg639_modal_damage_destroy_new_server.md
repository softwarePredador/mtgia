...
- Generated at: `2026-07-07T20:58:48.055692+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7196 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5957 | 271 |
| `battle_family_mapper_required` | 27916 | 92 |
...
| `battle_family::targeted_removal` | 926 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aftershock`, `Against All Odds`, `Agate Assault`, `Agent of Erebos` |
