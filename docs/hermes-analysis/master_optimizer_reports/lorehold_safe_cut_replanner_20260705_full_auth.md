...
- generated_at: `2026-07-05T16:02:44Z`
...
- blocked_reason_counts: `{"cut_is_early_mana_floor_support": 28, "cut_is_miracle_core_big_spell": 50, "cut_is_protection_shell": 28, "cut_not_flex_decision": 168, "incompatible_lane": 143, "missing_cut_safety_row": 154, "never_cut_lane": 58, "prior_rejected_cut": 42, "prior_rejected_signature": 2, "protected_cut": 44, "same_as_blocked_source_cut": 2}`
...
| past_in_flames_recast_safe_cut_arcane_signet | `past_in_flames_recast` | `Arcane Signet` | `cut_is_early_mana_floor_support` |
...
| past_in_flames_recast_safe_cut_boros_signet | `past_in_flames_recast` | `Boros Signet` | `cut_is_early_mana_floor_support` |
| past_in_flames_recast_safe_cut_call_forth_the_tempest | `past_in_flames_recast` | `Call Forth the Tempest` | `cut_is_miracle_core_big_spell, cut_not_flex_decision, incompatible_lane, missing_cut_safety_row, prior_rejected_cut` |
...
| past_in_flames_recast_safe_cut_dawns_truce | `past_in_flames_recast` | `Dawn's Truce` | `cut_is_protection_shell, cut_not_flex_decision, protected_cut` |
