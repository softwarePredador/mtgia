...
- Generated at: `2026-07-01T13:38:05.462913+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4515 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3186 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2038 | 389 |
| `battle_family_mapper_required` | 30509 | 230 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7473 |
| `damage_or_life_total_change` | 4002 |
| `triggered_or_static_ability` | 3907 |
| `token_creation` | 3641 |
| `draw_selection_topdeck` | 3576 |
| `graveyard_recursion` | 2014 |
| `targeted_removal` | 1098 |
| `mana_generation_or_ritual` | 953 |
| `tutor_search_library` | 839 |
| `modal_or_choice_effect` | 699 |
| `protection_prevention` | 569 |
| `recursion_or_bounce` | 545 |
...
| `battle_family::manual_model_review` | 7473 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
| `battle_family::damage_or_life_total_change` | 4002 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Acceptable Losses` |
...
| `battle_family::token_creation` | 3641 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A Killer Among Us`, `Aang and Katara`, `Aang, Airbending Master`, `Aatchik, Emerald Radian`, `Abby, Merciless Soldier`, `Abdel Adrian, Gorion's Ward`, `Abhorrent Overlord`, `Abyssal Harvester`, `Abzan Ascendancy`, `Academy Manufactor` |
| `battle_family::draw_selection_topdeck` | 3576 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
| `battle_family::graveyard_recursion` | 2014 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Aberrant Return`, `Abhorrent Oculus`, `Abomination of Llanowar` |
| `battle_family::targeted_removal` | 1098 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Acid Web Spider`, `Acidic Slime`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock` |
...
| `battle_family::recursion_or_bounce` | 545 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Adun Oakenshield`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe` |
