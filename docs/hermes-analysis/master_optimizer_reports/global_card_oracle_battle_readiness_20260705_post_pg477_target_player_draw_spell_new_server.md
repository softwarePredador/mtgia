...
- Generated at: `2026-07-05T03:09:54.662952+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5681 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4418 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4596 | 265 |
| `battle_family_mapper_required` | 29277 | 98 |
...
| `damage_or_life_total_change` | 3838 |
| `token_creation` | 3609 |
| `draw_selection_topdeck` | 3409 |
...
| `battle_family::damage_or_life_total_change` | 3838 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3409 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
