...
- Generated at: `2026-07-01T08:02:07+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 31360 |
| `xmage_authoritative_source_count` | 28424 |
| `xmage_missing_source_exception_count` | 2936 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 28424 |
| `manual_semantic_decision_units_remaining` | 2936 |
| `authoritative_source_coverage_ratio` | 0.9064 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 28424 |
...
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 328 |
| `bounce::targeted_return_to_hand_variant_v1` | 273 |
...
| `counter_spell::counter_target_stack_object_variant_v1` | 171 |
