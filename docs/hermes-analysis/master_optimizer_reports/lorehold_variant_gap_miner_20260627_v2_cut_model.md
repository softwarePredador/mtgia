...
- Generated at: `2026-06-27T23:07:39Z`
...
- candidate_status_counts: `{'blocked_runtime_rule_gap': 61, 'high_frequency_runtime_ready_unexplored': 21, 'runtime_ready_unexplored': 172, 'tested_negative_add_requires_new_cut': 16}`
- cut_status_counts: `{'blocked_core_cut': 28, 'blocked_locked_cut': 9, 'manual_review_needed': 5, 'requires_same_lane_gate': 38, 'risky_same_lane_only': 2, 'tested_negative_cut': 11, 'untested_flex_candidate': 1}`
- runtime_ready_unexplored_count: `193`
- blocked_runtime_rule_gap_count: `61`
- tested_negative_add_count: `16`
- tested_negative_cut_count: `11`
- pairing_count: `12`
- pairing_status_counts: `{'blocked_no_safe_cut_in_lane': 7, 'manual_cut_review_required': 3, 'needs_lane_model_before_gate': 2}`
- gate_ready_pairing_count: `0`
- manual_review_pairing_count: `3`
- blocked_pairing_count: `7`
...
| 11 | `Austere Command` | `high_frequency_runtime_ready_unexplored` | 64 | 609, 610, 611, 612 | `pressure_absorber_or_protection` | 1 | 0 | board_wipe | none | 0 |
| 12 | `Boseiju, Who Shelters All` | `high_frequency_runtime_ready_unexplored` | 64 | 612, 613, 615, 616 | `mana_base` | 1 | 0 | land | none | 0 |
| 13 | `Dance with Calamity` | `high_frequency_runtime_ready_unexplored` | 64 | 609, 611, 613, 614 | `hand_filter` | 1 | 0 | draw_cards, exile_value | none | 0 |
| 14 | `Galvanoth` | `high_frequency_runtime_ready_unexplored` | 64 | 611, 613, 614, 615 | `hand_filter` | 1 | 0 | creature | none | 0 |
| 15 | `Goldspan Dragon` | `high_frequency_runtime_ready_unexplored` | 64 | 608, 611, 614, 615 | `early_mana` | 1 | 0 | creature | none | 0 |
| 16 | `Insurrection` | `high_frequency_runtime_ready_unexplored` | 64 | 609, 611, 614, 615 | `finisher_or_big_spell` | 1 | 0 | steal_all_creatures | none | 0 |
| 17 | `Invoke Calamity` | `high_frequency_runtime_ready_unexplored` | 64 | 609, 614, 615, 616 | `graveyard_recursion` | 1 | 0 | free_cast, recursion | none | 0 |
| 18 | `Longshot, Rebel Bowman` | `high_frequency_runtime_ready_unexplored` | 64 | 611, 612, 613, 615 | `finisher_or_big_spell` | 1 | 0 | creature | none | 0 |
| 19 | `Penance` | `high_frequency_runtime_ready_unexplored` | 64 | 609, 611, 613, 614 | `hand_filter` | 1 | 0 | damage_prevention_shield | none | 0 |
| 20 | `Rugged Prairie` | `high_frequency_runtime_ready_unexplored` | 64 | 609, 610, 611, 616 | `mana_base` | 1 | 0 | land | none | 0 |
| 21 | `Sundown Pass` | `high_frequency_runtime_ready_unexplored` | 64 | 609, 611, 613, 615 | `mana_base` | 1 | 0 | land | none | 0 |
| 22 | `Brass's Bounty` | `tested_negative_add_requires_new_cut` | 58 | 609, 611, 612, 613, 614, 615 | `early_mana` | 2 | 1 | ramp_engine, treasure_maker | none | 1 |
...
- `Austere Command` -> `manual_cut_review_required` in lane `pressure_absorber_or_protection`; action: review the cut role/runtime model before gate; cut options: Emeria's Call // Emeria, Shattered Skyclave (manual_cut_review_required, manual_review_needed, pressure_absorber_or_protection); Deflecting Swat (protected_same_lane_benchmark_required, requires_same_lane_gate, pressure_absorber_or_protection); Flawless Maneuver (protected_same_lane_benchmark_required, requires_same_lane_gate, pressure_absorber_or_protection); Giver of Runes (protected_same_lane_benchmark_required, requires_same_lane_gate, pressure_absorber_or_protection); Lightning Greaves (protected_same_lane_benchmark_required, requires_same_lane_gate, pressure_absorber_or_protection)
