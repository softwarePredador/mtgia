...
CREATE TEMP TABLE pg611_trusted_oracle_hash_backfill_target(
  normalized_name text NOT NULL,
  logical_rule_key text NOT NULL
) ON COMMIT DROP;

INSERT INTO pg611_trusted_oracle_hash_backfill_target(normalized_name, logical_rule_key) VALUES
...
SET oracle_hash = NULL,
    updated_at = now()
FROM pg611_trusted_oracle_hash_backfill_target t
