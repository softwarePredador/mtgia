...
- `proposal_count`: `425`
- `pattern_count`: `39`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 333, "package_ready_unprepared": 2, "runtime_family_backlog": 12, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 11, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 10, "runtime_observation_requires_taxonomy": 1}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 11, "manual_model_observation_only": 333, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 62, "runtime_observation_requires_taxonomy": 1}`
...
| --- | --- | --- | ---: | ---: | --- |
| `creature/creature/controller_discards_card_type_token_mana_draw_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
| `token_maker/token_maker/opponent_discards_card_type_token_mana_draw_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### creature / creature / controller_discards_card_type_token_mana_draw_v1

- Pattern id: `xmage_pattern:4646c3addafa1aa4ddb6`
...
### token_maker / token_maker / opponent_discards_card_type_token_mana_draw_v1

- Pattern id: `xmage_pattern:d135c80002534b23260c`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Waste Not)
- Subpatterns: `1`
