...
- `proposal_count`: `384`
- `pattern_count`: `28`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 315, "package_already_prepared": 1, "package_ready_unprepared": 1, "runtime_family_backlog": 4, "split_scope_backlog": 59}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 3, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 315, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 49, "runtime_observation_requires_taxonomy": 1}`
...
| `creature/creature/controller_discards_one_or_more_damage_each_opponent_cycling_ping_annotation_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 314 | 52 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### creature / creature / controller_discards_one_or_more_damage_each_opponent_cycling_ping_annotation_v1

- Pattern id: `xmage_pattern:0a68ded0af03c561262d`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Magmakin Artillerist)
- Subpatterns: `1`
