...
- Generated at: `2026-07-02T11:25:13.368952+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5015 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3722 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 3900 | 263 |
| `battle_family_mapper_required` | 29973 | 100 |
...
| `battle_family::draw_selection_topdeck` | 3505 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
