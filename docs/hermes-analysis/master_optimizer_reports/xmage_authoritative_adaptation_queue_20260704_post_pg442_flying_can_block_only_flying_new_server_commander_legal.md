...
- Generated at: `2026-07-04T22:31:51+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 26645 |
| `xmage_authoritative_source_count` | 26331 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 26331 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.9882 |
| `adapter_work_unit_count` | 11402 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 26331 |
...
| Work Unit | Cards |
| --- | ---: |
| `recursion::xmage_graveyard_return_variant_review_v1` | 1819 |
| `draw_engine::xmage_draw_card_variant_review_v1` | 1634 |
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1113 |
| `direct_damage::targeted_damage_variant_v1` | 852 |
...
| `removal_destroy::targeted_destroy_variant_v1` | 624 |
| `tutor::xmage_library_search_variant_review_v1` | 592 |
| `add_counters::targeted_add_counters_variant_v1` | 459 |
| `board_wipe::xmage_mass_removal_or_sacrifice_variant_review_v1` | 433 |
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 345 |
| `parser_gap::unknown_superclass::no_signal` | 314 |
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 283 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11740 |
| `token_maker` | 2411 |
| `recursion` | 1819 |
| `draw_engine` | 1634 |
| `add_counters` | 1254 |
| `grant_protection_from_chosen_color` | 1119 |
| `direct_damage` | 857 |
| `life_gain` | 735 |
| `ramp_permanent` | 696 |
| `draw_cards` | 654 |
...
| --- | ---: |
| `targeting` | 13949 |
| `triggered_ability` | 11873 |
| `activated_ability` | 5568 |
| `static_ability` | 5545 |
| `counter` | 3871 |
| `condition` | 3295 |
| `token` | 2463 |
