...
- `proposal_count`: `448`
- `pattern_count`: `44`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 347, "runtime_family_backlog": 23, "split_scope_backlog": 74}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 19, "manual_model_observation_only": 347, "requires_subpattern_split_before_promotion": 64, "runtime_template_candidate_requires_executor_tests": 4}`
