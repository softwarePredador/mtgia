...
- `proposal_count`: `444`
- `pattern_count`: `42`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 346, "package_ready_unprepared": 1, "runtime_family_backlog": 20, "split_scope_backlog": 73}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 346, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 63, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `creature/creature/taii_wakeen_noncombat_damage_equal_toughness_draw_plus_x_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### creature / creature / taii_wakeen_noncombat_damage_equal_toughness_draw_plus_x_v1

- Pattern id: `xmage_pattern:48b807518ecfbca5cc36`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Taii Wakeen, Perfect Shot)
- Subpatterns: `1`
