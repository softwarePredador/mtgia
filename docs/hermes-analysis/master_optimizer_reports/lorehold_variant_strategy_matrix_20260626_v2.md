...
- Generated at: `2026-06-26T17:11:36.164752+00:00`
- Strategy profile: `lorehold_strategy_profile_v2_2026_06_26`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| 1 | VARIANT Lorehold Variant 02 - Rafael Paste 2026-06-23 (`deck_607`) | battle-variant | 138.5 | 98.8 | 34 | 97.9% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | recursion_role, tutor_role |
| 2 | VARIANT Lorehold Variant 10 - Rafael Paste 2026-06-24 (`deck_615`) | spell-copy-big-spells-variant | 135.4 | 97.8 | 34 | 100.0% | Big-spells shell that leans on Lorehold's miracle discount to cast expensive effects ahead of curve. | removal_role, recursion_role, tutor_role |
| 3 | VARIANT Lorehold Variant 09 - Rafael Paste 2026-06-24 (`deck_614`) | lifegain-storm-variant | 131.1 | 94.8 | 33 | 100.0% | Lifegain/storm shell that tries to convert repeated spell casts into life-buffered combo finishers. | removal_role, protection_role, recursion_role |
| 4 | VARIANT Lorehold Variant 01 - Rafael Paste 2026-06-22 (`deck_606`) | submitted-variant | 126.2 | 94.9 | 39 | 100.0% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | deterministic_finisher, removal_role, protection_role, recursion_role, tutor_role, wincon_role, high_land_count |
| 5 | VARIANT Lorehold Variant 08 - Rafael Paste 2026-06-24 (`deck_613`) | spell-copy-control-variant | 120.8 | 85.4 | 32 | 100.0% | Spell-copy control shell that tries to trade resources, protect a window, then convert copied spells into a win. | land_role, removal_role, recursion_role |
| 6 | VARIANT Lorehold Variant 11 - Rafael Paste 2026-06-24 (`deck_616`) | burn-dragon-control-variant | 117.7 | 87.6 | 29 | 85.7% | Burn/dragon-control shell that tries to survive long enough for high-impact threats and damage finishers. | graveyard_recursion, land_role, ramp_role, recursion_role, tutor_role, battle_rule_readiness, low_land_count |
| 7 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 116.6 | 83.0 | 33 | 100.0% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | wincon_role |
| 8 | VARIANT Lorehold Variant 04 - Rafael Paste 2026-06-24 (`deck_609`) | battle-variant | 115.6 | 88.6 | 30 | 100.0% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | land_role, protection_role, recursion_role, low_land_count |
| 9 | Lorehold strategy-first candidate v7 (`candidate_v7`) | strategy-first-candidate | 113.7 | 79.3 | 33 | 100.0% | Strategy-first miracle spellslinger control/combo shell that preserves the active core while tuning lands and package balance. | none |
| 10 | VARIANT Lorehold Variant 06 - Rafael Paste 2026-06-24 (`deck_611`) | big-spells-variant | 105.5 | 77.5 | 34 | 100.0% | Big-spells shell that leans on Lorehold's miracle discount to cast expensive effects ahead of curve. | protection_window, removal_role, protection_role, recursion_role |
| 11 | VARIANT Lorehold Variant 05 - Rafael Paste 2026-06-24 (`deck_610`) | artifact-control-variant | 95.0 | 72.1 | 30 | 85.3% | Artifact-control shell that tries to slow combat, build mana/artifact advantage, then win through compact spell or artifact payoff lines. | protection_window, deterministic_finisher, land_role, draw_role, removal_role, protection_role, recursion_role, wincon_role |
| 12 | VARIANT Lorehold Variant 07 - Rafael Paste 2026-06-24 (`deck_612`) | spell-copy-combo-variant | 91.8 | 72.2 | 27 | 93.0% | Spell-copy combo shell that prioritizes copy effects and burst mana to assemble deterministic spell-chain wins. | protection_window, land_role, draw_role, removal_role, protection_role, recursion_role, tutor_role, low_land_count |
| 13 | VARIANT Lorehold Variant 03 - Rafael Paste 2026-06-23 (`deck_608`) | battle-variant | 85.3 | 66.6 | 31 | 98.5% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | protection_window, deterministic_finisher, land_role, removal_role, protection_role, recursion_role, board_wipe_role, wincon_role |

## 1. VARIANT Lorehold Variant 02 - Rafael Paste 2026-06-23 (`deck_607`)

**Objective:** Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains.

**Commander intent alignment:** score `98.8`, status `needs_battle_proof`.

**Intent risks:** off_plan_cards
...
**Commander intent alignment:** score `97.8`, status `needs_battle_proof`.
...
**Commander intent alignment:** score `94.8`, status `needs_battle_proof`.
...
## 4. VARIANT Lorehold Variant 01 - Rafael Paste 2026-06-22 (`deck_606`)

**Objective:** Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains.

**Commander intent alignment:** score `94.9`, status `needs_battle_proof`.

**Intent risks:** package_deterministic_finisher_shortfall, role_land_overfilled, role_removal_shortfall, role_wincon_shortfall
...
**Commander intent alignment:** score `85.4`, status `needs_battle_proof`.
...
## 7. Runtime Lorehold Learned 19e93de3cca (`deck_6`)

**Objective:** Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains.

**Commander intent alignment:** score `83.0`, status `needs_battle_proof`.

**Intent risks:** package_early_plan_overfilled, package_hand_filter_overfilled, package_spell_chain_conversion_overfilled, package_pressure_absorber_overfilled, role_ramp_overfilled, role_draw_overfilled, role_wincon_shortfall, role_tutor_overfilled
...
## 8. VARIANT Lorehold Variant 04 - Rafael Paste 2026-06-24 (`deck_609`)

**Objective:** Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains.

**Commander intent alignment:** score `88.6`, status `needs_battle_proof`.

**Intent risks:** package_hand_filter_overfilled, package_spell_chain_conversion_overfilled, package_protection_window_shortfall, package_pressure_absorber_shortfall, package_graveyard_recursion_overfilled, package_deterministic_finisher_shortfall, role_land_shortfall, role_draw_overfilled, role_tutor_overfilled, off_plan_cards
...
## 9. Lorehold strategy-first candidate v7 (`candidate_v7`)
...
**Commander intent alignment:** score `79.3`, status `needs_battle_proof`.

**Intent risks:** package_early_plan_overfilled, package_hand_filter_overfilled, package_spell_chain_conversion_overfilled, package_pressure_absorber_overfilled, package_deterministic_finisher_overfilled, role_ramp_overfilled, role_draw_overfilled, role_protection_overfilled, role_tutor_overfilled
...
## 10. VARIANT Lorehold Variant 06 - Rafael Paste 2026-06-24 (`deck_611`)

**Objective:** Big-spells shell that leans on Lorehold's miracle discount to cast expensive effects ahead of curve.

**Commander intent alignment:** score `77.5`, status `needs_battle_proof`.
