...
- `review_only_or_needs_review_rule`: `240`
- `no_trusted_executable_rule`: `128`
...
| `high` | `battle_critical` | 7051 | `Lightning Helix` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `remove_creature` |
