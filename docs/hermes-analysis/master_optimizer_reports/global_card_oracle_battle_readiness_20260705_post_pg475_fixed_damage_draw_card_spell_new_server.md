...
- Generated at: `2026-07-05T02:53:16.523593+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5675 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4412 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4590 | 265 |
| `battle_family_mapper_required` | 29283 | 98 |
...
| `damage_or_life_total_change` | 3841 |
| `token_creation` | 3609 |
| `draw_selection_topdeck` | 3412 |
...
| `battle_family::damage_or_life_total_change` | 3841 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3412 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
