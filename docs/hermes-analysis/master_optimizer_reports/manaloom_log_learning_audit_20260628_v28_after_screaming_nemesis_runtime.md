...
- generated_at: `2026-06-28T22:18:10Z`
...
2. `critical` `runtime_or_test_failure` `text_runtime_traceback` count=15 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains runtime_traceback [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc043_mnemonic_betrayal_opponent_graveyard_runtime_package.md]
...
4. `critical` `runtime_or_test_failure` `text_test_failure` count=6 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains test_failure [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc043_mnemonic_betrayal_opponent_graveyard_runtime_package.md]
