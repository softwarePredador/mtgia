...
- Generated at: `2026-06-30T12:09:27Z`
- Runtime queue: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg278_lantern.json`
...
- Cards reviewed: `19`
- Status counts: `{"pg_package_applied_synced": 2, "review_required": 3, "split_scope_review_required": 14}`
- Promotion lanes: `{"access_density_candidate": 5, "split_family_scope_review_required": 14}`
...
| 12 | `Possibility Storm` | `split_scope_review_required` | `free_cast` | `split_family_scope_review_required` | `free_cast` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 13 | `Prototype Portal` | `split_scope_review_required` | `token_maker` | `split_family_scope_review_required` | `token_maker` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 14 | `Pyxis of Pandemonium` | `split_scope_review_required` | `free_cast` | `split_family_scope_review_required` | `free_cast` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 15 | `Brainstone` | `pg_package_applied_synced` | `access_density` | `access_density_candidate` | `` | 0 | Use the synced verified rule and rebuild the queue before any deck gate; do not rerun this package. |
| 16 | `Hidden Retreat` | `pg_package_applied_synced` | `access_density` | `access_density_candidate` | `` | 0 | Use the synced verified rule and rebuild the queue before any deck gate; do not rerun this package. |
| 17 | `Enlightened Tutor` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
| 18 | `Gamble` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
| 19 | `Penance` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
