...
- Generated at: `2026-07-06T10:55:38.421183+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6528 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5305 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5483 | 269 |
| `battle_family_mapper_required` | 28390 | 94 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6728 |
| `triggered_or_static_ability` | 3870 |
| `damage_or_life_total_change` | 3770 |
| `token_creation` | 3517 |
...
| `battle_family::manual_model_review` | 6728 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3770 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
