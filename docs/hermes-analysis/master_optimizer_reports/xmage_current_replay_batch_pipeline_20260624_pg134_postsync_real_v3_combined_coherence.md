...
- `review_only_or_needs_review_rule`: `160`
...
| `high` | `battle_critical` | 7051 | `Sink into Stupor` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `bounce`, `counter`, `remove_permanent` |
