...
- Generated at: `2026-07-07T01:54:37.264130+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=9021 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=9021 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=7623 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=7623 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=7623 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=8115 pg_runtime_keys=8112 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9269 |
...
| `pg_rows.deck_cards` | `pass` | rows=53941 |
