...
- generated_at: `2026-06-28T20:34:10Z`
...
- log_quality_gap: `2`
- postgres_sync_gap: `2`
- runtime_or_test_failure: `279`
- runtime_rule_gap: `578`
- xmage_mapping_gap: `1324`

## Action Queue

1. `critical` `runtime_rule_gap` `coherence_critical_high_findings` count=574 next=`prioritize_cards_with_no_active_or_no_trusted_rules_in_current_deck_scope`
   - coherence audit has critical=1, high=392 [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/deck_card_battle_rule_coherence_audit_current_explicit_20260628_123905.json]
     ...
     top_lorehold_runtime_missing: `Wild Ricochet, Whispersilk Cloak, Wand of Vertebrae, Vedalken Orrery, Unstable Glyphbridge // Sandswirl Wanderglyph`
   ...
   - coherence audit has critical=1, high=340 [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg240_bolt_bend_postsync_v1_combined_coherence.json]
     ...
     top_lorehold_runtime_missing: `Penance, Magmakin Artillerist, Wild Ricochet, Whispersilk Cloak, Wand of Vertebrae`
...
2. `critical` `runtime_or_test_failure` `text_runtime_traceback` count=13 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains runtime_traceback [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc035_dragon_rage_channeler_surveil_delirium_apply_20260628.out]
...
4. `critical` `runtime_or_test_failure` `text_test_failure` count=4 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains test_failure [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc034_high_noon_self_sacrifice_damage_package.md]
