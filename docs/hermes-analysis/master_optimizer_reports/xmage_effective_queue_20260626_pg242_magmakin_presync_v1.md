...
- Generated at: `2026-06-26T11:25:06+00:00`
- Status: `ready`
...
- `P0` Exhaust the unpackaged PG-ready residual before opening new runtime work. Reason: 1 cards are immediately packageable. Top exact cluster: controller_discards_one_or_more_damage_each_opponent_cycling_ping_annotation_v1 (1)
...
- Count: `1`
- Top scope clusters:
  - `creature` / `creature` / `controller_discards_one_or_more_damage_each_opponent_cycling_ping_annotation_v1`: `1` cards (Magmakin Artillerist)
