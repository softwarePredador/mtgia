...
Generated at: `2026-06-24T20:23:09+00:00`

Read-only artifact. `mutations_performed=[]`.

- Summary: `{"batch_metadata_candidate_count": 0, "card_count": 369, "family_count": 8, "family_counts": {"board_wipe_choice": 4, "creature": 4, "manual_model": 264, "mill_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 69, "token_maker": 21, "tutor": 4}, "manual_or_blocked_count": 345, "promotion_lane_counts": {"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 261, "runtime_family_implementation_required": 24, "split_family_scope_review_required": 80}, "runtime_family_required_count": 24}`
...
| `targeted_interaction` | 69 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 69}` | target legality, resolution, zone transition, and event provenance |
