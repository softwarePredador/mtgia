...
- Generated at: `2026-07-07T04:57:58.694519+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6794 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5578 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5756 | 270 |
| `battle_family_mapper_required` | 28117 | 93 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6645 |
| `triggered_or_static_ability` | 3841 |
| `damage_or_life_total_change` | 3746 |
| `token_creation` | 3490 |
...
| `battle_family::manual_model_review` | 6645 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3746 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::mana_generation_or_ritual` | 679 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon`, `Altar of Shadows` |
