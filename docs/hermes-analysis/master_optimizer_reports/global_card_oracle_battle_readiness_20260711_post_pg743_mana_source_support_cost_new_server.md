...
- Generated at: `2026-07-11T06:00:23.612249+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7603 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6434 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6409 | 275 |
| `battle_family_mapper_required` | 27467 | 89 |
...
| `battle_family::mana_generation_or_ritual` | 629 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon`, `Altar of Shadows` |
