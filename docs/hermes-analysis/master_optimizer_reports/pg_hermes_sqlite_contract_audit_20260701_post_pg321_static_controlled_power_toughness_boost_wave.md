...
- Generated at: `2026-07-01T18:25:31.846955+00:00`
- Status: `pass`
...
| `sqlite_rows.battle_card_rules` | `pass` | rows=6913 |
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=6913 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=6913 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6258 pg_runtime_keys=6255 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=7211 |
...
| `pg_rows.deck_cards` | `pass` | rows=52308 |
