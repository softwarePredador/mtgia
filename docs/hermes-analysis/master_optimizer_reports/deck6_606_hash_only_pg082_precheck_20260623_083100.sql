...
card_oracles AS (
  SELECT e.normalized_name, c.name, c.type_line, c.mana_cost, c.oracle_text,
...
SELECT
  ...
  (SELECT count(*) FROM card_oracles WHERE computed_oracle_hash IN (SELECT expected_oracle_hash FROM expected)) AS oracle_hash_match_rows,
  ...
  to_regclass('manaloom_deploy_audit.pg082_deck6_606_hash_only_20260623_083100') IS NOT NULL AS backup_table_already_exists;

WITH expected(normalized_name, logical_rule_key, expected_oracle_hash, expected_scope) AS (
  VALUES
    ('library of leng', 'battle_rule_v1:b6491cf6f7d7df9a3fb0d91abd3d31c3', '575aef3cc2523831e440ea7dcd55fa6e', 'discard_replacement_to_top_v1'),
    ('scroll rack', 'battle_rule_v1:3b58ff16a7eb52fb05c1bd8517225cd2', '8133928f03d5a5a77f2beecfcbd09e30', 'scroll_rack_upkeep_single_exchange_v1'),
    ('unexpected windfall', 'battle_rule_v1:f9f98ea1925518eea7a7c94c21ef2dc4', '9c4fbe06104051a2e8b1d295d307b26a', 'discard_draw_create_treasures_v1'),
    ('valakut awakening // valakut stoneforge', 'battle_rule_v1:6e1f3b876822abafe1de47610f46858d', '22b42fcc181b7aed71f78b2e1e51e887', 'bottom_then_draw_plus_one_mdfc_land_v1'),
    ('wayfarer''s bauble', 'battle_rule_v1:97eb0d5868d1c777b74aa7d35fc85eab', 'f11935fa793ae03d95ae75d62cdfa516', 'self_sacrifice_basic_land_tutor_artifact_v1')
)
SELECT
  c.name,
  c.type_line,
