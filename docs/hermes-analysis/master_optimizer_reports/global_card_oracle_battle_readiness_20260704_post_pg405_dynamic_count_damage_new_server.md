...
- Generated at: `2026-07-04T12:29:06.595462+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5325 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4054 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4189 | 250 |
| `battle_family_mapper_required` | 29641 | 100 |
...
| `battle_family::damage_or_life_total_change` | 3867 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
