...
- Generated at: `2026-06-24T22:01:48+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260624_pg191_invoke_calamity_postsync_v1_proposals.json`
- Package manifests scanned: `70`
- Cards covered by package manifests: `189`

## Effective Lanes

- `package_already_prepared`: `0`
- `package_ready_unprepared`: `0`
- `split_scope_backlog`: `75`
...
- `P1` After the PG-ready lane shrinks, batch the biggest split-scope cluster. Reason: The partially supported backlog is 75 cards. Top exact cluster: targeted_damage_variant_v1 (20)
...
- `P2` Keep the manual mapper lane last. Reason: 260 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Top scope clusters:
  ...
  - `targeted_interaction` / `draw_cards` / `source_controller_draw_variant_v1`: `16` cards (Arcane Denial, Archivist of Oghma, Bedlam Reveler, Blood Sun, Glint-Horn Buccaneer, Kefka, Court Mage // Kefka, Ruler of Ruin, Morbid Opportunist, Phyrexian Arena)
  ...
  - `targeted_interaction` / `recursion` / `graveyard_to_battlefield_variant_v1`: `3` cards (Forge Anew, Sun Titan, The Soul Stone)
...
- Count: `260`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `259` cards ("Name Sticker" Goblin, Ad Nauseam, Agate Instigator, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Ancient Copper Dragon)
