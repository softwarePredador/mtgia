\echo 'PG795B trusted rule oracle_hash backfill postcheck'

WITH backup AS (
  SELECT *
  FROM manaloom_deploy_audit.pg795b_trusted_rule_oracle_hash_backfill_new_server_20260712
),
remaining AS (
