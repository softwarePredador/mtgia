...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 435, "family_count": 11, "family_counts": {"board_wipe_choice": 4, "creature": 4, "manual_model": 341, "mill_spell": 1, "modal_spell": 1, "opponent_damage_spell": 1, "recursion": 2, "static_cost_reducer": 2, "targeted_interaction": 58, "token_maker": 17, "tutor": 4}, "manual_or_blocked_count": 414, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 338, "runtime_family_implementation_required": 20, "split_family_scope_review_required": 72}, "runtime_family_required_count": 20}`
...
| `manual_model` | 341 | `manual_model_required` | `{"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 337}` | manual Oracle/reference review |
...
| `opponent_damage_spell` | 1 | `runtime_supported_family` | `{"batch_metadata_candidate_requires_pg_precheck": 1}` | one-shot spell resolution that deals fixed noncombat damage to each live opponent |
...
- Family tests: `["test_pg206_boltwave_damages_each_opponent"]`
- Cards: `["Boltwave"]`
