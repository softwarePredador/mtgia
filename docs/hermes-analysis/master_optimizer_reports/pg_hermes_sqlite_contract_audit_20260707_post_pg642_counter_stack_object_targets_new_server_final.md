...
- Generated at: `2026-07-07T21:44:26.305218+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=6801 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=6801 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=7905 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=7905 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=7905 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=5892 pg_runtime_keys=8401 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9568 |
...
| `pg_rows.deck_cards` | `pass` | rows=57015 |
