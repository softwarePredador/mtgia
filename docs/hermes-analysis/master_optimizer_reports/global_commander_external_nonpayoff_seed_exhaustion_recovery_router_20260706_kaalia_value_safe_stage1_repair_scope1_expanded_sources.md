...
- generated_at: `2026-07-06T02:34:52.479765+00:00`
...
| `mana_acceleration` | `seed_exhaustion_role_needs_current_deck_negative_review` | 8 | 1 | 0 | 0 | `collect_current_deck_negative_review_for_external_nonpayoff_candidates` |
| `tutors_access` | `seed_exhaustion_role_needs_broader_external_seed_research` | 6 | 0 | 0 | 0 | `expand_external_nonpayoff_source_candidate_pool_for_exhausted_role` |
...
- `current_deck_external_candidates_need_negative_review:Mana Vault`
