\echo 'PG801B trusted rule oracle_hash backfill precheck'
...
SELECT EXISTS (
  ...
  WHERE table_schema = 'manaloom_deploy_audit'
    AND table_name = 'pg801b_trusted_rule_oracle_hash_backfill_new_server_20260712'
...
SELECT *
FROM target
ORDER BY review_status, card_name, logical_rule_key
LIMIT 80;
