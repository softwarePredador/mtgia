-- PG052 Valakut Awakening hash-only provenance precheck.
-- Scope: Deck 6 L2 hash-only fix for the already verified MDFC hand-filter rule.
-- No executor/effect_json change.
