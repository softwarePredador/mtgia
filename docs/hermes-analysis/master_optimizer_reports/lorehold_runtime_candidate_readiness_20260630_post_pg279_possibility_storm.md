...
- Generated at: `2026-06-30T12:23:59Z`
- Runtime queue: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg279_possibility_storm.json`
...
- Cards reviewed: `18`
- Status counts: `{"pg_package_applied_synced": 2, "review_required": 3, "split_scope_review_required": 13}`
- Promotion lanes: `{"access_density_candidate": 5, "split_family_scope_review_required": 13}`
...
| 8 | `Kayla's Music Box` | `split_scope_review_required` | `free_cast` | `split_family_scope_review_required` | `free_cast` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 9 | `Leyline Dowser` | `split_scope_review_required` | `recursion` | `split_family_scope_review_required` | `recursion` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 10 | `Naktamun Lorespinner // Wheel of Fortune` | `split_scope_review_required` | `draw_engine` | `split_family_scope_review_required` | `draw_engine` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 11 | `Orcish Spy` | `split_scope_review_required` | `topdeck_play` | `split_family_scope_review_required` | `topdeck_play` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 12 | `Prototype Portal` | `split_scope_review_required` | `token_maker` | `split_family_scope_review_required` | `token_maker` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 13 | `Pyxis of Pandemonium` | `split_scope_review_required` | `free_cast` | `split_family_scope_review_required` | `free_cast` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 14 | `Brainstone` | `pg_package_applied_synced` | `access_density` | `access_density_candidate` | `` | 0 | Use the synced verified rule and rebuild the queue before any deck gate; do not rerun this package. |
| 15 | `Hidden Retreat` | `pg_package_applied_synced` | `access_density` | `access_density_candidate` | `` | 0 | Use the synced verified rule and rebuild the queue before any deck gate; do not rerun this package. |
| 16 | `Enlightened Tutor` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
| 17 | `Gamble` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
| 18 | `Penance` | `review_required` | `access_density` | `access_density_candidate` | `` | 0 | Review current evidence before gate. |
