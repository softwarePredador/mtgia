...
- Generated at: `2026-07-11T05:30:55+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24548 |
| `xmage_authoritative_source_count` | 24235 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24235 |
| `manual_semantic_decision_units_remaining` | 313 |
| `authoritative_source_coverage_ratio` | 0.9872 |
| `adapter_work_unit_count` | 11293 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24235 |
...
| `removal_destroy::targeted_destroy_variant_v1` | 481 |
...
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 249 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11035 |
| `token_maker` | 2273 |
| `recursion` | 1792 |
| `draw_engine` | 1554 |
| `add_counters` | 1189 |
| `grant_protection_from_chosen_color` | 1070 |
| `direct_damage` | 755 |
| `life_gain` | 653 |
| `tutor` | 578 |
| `draw_cards` | 547 |
...
| --- | ---: |
| `targeting` | 13027 |
| `triggered_ability` | 11375 |
| `static_ability` | 5301 |
| `activated_ability` | 5042 |
| `counter` | 3699 |
| `condition` | 3238 |
| `token` | 2320 |
| `draw` | 2027 |
