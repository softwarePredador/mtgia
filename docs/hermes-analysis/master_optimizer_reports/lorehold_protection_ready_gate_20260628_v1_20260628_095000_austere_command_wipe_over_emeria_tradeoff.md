...
- generated_at: `2026-06-28T07:39:59Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_protection_ready_gate_20260628_v1_20260628_095000_austere_command_wipe_over_emeria_tradeoff_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: austere_command_wipe_over_emeria_tradeoff (`synergy_austere_command_wipe_over_emeria_tradeoff`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 24.00 | 2 | 1 | 0 | 0 | 0 | 0 | 0 | 3 | 7 | 0 | unattributed: events=7, restricted=7, tax=0 | none |
...
### 2. Lorehold synergy package: austere_command_wipe_over_emeria_tradeoff (`synergy_austere_command_wipe_over_emeria_tradeoff`)
...
| Sisay, Weatherlight Captain #61 (real) | 1 | 0 | 0 | 100.00% | 24.00 | elimination=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 1 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=40, lorehold_spell_cast=35, lorehold_spell_rummage=5, lorehold_upkeep_rummage=11, miracle_cast=13, thor_cost_paid=1, thor_spell_cast=1, topdeck_manipulation_activated=11

**Lorehold attack restriction telemetry:** events=7, attackers_before=20, attackers_after=13, attackers_restricted=7, tax_paid=0, sources=unattributed: events=7, restricted=7, tax=0
