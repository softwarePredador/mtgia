...
- `proposal_count`: `426`
- `pattern_count`: `40`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 333, "package_ready_unprepared": 1, "runtime_family_backlog": 14, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 13, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 10, "runtime_observation_requires_taxonomy": 1}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 13, "manual_model_observation_only": 333, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 62, "runtime_observation_requires_taxonomy": 1}`
...
| --- | --- | --- | ---: | ---: | --- |
| `board_wipe_choice/damage_each_opponent_and_opponent_creatures/blight_x_damage_each_opponent_and_opponent_creatures_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### board_wipe_choice / damage_each_opponent_and_opponent_creatures / blight_x_damage_each_opponent_and_opponent_creatures_v1

- Pattern id: `xmage_pattern:12653d419c476cb7dd1c`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Soul Immolation)
- Subpatterns: `1`
