...
- Generated at: `2026-07-07T00:22:01.614792+00:00`
- Status: `fail`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=8882 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=8882 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=6846 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=6846 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=6846 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=8062 pg_runtime_keys=8080 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9235 |
...
| `pg_rows.deck_cards` | `pass` | rows=51547 |
