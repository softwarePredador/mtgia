...
- `proposal_count`: `386`
- `pattern_count`: `28`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 317, "package_already_prepared": 1, "package_ready_unprepared": 1, "runtime_family_backlog": 4, "split_scope_backlog": 59}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 3, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 317, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 49, "runtime_observation_requires_taxonomy": 1}`
...
| `targeted_interaction/redirect_removal/single_target_spell_or_ability_redirect_costs_three_less_if_control_power_four_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### targeted_interaction / redirect_removal / single_target_spell_or_ability_redirect_costs_three_less_if_control_power_four_v1

- Pattern id: `xmage_pattern:1137ac7814c37f7bb7fb`
