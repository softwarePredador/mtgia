...
- Generated at: `2026-06-30T08:08:57Z`
...
| Approach of the Second Sun | 139 | `runtime_ready_unexposed` | `review_required` | miracle_hit, paid_cast_exposure | approach_cast_tracked=2, approach_first_resolution=1, cast_announced=1, cost_paid=66, miracle_cast=3, cost_paid:Approach of the Second Sun=82, discard_to_top:Approach of the Second Sun=55, lorehold_rummage_to_top:Approach of the Second Sun=49, miracle:Approach of the Second Sun=49 |
| Arcane Signet | 165 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=112, spell_cast=2, cost_paid:Arcane Signet=214 |
| Arid Mesa | 13 | `runtime_ready_unexposed` | `review_required` | none | land_played=13 |
| Artist's Talent | 494 | `draw_filter_value` | `review_required` | discard_payoff, draw_filter_value, paid_cast_exposure | cost_paid=3, trigger_resolved=273, trigger_skipped=186, cost_paid:Artist's Talent=129 |
| Avatar's Wrath | 81 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, miracle_hit, paid_cast_exposure | airbend_other_creatures_resolved=34, cost_paid=22, turn_end=2, cost_paid:Avatar's Wrath=10, discard_to_top:Avatar's Wrath=16, lorehold_rummage_to_top:Avatar's Wrath=88, miracle:Avatar's Wrath=5 |
| Battlefield Forge | 15 | `ramp_engine` | `review_required` | ramp_engine | land_played=15 |
| Bender's Waterskin | 260 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=216, cost_paid:Bender's Waterskin=172 |
| Big Score | 34 | `discard_ramp_value` | `review_required` | discard_payoff, miracle_hit, paid_cast_exposure, ramp_engine | additional_cost_paid=3, cost_paid=24, cost_paid:Big Score=19, miracle:Big Score=1 |
| Blasphemous Act | 297 | `board_wipe_pressure_reset` | `review_required` | discard_or_rummage_context, miracle_hit, pressure_reset_board_wipe | board_wipe_resolved=2, cost_paid=6, damage_wipe_resolved=11, miracle_cast=3, permanent_moved_from_battlefield=10, discard_to_top:Blasphemous Act=23, lorehold_rummage_to_top:Blasphemous Act=17, miracle:Blasphemous Act=6, spell_rummage_to_top:Blasphemous Act=5, static_cost_reduction_on:Blasphemous Act=982 |
| Bloodstained Mire | 31 | `runtime_ready_unexposed` | `review_required` | none | land_played=31 |
| Boros Signet | 53 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=14, cost_paid:Boros Signet=188 |
...
| Deflecting Swat | 88 | `spot_removal` | `review_required` | spot_removal | cast_announced=4, cost_paid=4, miracle_cast=2, priority_pass=16, redirect_removal_resolved=2, discard_to_top:Deflecting Swat=189, lorehold_rummage_to_top:Deflecting Swat=113, spell_rummage_to_top:Deflecting Swat=2 |
...
| Esper Sentinel | 471 | `draw_filter_value` | `review_required` | draw_filter_value, paid_cast_exposure, tutor_target | cast_announced=5, cost_paid=5, pg073_rule_snapshot=1, pg073_rule_summary=1, priority_pass=31, cost_paid:Esper Sentinel=242 |
...
| Farewell | 168 | `board_wipe_pressure_reset` | `review_required` | discard_or_rummage_context, miracle_hit, pressure_reset_board_wipe | permanent_moved_from_battlefield=8, replacement_applied=152, turn_end=2, discard_to_top:Farewell=24, lorehold_rummage_to_top:Farewell=24, miracle:Farewell=3 |
...
| Fellwar Stone | 71 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | spell_resolved=1, cost_paid:Fellwar Stone=496 |
...
| Furygale Flocking | 107 | `runtime_ready_unexposed` | `review_required` | board_development_tokens, miracle_hit, paid_cast_exposure | spell_resolved=1, tokens_created=1, cost_paid:Furygale Flocking=1, discard_to_top:Furygale Flocking=4, lorehold_rummage_to_top:Furygale Flocking=4, miracle:Furygale Flocking=2, static_cost_reduction_on:Furygale Flocking=1182 |
| Generous Gift | 38 | `spot_removal` | `review_required` | miracle_hit, paid_cast_exposure, spot_removal | compensation_tokens_created=1, cost_paid=4, removal_resolved=1, spell_resolved=1, cost_paid:Generous Gift=118, miracle:Generous Gift=4 |
| Giver of Runes | 58 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | activated_ability=2, cast_announced=3, cost_paid=3, creature_cast=3, spell_resolved=1, cost_paid:Giver of Runes=134 |
| Glittering Massif | 75 | `ramp_engine` | `review_required` | discard_or_rummage_context, ramp_engine | land_played=73, turn_end=2 |
| Hexing Squelcher | 78 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid=6, creature_cast=1, creature_to_battlefield=2, replacement_applied=6, spell_resolved=2, cost_paid:Hexing Squelcher=317 |
...
| Improvisation Capstone | 77 | `draw_filter_value` | `review_required` | draw_filter_value, miracle_hit, paid_cast_exposure | cost_paid=67, cost_paid:Improvisation Capstone=16, miracle:Improvisation Capstone=1 |
...
| Jeska's Will | 33 | `runtime_ready_unexposed` | `review_required` | miracle_hit, paid_cast_exposure | jeskas_will_resolved=2, spell_cast=2, spell_resolved=2, cost_paid:Jeska's Will=59, discard_to_top:Jeska's Will=4, lorehold_rummage_to_top:Jeska's Will=4, miracle:Jeska's Will=3 |
| Land Tax | 3012 | `tutor_access` | `review_required` | paid_cast_exposure, tutor_access | cost_paid=508, land_tax_trigger_resolved=496, land_tax_trigger_skipped=1952, spell_cast=1, spell_resolved=2, cost_paid:Land Tax=198 |
| Library of Leng | 730 | `runtime_ready_unexposed` | `review_required` | discard_payoff, paid_cast_exposure | cost_paid=640, runtime_rule_loaded=1, saga_chapter_resolved=57, cost_paid:Library of Leng=171 |
...
| Lorehold, the Historian | 4602 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cast_announced=13, cast_illegal=8, commander_cast=8, cost_paid=2586, equipment_attached=1, cost_paid:Lorehold, the Historian=2606, static_cost_reduction_on:Lorehold, the Historian=342 |
| Marsh Flats | 29 | `runtime_ready_unexposed` | `review_required` | none | land_played=29 |
| Mizzix's Mastery | 93 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, paid_cast_exposure | cast_announced=3, cost_paid=38, miracle_cast=1, mizzix_mastery_copy_cast=2, mizzix_mastery_resolved=2, cost_paid:Mizzix's Mastery=33 |
| Molecule Man | 88 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, paid_cast_exposure | cost_paid=86, turn_end=1, cost_paid:Molecule Man=3 |
...
| Mother of Runes | 70 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cast_announced=3, cost_paid=3, creature_cast=5, replacement_applied=12, spell_resolved=1, cost_paid:Mother of Runes=229 |
| Mountain // Mountain | 355 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context | land_played=49, land_tax_trigger_resolved=303, turn_end=3 |
| Path to Exile | 133 | `spot_removal` | `review_required` | miracle_hit, paid_cast_exposure, spot_removal | cast_announced=2, cost_paid=29, focused_final_state=1, miracle_cast=3, priority_pass=15, cost_paid:Path to Exile=104, miracle:Path to Exile=3 |
| Pearl Medallion | 136 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid:Pearl Medallion=134, static_cost_reduction_saved:Pearl Medallion=654, static_cost_reduction_source_cast:Pearl Medallion=654 |
...
| Plains // Plains | 219 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context | land_played=76, land_tax_trigger_resolved=139, turn_end=4 |
| Plaza of Heroes | 17 | `ramp_engine` | `review_required` | discard_or_rummage_context, ramp_engine | land_played=14, turn_end=3 |
| Prismari Pianist | 71 | `runtime_ready_unexposed` | `review_required` | board_development_tokens, paid_cast_exposure | replacement_applied=6, spell_resolved=1, trigger_resolved=39, cost_paid:Prismari Pianist=85 |
...
| Reforge the Soul | 27 | `draw_filter_value` | `review_required` | discard_or_rummage_context, discard_payoff, draw_filter_value | cost_paid=7, spell_resolved=2, turn_end=2, wheel_resolved=4, discard_to_top:Reforge the Soul=47, lorehold_rummage_to_top:Reforge the Soul=71 |
| Reliquary Tower | 31 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context | land_played=29, turn_end=2 |
| Rise of the Eldrazi | 56 | `spot_removal` | `review_required` | spot_removal, tutor_target | composite_rule_component_resolved=3, composite_rule_resolved=3, cost_paid=3, miracle_cast=6, priority_pass=9, discard_to_top:Rise of the Eldrazi=59, lorehold_rummage_to_top:Rise of the Eldrazi=51, spell_rummage_to_top:Rise of the Eldrazi=5 |
| Ruby Medallion | 177 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, paid_cast_exposure | cost_paid=25, focused_state_assertion=1, spell_resolved=1, turn_end=2, cost_paid:Ruby Medallion=184, static_cost_reduction_saved:Ruby Medallion=758, static_cost_reduction_source_cast:Ruby Medallion=758 |
...
| Scroll Rack | 2494 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | activated_ability_skipped=8, cast_announced=1, cost_paid=596, priority_pass=4, runtime_rule_loaded=1, cost_paid:Scroll Rack=168, topdeck:Scroll Rack=1731 |
| Sensei's Divining Top | 3168 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid=1014, saga_chapter_resolved=276, topdeck_manipulation_activated=1634, cost_paid:Sensei's Divining Top=1006, topdeck:Sensei's Divining Top=2135 |
| Smothering Tithe | 839 | `ramp_engine` | `review_required` | discard_or_rummage_context, paid_cast_exposure, ramp_engine | cost_paid=65, trigger_resolved=734, turn_end=2, cost_paid:Smothering Tithe=112 |
| Sol Ring | 213 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cast_announced=2, cost_paid=128, etb_removal_resolved=2, removal_resolved=3, saga_chapter_resolved=18, cost_paid:Sol Ring=185 |
| Spectator Seating | 9 | `runtime_ready_unexposed` | `review_required` | none | land_played=9 |
| Starfall Invocation | 381 | `board_wipe_pressure_reset` | `review_required` | miracle_hit, paid_cast_exposure, pressure_reset_board_wipe | board_wipe_resolved=86, cost_paid=2, permanent_moved_from_battlefield=86, replacement_applied=203, cost_paid:Starfall Invocation=2, discard_to_top:Starfall Invocation=7, lorehold_rummage_to_top:Starfall Invocation=7, miracle:Starfall Invocation=3 |
...
| Stroke of Midnight | 34 | `spot_removal` | `review_required` | miracle_hit, paid_cast_exposure, spot_removal | compensation_tokens_created=1, cost_paid=8, removal_resolved=1, replacement_applied=14, spell_resolved=1, cost_paid:Stroke of Midnight=15, miracle:Stroke of Midnight=6 |
...
| Surge to Victory | 254 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, miracle_hit | cost_paid=7, spell_copied=3, trigger_resolved=217, turn_end=1, miracle:Surge to Victory=51 |
...
| Swords to Plowshares | 208 | `spot_removal` | `review_required` | miracle_hit, paid_cast_exposure, spot_removal | cost_paid=68, removal_resolved=1, replacement_applied=112, spell_resolved=1, cost_paid:Swords to Plowshares=56, miracle:Swords to Plowshares=4 |
| Talisman of Conviction | 55 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid:Talisman of Conviction=209 |
...
| The Mind Stone | 2043 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=688, trigger_resolved=1010, trigger_skipped=36, utility_artifact_activated=270, cost_paid:The Mind Stone=156 |
| The Scarlet Witch | 351 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid=304, cost_paid:The Scarlet Witch=88, static_cost_reduction_saved:The Scarlet Witch=280, static_cost_reduction_source_cast:The Scarlet Witch=16 |
| Thor, God of Thunder | 133 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | replacement_applied=12, trigger_resolved=66, cost_paid:Thor, God of Thunder=2, spell_cast:Thor, God of Thunder=2, thor_noncreature_damage:Thor, God of Thunder=58, thor_noncreature_damage_amount:Thor, God of Thunder=698 |
...
| Urza's Saga | 2288 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context | land_played=19, saga_chapter_progressed=1137, saga_chapter_resolved=561, saga_sacrificed_by_sba=568, turn_end=3 |
| Victory Chimes | 263 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=236, cost_paid:Victory Chimes=117 |
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_general_synergy_gate_20260627_real2_v1_20260627_123013.json` path `packages[2].gate_summary.candidate.telemetry.top_cards[3]` turn `` effect `` metric `cost_paid:Boros Signet`
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_enlightened_tutor_gate_20260630_creative_technique_seed20260630_real8_games3_partial.json` path `results[0].telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Fellwar Stone`
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_general_synergy_gate_20260627_real2_v1_20260627_123013.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[11]` turn `` effect `` metric `cost_paid:Generous Gift`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_library_leng_telemetry_gate_20260627_seed42_squee_v1.json` path `results[0].telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Generous Gift`
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_hand_filter_expanded_package_gate_20260630_post_pg270_v2_20260630_080110_olorin_hand_filter_cut_improvisation_capstone_expanded607.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kraum, Ludevic's Opus #81 (real):0[67]` turn `11` effect `exile_value` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_hand_filter_expanded_package_gate_20260630_post_pg270_v2_20260630_080110_olorin_hand_filter_cut_improvisation_capstone_expanded607.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Thrasios, Triton Hero #101 (real):1[54]` turn `8` effect `exile_value` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_hand_filter_expanded_package_gate_20260630_post_pg270_v2_20260630_080110_olorin_hand_filter_cut_improvisation_capstone_expanded607.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Thrasios, Triton Hero #101 (real):2[56]` turn `9` effect `exile_value` metric ``
...
- `thor_noncreature_damage_amount` from `docs/hermes-analysis/master_optimizer_reports/lorehold_electro_waterskin_gate_20260630_fixed_20260630_042339_electro_assaulting_battery_same_lane_benchmark_cut_bender_s_waterskin.json` path `results[0].telemetry.top_cards[11]` turn `` effect `` metric `thor_noncreature_damage_amount:Thor, God of Thunder`
