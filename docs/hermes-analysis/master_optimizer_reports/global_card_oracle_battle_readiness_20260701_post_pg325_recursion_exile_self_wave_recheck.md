...
- Generated at: `2026-07-01T19:45:58.980594+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4792 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3479 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2331 | 394 |
| `battle_family_mapper_required` | 30216 | 225 |
...
| `battle_family::recursion_or_bounce` | 534 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Aid the Fallen` |
