...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 450, "family_count": 9, "family_counts": {"board_wipe_choice": 4, "creature": 5, "manual_model": 350, "mill_spell": 1, "modal_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 63, "token_maker": 20, "tutor": 4}, "manual_or_blocked_count": 426, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 347, "runtime_family_implementation_required": 23, "split_family_scope_review_required": 75}, "runtime_family_required_count": 23}`
...
| `targeted_interaction` | 63 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 63}` | target legality, resolution, zone transition, and event provenance |
...
- Family tests: `[]`
- Cards: `["Razaketh, the Foulblooded", "Rune-Scarred Demon", "Sun Titan", "Blood Artist", "Starfield Shepherd"]`
...
- Batch strategy: `split_by_scope_before_metadata_batch`
- Family tests: `[]`
- Cards: `["Flusterstorm", "Chain of Vapor", "Vandalblast", "Reprieve", "Bloodchief Ascension", "Glint-Horn Buccaneer", "Tezzeret, Cruel Captain", "Trouble in Pairs"]`
