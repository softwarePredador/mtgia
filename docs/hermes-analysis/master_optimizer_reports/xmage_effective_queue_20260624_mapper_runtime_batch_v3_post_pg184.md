...
- Generated at: `2026-06-24T19:26:39+00:00`
- Status: `ready`
...
- Package manifests scanned: `63`
- Cards covered by package manifests: `182`
...
- `P0` Stop rebuilding cards that already have PG package artifacts. Reason: 2 current candidates are already covered by prepared package manifests in the report directory.
...
- `PG184` `mill_threshold_ritual_batch`: `2` cards
