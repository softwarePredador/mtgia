...
- Generated at: `2026-07-05T08:40:35.835409+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5909 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4652 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4830 | 265 |
| `battle_family_mapper_required` | 29043 | 98 |
...
| `battle_family::manual_model_review` | 6980 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::targeted_removal` | 1030 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Acid Web Spider`, `Acidic Slime`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock` |
