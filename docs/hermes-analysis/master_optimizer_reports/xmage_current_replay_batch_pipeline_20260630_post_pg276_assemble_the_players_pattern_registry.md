...
- `proposal_count`: `125`
- `pattern_count`: `20`
- `lane_counts`: `{"manual_mapper_backlog": 61, "split_scope_backlog": 64}`
...
- `card_counts_by_pattern_status`: `{"candidate_template_requires_review_tests": 13, "manual_model_observation_only": 61, "requires_subpattern_split_before_promotion": 51}`
...
| `recursion/recursion/xmage_graveyard_return_variant_review_v1` | `split_scope_backlog` | `requires_subpattern_split_before_promotion` | 9 | 5 | Split by ability kind, target constraints, triggers, costs, and secondary effects before promotion. |
...
- Lane: `split_scope_backlog`
- Status: `requires_subpattern_split_before_promotion`
- Cards: `9` (Bond of Insight, Charmbreaker Devils, Endurance, Experimental Overload, Flashback, Gandalf's Sanction, Moonshadow, Pulsemage Advocate, Worldfire)
- Subpatterns: `5`
- Required evidence: `["subpattern split", "focused ManaLoom tests per subpattern", "package generation only for exact supported subpatterns"]`
