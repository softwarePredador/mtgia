...
- Generated at: `2026-07-12T21:19:56+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24143 |
| `xmage_authoritative_source_count` | 23830 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 23830 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 23830 |
...
| `draw_engine::xmage_draw_card_variant_review_v1` | 1546 |
...
| `draw_cards::xmage_draw_card_variant_review_v1` | 520 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 10848 |
| `token_maker` | 2262 |
| `recursion` | 1781 |
| `draw_engine` | 1546 |
| `add_counters` | 1183 |
...
| --- | ---: |
| `targeting` | 12806 |
| `triggered_ability` | 11354 |
| `static_ability` | 5211 |
| `activated_ability` | 4987 |
| `counter` | 3680 |
| `condition` | 3216 |
| `token` | 2309 |
| `draw` | 1978 |
