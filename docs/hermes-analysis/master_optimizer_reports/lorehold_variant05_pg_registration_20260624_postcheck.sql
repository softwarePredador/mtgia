\pset pager off
-- PG register postcheck for Lorehold Variant 05.
SELECT
  'pg_lorehold_variant05_deck' AS check_name,
...
FROM decks d
WHERE d.id = '8aa57962-3a3e-5351-89fd-e4651456a3bd'::uuid;

SELECT
  'pg_lorehold_variant05_deck_cards' AS check_name,
  COUNT(*) AS rows,
...
FROM deck_cards
WHERE deck_id = '8aa57962-3a3e-5351-89fd-e4651456a3bd'::uuid;

SELECT
  'pg_lorehold_variant05_learned' AS check_name,
...
SELECT
  'pg_lorehold_variant05_missing_card_rows' AS check_name,
  COUNT(*) AS missing_card_rows
FROM deck_cards dc
LEFT JOIN cards c ON c.id = dc.card_id
WHERE dc.deck_id = '8aa57962-3a3e-5351-89fd-e4651456a3bd'::uuid
  AND c.id IS NULL;
