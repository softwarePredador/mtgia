...
- generated_at: `2026-06-28T23:00:29Z`
...
1. `critical` `runtime_rule_gap` `coherence_critical_high_findings` count=583 next=`prioritize_cards_with_no_active_or_no_trusted_rules_in_current_deck_scope`
   - coherence audit has critical=1, high=392 [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/deck_card_battle_rule_coherence_audit_current_explicit_20260628_123905.json]
     ...
     top_lorehold_runtime_missing: `Unstable Glyphbridge // Sandswirl Wanderglyph, Toralf, God of Fury // Toralf's Hammer, Rune-Tail, Kitsune Ascendant // Rune-Tail's Essence, Radiant Performer, Pyxis of Pandemonium`
...
2. `critical` `runtime_or_test_failure` `text_runtime_traceback` count=17 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains runtime_traceback [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc049_touch_the_spirit_realm_channel_runtime_package.md]
3. `critical` `runtime_or_test_failure` `text_test_failure` count=8 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains test_failure [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc049_touch_the_spirit_realm_channel_runtime_package.md]
