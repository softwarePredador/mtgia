...
- Generated at: `2026-07-04T22:14:56.368439+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5373 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4090 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4268 | 263 |
| `battle_family_mapper_required` | 29605 | 100 |
...
| `battle_family::manual_model_review` | 7169 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::tutor_search_library` | 805 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A.I.M. Scientists`, `Aang's Journey`, `Absorb Vis`, `Abzan Monument`, `Academy Rector`, `Aerial Surveyor`, `Agency Outfitter`, `Ainok Guide`, `Ajani's Aid`, `Alabaster Host Intercessor` |
