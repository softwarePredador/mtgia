...
- `trusted_rule_without_oracle_hash`: `177`
- `review_only_or_needs_review_rule`: `176`
- `no_active_battle_rule`: `103`
- `generic_effect_without_model_scope`: `101`
...
| `high` | `battle_critical` | 7051 | `Weathered Wayfarer` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `tutor` |
...
| `high` | `battle_support` | 7561 | `Chrome Mox` | 11 | 11 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `ramp_permanent` |
| `high` | `battle_support` | 7510 | `Mox Diamond` | 10 | 10 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `ramp_permanent` |
