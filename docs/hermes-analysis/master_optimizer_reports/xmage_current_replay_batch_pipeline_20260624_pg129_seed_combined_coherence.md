...
- `trusted_rule_without_oracle_hash`: `172`
- `review_only_or_needs_review_rule`: `171`
- `generic_effect_without_model_scope`: `97`
- `no_active_battle_rule`: `96`
...
| `high` | `battle_support` | 7459 | `Birds of Paradise` | 9 | 9 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `ramp_permanent` |
| `high` | `battle_support` | 7408 | `Crop Rotation` | 8 | 8 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `land_ramp`, `ramp_permanent` |
