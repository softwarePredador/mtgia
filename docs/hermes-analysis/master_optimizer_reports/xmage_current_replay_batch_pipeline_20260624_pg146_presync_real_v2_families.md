...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 241, "family_count": 4, "family_counts": {"copy_creature_token": 1, "creature": 1, "manual_model": 235, "token_maker": 4}, "manual_or_blocked_count": 236, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 3, "mapper_metadata_or_test_scenario_required": 232, "runtime_family_implementation_required": 4, "split_family_scope_review_required": 1}, "runtime_family_required_count": 4}`
...
| `token_maker` | 4 | `runtime_family_required` | `{"runtime_family_implementation_required": 4}` | token creation with stats, abilities, duration, and zone cleanup |
...
- Family tests: `[]`
- Cards: `["Insidious Roots", "Eldrazi Confluence", "Springheart Nantuko", "Magda, Brazen Outlaw"]`
