...
- Generated at: `2026-07-04T09:21:52.635807+00:00`
- Status: `pass`
- PostgreSQL target: `127.0.0.1:15432/halder`
- SQLite DB: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/manaloom-knowledge/scripts/knowledge.db`
- Summary: `{"check_count": 50, "status_counts": {"pass": 50}}`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=7501 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=7501 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=6166 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=6166 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=6166 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6704 pg_runtime_keys=6701 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=7749 |
