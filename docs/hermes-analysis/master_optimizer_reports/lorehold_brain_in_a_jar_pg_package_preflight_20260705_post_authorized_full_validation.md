...
- Generated at: `2026-07-05T11:33:37Z`
...
- `apply_sql`: `docs/hermes-analysis/master_optimizer_reports/lorehold_brain_in_a_jar_pg_package_preflight_20260705_post_authorized_full_validation_apply.sql`
- `exact_contract`: `docs/hermes-analysis/master_optimizer_reports/lorehold_brain_in_a_jar_exact_runtime_contract_20260705_post_authorized_full_validation.json`
- `postcheck_sql`: `docs/hermes-analysis/master_optimizer_reports/lorehold_brain_in_a_jar_pg_package_preflight_20260705_post_authorized_full_validation_postcheck.sql`
- `precheck_sql`: `docs/hermes-analysis/master_optimizer_reports/lorehold_brain_in_a_jar_pg_package_preflight_20260705_post_authorized_full_validation_precheck.sql`
- `rollback_sql`: `docs/hermes-analysis/master_optimizer_reports/lorehold_brain_in_a_jar_pg_package_preflight_20260705_post_authorized_full_validation_rollback.sql`
- `runtime_cut_preflight`: `docs/hermes-analysis/master_optimizer_reports/lorehold_brain_in_a_jar_runtime_cut_preflight_20260705_post_authorized_full_validation.json`
