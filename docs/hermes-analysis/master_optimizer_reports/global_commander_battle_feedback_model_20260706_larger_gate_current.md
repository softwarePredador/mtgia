...
- generated_at: `2026-07-06T14:49:47.142437+00:00`
- status: `pass`
...
| --- | --- | --- | --- | --- | ---: | ---: | ---: | --- |
| `pair_needs_exposure_replay_before_gate` | `Lorehold, the Historian` | `609` | `Artist's Talent, Bant Panorama, Bloodstained Mire, Cabaretti Courtyard, City of Brass, Escape Tunnel, Sunbaked Canyon` | `Apex of Power, Big Score, Bolt Bend, Brass's Bounty, Hit the Mother Lode, Reforge the Soul, Tibalt's Trickery` | 0.0 | 0.0 | 1 | `run_exposure_replay_or_focused_test_before_candidate_gate` |
...
| --- | --- | --- | --- | --- | --- | ---: | ---: | --- | --- |
| `package_blocked_by_protected_baseline_gate` | `package_failed_protected_baseline_gate` | `Lorehold, the Historian` | `609` | `Artist's Talent, Bant Panorama, Bloodstained Mire` | `Big Score, Brass's Bounty, Hit the Mother Lode` | -2 | -1 | `Escape Tunnel` | `block_package_until_new_source_lane_cut_or_strategy` |
