...
| 2 |  | Lorehold synergy package: seething_song_cut_fellwar_stone (`synergy_seething_song_cut_fellwar_stone`) | synergy-package | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 3 | 1 | 0 | 0 | 0 | 0 | 0 | 3 | none |
...
### 2. Lorehold synergy package: seething_song_cut_fellwar_stone (`synergy_seething_song_cut_fellwar_stone`)
...
**Strategic event counts:** lorehold_cost_paid=31, lorehold_spell_cast=29, lorehold_upkeep_rummage=21, topdeck_manipulation_activated=4, miracle_cast=6, lorehold_spell_rummage=2
