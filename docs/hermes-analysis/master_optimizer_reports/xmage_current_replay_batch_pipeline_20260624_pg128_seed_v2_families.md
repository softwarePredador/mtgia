...
- Summary: `{"batch_metadata_candidate_count": 6, "card_count": 304, "family_count": 3, "family_counts": {"manual_model": 254, "targeted_interaction": 25, "token_maker": 25}, "manual_or_blocked_count": 273, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 6, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 247, "runtime_family_implementation_required": 25, "split_family_scope_review_required": 22}, "runtime_family_required_count": 25}`
...
| `targeted_interaction` | 25 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 3, "split_family_scope_review_required": 22}` | target legality, resolution, zone transition, and event provenance |
...
- Family tests: `[]`
- Cards: `["Orcish Bowmasters", "Deathrite Shaman", "Faerie Mastermind", "Wan Shi Tong, Librarian", "Agatha's Soul Cauldron", "Borne Upon a Wind", "Into the Flood Maw", "Vexing Bauble"]`
