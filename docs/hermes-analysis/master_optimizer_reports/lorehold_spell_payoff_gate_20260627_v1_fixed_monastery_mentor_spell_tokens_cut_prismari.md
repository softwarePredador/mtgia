...
- generated_at: `2026-06-27T20:53:22Z`
...
| 2 |  | Lorehold synergy package: monastery_mentor_spell_tokens_cut_prismari (`synergy_monastery_mentor_spell_tokens_cut_prismari`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 6.00 | 3 | 0 | 0 | 0 | 0 | 0 | 0 | 3 | none |
...
### 2. Lorehold synergy package: monastery_mentor_spell_tokens_cut_prismari (`synergy_monastery_mentor_spell_tokens_cut_prismari`)
...
| Sisay, Weatherlight Captain #61 (real) | 1 | 0 | 0 | 100.00% | 6.00 | approach=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 1 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=19, lorehold_spell_cast=17, lorehold_upkeep_rummage=13, miracle_cast=6
