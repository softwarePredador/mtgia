...
- `proposal_count`: `430`
- `pattern_count`: `43`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 333, "runtime_family_backlog": 19, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 2, "requires_subpattern_split_before_promotion": 10, "runtime_observation_requires_taxonomy": 1, "runtime_template_candidate_requires_executor_tests": 1}`
