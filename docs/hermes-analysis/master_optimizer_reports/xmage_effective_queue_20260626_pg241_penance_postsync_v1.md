...
- Generated at: `2026-06-26T11:10:41+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg241_penance_postsync_v1_proposals.json`
- Package manifests scanned: `115`
- Cards covered by package manifests: `256`
...
- `P2` Keep the manual mapper lane last. Reason: 316 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `316`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `315` cards ("Name Sticker" Goblin, Ad Nauseam, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury, Amphibian Downpour)
