...
- Generated at: `2026-06-30T03:09:15.966998+00:00`
- Strategy profile: `lorehold_strategy_profile_v3_2026_06_26`
- Scope: decks `607, 615` plus candidate v7 when available.
- Best structural deck before equal battle gate: `candidate_607_enlightened_tutor_creative_technique_v1`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| 1 | Lorehold 607 + Enlightened Tutor over Creative Technique v1 (`candidate_607_enlightened_tutor_creative_technique_v1`) | 607-enlightened-tutor-creative-technique | 141.3 | 100.0 | 34 | 97.9% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | recursion_role, tutor_role |
