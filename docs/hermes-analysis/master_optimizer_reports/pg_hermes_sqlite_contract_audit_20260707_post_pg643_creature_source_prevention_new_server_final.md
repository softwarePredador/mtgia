...
- Generated at: `2026-07-07T22:08:03.802229+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=6806 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=6806 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=7911 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=7911 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=7911 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=5897 pg_runtime_keys=8406 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9573 |
...
| `pg_rows.deck_cards` | `pass` | rows=58829 |
