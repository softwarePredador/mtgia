...
- generated_at: `2026-07-06T01:46:01.123741+00:00`
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| `haste_protection_silence` | `seed_exhaustion_role_needs_current_deck_negative_review` | 2 | 1 | 2 | 1 | `collect_current_deck_negative_review_for_external_nonpayoff_candidates` |
| `mana_acceleration` | `seed_exhaustion_role_needs_current_deck_negative_review` | 3 | 1 | 1 | 0 | `collect_current_deck_negative_review_for_external_nonpayoff_candidates` |
| `tutors_access` | `seed_exhaustion_role_needs_current_deck_negative_review` | 0 | 4 | 1 | 0 | `collect_current_deck_negative_review_for_external_nonpayoff_candidates` |
...
- `P2` `resolve_external_nonpayoff_candidate_identity_before_seed_review`: Identity-missing source candidates cannot seed miner research.
- `P3` `hold_package_adds_until_value_safe_same_lane_pair_exists`: Cards already selected as package adds still need value-safe same-lane cuts before materialization.
...
- `Lightning Greaves` -> `haste_protection_silence`
- `Arcane Signet` -> `mana_acceleration`
- `Demonic Tutor` -> `tutors_access`
- `Enlightened Tutor` -> `tutors_access`
- `Vampiric Tutor` -> `tutors_access`
- `Diabolic Intent` -> `tutors_access`
...
- `current_deck_external_candidates_need_negative_review:Lightning Greaves,Arcane Signet,Demonic Tutor,Enlightened Tutor,Vampiric Tutor,Diabolic Intent`
- `held_package_external_candidates_need_value_safe_pairs:Swiftfoot Boots,Boros Charm,Fellwar Stone,Gamble`
- `unseeded_roles_need_expanded_source_candidates:tutors_access`
- `identity_resolution_required:Bitter Reunion`
