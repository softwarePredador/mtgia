...
- Generated at: `2026-06-28T10:49:58Z`
...
- Promotion lanes: `{"batch_metadata_candidate_requires_pg_precheck": 3, "mapper_metadata_or_test_scenario_required": 52, "split_family_scope_review_required": 6}`
...
- Targeted interaction subfamily statuses: `{"runtime_family_implementation_required": 5, "runtime_supported_family": 1}`
- Family count: `5`
...
| 2 | `targeted_interaction` | 6 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 5, "finisher_or_big_spell": 1}` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 5}` | target legality, resolution, zone transition, and event provenance |
...
| `Terror of the Peaks` | 0 | `608, 612` | `contextual` | `split_family_scope_review_required` | `targeted_damage_etb_power_to_any_target` | implement Terror-of-the-Peaks style ETB power damage resolver and focused battle test | `direct_damage` | `targeted_damage_variant_v1` | `TerrorOfThePeaks` |
...
| `Firesong and Sunspeaker` | -10 | `616` | `finisher_or_big_spell` | `split_family_scope_review_required` | `instant_sorcery_lifelink_lifegain_damage_engine` | implement Firesong and Sunspeaker lifelink/lifegain trigger as a standalone battle family | `direct_damage` | `targeted_damage_variant_v1` | `FiresongAndSunspeaker` |
