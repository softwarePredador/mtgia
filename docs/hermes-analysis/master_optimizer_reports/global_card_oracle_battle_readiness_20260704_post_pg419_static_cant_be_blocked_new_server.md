...
- Generated at: `2026-07-04T18:13:11.251916+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5506 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4243 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4421 | 265 |
| `battle_family_mapper_required` | 29452 | 98 |
...
| `battle_family::manual_model_review` | 7232 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
