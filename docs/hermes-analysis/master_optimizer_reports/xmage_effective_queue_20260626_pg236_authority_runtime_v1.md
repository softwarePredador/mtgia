...
- Generated at: `2026-06-26T09:10:43+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg236_authority_runtime_v1_proposals.json`
- Package manifests scanned: `109`
- Cards covered by package manifests: `245`
...
- `P0` Exhaust the unpackaged PG-ready residual before opening new runtime work. Reason: 1 cards are immediately packageable. Top exact cluster: opponent_creature_enter_tapped_gain_life_v1 (1)
...
- `P2` Keep the manual mapper lane last. Reason: 323 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `1`
- Top scope clusters:
  - `passive` / `passive` / `opponent_creature_enter_tapped_gain_life_v1`: `1` cards (Authority of the Consuls)
...
- Count: `323`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `322` cards ("Name Sticker" Goblin, Ad Nauseam, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury, Amphibian Downpour)
