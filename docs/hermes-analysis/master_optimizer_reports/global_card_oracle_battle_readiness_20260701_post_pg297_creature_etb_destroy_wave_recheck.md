...
- Generated at: `2026-07-01T10:48:32.660523+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4314 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 2979 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1831 | 389 |
| `battle_family_mapper_required` | 30716 | 230 |
...
| `battle_family::targeted_removal` | 1135 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Acid Web Spider`, `Acidic Slime`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock` |
