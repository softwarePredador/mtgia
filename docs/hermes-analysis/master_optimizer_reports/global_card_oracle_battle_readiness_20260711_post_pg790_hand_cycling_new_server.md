...
- Generated at: `2026-07-11T21:58:56.522585+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7784 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6620 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6584 | 277 |
| `battle_family_mapper_required` | 27281 | 87 |
...
| `damage_or_life_total_change` | 3646 |
| `token_creation` | 3450 |
...
| `battle_family::damage_or_life_total_change` | 3646 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::mana_generation_or_ritual` | 611 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon`, `Altar of Shadows` |
