...
- generated_at: `2026-06-27T18:30:03Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: primal_amulet_spell_engine (`synergy_primal_amulet_spell_engine`) | synergy-package | 9 | 1 | 8 | 0 | 11.11% | 11.00 | 4 | 1 | 0 | 0 | 0 | 0 | 0 | 9 | none |
...
**Strategic event counts:** lorehold_cost_paid=74, lorehold_spell_cast=59, lorehold_upkeep_rummage=31, topdeck_manipulation_activated=1, miracle_cast=6, lorehold_spell_rummage=1
