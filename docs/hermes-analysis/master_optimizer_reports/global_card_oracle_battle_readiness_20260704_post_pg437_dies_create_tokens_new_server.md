...
- Generated at: `2026-07-04T21:52:40.804266+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5311 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4027 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4205 | 263 |
| `battle_family_mapper_required` | 29668 | 100 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7190 |
| `triggered_or_static_ability` | 3907 |
| `damage_or_life_total_change` | 3900 |
| `token_creation` | 3609 |
...
| `battle_family::manual_model_review` | 7190 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3900 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Acceptable Losses` |
