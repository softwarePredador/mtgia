...
Generated at: `2026-06-29T17:02:18+00:00`
...
- `shadow_rule_preserved_for_history`: `89`
- `trusted_rule_without_oracle_hash`: `83`
- `no_active_battle_rule`: `73`
- `generic_effect_without_model_scope`: `47`
...
| `high` | `battle_critical` | 7051 | `Bridgeworks Battle` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards` |
