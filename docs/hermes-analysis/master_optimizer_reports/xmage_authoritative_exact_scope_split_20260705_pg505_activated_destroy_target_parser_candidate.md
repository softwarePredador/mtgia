...
- `activated_destroy_oracle_not_simple`: `["Boom Box", "Devout Harpist", "Eastern Paladin", "Gorilla Shaman", "Haazda Exonerator", "King Suleiman", "Miracle Worker", "Nezumi Shadow-Watcher", "Northern Paladin", "Nosy Goblin", "Orcish Settlers", "Plaguebearer"]`
...
- `activated_destroy_source_target_not_supported`: `["Deepfire Elemental", "Dogged Hunter", "Hearth Kami", "Knight of Dusk", "Ogre Siegebreaker", "Rats of Rath", "Witch's Mist"]`
...
- `etb_destroy_target_not_supported`: `["Angel of Despair", "Armaggon, Future Shark", "Dark Hatchling", "Final-Sting Faerie", "Gilt-Leaf Winnower", "Kraul Whipcracker", "Lurking Deadeye", "Nekrataal", "Ogre Gatecrasher", "Stingerfling Spider"]`
...
- `token_description_keyword_not_supported`: `["Birthing Boughs", "Carrion Call", "Dance with Devils", "Devils' Playground", "Dragon Egg", "Errand of Duty", "Goblin Wizardry", "Harried Spearguard", "Hobbling Zombie", "Mage's Attendant", "Master of the Hunt", "Mitotic Slime"]`
...
- `token_literal_description_missing`: `["Symbiotic Beast", "Symbiotic Elf", "Symbiotic Wurm"]`
