...
- generated_at: `2026-06-27T18:07:29Z`
...
| 2 |  | Lorehold synergy package: angel_grace_life_floor_cut_dawn (`synergy_angel_grace_life_floor_cut_dawn`) | synergy-package | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 5 | 2 | 1 | 2 | 1 | 1 | 0 | 7 | none |
...
### 2. Lorehold synergy package: angel_grace_life_floor_cut_dawn (`synergy_angel_grace_life_floor_cut_dawn`)
...
**Strategic event counts:** lorehold_cost_paid=82, lorehold_spell_cast=59, lorehold_upkeep_rummage=48, miracle_cast=11, lorehold_spell_rummage=3, squee_to_graveyard=3, graveyard_upkeep_return_self_to_hand=2, squee_upkeep_return=2, squee_return_after_known_graveyard_entry=2, topdeck_manipulation_activated=4, discard_to_top_replacement=6, lorehold_rummage_discard_to_top=6
