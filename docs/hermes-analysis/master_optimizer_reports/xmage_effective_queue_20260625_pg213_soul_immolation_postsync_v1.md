...
- Generated at: `2026-06-25T09:27:20+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg213_soul_immolation_postsync_v1_proposals.json`
- Package manifests scanned: `91`
- Cards covered by package manifests: `214`
...
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 14 cards. Top reusable exact scope cluster: damage_all_variant_v1 (1). Largest raw family is token_maker (13 cards across 13 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
