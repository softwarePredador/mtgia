...
- generated_at: `2026-06-27T20:41:46Z`
...
| 2 |  | Lorehold synergy package: lapse_approach_topdeck_cut_tibalts_trickery (`synergy_lapse_approach_topdeck_cut_tibalts_trickery`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 11.00 | 3 | 1 | 1 | 0 | 0 | 0 | 0 | 1 | none |
...
### 2. Lorehold synergy package: lapse_approach_topdeck_cut_tibalts_trickery (`synergy_lapse_approach_topdeck_cut_tibalts_trickery`)
...
| Winota, Joiner of Forces #39 (real) | 1 | 0 | 0 | 100.00% | 11.00 | approach=1 |

**Strategic event counts:** lorehold_cost_paid=39, lorehold_spell_cast=33, lorehold_upkeep_rummage=7, discard_to_top_replacement=7, lorehold_rummage_discard_to_top=7, miracle_cast=7, topdeck_manipulation_activated=6
