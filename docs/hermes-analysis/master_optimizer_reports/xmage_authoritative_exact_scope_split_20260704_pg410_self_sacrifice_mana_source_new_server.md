...
| `Morgue Toad` | `xmage_self_sacrifice_mana_source_permanent` | `xmage_self_sacrifice_mana_source_permanent_v1` | `ramp_permanent` | `battle_rule_v1:d7bd10f259751a844ba56293ab501501` |
| `Rith's Attendant` | `xmage_self_sacrifice_mana_source_permanent` | `xmage_self_sacrifice_mana_source_permanent_v1` | `ramp_permanent` | `battle_rule_v1:e6eb30b02a5e82a34a0af6a85631696c` |
| `Satyr Hedonist` | `xmage_self_sacrifice_mana_source_permanent` | `xmage_self_sacrifice_mana_source_permanent_v1` | `ramp_permanent` | `battle_rule_v1:af510c5e5b789c3ad56b26271af0c3df` |
| `Treva's Attendant` | `xmage_self_sacrifice_mana_source_permanent` | `xmage_self_sacrifice_mana_source_permanent_v1` | `ramp_permanent` | `battle_rule_v1:9d409157b20663ee285ca20a1fafd18c` |
