...
- generated_at: `2026-06-27T19:04:03Z`
...
| 2 |  | Lorehold synergy package: boseiju_spell_protection_land (`synergy_boseiju_spell_protection_land`) | synergy-package | 9 | 3 | 6 | 0 | 33.33% | 12.33 | 5 | 3 | 0 | 1 | 1 | 1 | 0 | 7 | none |
...
### 2. Lorehold synergy package: boseiju_spell_protection_land (`synergy_boseiju_spell_protection_land`)
...
| Sisay, Weatherlight Captain #61 (real) | 3 | 0 | 0 | 100.00% | 12.33 | elimination=3 |
| Winota, Joiner of Forces #39 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=79, lorehold_spell_cast=60, lorehold_upkeep_rummage=26, miracle_cast=12, topdeck_manipulation_activated=8, squee_to_graveyard=2, graveyard_upkeep_return_self_to_hand=2, squee_upkeep_return=2, squee_return_after_known_graveyard_entry=2, lorehold_spell_rummage=1
