...
- generated_at: `2026-06-28T03:46:20Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 1 | 1 | 0 | 1 | 1 | 1 | 0 | 2 | 0 | 0 | none | wincon_role |
...
**Strategic event counts:** lorehold_cost_paid=16, lorehold_spell_cast=9, lorehold_upkeep_rummage=5, squee_to_graveyard=2, graveyard_upkeep_return_self_to_hand=2, squee_upkeep_return=2, squee_return_after_known_graveyard_entry=2, topdeck_manipulation_activated=2, lorehold_rummage_discards_squee=1, miracle_cast=1
