...
- Generated at: `2026-06-25T09:02:11+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg212_ultima_postsync_v1_proposals.json`
- Package manifests scanned: `90`
- Cards covered by package manifests: `213`
...
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 15 cards. Top reusable exact scope cluster: damage_all_variant_v1 (2). Largest raw family is token_maker (13 cards across 13 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
