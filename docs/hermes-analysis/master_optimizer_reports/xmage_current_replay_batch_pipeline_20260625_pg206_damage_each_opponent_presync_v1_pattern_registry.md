...
- Generated at: `2026-06-25T06:32:13+00:00`
- Status: `ready`
- Mutations performed: `[]`
...
- `proposal_count`: `435`
- `pattern_count`: `42`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 338, "package_ready_unprepared": 1, "runtime_family_backlog": 20, "split_scope_backlog": 72}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 338, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `opponent_damage_spell/damage_each_opponent/spell_damage_each_opponent_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 337 | 53 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### opponent_damage_spell / damage_each_opponent / spell_damage_each_opponent_v1

- Pattern id: `xmage_pattern:61f2d4edc85d9f5e0316`
