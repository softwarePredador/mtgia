...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: galvanoth_topdeck_freecast (`synergy_galvanoth_topdeck_freecast`) | synergy-package | 9 | 1 | 8 | 0 | 11.11% | 10.00 | 5 | 2 | 0 | 0 | 0 | 0 | 6 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 4 | 1 | 0 | 0 | 0 | 0 | 9 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: galvanoth_topdeck_freecast (`synergy_galvanoth_topdeck_freecast`)
...
**Strategic event counts:** lorehold_cost_paid=60, lorehold_spell_cast=46, lorehold_upkeep_rummage=23, topdeck_manipulation_activated=3, miracle_cast=5
