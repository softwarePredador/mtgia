...
- generated_at: `2026-06-27T11:48:24Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_synergy_package_gate_20260627_v1_20260627_114609_one_ring_burden_reset_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: one_ring_burden_reset (`synergy_one_ring_burden_reset`) | synergy-package | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 1 | 1 | none |
...
### 2. Lorehold synergy package: one_ring_burden_reset (`synergy_one_ring_burden_reset`)
...
**Strategic event counts:** lorehold_cost_paid=20, lorehold_spell_cast=17, topdeck_manipulation_activated=4, miracle_cast=4
