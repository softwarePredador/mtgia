...
- generated_at: `2026-06-27T16:09:47Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: galvanoth_topdeck_freecast_cut_squelcher (`synergy_galvanoth_topdeck_freecast_cut_squelcher`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 16.50 | 4 | 1 | 0 | 0 | 0 | 0 | 7 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 4 | 1 | 0 | 0 | 0 | 0 | 9 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: galvanoth_topdeck_freecast_cut_squelcher (`synergy_galvanoth_topdeck_freecast_cut_squelcher`)
...
| Sisay, Weatherlight Captain #61 (real) | 2 | 1 | 0 | 66.67% | 16.50 | elimination=2 |
| Winota, Joiner of Forces #39 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=89, lorehold_spell_cast=76, lorehold_upkeep_rummage=41, miracle_cast=16, topdeck_manipulation_activated=3, lorehold_spell_rummage=5
