...
- Generated at: `2026-07-06T04:47:44.351398+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6382 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5157 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5335 | 269 |
| `battle_family_mapper_required` | 28538 | 94 |
...
| `battle_family::draw_selection_topdeck` | 3363 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
