...
Generated at: `2026-06-24T15:19:08+00:00`
...
- `review_only_or_needs_review_rule`: `309`
- `no_active_battle_rule`: `182`
- `trusted_rule_without_oracle_hash`: `154`
- `no_trusted_executable_rule`: `137`
...
| `high` | `battle_critical` | 7306 | `Brass's Bounty` | 6 | 6 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_engine`, `token_maker` |
...
| `high` | `battle_critical` | 7153 | `Double Vision` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `copy_spell` |
...
| `high` | `battle_critical` | 7051 | `Bedevil` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `remove_permanent` |
...
| `high` | `battle_critical` | 7051 | `Cathartic Reunion` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `draw_cards` |
...
| `high` | `battle_critical` | 7051 | `Crackle with Power` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `draw_cards` |
...
| `high` | `battle_critical` | 7051 | `Fate Unraveler` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `draw_engine` |
