...
| `benchmark.hybrid_strategy_ranked` | `pass` | ["exact_scope_cluster_first", "hybrid_effective_queue_pattern_registry", "package_manifest_first", "full_xmage_first", "pattern_registry_first", "card_by_card_queue", "runtime_exact_scope_first", "test_miner_first"] |
| `benchmark.ranking_first` | `pass` | {"cards_per_work_unit": 19.0, "decision_score": 72.27, "strategy_id": "exact_scope_cluster_first", "verdict": "use_as_next_modeling_lane"} |
...
| `effective_queue.package_already_prepared` | `pass` | 1 |
| `pipeline_manifest.expected_effective_deck_ids` | `pass` | [6, 25, 31, 42, 54, 58, 62, 74, 83, 84, 104, 105, 116, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616, 617, 618, 619] |
| `pipeline_manifest.forced_include_deck_ids` | `pass` | [6, 58, 74, 105, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616, 617, 618, 619] |
| `pipeline_manifest.materialization_apply` | `pass` | local_sqlite_learned_decks=[25, 31, 42, 54, 58, 62, 74, 83, 84, 104, 105, 116] |
