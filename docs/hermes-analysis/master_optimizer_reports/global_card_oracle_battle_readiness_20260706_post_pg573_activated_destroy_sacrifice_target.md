...
- Generated at: `2026-07-06T21:20:29.014888+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6620 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5397 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5575 | 269 |
| `battle_family_mapper_required` | 28298 | 94 |
...
| `battle_family::targeted_removal` | 986 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock`, `Against All Odds`, `Agate Assault` |
