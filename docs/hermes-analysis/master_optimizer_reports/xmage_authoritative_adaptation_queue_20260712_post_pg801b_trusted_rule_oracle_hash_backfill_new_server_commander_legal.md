...
- Generated at: `2026-07-12T02:27:09+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24344 |
| `xmage_authoritative_source_count` | 24031 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24031 |
| `manual_semantic_decision_units_remaining` | 313 |
| `authoritative_source_coverage_ratio` | 0.9871 |
| `adapter_work_unit_count` | 11270 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24031 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 10965 |
| `token_maker` | 2266 |
| `recursion` | 1789 |
| `draw_engine` | 1553 |
| `add_counters` | 1189 |
