...
- Generated at: `2026-06-26T11:08:09.738886+00:00`
- Status: `ready`
- Active deck id: `6`
- Lorehold deck ids: `[6, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616]`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg241_penance_presync_v1_proposals.json`
...
- Rows: `395`
- Recommendation lanes: `{"active_low_confidence_review": 13, "core_keep": 87, "low_priority": 52, "needs_rule_before_strategy": 67, "policy_blocked": 2, "priority_benchmark_candidate": 44, "watchlist_candidate": 130}`
- Rule statuses: `{"battle_ready": 327, "blocked_missing_xmage_source": 2, "mapper_manual": 59, "package_ready": 1, "split_scope": 6}`
...
| Invincible Hymn | 3.5 | wincon | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Twinflame Tyrant | 3.5 | wincon | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Ancient Copper Dragon | 3.0 | ramp | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Blood Moon | 3.0 | draw | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Planetarium of Wan Shi Tong | 3.0 | draw | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Semblance Anvil | 3.0 | ramp | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Heroes Remembered | 2.5 | draw | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Cloud Key | 1.0 | ramp | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Vedalken Orrery | 1.0 | ramp | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Neheb, the Eternal | 0.5 | ramp | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Wild Ricochet | 0.0 | unknown | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Goliath Daydreamer | -1.0 | unknown | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
| Unstable Glyphbridge // Sandswirl Wanderglyph | -1.0 | board_wipe | mapper_manual | xmage_reference_requires_manual_model_review_v1 | map_or_verify_rule_before_strategy_scoring |
