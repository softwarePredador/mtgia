...
- Summary: `{"batch_metadata_candidate_count": 0, "card_count": 109, "family_count": 13, "family_counts": {"board_wipe_choice": 2, "copy_spell_engine": 1, "draw_engine": 1, "free_cast": 7, "life_total_change": 1, "manual_model": 49, "passive": 5, "ramp_permanent": 5, "recursion": 8, "targeted_interaction": 12, "targeted_protection": 7, "topdeck_play": 2, "tutor": 9}, "manual_or_blocked_count": 109, "promotion_lane_counts": {"mapper_metadata_or_test_scenario_required": 49, "split_family_scope_review_required": 60}, "runtime_family_required_count": 0}`
...
| `draw_engine` | 1 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 1}` | static and activated draw-engine bookkeeping with delayed card movement |
...
| `manual_model` | 49 | `manual_model_required` | `{"mapper_metadata_or_test_scenario_required": 49}` | manual Oracle/reference review |
...
| `recursion` | 8 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 8}` | graveyard target selection, zone movement to hand or battlefield, and replacement-cost annotations |
...
| `tutor` | 9 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 9}` | library search, constrained target selection, and zone movement to hand, top, graveyard, or battlefield |
...
- Family tests: `[]`
- Cards: `["Dauntless Dismantler", "Culling Ritual"]`
...
- Family tests: `[]`
- Cards: `["All Is Dust", "Amphibian Downpour", "Commandeer", "Peer into the Abyss", "Gilded Drake", "Seedborn Muse", "Spellskite", "Wandering Archaic"]`
...
- Cards: `["Flashback", "Worldfire", "Endurance", "Moonshadow", "Bond of Insight", "Experimental Overload", "Gandalf's Sanction", "Pulsemage Advocate"]`
