...
- Generated at: `2026-06-26T10:19:02+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg239_coruscation_runtime_v1_proposals.json`
- Package manifests scanned: `112`
- Cards covered by package manifests: `249`
...
- `P0` Exhaust the unpackaged PG-ready residual before opening new runtime work. Reason: 5 cards are immediately packageable. Top exact cluster: noncreature_spell_cast_damage_each_opponent_v1 (3)
...
- `P2` Keep the manual mapper lane last. Reason: 318 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `5`
- Top scope clusters:
  - `spell_cast_damage_engine` / `creature` / `noncreature_spell_cast_damage_each_opponent_v1`: `3` cards (Coruscation Mage, Longshot, Rebel Bowman, Vivi Ornitier)
  - `spell_cast_damage_engine` / `passive` / `instant_sorcery_cast_damage_each_opponent_v1`: `1` cards (Fiery Inscription)
  - `spell_cast_damage_engine` / `creature` / `spell_cast_damage_each_opponent_v1`: `1` cards (Guttersnipe)
...
- Count: `318`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `317` cards ("Name Sticker" Goblin, Ad Nauseam, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury, Amphibian Downpour)
