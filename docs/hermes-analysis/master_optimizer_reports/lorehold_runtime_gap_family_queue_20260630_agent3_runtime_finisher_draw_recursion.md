...
- Generated at: `2026-06-30T13:47:32Z`
- XMage root: `/Users/desenvolvimentomobile/Downloads/mage-master`
- SQLite current-rule filter: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/manaloom-knowledge/scripts/knowledge.db`
...
| 5 | `board_wipe_choice` | 4 | `runtime_family_required` | `implement_family_before_metadata_batch` | `{"contextual": 1, "hand_filter": 2, "pressure_absorber_or_protection": 1}` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 3}` | multi-player choice/wipe/sacrifice resolution |
...
| 7 | `draw_engine` | 3 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 1, "early_mana": 1, "hand_filter": 1}` | `{"batch_metadata_candidate_requires_pg_precheck": 3}` | static and activated draw-engine bookkeeping with delayed card movement |
...
| Card | Score | Variant decks | Lane | Promotion | Subfamily | Next step | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| `Charmbreaker Devils` | -10 | `612` | `contextual` | `batch_metadata_candidate_requires_pg_precheck` | `` |  | `creature` | `upkeep_return_random_instant_sorcery_graveyard_to_hand_spell_cast_plus_4_0_v1` | `CharmbreakerDevils` |
...
| Card | Score | Variant decks | Lane | Promotion | Subfamily | Next step | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| `Chandra's Ignition` | -10 | `613` | `hand_filter` | `batch_metadata_candidate_requires_pg_precheck` | `` |  | `sweeper_damage` | `controlled_creature_power_damage_each_other_creature_each_opponent_v1` | `ChandrasIgnition` |
...
| `Naktamun Lorespinner // Wheel of Fortune` | -10 | `608` | `contextual` | `batch_metadata_candidate_requires_pg_precheck` | `` |  | `creature` | `upkeep_prepare_if_player_hand_size_lte_one_prepared_wheel_discard_draw_seven_v1` | `NaktamunLorespinner` |
...
| Card | Score | Variant decks | Lane | Promotion | Subfamily | Next step | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| `Ancient Gold Dragon` | -10 | `612` | `finisher_or_big_spell` | `batch_metadata_candidate_requires_pg_precheck` | `` |  | `token_maker` | `source_combat_damage_player_roll_d20_create_faerie_dragon_tokens_equal_result_v1` | `AncientGoldDragon` |
