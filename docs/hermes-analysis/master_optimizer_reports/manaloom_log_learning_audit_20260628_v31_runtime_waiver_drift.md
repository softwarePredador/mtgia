...
- generated_at: `2026-06-28T22:42:25Z`
...
- log_quality_gap: `2`
- postgres_sync_gap: `2`
- runtime_environment_drift: `1`
- runtime_or_test_failure: `283`
- runtime_rule_gap: `587`
- xmage_mapping_gap: `1324`

## Action Queue

1. `critical` `runtime_rule_gap` `coherence_critical_high_findings` count=583 next=`prioritize_cards_with_no_active_or_no_trusted_rules_in_current_deck_scope`
   - coherence audit has critical=1, high=392 [docs/hermes-analysis/master_optimizer_reports/deck_card_battle_rule_coherence_audit_current_explicit_20260628_123905.json]
     ...
     top_lorehold_runtime_missing: `Unstable Glyphbridge // Sandswirl Wanderglyph, Toralf, God of Fury // Toralf's Hammer, Rune-Tail, Kitsune Ascendant // Rune-Tail's Essence, Repercussion, Rem Karolus, Stalwart Slayer`
...
2. `critical` `runtime_or_test_failure` `text_runtime_traceback` count=15 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   - text log contains runtime_traceback [docs/hermes-analysis/master_optimizer_reports/battle_deck607_rule_runtime_research_20260628_v1.md]
   - text log contains runtime_traceback [docs/hermes-analysis/master_optimizer_reports/pgc043_mnemonic_betrayal_opponent_graveyard_runtime_package.md]
...
4. `critical` `runtime_or_test_failure` `text_test_failure` count=6 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   - text log contains test_failure [docs/hermes-analysis/master_optimizer_reports/battle_deck607_rule_runtime_research_20260628_v1.md]
   - text log contains test_failure [docs/hermes-analysis/master_optimizer_reports/pgc043_mnemonic_betrayal_opponent_graveyard_runtime_package.md]
...
8. `high` `blocked_workflow` `text_blocked` count=90 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains blocked [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2.md]
...
11. `high` `evidence_gap` `candidate_unobserved` count=3 next=`do_not_score_swap_until_forced_or_natural_access_sample_exists`
   ...
   - candidate card was not observed: Birgi, God of Storytelling // Harnfel, Horn of Bounty [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate_17lands_prior.json]
12. `high` `evidence_gap` `top_level_status` count=3 next=`rerun_with_candidate_observation_or_min_used_sample`
   ...
   - report status is inconclusive_candidate_unobserved [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate_17lands_prior.json]
13. `high` `evidence_gap` `top_level_status` count=2 next=`rerun_with_candidate_observation_or_min_used_sample`
   - report status is needs_more_evidence [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2.json]
...
16. `high` `runtime_environment_drift` `worktree_runtime_waiver_drift` count=1 next=`sync_or_reapply_committed_runtime_waivers_before_running_local_audits`
   - worktree battle_analyst_v9.py is missing committed runtime waivers from HEAD: 10 cards [docs/hermes-analysis/manaloom-knowledge/scripts/battle_analyst_v9.py]
...
18. `high` `runtime_rule_gap` `squee_graveyard_anomaly` count=1 next=`fix_squee_zone_accounting_before_using_recursion_results`
...
19. `medium` `xmage_mapping_gap` `manual_or_blocked_rules` count=591 next=`group_manual_rows_by_effect_family_and_create_mapper_or_runtime_family_test`
...
20. `medium` `runtime_or_test_failure` `text_warning` count=249 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
...
21. `medium` `battle_rhythm_gap` `prior_rhythm_flags` count=5 next=`calibrate_or_quarantine_gate_metrics_before_treating_winrate_as_strategy_signal`
   ...
   - battle prior emitted 4 rhythm flags [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate_17lands_prior.json]
22. `medium` `evidence_gap` `focus_card_library_only` count=4 next=`rerun_targeted_gate_with_forced_focus_access_or_larger_sample`
   - focus card traced but not accessed: The Mind Stone [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
   - focus card traced but not accessed: The Mind Stone [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
23. `medium` `evidence_gap` `focus_card_library_only` count=3 next=`rerun_targeted_gate_with_forced_focus_access_or_larger_sample`
   - focus card traced but not accessed: Birgi, God of Storytelling // Harnfel, Horn of Bounty [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
   - focus card traced but not accessed: Birgi, God of Storytelling // Harnfel, Horn of Bounty [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
24. `medium` `evidence_gap` `focus_card_library_only` count=3 next=`rerun_targeted_gate_with_forced_focus_access_or_larger_sample`
   - focus card traced but not accessed: Library of Leng [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
   - focus card traced but not accessed: Library of Leng [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
25. `medium` `evidence_gap` `focus_card_library_only` count=3 next=`rerun_targeted_gate_with_forced_focus_access_or_larger_sample`
   - focus card traced but not accessed: Squee, Goblin Nabob [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
   - focus card traced but not accessed: Squee, Goblin Nabob [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
26. `medium` `evidence_gap` `focus_card_library_only` count=2 next=`rerun_targeted_gate_with_forced_focus_access_or_larger_sample`
   - focus card traced but not accessed: Land Tax [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
   - focus card traced but not accessed: Land Tax [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
27. `medium` `evidence_gap` `focus_card_library_only` count=2 next=`rerun_targeted_gate_with_forced_focus_access_or_larger_sample`
   - focus card traced but not accessed: Scroll Rack [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
   - focus card traced but not accessed: Scroll Rack [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2_birgi_v1_gate.json]
28. `medium` `runtime_or_test_failure` `gate_row_status` count=2 next=`inspect_gate_row_error_and_add_or_fix_runtime_test`
...
30. `medium` `battle_rhythm_gap` `top_level_status` count=1 next=`inspect_rhythm_flags_before_using_gate_for_deckbuilder`
...
32. `medium` `battle_runtime_quality` `stalled_games` count=1 next=`rerun_with_checkpoint_trace_and_fix_loop_or_decision_dead_end`
...
33. `medium` `evidence_gap` `focus_card_library_only` count=1 next=`rerun_targeted_gate_with_forced_focus_access_or_larger_sample`
...
34. `medium` `runtime_or_test_failure` `gate_row_status` count=1 next=`inspect_gate_row_error_and_add_or_fix_runtime_test`
   - candidate_607_birgi_v1 row status is needs_more_evidence_candidate_unobserved [docs/hermes-analysis/master_optimizer_reports/lorehold_registry_candidate_runner_17lands_prior_birgi_execute_20260628_v2.json]
...
37. `medium` `runtime_or_test_failure` `gate_row_status` count=1 next=`inspect_gate_row_error_and_add_or_fix_runtime_test`
...
38. `low` `log_quality_gap` `json_extra_data` count=2 next=`normalize_artifact_writer_to_emit_single_json_document`
