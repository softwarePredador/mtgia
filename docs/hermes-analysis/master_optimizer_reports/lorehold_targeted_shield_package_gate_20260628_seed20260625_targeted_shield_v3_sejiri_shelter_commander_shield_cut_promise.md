...
- generated_at: `2026-06-28T04:48:59Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_targeted_shield_package_gate_20260628_seed20260625_targeted_shield_v3_sejiri_shelter_commander_shield_cut_promise_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: sejiri_shelter_commander_shield_cut_promise (`synergy_sejiri_shelter_commander_shield_cut_promise`) | synergy-package | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 1 | 0 | 2 | 0 | 0 | 0 | 0 | 2 | 0 | 0 | none | none |
...
### 2. Lorehold synergy package: sejiri_shelter_commander_shield_cut_promise (`synergy_sejiri_shelter_commander_shield_cut_promise`)
...
**Strategic event counts:** discard_to_top_replacement=13, lorehold_cost_paid=19, lorehold_rummage_discard_to_top=13, lorehold_spell_cast=16, lorehold_upkeep_rummage=16, miracle_cast=1
