...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pg031_deflecting_swat_battle_rule_20260622_195126') IS NULL THEN
    RAISE EXCEPTION 'PG031 rollback backup table is missing';
  END IF;
END $$;
...
WHERE normalized_name = 'deflecting swat'
  AND (
    ...
    OR logical_rule_key IN (
      ...
      FROM manaloom_deploy_audit.pg031_deflecting_swat_battle_rule_20260622_195126
...
SELECT
  'pg031_rollback_result' AS check_name,
  card_name,
  logical_rule_key,
  effect_json,
  source,
