...
| `benchmark.hybrid_strategy_ranked` | `pass` | ["hybrid_effective_queue_pattern_registry", "exact_scope_cluster_first", "package_manifest_first", "full_xmage_first", "runtime_exact_scope_first", "pattern_registry_first", "card_by_card_queue", "test_miner_first"] |
| `benchmark.ranking_first` | `pass` | {"cards_per_work_unit": 19.25, "decision_score": 80.1, "strategy_id": "hybrid_effective_queue_pattern_registry", "verdict": "recommended"} |
