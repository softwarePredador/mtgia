...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: core_challenge_aetherflux_over_storm (`synergy_core_challenge_aetherflux_over_storm`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 15.00 | 6 | 2 | 0 | 0 | 0 | 0 | 8 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 2 | 1 | 0 | 0 | 0 | 0 | 8 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: core_challenge_aetherflux_over_storm (`synergy_core_challenge_aetherflux_over_storm`)
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Vivi Ornitier #99 (real) | 1 | 2 | 0 | 33.33% | 21.00 | approach=1 |
| Sisay, Weatherlight Captain #61 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 9.00 | approach=1 |

**Strategic event counts:** lorehold_cost_paid=87, lorehold_spell_cast=77, lorehold_upkeep_rummage=39, miracle_cast=15, topdeck_manipulation_activated=6, lorehold_spell_rummage=7
