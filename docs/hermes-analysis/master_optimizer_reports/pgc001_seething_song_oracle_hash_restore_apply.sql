...
CREATE TABLE manaloom_deploy_audit.pgc001_seething_song_oracle_hash_restore_20260628 AS
SELECT *
...
updated AS (
  ...
  SET
    ...
    notes = concat_ws(
      E'\n',
      nullif(r.notes, ''),
      'PGC001 2026-06-28: restored Seething Song oracle_hash after legacy PG sync drift. No executor, oracle, deck, or logical_rule_key change.'
    )
  FROM expected
