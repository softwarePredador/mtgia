...
- Generated at: `2026-07-12T06:44:46.166205+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7895 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6739 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6632 | 264 |
| `battle_family_mapper_required` | 27162 | 87 |
...
| `damage_or_life_total_change` | 3639 |
| `token_creation` | 3450 |
...
| `battle_family::damage_or_life_total_change` | 3639 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
