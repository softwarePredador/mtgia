...
- Generated at: `2026-07-04T05:14:36.561070+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5148 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3863 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 3998 | 250 |
| `battle_family_mapper_required` | 29832 | 100 |
...
| `damage_or_life_total_change` | 3929 |
| `triggered_or_static_ability` | 3907 |
| `token_creation` | 3633 |
| `draw_selection_topdeck` | 3434 |
...
| `battle_family::damage_or_life_total_change` | 3929 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3434 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
