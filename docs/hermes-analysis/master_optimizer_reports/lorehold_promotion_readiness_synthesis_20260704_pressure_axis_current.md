...
- hypotheses needing named cut/gate: `99`
...
| `pressure` | `pressure_tradeoff_diagnostic_only_keep_607` | `keep_607` | `docs/hermes-analysis/master_optimizer_reports/lorehold_pressure_tradeoff_decision_synthesis_20260704_current.json` |
...
- classification counts: `{"already_in_607": 28, "blocked_or_rejected": 38, "hypothesis_or_gate_needed": 99}`
