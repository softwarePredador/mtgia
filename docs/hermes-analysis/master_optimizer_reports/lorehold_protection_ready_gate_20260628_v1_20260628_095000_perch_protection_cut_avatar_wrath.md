...
- generated_at: `2026-06-28T07:39:36Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_protection_ready_gate_20260628_v1_20260628_095000_perch_protection_cut_avatar_wrath_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: perch_protection_cut_avatar_wrath (`synergy_perch_protection_cut_avatar_wrath`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 17.00 | 2 | 2 | 0 | 0 | 0 | 0 | 0 | 2 | 0 | 0 | none | none |
...
### 2. Lorehold synergy package: perch_protection_cut_avatar_wrath (`synergy_perch_protection_cut_avatar_wrath`)
...
| Winota, Joiner of Forces #39 (real) | 1 | 0 | 0 | 100.00% | 17.00 | approach=1 |

**Strategic event counts:** lorehold_cost_paid=40, lorehold_spell_cast=35, lorehold_spell_rummage=4, lorehold_upkeep_rummage=12, miracle_cast=4, topdeck_manipulation_activated=4
