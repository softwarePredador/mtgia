...
- Generated at: `2026-07-02T01:51:53.519042+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4876 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3577 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2429 | 183 |
| `battle_family_mapper_required` | 30118 | 100 |
...
| `trusted_rule_oracle_hash_backfill` | 1406 | 80 |
...
| `token_creation` | 3641 |
| `draw_selection_topdeck` | 3542 |
| `graveyard_recursion` | 1954 |
...
| `battle_family::draw_selection_topdeck` | 3542 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
| `battle_family::graveyard_recursion` | 1954 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Abhorrent Oculus`, `Abomination of Llanowar`, `Aboshan's Desire` |
...
| `battle_family::recursion_or_bounce` | 507 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
