...
- `proposal_count`: `299`
- `pattern_count`: `19`
- `lane_counts`: `{"blocked_missing_xmage_source": 2, "manual_mapper_backlog": 268, "package_already_prepared": 1, "package_ready_unprepared": 1, "runtime_family_backlog": 3, "split_scope_backlog": 24}`
...
| `creature/creature/starfield_shepherd_etb_basic_plains_or_creature_mana_value_1_or_less_to_hand_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### creature / creature / starfield_shepherd_etb_basic_plains_or_creature_mana_value_1_or_less_to_hand_v1

- Pattern id: `xmage_pattern:c1e6b943ed27f5687a2e`
