...
- `boost_untap_effect_class_not_exact`: `["Act of Heroism", "Awaken the Sleeper", "Besmirch", "Blessed Alliance", "Burst of Energy", "Catch // Release", "Caught Red-Handed", "Cerulean Wisps", "Crypsis", "Disharmony", "Djeru's Resolve", "Domineering Will"]`
...
- `gain_control_untap_haste_ability_class_not_supported`: `["Harness by Force", "Limits of Solidarity", "Lose Calm", "Spreading Insurrection", "Traitorous Blood", "Turn Against", "Word of Seizing"]`
...
- `token_source_create_token_not_fixed`: `["Caller of the Claw", "Dripping-Tongue Zubera", "Evangel of Heliod", "Fresh Meat", "Ghoulcaller's Harvest", "Great Desert Prospector", "Hallowed Spiritkeeper", "Militant Angel", "Nested Shambler", "Revenge of the Rats", "Reverent Hoplite", "Spider Spawning"]`
