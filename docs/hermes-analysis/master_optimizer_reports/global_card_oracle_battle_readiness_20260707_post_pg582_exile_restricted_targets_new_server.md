...
- Generated at: `2026-07-07T00:25:17.455568+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6673 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5454 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5632 | 269 |
| `battle_family_mapper_required` | 28241 | 94 |
...
| `battle_family::targeted_removal` | 977 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock`, `Against All Odds`, `Agate Assault` |
