...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pgc064_copy_spell_choose_new_targets_runtime_20260629') IS NULL THEN
    RAISE EXCEPTION 'PGC064 backup table is missing';
  END IF;
END $$;
...
FROM manaloom_deploy_audit.pgc064_copy_spell_choose_new_targets_runtime_20260629 backup
