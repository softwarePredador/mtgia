...
- `boost_keyword_source_not_single_fixed`: `["Arm the Cathars", "Chorus of Might", "Coordinated Assault", "Cutthroat Maneuver", "Frantic Confrontation", "Get a Leg Up", "Lunar Frenzy", "Pedal to the Metal", "Press the Advantage", "Rally Maneuver", "Run Amok", "Strength in Numbers"]`
...
- `damage_additional_cost_not_supported`: `["Close Encounter", "Devour in Flames", "Final Flare", "Heartfire", "Lightning Axe", "Monstrous Emergence", "Pumpkin Bombardment"]`
...
- `exile_draw_oracle_not_exact_fixed`: `["Cremate"]`
