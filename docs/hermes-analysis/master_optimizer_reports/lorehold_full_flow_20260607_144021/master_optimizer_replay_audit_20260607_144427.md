...
| --- | --- | --- |
| medium | Aggro (Krenko) | 3 stalls; inspect missed wincon or game-end conditions. |
| medium | Aggro (Krenko) | Slow average turn 21.2; inspect sequencing and finisher timing. |
| medium | Control (Atraxa) | 8 stalls; inspect missed wincon or game-end conditions. |
| medium | Control (Atraxa) | Slow average turn 17.3; inspect sequencing and finisher timing. |
| medium | Combo (Kinnan) | 4 stalls; inspect missed wincon or game-end conditions. |
| medium | Combo (Kinnan) | Slow average turn 18.3; inspect sequencing and finisher timing. |
| medium | Midrange (Korvold) | 5 stalls; inspect missed wincon or game-end conditions. |
| medium | Midrange (Korvold) | Slow average turn 20.9; inspect sequencing and finisher timing. |
| medium | Spellslinger (Niv) | 5 stalls; inspect missed wincon or game-end conditions. |
| medium | Spellslinger (Niv) | Slow average turn 18.1; inspect sequencing and finisher timing. |
| medium | Stax (Winota) | 4 stalls; inspect missed wincon or game-end conditions. |
| medium | Stax (Winota) | Slow average turn 17.8; inspect sequencing and finisher timing. |
