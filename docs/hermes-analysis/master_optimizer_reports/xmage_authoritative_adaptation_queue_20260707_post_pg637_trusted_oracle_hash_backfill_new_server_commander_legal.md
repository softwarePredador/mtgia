...
- Generated at: `2026-07-07T20:22:16+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24998 |
| `xmage_authoritative_source_count` | 24685 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24685 |
| `manual_semantic_decision_units_remaining` | 313 |
| `authoritative_source_coverage_ratio` | 0.9875 |
| `adapter_work_unit_count` | 11329 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24685 |
...
| `removal_destroy::targeted_destroy_variant_v1` | 504 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11160 |
| `token_maker` | 2306 |
| `recursion` | 1793 |
| `draw_engine` | 1575 |
| `add_counters` | 1208 |
