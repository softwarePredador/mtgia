...
- Generated at: `2026-07-01T11:10:12.185486+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4340 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3005 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1857 | 389 |
| `battle_family_mapper_required` | 30690 | 230 |
...
| `battle_family::recursion_or_bounce` | 553 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Adun Oakenshield`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe` |
