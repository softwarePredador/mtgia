...
- Generated at: `2026-07-02T08:11:07.814839+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4958 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3662 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2514 | 183 |
| `battle_family_mapper_required` | 30033 | 100 |
...
| `battle_family::recursion_or_bounce` | 501 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
