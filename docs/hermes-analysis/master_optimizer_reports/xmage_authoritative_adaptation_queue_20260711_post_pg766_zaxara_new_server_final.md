...
- Generated at: `2026-07-11T14:10:29+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24459 |
| `xmage_authoritative_source_count` | 24146 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24146 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24146 |
...
| `draw_cards::xmage_draw_card_variant_review_v1` | 532 |
...
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 116 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11004 |
| `token_maker` | 2266 |
| `recursion` | 1792 |
| `draw_engine` | 1553 |
| `add_counters` | 1189 |
...
| --- | ---: |
| `targeting` | 12972 |
| `triggered_ability` | 11364 |
| `static_ability` | 5301 |
| `activated_ability` | 5016 |
| `counter` | 3697 |
| `condition` | 3238 |
| `token` | 2313 |
| `draw` | 2009 |
