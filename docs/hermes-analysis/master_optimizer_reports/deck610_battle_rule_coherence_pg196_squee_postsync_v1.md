...
Generated at: `2026-06-25T00:40:02+00:00`
...
- `no_active_battle_rule`: `19`
- `trusted_rule_without_oracle_hash`: `9`
- `no_trusted_executable_rule`: `8`
...
| `high` | `battle_critical` | 7051 | `Wake the Past` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `recursion` |
...
| `high` | `support_or_passive` | 7051 | `Redress Fate` | 1 | 1 | `no_active_battle_rule` | - |
