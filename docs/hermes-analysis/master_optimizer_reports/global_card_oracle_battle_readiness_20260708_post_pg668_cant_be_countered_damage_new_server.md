...
- Generated at: `2026-07-08T19:05:34.558759+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7275 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6073 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6045 | 272 |
| `battle_family_mapper_required` | 27831 | 92 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6532 |
| `triggered_or_static_ability` | 3841 |
| `damage_or_life_total_change` | 3695 |
| `token_creation` | 3490 |
| `draw_selection_topdeck` | 3312 |
| `graveyard_recursion` | 1888 |
| `targeted_removal` | 922 |
| `tutor_search_library` | 744 |
| `modal_or_choice_effect` | 699 |
| `mana_generation_or_ritual` | 660 |
| `alternate_or_free_cast` | 494 |
| `protection_prevention` | 487 |
| `recursion_or_bounce` | 464 |
| `counterspell_or_stack_interaction` | 334 |
...
| --- | ---: | --- | --- |
| `battle_family::manual_model_review` | 6532 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
| `battle_family::triggered_or_static_ability` | 3841 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ _____ Rocketship`, `Aang, at the Crossroads // Aang, Destined Savior`, `Aang, the Last Airbender`, `Abbot of Keral Keep`, `Aberrant Manawurm`, `Abigale, Poet Laureate // Heroic Stanza`, `Aboleth Spawn`, `Abomination`, `Aboroth`, `Absorbing Man` |
| `battle_family::damage_or_life_total_change` | 3695 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
| `battle_family::token_creation` | 3490 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A Killer Among Us`, `Aang and Katara`, `Aang, Airbending Master`, `Aatchik, Emerald Radian`, `Abby, Merciless Soldier`, `Abdel Adrian, Gorion's Ward`, `Abhorrent Overlord`, `Abyssal Harvester`, `Abzan Ascendancy`, `Academy Manufactor` |
| `battle_family::draw_selection_topdeck` | 3312 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
| `battle_family::graveyard_recursion` | 1888 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Abhorrent Oculus`, `Abomination of Llanowar`, `Aboshan's Desire` |
| `battle_family::targeted_removal` | 922 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aftershock`, `Against All Odds`, `Agate Assault`, `Agent of Erebos` |
| `battle_family::tutor_search_library` | 744 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A.I.M. Scientists`, `Aang's Journey`, `Absorb Vis`, `Abzan Monument`, `Academy Rector`, `Aerial Surveyor`, `Agency Outfitter`, `Ainok Guide`, `Ajani's Aid`, `Alabaster Host Intercessor` |
...
| `battle_family::mana_generation_or_ritual` | 660 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon`, `Altar of Shadows` |
| `battle_family::alternate_or_free_cast` | 494 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abundant Maw`, `Acid-Spewer Dragon`, `Adventurous Eater // Have a Bite`, `Aerie Bowmasters`, `Aether Meltdown`, `Aether Searcher`, `Aether Web`, `Affa Guard Hound`, `Ainok Tracker`, `Alley Assailant` |
| `battle_family::protection_prevention` | 487 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolute Grace`, `Absolute Law`, `Adept Watershaper`, `Aegis of the Gods`, `Agent Frank Horrigan`, `Agent of the Shadow Thieves`, `Airtight Alibi`, `Akroma's Memorial`, `Akroma, Angel of Fury`, `Akroma, Vision of Ixidor` |
| `battle_family::recursion_or_bounce` | 464 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval`, `Alesha, Who Laughs at Fate` |
| `battle_family::counterspell_or_stack_interaction` | 334 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abjure`, `Abstruse Interference`, `Access Denied`, `Admiral's Order`, `Adric, Mathematical Genius`, `Amazing Acrobatics`, `Anticognition`, `Archmage's Charm`, `Arenson's Aura`, `Artistic Refusal` |
...
| `Aboroth` | 250 | `battle_family_mapper_required` | `triggered_or_static_ability` | 0 | 14 | `available` |
| `Aboshan's Desire` | 250 | `battle_family_mapper_required` | `graveyard_recursion` | 0 | 17 | `available` |
| `Aboshan, Cephalid Emperor` | 250 | `battle_family_mapper_required` | `manual_model_review` | 0 | 14 | `available` |
| `About Face` | 250 | `battle_family_mapper_required` | `manual_model_review` | 0 | 18 | `available` |
| `Absolute Grace` | 250 | `battle_family_mapper_required` | `protection_prevention` | 0 | 22 | `available` |
| `Absolute Law` | 250 | `battle_family_mapper_required` | `protection_prevention` | 0 | 15 | `available` |
| `Absolute Virtue` | 250 | `battle_family_mapper_required` | `damage_or_life_total_change` | 0 | 10 | `available` |
