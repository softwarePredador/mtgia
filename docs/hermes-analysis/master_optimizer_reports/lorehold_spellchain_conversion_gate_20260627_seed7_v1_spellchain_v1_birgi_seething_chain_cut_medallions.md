...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: birgi_seething_chain_cut_medallions (`synergy_birgi_seething_chain_cut_medallions`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 21.00 | 4 | 2 | 0 | 1 | 0 | 0 | 0 | 6 | none |
...
| Sisay, Weatherlight Captain #61 (real) | 1 | 2 | 0 | 33.33% | 19.00 | elimination=1 |
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 23.00 | elimination=1 |

**Strategic event counts:** lorehold_cost_paid=71, lorehold_spell_cast=59, lorehold_upkeep_rummage=27, miracle_cast=15, topdeck_manipulation_activated=14, lorehold_spell_rummage=1, squee_to_graveyard=1
