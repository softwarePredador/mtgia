...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 366, "family_count": 8, "family_counts": {"board_wipe_choice": 4, "creature": 4, "manual_model": 264, "mill_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 66, "token_maker": 21, "tutor": 4}, "manual_or_blocked_count": 341, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 261, "runtime_family_implementation_required": 24, "split_family_scope_review_required": 76}, "runtime_family_required_count": 24}`
...
| `targeted_interaction` | 66 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 65}` | target legality, resolution, zone transition, and event provenance |
