...
- Generated at: `2026-06-25T06:33:56+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg206_damage_each_opponent_postsync_v1_proposals.json`
- Package manifests scanned: `84`
- Cards covered by package manifests: `205`
...
- `runtime_family_backlog`: `20`
- `manual_mapper_backlog`: `338`
- `blocked_missing_xmage_source`: `4`

## Recommendations

- `P1` After the PG-ready lane shrinks, batch the biggest split-scope cluster. Reason: The partially supported backlog is 72 cards. Top exact cluster: targeted_damage_variant_v1 (20)
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 20 cards. Top reusable exact scope cluster: damage_all_variant_v1 (2). Largest raw family is token_maker (16 cards across 16 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
- `P2` Keep the manual mapper lane last. Reason: 338 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `338`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `337` cards ("Name Sticker" Goblin, Ad Nauseam, Agate Instigator, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury)
