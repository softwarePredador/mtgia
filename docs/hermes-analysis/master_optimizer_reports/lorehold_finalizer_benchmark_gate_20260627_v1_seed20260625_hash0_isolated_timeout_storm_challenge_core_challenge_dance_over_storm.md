...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: core_challenge_dance_over_storm (`synergy_core_challenge_dance_over_storm`) | synergy-package | 9 | 4 | 5 | 0 | 44.44% | 22.75 | 5 | 3 | 1 | 1 | 1 | 0 | 4 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 2 | 1 | 0 | 0 | 0 | 0 | 8 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: core_challenge_dance_over_storm (`synergy_core_challenge_dance_over_storm`)
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Vivi Ornitier #99 (real) | 1 | 2 | 0 | 33.33% | 21.00 | elimination=1 |
| Sisay, Weatherlight Captain #61 (real) | 2 | 1 | 0 | 66.67% | 25.50 | approach=2 |
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 19.00 | elimination=1 |

**Strategic event counts:** lorehold_cost_paid=124, lorehold_spell_cast=102, lorehold_upkeep_rummage=18, topdeck_manipulation_activated=27, miracle_cast=24, lorehold_spell_rummage=2, squee_to_graveyard=2, graveyard_upkeep_return_self_to_hand=2, squee_upkeep_return=2, squee_return_after_known_graveyard_entry=2, thor_cost_paid=1, thor_spell_cast=1
