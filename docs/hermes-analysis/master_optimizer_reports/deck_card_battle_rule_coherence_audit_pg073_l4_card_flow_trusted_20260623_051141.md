...
- `trusted_rule_without_oracle_hash`: `69`
- `no_trusted_executable_rule`: `26`
- `review_only_or_needs_review_rule`: `26`
- `generic_effect_without_model_scope`: `24`
- `no_active_battle_rule`: `7`

## Top 102 Actionable Cards

| Severity | Impact | Priority | Card | Decks | Qty | Findings | Effects |
| --- | --- | ---: | --- | ---: | ---: | --- | --- |
| `high` | `battle_critical` | 7102 | `Artist's Talent` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine` |
| `high` | `battle_critical` | 7102 | `Pinnacle Monk // Mystic Peak` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
| `high` | `battle_critical` | 7102 | `Redirect Lightning` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards` |
| `high` | `battle_critical` | 7102 | `Reforge the Soul` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards` |
| `high` | `battle_critical` | 7102 | `Rise of the Eldrazi` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `extra_turn` |
| `high` | `battle_critical` | 7102 | `Storm Herd` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `token_maker` |
| `high` | `battle_critical` | 7102 | `Witch Enchanter // Witch-Blessed Meadow` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
| `high` | `battle_critical` | 7051 | `Angel's Grace` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `cannot_lose_turn` |
...
| `medium` | `battle_critical` | 4153 | `Scroll Rack` | 3 | 3 | `trusted_rule_without_oracle_hash` | `topdeck_manipulation` |
| `medium` | `battle_critical` | 4102 | `Farewell` | 2 | 2 | `trusted_rule_without_oracle_hash` | `board_wipe` |
| `medium` | `battle_critical` | 4102 | `Hit the Mother Lode` | 2 | 2 | `trusted_rule_without_oracle_hash` | `draw_cards`, `treasure_maker` |
| `medium` | `battle_critical` | 4102 | `Tibalt's Trickery` | 2 | 2 | `trusted_rule_without_oracle_hash` | `counter` |
...
| `medium` | `battle_support` | 4204 | `Jeska's Will` | 4 | 4 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_ritual` |
| `medium` | `battle_support` | 4204 | `Talisman of Conviction` | 4 | 4 | `trusted_rule_without_oracle_hash` | `ramp_permanent` |
| `medium` | `battle_support` | 4153 | `Mizzix's Mastery` | 3 | 3 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `overload_recursion` |
| `medium` | `battle_support` | 4102 | `Bender's Waterskin` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_permanent` |
| `medium` | `battle_support` | 4102 | `Fellwar Stone` | 2 | 2 | `trusted_rule_without_oracle_hash` | `ramp_permanent` |
| `medium` | `battle_support` | 4102 | `Mana Vault` | 2 | 2 | `trusted_rule_without_oracle_hash` | `ramp_permanent` |
| `medium` | `battle_support` | 4102 | `Swiftfoot Boots` | 2 | 2 | `trusted_rule_without_oracle_hash` | `equipment_static_attachment` |
| `medium` | `battle_support` | 4102 | `Unexpected Windfall` | 2 | 2 | `trusted_rule_without_oracle_hash` | `treasure_maker` |
| `medium` | `battle_support` | 4102 | `Victory Chimes` | 2 | 2 | `trusted_rule_without_oracle_hash` | `ramp_permanent` |
...
| `medium` | `support_or_passive` | 4153 | `Library of Leng` | 3 | 3 | `trusted_rule_without_oracle_hash` | `passive` |
| `medium` | `support_or_passive` | 4153 | `Valakut Awakening // Valakut Stoneforge` | 3 | 3 | `trusted_rule_without_oracle_hash` | `hand_filter` |
| `medium` | `support_or_passive` | 4102 | `Giver of Runes` | 2 | 2 | `trusted_rule_without_oracle_hash` | `creature` |
| `medium` | `support_or_passive` | 4102 | `Hexing Squelcher` | 2 | 2 | `trusted_rule_without_oracle_hash` | `creature` |
| `medium` | `support_or_passive` | 4102 | `Improvisation Capstone` | 2 | 2 | `trusted_rule_without_oracle_hash` | `exile_value` |
| `medium` | `support_or_passive` | 4102 | `Monument to Endurance` | 2 | 2 | `trusted_rule_without_oracle_hash` | `passive` |
| `medium` | `support_or_passive` | 4102 | `Mother of Runes` | 2 | 2 | `trusted_rule_without_oracle_hash` | `creature` |
| `medium` | `support_or_passive` | 4102 | `Storm-Kiln Artist` | 2 | 2 | `trusted_rule_without_oracle_hash` | `creature` |
