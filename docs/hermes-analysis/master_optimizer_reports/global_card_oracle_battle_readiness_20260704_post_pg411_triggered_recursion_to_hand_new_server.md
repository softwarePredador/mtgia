...
- Generated at: `2026-07-04T15:21:46.198771+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5388 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4124 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4259 | 252 |
| `battle_family_mapper_required` | 29571 | 98 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7246 |
| `triggered_or_static_ability` | 3907 |
| `damage_or_life_total_change` | 3863 |
| `token_creation` | 3609 |
...
| `battle_family::manual_model_review` | 7246 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3863 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
