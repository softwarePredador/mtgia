...
- Generated at: `2026-07-07T23:06:27.941115+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7210 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6003 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5975 | 272 |
| `battle_family_mapper_required` | 27901 | 92 |
...
| `damage_or_life_total_change` | 3716 |
| `token_creation` | 3490 |
...
| `battle_family::damage_or_life_total_change` | 3716 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
