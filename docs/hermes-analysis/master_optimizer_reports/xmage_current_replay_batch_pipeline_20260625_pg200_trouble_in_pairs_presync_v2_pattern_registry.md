...
- `proposal_count`: `443`
- `pattern_count`: `42`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 346, "package_ready_unprepared": 1, "runtime_family_backlog": 20, "split_scope_backlog": 72}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 346, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `draw_engine/draw_engine/opponent_second_draw_second_spell_two_attackers_draw_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 345 | 54 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### draw_engine / draw_engine / opponent_second_draw_second_spell_two_attackers_draw_v1

- Pattern id: `xmage_pattern:934dc8699b5ac855b27a`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Trouble in Pairs)
- Subpatterns: `1`
