...
- `token_description_keyword_not_supported`: `["Birthing Boughs", "Carrion Call", "Dance with Devils", "Devils' Playground", "Dragon Egg", "Errand of Duty", "Form a Posse", "Harried Spearguard", "Hobbling Zombie", "Mage's Attendant", "Master of the Hunt", "Mitotic Slime"]`
...
- `token_source_create_token_not_fixed`: `["Dripping-Tongue Zubera", "Evangel of Heliod", "Flurry of Wings", "Fresh Meat", "Great Desert Prospector", "Hallowed Spiritkeeper", "Nested Shambler", "Ordered Migration", "Reverent Hoplite", "Rise from the Tides", "Roc Egg", "Spontaneous Generation"]`
