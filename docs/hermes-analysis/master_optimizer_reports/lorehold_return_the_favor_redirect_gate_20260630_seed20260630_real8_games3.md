...
- generated_at: `2026-06-30T03:58:59Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_return_the_favor_redirect_gate_20260630_seed20260630_real8_games3_game_checkpoint.json`
...
| 2 | 2 | Lorehold 607 + Return the Favor over Redirect Lightning v1 (`candidate_607_return_the_favor_redirect_lightning_v1`) | 607-return-the-favor-redirect-lightning | 24 | 8 | 16 | 0 | 33.33% | 15.50 | 15 | 10 | 3 | 0 | 0 | 0 | 0 | 20 | 0 | 0 | none | recursion_role, tutor_role |
...
| Rograkh, Son of Rohgahh #95 (real) | 2 | 1 | 0 | 66.67% | 19.50 | elimination=2 |
| K-9, Mark I #34 (real) | 2 | 1 | 0 | 66.67% | 11.00 | approach=1, elimination=1 |
| Winota, Joiner of Forces #73 (real) | 1 | 2 | 0 | 33.33% | 17.00 | elimination=1 |
| Thrasios, Triton Hero #101 (real) | 1 | 2 | 0 | 33.33% | 15.00 | approach=1 |
| Kinnan, Bonder Prodigy #72 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |
| Kefka, Court Mage #112 (real) | 1 | 2 | 0 | 33.33% | 13.00 | elimination=1 |
| Kraum, Ludevic's Opus #81 (real) | 1 | 2 | 0 | 33.33% | 18.00 | elimination=1 |

**Strategic event counts:** discard_to_top_replacement=24, lorehold_cost_paid=241, lorehold_rummage_discard_to_top=24, lorehold_spell_cast=225, lorehold_spell_rummage=7, lorehold_upkeep_rummage=101, miracle_cast=60, scarlet_static_cost_reduction_casts=5, scarlet_static_cost_reduction_total=10, static_cost_reduction_casts=21, static_cost_reduction_total=47, topdeck_manipulation_activated=40
