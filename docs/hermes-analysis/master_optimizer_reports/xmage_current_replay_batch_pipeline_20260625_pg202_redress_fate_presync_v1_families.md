...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 441, "family_count": 10, "family_counts": {"board_wipe_choice": 4, "creature": 4, "manual_model": 347, "mill_spell": 1, "modal_spell": 1, "recursion": 3, "static_cost_reducer": 2, "targeted_interaction": 58, "token_maker": 17, "tutor": 4}, "manual_or_blocked_count": 420, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 344, "runtime_family_implementation_required": 20, "split_family_scope_review_required": 72}, "runtime_family_required_count": 20}`
...
| `manual_model` | 347 | `manual_model_required` | `{"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 343}` | manual Oracle/reference review |
...
| `recursion` | 3 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 2}` | graveyard target selection, zone movement to hand or battlefield, and replacement-cost annotations |
...
- Cards: `["Forge Anew", "The Soul Stone", "Redress Fate"]`
