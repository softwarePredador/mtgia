...
- generated_at: `2026-06-27T18:49:36Z`
...
| 2 |  | Lorehold synergy package: enlightened_engine_access_cut_thor (`synergy_enlightened_engine_access_cut_thor`) | synergy-package | 9 | 4 | 5 | 0 | 44.44% | 17.50 | 5 | 4 | 1 | 0 | 0 | 0 | 0 | 3 | none |
...
### 2. Lorehold synergy package: enlightened_engine_access_cut_thor (`synergy_enlightened_engine_access_cut_thor`)
...
| Opponent | W | L | S | WR | Avg Win Turn | Reasons |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Vivi Ornitier #99 (real) | 2 | 1 | 0 | 66.67% | 16.50 | elimination=1, approach=1 |
| Sisay, Weatherlight Captain #61 (real) | 1 | 2 | 0 | 33.33% | 21.00 | elimination=1 |
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 16.00 | elimination=1 |

**Strategic event counts:** lorehold_cost_paid=93, lorehold_spell_cast=75, lorehold_upkeep_rummage=14, discard_to_top_replacement=7, lorehold_rummage_discard_to_top=7, miracle_cast=18, topdeck_manipulation_activated=9
