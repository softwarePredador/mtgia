...
- Generated at: `2026-07-04T21:22:20Z`
...
- Evidence paths scanned: `324`
- JSON files scanned: `250`
...
| Arcane Signet | 195 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=112, spell_cast=2, cost_paid:Arcane Signet=274 |
| Arid Mesa | 13 | `runtime_ready_unexposed` | `review_required` | none | land_played=13 |
| Artist's Talent | 535 | `draw_filter_value` | `review_required` | discard_payoff, draw_filter_value, paid_cast_exposure | cost_paid=3, trigger_resolved=303, trigger_skipped=194, cost_paid:Artist's Talent=138 |
| Avatar's Wrath | 118 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, miracle_hit, paid_cast_exposure | airbend_other_creatures_resolved=34, cost_paid=22, replacement_applied=16, turn_end=2, cost_paid:Avatar's Wrath=10, discard_to_top:Avatar's Wrath=25, lorehold_rummage_to_top:Avatar's Wrath=97, miracle:Avatar's Wrath=35 |
| Battlefield Forge | 15 | `ramp_engine` | `review_required` | ramp_engine | land_played=15 |
| Bender's Waterskin | 268 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=216, cost_paid:Bender's Waterskin=185 |
| Big Score | 40 | `discard_ramp_value` | `review_required` | discard_or_rummage_context, discard_payoff, miracle_hit, paid_cast_exposure, ramp_engine | additional_cost_paid=3, cost_paid=24, turn_end=6, cost_paid:Big Score=19, miracle:Big Score=1 |
| Blasphemous Act | 368 | `board_wipe_pressure_reset` | `review_required` | discard_or_rummage_context, miracle_hit, paid_cast_exposure, pressure_reset_board_wipe | board_wipe_resolved=2, cost_paid=6, damage_wipe_resolved=11, miracle_cast=3, permanent_moved_from_battlefield=10, cost_paid:Blasphemous Act=2, discard_to_top:Blasphemous Act=32, lorehold_rummage_to_top:Blasphemous Act=26, miracle:Blasphemous Act=6, spell_rummage_to_top:Blasphemous Act=5 |
| Bloodstained Mire | 31 | `runtime_ready_unexposed` | `review_required` | none | land_played=31 |
| Boros Signet | 65 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=14, cost_paid:Boros Signet=218 |
...
| Creative Technique | 58 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, paid_cast_exposure | cost_paid=26, demonstrate_resolved=1, forced_focus_access_applied=18, top_nonland_free_cast=2, top_nonland_free_cast_resolved=1, cost_paid:Creative Technique=4, discard_to_top:Creative Technique=3, lorehold_rummage_to_top:Creative Technique=3 |
...
| Deflecting Swat | 126 | `spot_removal` | `review_required` | spot_removal | cast_announced=4, cost_paid=4, miracle_cast=2, priority_pass=16, redirect_removal_resolved=2, discard_to_top:Deflecting Swat=456, lorehold_rummage_to_top:Deflecting Swat=392, spell_rummage_to_top:Deflecting Swat=12 |
...
| Esper Sentinel | 527 | `draw_filter_value` | `review_required` | draw_filter_value, paid_cast_exposure, tutor_target | cast_announced=5, cost_paid=5, pg073_rule_snapshot=1, pg073_rule_summary=1, priority_pass=31, cost_paid:Esper Sentinel=280 |
...
| Farewell | 231 | `board_wipe_pressure_reset` | `review_required` | discard_or_rummage_context, miracle_hit, pressure_reset_board_wipe | permanent_moved_from_battlefield=8, replacement_applied=185, turn_end=2, discard_to_top:Farewell=84, lorehold_rummage_to_top:Farewell=84, miracle:Farewell=3 |
| Fated Clash | 267 | `board_wipe_pressure_reset` | `review_required` | discard_or_rummage_context, miracle_hit, pressure_reset_board_wipe, protection_window | board_wipe_resolved=123, cost_paid=6, permanent_moved_from_battlefield=50, replacement_applied=11, spell_resolved=74, miracle:Fated Clash=2 |
| Fellwar Stone | 86 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | spell_resolved=1, cost_paid:Fellwar Stone=610 |
...
| Furygale Flocking | 160 | `runtime_ready_unexposed` | `review_required` | board_development_tokens, miracle_hit, paid_cast_exposure | spell_resolved=1, tokens_created=1, cost_paid:Furygale Flocking=1, discard_to_top:Furygale Flocking=4, lorehold_rummage_to_top:Furygale Flocking=4, miracle:Furygale Flocking=2, static_cost_reduction_on:Furygale Flocking=1541 |
| Generous Gift | 52 | `spot_removal` | `review_required` | miracle_hit, paid_cast_exposure, spot_removal | compensation_tokens_created=1, cost_paid=12, removal_resolved=1, replacement_applied=4, spell_resolved=1, cost_paid:Generous Gift=120, miracle:Generous Gift=4 |
| Giver of Runes | 72 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | activated_ability=2, cast_announced=3, cost_paid=3, creature_cast=3, spell_resolved=1, cost_paid:Giver of Runes=194 |
| Glittering Massif | 75 | `ramp_engine` | `review_required` | discard_or_rummage_context, ramp_engine | land_played=73, turn_end=2 |
| Hexing Squelcher | 93 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid=6, creature_cast=1, creature_to_battlefield=2, replacement_applied=6, spell_resolved=2, cost_paid:Hexing Squelcher=335 |
...
| Jeska's Will | 44 | `runtime_ready_unexposed` | `review_required` | miracle_hit, paid_cast_exposure | jeskas_will_resolved=2, spell_cast=2, spell_resolved=2, cost_paid:Jeska's Will=74, discard_to_top:Jeska's Will=4, lorehold_rummage_to_top:Jeska's Will=4, miracle:Jeska's Will=3 |
| Land Tax | 3449 | `tutor_access` | `review_required` | paid_cast_exposure, tutor_access | cost_paid=581, land_tax_trigger_resolved=580, land_tax_trigger_skipped=2230, spell_cast=1, spell_resolved=2, cost_paid:Land Tax=210 |
| Library of Leng | 855 | `runtime_ready_unexposed` | `review_required` | discard_payoff, paid_cast_exposure | cost_paid=753, runtime_rule_loaded=1, saga_chapter_resolved=62, cost_paid:Library of Leng=178 |
| Lightning Greaves | 85 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cast_announced=3, cost_paid=3, equipment_attached=1, equipment_unattached=4, priority_pass=12, cost_paid:Lightning Greaves=222 |
| Lorehold, the Historian | 5768 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cast_announced=13, cast_illegal=8, commander_cast=8, cost_paid=3271, equipment_attached=1, cost_paid:Lorehold, the Historian=3039, static_cost_reduction_on:Lorehold, the Historian=368 |
| Marsh Flats | 29 | `runtime_ready_unexposed` | `review_required` | none | land_played=29 |
| Mizzix's Mastery | 97 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, paid_cast_exposure | cast_announced=3, cost_paid=38, miracle_cast=1, mizzix_mastery_copy_cast=2, mizzix_mastery_resolved=2, cost_paid:Mizzix's Mastery=39 |
| Molecule Man | 102 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, paid_cast_exposure | cost_paid=100, turn_end=1, cost_paid:Molecule Man=3 |
| Monument to Endurance | 73 | `discard_ramp_value` | `review_required` | discard_payoff, paid_cast_exposure, ramp_engine | cost_paid=12, discard_modal_trigger_resolved=7, cost_paid:Monument to Endurance=138 |
| Mother of Runes | 89 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cast_announced=3, cost_paid=3, creature_cast=5, replacement_applied=12, spell_resolved=1, cost_paid:Mother of Runes=284 |
| Mountain // Mountain | 402 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context | land_played=49, land_tax_trigger_resolved=350, turn_end=3 |
| Path to Exile | 166 | `spot_removal` | `review_required` | miracle_hit, paid_cast_exposure, spot_removal | cast_announced=2, cost_paid=40, focused_final_state=1, miracle_cast=3, priority_pass=15, cost_paid:Path to Exile=133, miracle:Path to Exile=12 |
| Pearl Medallion | 184 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid:Pearl Medallion=134, static_cost_reduction_saved:Pearl Medallion=797, static_cost_reduction_source_cast:Pearl Medallion=797 |
...
| Plains // Plains | 244 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context | land_played=76, land_tax_trigger_resolved=164, turn_end=4 |
...
| Rise of the Eldrazi | 60 | `spot_removal` | `review_required` | discard_or_rummage_context, spot_removal, tutor_target | composite_rule_component_resolved=3, composite_rule_resolved=3, cost_paid=3, miracle_cast=6, priority_pass=9, discard_to_top:Rise of the Eldrazi=57, lorehold_rummage_to_top:Rise of the Eldrazi=31, spell_rummage_to_top:Rise of the Eldrazi=25 |
| Ruby Medallion | 219 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, paid_cast_exposure | cost_paid=25, focused_state_assertion=1, spell_resolved=1, turn_end=2, cost_paid:Ruby Medallion=184, static_cost_reduction_saved:Ruby Medallion=954, static_cost_reduction_source_cast:Ruby Medallion=954 |
...
| Scroll Rack | 2957 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | activated_ability_skipped=8, cast_announced=1, cost_paid=717, priority_pass=4, runtime_rule_loaded=1, cost_paid:Scroll Rack=184, topdeck:Scroll Rack=2058 |
| Sensei's Divining Top | 3816 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid=1239, saga_chapter_resolved=336, topdeck_manipulation_activated=1939, cost_paid:Sensei's Divining Top=1205, topdeck:Sensei's Divining Top=2512 |
| Smothering Tithe | 859 | `ramp_engine` | `review_required` | discard_or_rummage_context, paid_cast_exposure, ramp_engine | cost_paid=65, trigger_resolved=734, turn_end=2, cost_paid:Smothering Tithe=150 |
| Sol Ring | 226 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cast_announced=2, cost_paid=128, etb_removal_resolved=2, removal_resolved=3, saga_chapter_resolved=19, cost_paid:Sol Ring=204 |
| Spectator Seating | 9 | `runtime_ready_unexposed` | `review_required` | none | land_played=9 |
| Starfall Invocation | 396 | `board_wipe_pressure_reset` | `review_required` | miracle_hit, paid_cast_exposure, pressure_reset_board_wipe | board_wipe_resolved=86, cost_paid=2, permanent_moved_from_battlefield=87, replacement_applied=217, cost_paid:Starfall Invocation=2, discard_to_top:Starfall Invocation=7, lorehold_rummage_to_top:Starfall Invocation=7, miracle:Starfall Invocation=3 |
...
| Stroke of Midnight | 43 | `spot_removal` | `review_required` | miracle_hit, paid_cast_exposure, spot_removal | compensation_tokens_created=1, cost_paid=10, removal_resolved=1, replacement_applied=19, spell_resolved=1, cost_paid:Stroke of Midnight=17, miracle:Stroke of Midnight=6 |
...
| Surge to Victory | 275 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context, miracle_hit | cost_paid=7, spell_copied=3, trigger_resolved=232, turn_end=1, discard_to_top:Surge to Victory=33, lorehold_rummage_to_top:Surge to Victory=33, miracle:Surge to Victory=51 |
| Swiftfoot Boots | 73 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | equipment_attached=1, spell_resolved=1, cost_paid:Swiftfoot Boots=264 |
| Swords to Plowshares | 271 | `spot_removal` | `review_required` | miracle_hit, paid_cast_exposure, spot_removal | cost_paid=80, removal_resolved=1, replacement_applied=158, spell_resolved=1, cost_paid:Swords to Plowshares=64, miracle:Swords to Plowshares=4 |
| Talisman of Conviction | 69 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid:Talisman of Conviction=235 |
...
| The Mind Stone | 2312 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=772, trigger_resolved=1143, trigger_skipped=43, utility_artifact_activated=308, cost_paid:The Mind Stone=222 |
| The Scarlet Witch | 362 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | cost_paid=304, cost_paid:The Scarlet Witch=88, static_cost_reduction_saved:The Scarlet Witch=376, static_cost_reduction_source_cast:The Scarlet Witch=25 |
| Thor, God of Thunder | 152 | `runtime_ready_unexposed` | `review_required` | paid_cast_exposure | replacement_applied=12, trigger_resolved=73, cost_paid:Thor, God of Thunder=2, spell_cast:Thor, God of Thunder=2, thor_noncreature_damage:Thor, God of Thunder=55, thor_noncreature_damage_amount:Thor, God of Thunder=852 |
| Tibalt's Trickery | 17 | `runtime_ready_unexposed` | `review_required` | none | discard_to_top:Tibalt's Trickery=64, lorehold_rummage_to_top:Tibalt's Trickery=40 |
| Tragic Arrogance | 80 | `board_wipe_pressure_reset` | `review_required` | discard_or_rummage_context, miracle_hit, pressure_reset_board_wipe | board_wipe_resolved=31, cost_paid=6, permanent_moved_from_battlefield=32, turn_end=3, discard_to_top:Tragic Arrogance=15, lorehold_rummage_to_top:Tragic Arrogance=15, miracle:Tragic Arrogance=3 |
...
| Urza's Saga | 2656 | `runtime_ready_unexposed` | `review_required` | discard_or_rummage_context | land_played=22, saga_chapter_progressed=1328, saga_chapter_resolved=648, saga_sacrificed_by_sba=655, turn_end=3 |
| Victory Chimes | 283 | `ramp_engine` | `review_required` | paid_cast_exposure, ramp_engine | cost_paid=236, cost_paid:Victory Chimes=175 |
| War Room | 13 | `runtime_ready_unexposed` | `review_required` | none | land_played=13 |
| Winds of Abandon | 59 | `spot_removal` | `review_required` | paid_cast_exposure, spot_removal | cost_paid=10, removal_resolved=2, replacement_applied=18, spell_resolved=2, cost_paid:Winds of Abandon=70 |
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Arcane Signet`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Arcane Signet`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Arcane Signet`
...
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Winota, Joiner of Forces #39 (real):0[128]` turn `20` effect `rummage` metric ``
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Sisay, Weatherlight Captain #61 (real):0[45]` turn `7` effect `rummage` metric ``
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Sisay, Weatherlight Captain #61 (real):0[54]` turn `8` effect `rummage` metric ``
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Winota, Joiner of Forces #39 (real):0[128]` turn `20` effect `rummage` metric ``
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Sisay, Weatherlight Captain #61 (real):0[45]` turn `7` effect `rummage` metric ``
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Sisay, Weatherlight Captain #61 (real):0[54]` turn `8` effect `rummage` metric ``
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[4]` turn `` effect `` metric `lorehold_rummage_to_top:Avatar's Wrath`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[5]` turn `` effect `` metric `discard_to_top:Avatar's Wrath`
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[4]` turn `` effect `` metric `lorehold_rummage_to_top:Avatar's Wrath`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[5]` turn `` effect `` metric `discard_to_top:Avatar's Wrath`
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[4]` turn `` effect `` metric `lorehold_rummage_to_top:Avatar's Wrath`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[5]` turn `` effect `` metric `discard_to_top:Avatar's Wrath`
...
- `static_cost_reduction_on` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[6]` turn `` effect `` metric `static_cost_reduction_on:Blasphemous Act`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[7]` turn `` effect `` metric `static_cost_reduction_saved:Blasphemous Act`
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[5]` turn `` effect `` metric `cost_paid:Boros Signet`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[5]` turn `` effect `` metric `cost_paid:Boros Signet`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[5]` turn `` effect `` metric `cost_paid:Boros Signet`
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_discard_ramp_value_monument_gate_20260630_goal_learning_smoke_20260630_210849.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[9]` turn `` effect `` metric `cost_paid:Boros Signet`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_discard_ramp_value_monument_gate_20260630_goal_learning_smoke_20260630_210849_cool_but_rude_same_lane_benchmark_cut_monument_to_endurance.json` path `results[1].telemetry.top_cards[9]` turn `` effect `` metric `cost_paid:Boros Signet`
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `forced_focus_access_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kenrith, the Returned King #113 (real):0[0]` turn `0` effect `` metric ``
- `forced_focus_access_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Sisay, Weatherlight Captain #61 (real):0[0]` turn `0` effect `` metric ``
- `forced_focus_access_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[0]` turn `0` effect `` metric ``
- `forced_focus_access_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Winota, Joiner of Forces #39 (real):0[0]` turn `0` effect `` metric ``
- `forced_focus_access_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_trace_samples[0]` turn `0` effect `` metric ``
- `forced_focus_access_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[0]` turn `0` effect `` metric ``
- `forced_focus_access_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Sisay, Weatherlight Captain #61 (real):0[0]` turn `0` effect `` metric ``
- `forced_focus_access_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[0]` turn `0` effect `` metric ``
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[11]` turn `` effect `` metric `cost_paid:Esper Sentinel`
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[61]` turn `9` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[61]` turn `9` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[58]` turn `9` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Winota, Joiner of Forces #39 (real):0[44]` turn `7` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[58]` turn `9` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Winota, Joiner of Forces #39 (real):0[44]` turn `7` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kefka, Court Mage #112 (real):1[31]` turn `6` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kraum, Ludevic's Opus #81 (real):0[71]` turn `12` effect `` metric ``

### Fated Clash

- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[106]` turn `12` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[72]` turn `10` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[106]` turn `12` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[72]` turn `10` effect `` metric ``
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Fellwar Stone`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Fellwar Stone`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Fellwar Stone`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058_chaos_warp_same_lane_benchmark_cut_generous_gift.json` path `results[0].telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Fellwar Stone`
...
- `static_cost_reduction_on` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[2]` turn `` effect `` metric `static_cost_reduction_on:Furygale Flocking`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[3]` turn `` effect `` metric `static_cost_reduction_saved:Furygale Flocking`
- `static_cost_reduction_on` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[2]` turn `` effect `` metric `static_cost_reduction_on:Furygale Flocking`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[3]` turn `` effect `` metric `static_cost_reduction_saved:Furygale Flocking`
- `static_cost_reduction_on` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[2]` turn `` effect `` metric `static_cost_reduction_on:Furygale Flocking`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[3]` turn `` effect `` metric `static_cost_reduction_saved:Furygale Flocking`
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058_chaos_warp_same_lane_benchmark_cut_generous_gift.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kraum, Ludevic's Opus #81 (real):0[29]` turn `6` effect `remove_permanent` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058_chaos_warp_same_lane_benchmark_cut_generous_gift.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kraum, Ludevic's Opus #81 (real):0[31]` turn `6` effect `` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058_chaos_warp_same_lane_benchmark_cut_generous_gift.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kraum, Ludevic's Opus #81 (real):1[35]` turn `7` effect `remove_permanent` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058_chaos_warp_same_lane_benchmark_cut_generous_gift.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kraum, Ludevic's Opus #81 (real):1[37]` turn `7` effect `` metric ``
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Giver of Runes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Giver of Runes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Giver of Runes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[11]` turn `` effect `` metric `cost_paid:Giver of Runes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[11]` turn `` effect `` metric `cost_paid:Giver of Runes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[11]` turn `` effect `` metric `cost_paid:Giver of Runes`
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Hexing Squelcher`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Hexing Squelcher`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Hexing Squelcher`
...
- `land_tax_trigger_skipped` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[104]` turn `14` effect `` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[27]` turn `5` effect `land_tax` metric ``
- `land_tax_trigger_skipped` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[34]` turn `6` effect `` metric ``
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[41]` turn `7` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[41]` turn `7` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[38]` turn `7` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[4]` turn `1` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[141]` turn `19` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[38]` turn `7` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[4]` turn `1` effect `passive` metric ``
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Lightning Greaves`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Lightning Greaves`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[8]` turn `` effect `` metric `cost_paid:Lightning Greaves`
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[2]` turn `` effect `` metric `cost_paid:Lorehold, the Historian`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kenrith, the Returned King #113 (real):0[22]` turn `4` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[31]` turn `6` effect `passive` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[61]` turn `9` effect `` metric ``
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[122]` turn `14` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[122]` turn `14` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:K-9, Mark I #34 (real):2[51]` turn `7` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058_chaos_warp_same_lane_benchmark_cut_generous_gift.json` path `results[0].telemetry.focus_card_game_traces.deck_607:K-9, Mark I #34 (real):2[51]` turn `7` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058_chaos_warp_same_lane_benchmark_cut_generous_gift.json` path `results[1].telemetry.focus_card_game_traces.synergy_chaos_warp_same_lane_benchmark_cut_generous_gift:K-9, Mark I #34 (real):2[117]` turn `20` effect `passive` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_chaos_warp_generous_gift_gate_20260630_goal_learning_smoke_20260630_205058_chaos_warp_same_lane_benchmark_cut_generous_gift.json` path `results[1].telemetry.focus_card_game_traces.synergy_chaos_warp_same_lane_benchmark_cut_generous_gift:Rograkh, Son of Rohgahh #95 (real):1[137]` turn `23` effect `passive` metric ``
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[11]` turn `` effect `` metric `cost_paid:Monument to Endurance`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[11]` turn `` effect `` metric `cost_paid:Monument to Endurance`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[11]` turn `` effect `` metric `cost_paid:Monument to Endurance`
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `land_tax_trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Thrasios, Triton Hero #101 (real):0[28]` turn `6` effect `` metric ``
- `land_tax_trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Thrasios, Triton Hero #101 (real):0[34]` turn `7` effect `` metric ``
- `land_tax_trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kinnan, Bonder Prodigy #72 (real):1[51]` turn `8` effect `` metric ``
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[10]` turn `` effect `` metric `static_cost_reduction_source_cast:Pearl Medallion`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[9]` turn `` effect `` metric `static_cost_reduction_saved:Pearl Medallion`
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[10]` turn `` effect `` metric `static_cost_reduction_source_cast:Pearl Medallion`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[9]` turn `` effect `` metric `static_cost_reduction_saved:Pearl Medallion`
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[10]` turn `` effect `` metric `static_cost_reduction_source_cast:Pearl Medallion`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[9]` turn `` effect `` metric `static_cost_reduction_saved:Pearl Medallion`
...
- `land_tax_trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Thrasios, Triton Hero #101 (real):0[40]` turn `8` effect `` metric ``
...
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[6]` turn `` effect `` metric `static_cost_reduction_saved:Ruby Medallion`
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[7]` turn `` effect `` metric `static_cost_reduction_source_cast:Ruby Medallion`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[6]` turn `` effect `` metric `static_cost_reduction_saved:Ruby Medallion`
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[7]` turn `` effect `` metric `static_cost_reduction_source_cast:Ruby Medallion`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[6]` turn `` effect `` metric `static_cost_reduction_saved:Ruby Medallion`
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[7]` turn `` effect `` metric `static_cost_reduction_source_cast:Ruby Medallion`
...
- `topdeck` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[2]` turn `` effect `` metric `topdeck:Scroll Rack`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[94]` turn `18` effect `topdeck_manipulation` metric ``
- `topdeck_manipulation_activated` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[99]` turn `19` effect `` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[69]` turn `9` effect `topdeck_manipulation` metric ``
- `topdeck_manipulation_activated` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[72]` turn `9` effect `` metric ``

### Sensei's Divining Top

- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[3]` turn `` effect `` metric `cost_paid:Sensei's Divining Top`
- `topdeck` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[6]` turn `` effect `` metric `topdeck:Sensei's Divining Top`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[40]` turn `7` effect `topdeck_manipulation` metric ``
- `topdeck_manipulation_activated` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[46]` turn `7` effect `` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[51]` turn `8` effect `topdeck_manipulation` metric ``
- `topdeck_manipulation_activated` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[55]` turn `8` effect `` metric ``
- `topdeck_manipulation_activated` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[60]` turn `9` effect `` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[73]` turn `10` effect `topdeck_manipulation` metric ``
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[9]` turn `` effect `` metric `cost_paid:Smothering Tithe`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[9]` turn `` effect `` metric `cost_paid:Smothering Tithe`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[9]` turn `` effect `` metric `cost_paid:Smothering Tithe`
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Sisay, Weatherlight Captain #61 (real):0[39]` turn `7` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[84]` turn `11` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[115]` turn `16` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Sisay, Weatherlight Captain #61 (real):0[39]` turn `7` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[84]` turn `11` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Vivi Ornitier #99 (real):0[115]` turn `16` effect `` metric ``
...
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_discard_ramp_value_monument_gate_20260630_goal_learning_smoke_20260630_210849_cool_but_rude_same_lane_benchmark_cut_monument_to_endurance.json` path `results[1].telemetry.focus_card_game_traces.synergy_cool_but_rude_same_lane_benchmark_cut_monument_to_endurance:K-9, Mark I #34 (real):1[57]` turn `10` effect `` metric ``
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[1]` turn `` effect `` metric `lorehold_rummage_to_top:Surge to Victory`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[2]` turn `` effect `` metric `discard_to_top:Surge to Victory`
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[1]` turn `` effect `` metric `lorehold_rummage_to_top:Surge to Victory`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[2]` turn `` effect `` metric `discard_to_top:Surge to Victory`
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[1]` turn `` effect `` metric `lorehold_rummage_to_top:Surge to Victory`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[2]` turn `` effect `` metric `discard_to_top:Surge to Victory`
...
- `equipment_attached` from `docs/hermes-analysis/master_optimizer_reports/deck606_pg078_l2_hash_scope_restore_focused_events_20260623_063535.jsonl` path `line:17` turn `4` effect `equipment_static_attachment` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Swiftfoot Boots`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Swiftfoot Boots`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Swiftfoot Boots`
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kefka, Court Mage #112 (real):1[69]` turn `12` effect `` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Winota, Joiner of Forces #73 (real):1[47]` turn `7` effect `remove_creature` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Winota, Joiner of Forces #73 (real):1[48]` turn `7` effect `` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Thrasios, Triton Hero #76 (real):1[40]` turn `7` effect `remove_creature` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Thrasios, Triton Hero #76 (real):1[41]` turn `7` effect `` metric ``
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Sisay, Weatherlight Captain #61 (real):0[27]` turn `5` effect `ramp_permanent` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Sisay, Weatherlight Captain #61 (real):0[27]` turn `5` effect `ramp_permanent` metric ``
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:K-9, Mark I #34 (real):2[14]` turn `3` effect `ramp_permanent` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kefka, Court Mage #112 (real):0[14]` turn `3` effect `ramp_permanent` metric ``
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kefka, Court Mage #112 (real):1[19]` turn `4` effect `ramp_permanent` metric ``
- `utility_artifact_activated` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Kefka, Court Mage #112 (real):1[57]` turn `10` effect `` metric ``

### The Scarlet Witch

- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[1]` turn `` effect `` metric `static_cost_reduction_saved:The Scarlet Witch`
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[9]` turn `` effect `` metric `static_cost_reduction_source_cast:The Scarlet Witch`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[1]` turn `` effect `` metric `static_cost_reduction_saved:The Scarlet Witch`
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[9]` turn `` effect `` metric `static_cost_reduction_source_cast:The Scarlet Witch`
- `static_cost_reduction_saved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[1]` turn `` effect `` metric `static_cost_reduction_saved:The Scarlet Witch`
- `static_cost_reduction_source_cast` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[9]` turn `` effect `` metric `static_cost_reduction_source_cast:The Scarlet Witch`
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `thor_noncreature_damage_amount` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[1]` turn `` effect `` metric `thor_noncreature_damage_amount:Thor, God of Thunder`
- `thor_noncreature_damage` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[8]` turn `` effect `` metric `thor_noncreature_damage:Thor, God of Thunder`
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[105]` turn `12` effect `damage_any_target` metric ``
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[114]` turn `13` effect `damage_any_target` metric ``
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[131]` turn `15` effect `damage_any_target` metric ``
- `trigger_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.focus_card_game_traces.deck_607:Vivi Ornitier #99 (real):0[90]` turn `11` effect `damage_any_target` metric ``
- `thor_noncreature_damage_amount` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[1]` turn `` effect `` metric `thor_noncreature_damage_amount:Thor, God of Thunder`
- `thor_noncreature_damage` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[8]` turn `` effect `` metric `thor_noncreature_damage:Thor, God of Thunder`

### Tibalt's Trickery

- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[0]` turn `` effect `` metric `lorehold_rummage_to_top:Tibalt's Trickery`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[1]` turn `` effect `` metric `discard_to_top:Tibalt's Trickery`
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[0]` turn `` effect `` metric `lorehold_rummage_to_top:Tibalt's Trickery`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[1]` turn `` effect `` metric `discard_to_top:Tibalt's Trickery`
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[0]` turn `` effect `` metric `lorehold_rummage_to_top:Tibalt's Trickery`
- `discard_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[0].telemetry.top_cards[1]` turn `` effect `` metric `discard_to_top:Tibalt's Trickery`
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.baseline.telemetry.top_cards[11]` turn `` effect `` metric `lorehold_rummage_to_top:Tibalt's Trickery`
- `lorehold_rummage_to_top` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[0].telemetry.top_cards[11]` turn `` effect `` metric `lorehold_rummage_to_top:Tibalt's Trickery`
...
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_enlightened_tutor_gate_20260630_creative_technique_seed20260630_real8_games3_partial.json` path `results[1].telemetry.focus_card_game_traces.candidate_607_enlightened_tutor_creative_technique_v1:Kraum, Ludevic's Opus #81 (real):1[84]` turn `13` effect `selective_nonland_sacrifice` metric ``
- `permanent_moved_from_battlefield` from `docs/hermes-analysis/master_optimizer_reports/lorehold_failure_targeted_trace_audit_20260630_after_profiled_gate.json` path `primary_seed_records.42.squee_trace_summary.samples[17]` turn `7` effect `` metric ``
- `turn_end` from `docs/hermes-analysis/master_optimizer_reports/lorehold_finalizer_benchmark_gate_20260627_v1_seed20260625_hash0_isolated_timeout_storm_challenge.json` path `packages[0].gate_summary.candidate.telemetry.squee_game_traces.synergy_core_challenge_dance_over_storm:Vivi Ornitier #99 (real):2[5]` turn `19` effect `` metric ``
- `turn_end` from `docs/hermes-analysis/master_optimizer_reports/lorehold_finalizer_benchmark_gate_20260627_v1_seed20260625_hash0_isolated_timeout_storm_challenge.json` path `packages[0].gate_summary.candidate.telemetry.squee_trace_samples[5]` turn `19` effect `` metric ``
...
- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `saga_chapter_progressed` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[14]` turn `3` effect `` metric ``
- `saga_chapter_progressed` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[20]` turn `4` effect `` metric ``
- `saga_chapter_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[21]` turn `4` effect `` metric ``
- `saga_sacrificed_by_sba` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[23]` turn `4` effect `` metric ``
- `saga_chapter_progressed` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[14]` turn `3` effect `` metric ``
- `saga_chapter_progressed` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[20]` turn `4` effect `` metric ``
- `saga_chapter_resolved` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[21]` turn `4` effect `` metric ``
- `saga_sacrificed_by_sba` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_forced_opening_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.focus_card_game_traces.synergy_possibility_storm_same_lane_benchmark_cut_creative_technique:Kenrith, the Returned King #113 (real):0[23]` turn `4` effect `` metric ``

### Victory Chimes

- Decision: `review_required`; next: connect role to an explicit package hypothesis
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[9]` turn `` effect `` metric `cost_paid:Victory Chimes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[9]` turn `` effect `` metric `cost_paid:Victory Chimes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_607_unprotected_staple_relearn_gate_20260704_possibility_storm_smoke_possibility_storm_same_lane_benchmark_cut_creative_technique_partial.json` path `results[1].telemetry.top_cards[9]` turn `` effect `` metric `cost_paid:Victory Chimes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730.json` path `packages[0].gate_summary.candidate.telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Victory Chimes`
- `cost_paid` from `docs/hermes-analysis/master_optimizer_reports/lorehold_big_spell_value_creative_technique_gate_20260630_goal_learning_smoke_20260630_213730_possibility_storm_same_lane_benchmark_cut_creative_technique.json` path `results[1].telemetry.top_cards[10]` turn `` effect `` metric `cost_paid:Victory Chimes`
...
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_discard_ramp_value_monument_remaining_gate_20260630_goal_learning_smoke_20260630_213021_glint_horn_buccaneer_same_lane_benchmark_cut_monument_to_endurance.json` path `results[1].telemetry.focus_card_game_traces.synergy_glint_horn_buccaneer_same_lane_benchmark_cut_monument_to_endurance:Winota, Joiner of Forces #73 (real):2[49]` turn `8` effect `` metric ``
- `replacement_applied` from `docs/hermes-analysis/master_optimizer_reports/lorehold_discard_ramp_value_monument_remaining_gate_20260630_goal_learning_smoke_20260630_213021_surly_badgersaur_same_lane_benchmark_cut_monument_to_endurance.json` path `results[1].telemetry.focus_card_game_traces.synergy_surly_badgersaur_same_lane_benchmark_cut_monument_to_endurance:K-9, Mark I #34 (real):1[65]` turn `10` effect `` metric ``
