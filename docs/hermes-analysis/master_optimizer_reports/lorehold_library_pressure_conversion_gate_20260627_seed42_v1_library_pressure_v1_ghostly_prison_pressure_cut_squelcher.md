...
| 2 |  | Lorehold synergy package: ghostly_prison_pressure_cut_squelcher (`synergy_ghostly_prison_pressure_cut_squelcher`) | synergy-package | 9 | 3 | 6 | 0 | 33.33% | 16.33 | 4 | 1 | 0 | 2 | 1 | 1 | 0 | 6 | none |
...
### 2. Lorehold synergy package: ghostly_prison_pressure_cut_squelcher (`synergy_ghostly_prison_pressure_cut_squelcher`)
...
| Opponent | W | L | S | WR | Avg Win Turn | Reasons |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Vivi Ornitier #99 (real) | 2 | 1 | 0 | 66.67% | 18.50 | elimination=2 |
| Sisay, Weatherlight Captain #61 (real) | 1 | 2 | 0 | 33.33% | 12.00 | elimination=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=101, lorehold_spell_cast=89, lorehold_spell_rummage=17, lorehold_upkeep_rummage=27, miracle_cast=17, topdeck_manipulation_activated=9, squee_to_graveyard=2, graveyard_upkeep_return_self_to_hand=1, squee_upkeep_return=1, squee_return_after_known_graveyard_entry=1
