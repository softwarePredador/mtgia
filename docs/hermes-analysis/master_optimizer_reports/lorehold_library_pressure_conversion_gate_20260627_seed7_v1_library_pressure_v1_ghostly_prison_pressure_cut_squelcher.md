...
- generated_at: `2026-06-27T17:52:41Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: ghostly_prison_pressure_cut_squelcher (`synergy_ghostly_prison_pressure_cut_squelcher`) | synergy-package | 9 | 2 | 7 | 0 | 22.22% | 16.50 | 6 | 2 | 0 | 0 | 0 | 0 | 0 | 7 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 4 | 1 | 0 | 0 | 0 | 0 | 0 | 9 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: ghostly_prison_pressure_cut_squelcher (`synergy_ghostly_prison_pressure_cut_squelcher`)
...
**Strategic event counts:** lorehold_cost_paid=77, lorehold_spell_cast=65, lorehold_upkeep_rummage=46, miracle_cast=16, topdeck_manipulation_activated=4, lorehold_spell_rummage=1
