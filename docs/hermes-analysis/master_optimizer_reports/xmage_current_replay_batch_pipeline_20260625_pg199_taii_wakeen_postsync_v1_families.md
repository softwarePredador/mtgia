...
- Summary: `{"batch_metadata_candidate_count": 0, "card_count": 443, "family_count": 9, "family_counts": {"board_wipe_choice": 4, "creature": 4, "manual_model": 349, "mill_spell": 1, "modal_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 61, "token_maker": 17, "tutor": 4}, "manual_or_blocked_count": 423, "promotion_lane_counts": {"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 346, "runtime_family_implementation_required": 20, "split_family_scope_review_required": 73}, "runtime_family_required_count": 20}`
...
| `targeted_interaction` | 61 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 61}` | target legality, resolution, zone transition, and event provenance |
