\echo 'PG719b trusted rule oracle_hash backfill apply'

BEGIN;

CREATE SCHEMA IF NOT EXISTS manaloom_deploy_audit;

DROP TABLE IF EXISTS manaloom_deploy_audit.pg719b_trusted_rule_oracle_hash_backfill_20260710;

CREATE TABLE manaloom_deploy_audit.pg719b_trusted_rule_oracle_hash_backfill_20260710 AS
...
WITH candidate_hashes AS (
  ...
  UPDATE public.card_battle_rules r
     SET oracle_hash = s.oracle_hash,
         notes = concat_ws(E'\n', nullif(r.notes, ''), 'PG719B: oracle_hash backfilled from cards.oracle_text for trusted executable rule.'),
