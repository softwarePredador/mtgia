...
- generated_at: `2026-06-28T00:02:06Z`
...
| 2 |  | Lorehold synergy package: enlightened_access_benchmark_cut_land_tax (`synergy_enlightened_access_benchmark_cut_land_tax`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 18.00 | 3 | 1 | 2 | 0 | 0 | 0 | 0 | 2 | 0 | 0 | none | none |
...
### 2. Lorehold synergy package: enlightened_access_benchmark_cut_land_tax (`synergy_enlightened_access_benchmark_cut_land_tax`)
...
**Strategic event counts:** lorehold_cost_paid=32, lorehold_spell_cast=27, lorehold_upkeep_rummage=18, miracle_cast=14, discard_to_top_replacement=9, lorehold_rummage_discard_to_top=9, topdeck_manipulation_activated=9
