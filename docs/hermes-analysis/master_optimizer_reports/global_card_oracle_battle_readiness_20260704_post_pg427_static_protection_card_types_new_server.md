...
- Generated at: `2026-07-04T20:01:39.306466+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5676 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4413 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4591 | 265 |
| `battle_family_mapper_required` | 29282 | 98 |
...
| `battle_family::protection_prevention` | 501 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolute Grace`, `Absolute Law`, `Adept Watershaper`, `Aegis of the Gods`, `Agent Frank Horrigan`, `Agent of the Shadow Thieves`, `Airtight Alibi`, `Akroma's Memorial`, `Akroma, Angel of Fury`, `Akroma, Vision of Ixidor` |
