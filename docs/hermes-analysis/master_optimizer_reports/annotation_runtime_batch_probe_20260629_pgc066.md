# Annotation Runtime Batch Probe - PGC066

- Generated UTC: `2026-06-29T11:14:35+00:00`
- Baseline input: `39` cards from `annotation_runtime_batch_probe_20260629_pgc060.json`
- Clean cards: `12`
- Residual cards: `27`
- Runtime executor value paths: `41`

## Clean Cards

`City of Brass`; `Clifftop Retreat`; `Dualcaster Mage`; `Elves of Deep Shadow`; `Erode`; `Inspiring Vantage`; `Mana Confluence`; `Reverberate`; `Sundering Eruption // Volcanic Fissure`; `Sundown Pass`; `Tarnished Citadel`; `Untimely Malfunction`
