...
- `mana_source_source_sacrifice_cost_not_supported`: `["Astrolabe", "Barbed Sextant", "Basal Sliver", "Buried Treasure", "Cryptex", "Elsewhere Flask", "Exploding Barrel", "Five Hundred Year Diary", "Golden Egg", "Guild Globe", "Jack-o'-Lantern", "Kaleidostone"]`
...
- `token_description_keyword_not_supported`: `["Birthing Boughs", "Carrion Call", "Dance with Devils", "Devils' Playground", "Dragon Egg", "Errand of Duty", "Fire Nation Attacks", "Form a Posse", "Gysahl Greens", "Harried Spearguard", "Hobbling Zombie", "Mage's Attendant"]`
...
- `token_source_create_token_not_fixed`: `["Dripping-Tongue Zubera", "Evangel of Heliod", "Fresh Meat", "Ghoulcaller's Harvest", "Great Desert Prospector", "Hallowed Spiritkeeper", "Nested Shambler", "Revenge of the Rats", "Reverent Hoplite", "Roc Egg", "Spider Spawning", "Springjack Shepherd"]`
