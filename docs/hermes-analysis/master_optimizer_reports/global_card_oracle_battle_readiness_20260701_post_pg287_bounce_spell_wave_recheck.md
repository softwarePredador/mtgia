...
- Generated at: `2026-07-01T08:20:29.969325+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 3664 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 2315 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1172 | 388 |
| `battle_family_mapper_required` | 31380 | 231 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7982 |
| `damage_or_life_total_change` | 4125 |
...
| `battle_family::manual_model_review` | 7982 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
| `battle_family::damage_or_life_total_change` | 4125 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Aardvark Sloth`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide` |
...
| `battle_family::recursion_or_bounce` | 593 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Adun Oakenshield`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe` |
