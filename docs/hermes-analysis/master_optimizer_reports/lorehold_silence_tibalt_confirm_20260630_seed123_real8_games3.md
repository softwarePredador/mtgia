...
- generated_at: `2026-06-30T03:30:29Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_silence_tibalt_confirm_20260630_seed123_real8_games3_game_checkpoint.json`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | 1 | Lorehold 607 + Silence over Tibalt Trickery v1 (`candidate_607_silence_tibalts_trickery_v1`) | 607-silence-tibalts-trickery | 24 | 12 | 12 | 0 | 50.00% | 17.58 | 15 | 8 | 5 | 0 | 0 | 0 | 0 | 16 | 0 | 0 | none | recursion_role, tutor_role |
...
### 1. Lorehold 607 + Silence over Tibalt Trickery v1 (`candidate_607_silence_tibalts_trickery_v1`)
...
| Rograkh, Son of Rohgahh #95 (real) | 2 | 1 | 0 | 66.67% | 21.50 | approach=1, elimination=1 |
| K-9, Mark I #34 (real) | 2 | 1 | 0 | 66.67% | 18.50 | elimination=2 |
| Winota, Joiner of Forces #73 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |
| Thrasios, Triton Hero #101 (real) | 3 | 0 | 0 | 100.00% | 16.00 | approach=1, elimination=2 |
| Kinnan, Bonder Prodigy #72 (real) | 1 | 2 | 0 | 33.33% | 17.00 | elimination=1 |
| Kefka, Court Mage #112 (real) | 3 | 0 | 0 | 100.00% | 15.67 | approach=1, elimination=2 |
| Kraum, Ludevic's Opus #81 (real) | 1 | 2 | 0 | 33.33% | 19.00 | elimination=1 |

**Strategic event counts:** discard_to_top_replacement=56, lorehold_cost_paid=311, lorehold_rummage_discard_to_top=31, lorehold_spell_cast=279, lorehold_spell_rummage=46, lorehold_spell_rummage_discard_to_top=25, lorehold_upkeep_rummage=86, miracle_cast=61, scarlet_static_cost_reduction_casts=4, scarlet_static_cost_reduction_total=8, static_cost_reduction_casts=67, static_cost_reduction_total=85, topdeck_manipulation_activated=44
