...
- Generated at: `2026-07-01T08:18:54+00:00`
- Status: `ready`
- Mutations performed: `[]`

## Summary

`{"adapter_work_unit_counts": {"bounce::targeted_return_to_hand_variant_v1": 7}, "blocked_reason_counts": {"additional_cost_detected": 110, "bounce_ability_class_not_simple": 28, "bounce_effect_class_not_pure": 44, "bounce_target_not_supported": 20, "counter_ability_class_not_simple": 19, "counter_effect_class_not_pure": 35, "counter_oracle_not_simple": 2, "counter_target_not_supported": 23, "damage_amount_not_fixed": 45, "damage_effect_class_not_pure": 123, "damage_target_not_supported": 24, "destroy_effect_class_not_pure": 138, "destroy_target_not_supported": 74, "draw_effect_class_not_pure": 562, "exile_effect_class_not_pure": 42, "exile_oracle_not_simple": 9, "exile_target_not_supported": 29, "life_gain_amount_not_fixed": 19, "life_gain_effect_class_not_pure": 166, "life_gain_oracle_not_simple": 11, "mana_source_effect_class_not_simple": 307, "mana_source_oracle_not_simple": 121, "mana_source_safe_ability_missing": 133, "mana_source_spell_not_supported": 1, "mana_source_unsafe_ability_class": 135, "not_instant_or_sorcery_spell": 2054, "not_one_shot_spell_ability": 183}, "considered_supported_work_unit_rows": 4464, "family_counts": {"xmage_return_target_to_hand_spell": 7}, "proposal_count": 7, "proposal_status_counts": {"batch_pg_candidate_after_precheck": 7}, "safe_for_batch_pg_package_count": 7, "scope_counts": {"xmage_return_target_to_hand_spell_v1": 7}}`

## Selected Proposals

| Card | Family | Scope | Effect | Logical rule key |
| --- | --- | --- | --- | --- |
| `Boomerang` | `xmage_return_target_to_hand_spell` | `xmage_return_target_to_hand_spell_v1` | `remove_permanent` | `battle_rule_v1:2048333401c1ae3096acb4d43a4c83db` |
| `Disperse` | `xmage_return_target_to_hand_spell` | `xmage_return_target_to_hand_spell_v1` | `remove_permanent` | `battle_rule_v1:e0cd5a647871ffed2ebf25c3b0fa4ab2` |
| `Drown in Shapelessness` | `xmage_return_target_to_hand_spell` | `xmage_return_target_to_hand_spell_v1` | `remove_creature` | `battle_rule_v1:92639258e9e2b1aa134f47b808061c76` |
| `Eye of Nowhere` | `xmage_return_target_to_hand_spell` | `xmage_return_target_to_hand_spell_v1` | `remove_permanent` | `battle_rule_v1:3bf436b016651becbbdb0d7d2fb400dc` |
| `Regress` | `xmage_return_target_to_hand_spell` | `xmage_return_target_to_hand_spell_v1` | `remove_permanent` | `battle_rule_v1:2048333401c1ae3096acb4d43a4c83db` |
| `Unsummon` | `xmage_return_target_to_hand_spell` | `xmage_return_target_to_hand_spell_v1` | `remove_creature` | `battle_rule_v1:92639258e9e2b1aa134f47b808061c76` |
| `Void Snare` | `xmage_return_target_to_hand_spell` | `xmage_return_target_to_hand_spell_v1` | `remove_permanent` | `battle_rule_v1:45be913b2a550d0ade45b3d034532330` |

## Blocked Samples

- `additional_cost_detected`: `["Abjure", "Acceptable Losses", "Aether Tide", "Altar's Reap", "Angelic Purge", "Annihilating Glare", "Artillerize", "Bankrupt in Blood", "Betrayer's Bargain", "Bitter Triumph", "Blood Divination", "Bogslither's Embrace"]`
...
- `not_instant_or_sorcery_spell`: `["Aberrant", "Abiding Grace", "Abomination", "Absolver Thrull", "Absolving Lammasu", "Abyssal Hunter", "Academy Journeymage", "Acid Web Spider", "Acidic Dagger", "Acidic Slime", "Acidic Sliver", "Acolyte of the Inferno"]`
- `not_one_shot_spell_ability`: `["Ajani's Response", "Aleatory", "Arm with Aether", "Arwen's Gift", "Astral Confrontation", "Balduvian Rage", "Banish from Edoras", "Benefactor's Draught", "Bind", "Bind // Liberate", "Blessed Wine", "Bone Harvest"]`
