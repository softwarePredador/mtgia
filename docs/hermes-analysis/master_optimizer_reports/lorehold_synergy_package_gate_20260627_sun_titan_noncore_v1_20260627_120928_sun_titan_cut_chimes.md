...
- generated_at: `2026-06-27T12:13:59Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_synergy_package_gate_20260627_sun_titan_noncore_v1_20260627_120928_sun_titan_cut_chimes_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: sun_titan_cut_chimes (`synergy_sun_titan_cut_chimes`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 23.00 | 2 | 1 | none |
...
### 2. Lorehold synergy package: sun_titan_cut_chimes (`synergy_sun_titan_cut_chimes`)
...
**Strategic event counts:** lorehold_cost_paid=37, lorehold_spell_cast=31, miracle_cast=8, topdeck_manipulation_activated=3
