...
- generated_at: `2026-06-30T03:30:27Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_silence_tibalt_confirm_20260630_seed20260630_real8_games3_game_checkpoint.json`
...
| 2 | 1 | Lorehold 607 + Silence over Tibalt Trickery v1 (`candidate_607_silence_tibalts_trickery_v1`) | 607-silence-tibalts-trickery | 24 | 9 | 15 | 0 | 37.50% | 13.89 | 12 | 8 | 6 | 0 | 0 | 0 | 0 | 20 | 8 | 0 | unattributed: events=8, restricted=8, tax=0 | recursion_role, tutor_role |
...
| Opponent | W | L | S | WR | Avg Win Turn | Reasons |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Thrasios, Triton Hero #76 (real) | 1 | 2 | 0 | 33.33% | 9.00 | approach=1 |
| Rograkh, Son of Rohgahh #95 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |
| K-9, Mark I #34 (real) | 2 | 1 | 0 | 66.67% | 15.00 | elimination=2 |
| Winota, Joiner of Forces #73 (real) | 1 | 2 | 0 | 33.33% | 11.00 | approach=1 |
| Thrasios, Triton Hero #101 (real) | 1 | 2 | 0 | 33.33% | 12.00 | approach=1 |
| Kinnan, Bonder Prodigy #72 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |
| Kefka, Court Mage #112 (real) | 2 | 1 | 0 | 66.67% | 14.50 | elimination=2 |
| Kraum, Ludevic's Opus #81 (real) | 2 | 1 | 0 | 66.67% | 17.00 | approach=1, elimination=1 |

**Strategic event counts:** discard_to_top_replacement=47, lorehold_cost_paid=260, lorehold_rummage_discard_to_top=37, lorehold_spell_cast=235, lorehold_spell_rummage=13, lorehold_spell_rummage_discard_to_top=10, lorehold_upkeep_rummage=86, miracle_cast=32, scarlet_static_cost_reduction_casts=1, scarlet_static_cost_reduction_total=2, static_cost_reduction_casts=36, static_cost_reduction_total=75, thor_cost_paid=3, thor_noncreature_damage=3, thor_noncreature_damage_amount=8, topdeck_manipulation_activated=30

**Lorehold attack restriction telemetry:** events=8, attackers_before=17, attackers_after=9, attackers_restricted=8, tax_paid=0, sources=unattributed: events=8, restricted=8, tax=0
