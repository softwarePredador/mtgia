...
- generated_at: 2026-06-19T15:37:23.710540+00:00
- deck_id: 6
- opponents_loaded: 12
...
| Six | creature | battle_rule_review_only_generated | cast_permission_not_explicit, review_only_rule, trigger_not_explicit | Lumra, Bellow of the Woods #49 (real) |
...
| Amulet of Vigor | unknown | battle_rule_review_only_generated | review_only_rule, trigger_not_explicit | Lumra, Bellow of the Woods #49 (real) |
| Chatterfang, Squirrel General | creature | battle_rule_review_only_generated | review_only_rule, temporary_effect_not_explicit | Kenrith, the Returned King #113 (real) |
| Curse of Opulence | ramp_permanent | battle_rule_review_only_generated | review_only_rule, trigger_not_explicit | Ishai, Ojutai Dragonspeaker #28 (real) |
| Ephemerate | remove_creature | battle_rule_review_only_generated | cast_permission_not_explicit, review_only_rule | Gwen Stacy #65 (real) |
| Horizon Explorer | tutor | battle_rule_review_only_generated | review_only_rule, trigger_not_explicit | Lumra, Bellow of the Woods #49 (real) |
| Lotus Cobra | ramp_permanent | battle_rule_review_only_generated | review_only_rule, trigger_not_explicit | Lumra, Bellow of the Woods #49 (real) |
| Nissa, Resurgent Animist | ramp_permanent | battle_rule_review_only_generated | review_only_rule, trigger_not_explicit | Lumra, Bellow of the Woods #49 (real) |
| Tireless Provisioner | ramp_permanent | battle_rule_review_only_generated | review_only_rule, trigger_not_explicit | Lumra, Bellow of the Woods #49 (real) |
| Veil of Summer | draw_cards | battle_rule_review_only_generated | review_only_rule, temporary_effect_not_explicit | Akiri, Line-Slinger #30 (real), Etali, Primal Conqueror #105 (real), Kenrith, the Returned King #113 (real), Kinnan, Bonder Prodigy #37 (real) |
