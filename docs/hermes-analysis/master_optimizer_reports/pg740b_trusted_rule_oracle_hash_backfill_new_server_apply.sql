\echo 'PG740B trusted rule oracle_hash backfill apply'

BEGIN;

CREATE SCHEMA IF NOT EXISTS manaloom_deploy_audit;

DROP TABLE IF EXISTS manaloom_deploy_audit.pg740b_trusted_rule_oracle_hash_backfill_new_server_20260711;

CREATE TABLE manaloom_deploy_audit.pg740b_trusted_rule_oracle_hash_backfill_new_server_20260711 AS
SELECT
  br.card_id,
  br.normalized_name,
  br.card_name,
...
updated AS (
  ...
  SET
    ...
    updated_at = NOW(),
    notes = CONCAT_WS(' | ', NULLIF(br.notes, ''), 'pg740b trusted_rule_oracle_hash_backfill_new_server')
  FROM target
