...
- `proposal_count`: `140`
- `pattern_count`: `21`
- `lane_counts`: `{"manual_mapper_backlog": 63, "split_scope_backlog": 77}`
- `pattern_status_counts`: `{"candidate_template_requires_review_tests": 7, "manual_model_observation_only": 1, "requires_subpattern_split_before_promotion": 13}`
- `card_counts_by_pattern_status`: `{"candidate_template_requires_review_tests": 10, "manual_model_observation_only": 63, "requires_subpattern_split_before_promotion": 67}`
...
- Lane: `split_scope_backlog`
- Status: `requires_subpattern_split_before_promotion`
- Cards: `2` (Cursed Mirror, Lion's Eye Diamond)
- Subpatterns: `2`
- Required evidence: `["subpattern split", "focused ManaLoom tests per subpattern", "package generation only for exact supported subpatterns"]`
