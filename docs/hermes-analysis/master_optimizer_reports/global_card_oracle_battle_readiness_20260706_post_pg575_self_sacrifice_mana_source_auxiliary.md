...
- Generated at: `2026-07-06T21:56:27.054266+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6638 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5417 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5595 | 269 |
| `battle_family_mapper_required` | 28278 | 94 |
...
| `battle_family::mana_generation_or_ritual` | 684 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `All-Fates Scroll` |
