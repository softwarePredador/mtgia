...
- Generated at: `2026-06-24T15:13:15+00:00`
- Status: `ready`
- Mutations performed: `[]`
...
- `proposal_count`: `504`
- `pattern_count`: `77`
- `lane_counts`: `{"blocked_missing_xmage_source": 2, "manual_mapper_backlog": 356, "package_already_prepared": 54, "runtime_family_backlog": 24, "split_scope_backlog": 68}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "fragmented_runtime_observation_only": 20, "governance_only_pending_pg_apply": 43, "manual_model_observation_only": 2, "requires_subpattern_split_before_promotion": 9, "runtime_template_candidate_requires_executor_tests": 2}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 2, "fragmented_runtime_observation_only": 20, "governance_only_pending_pg_apply": 54, "manual_model_observation_only": 356, "requires_subpattern_split_before_promotion": 68, "runtime_template_candidate_requires_executor_tests": 4}`
...
| `draw_engine/draw_engine/opponent_discards_card_may_draw_v1` | `package_already_prepared` | `governance_only_pending_pg_apply` | 1 | 1 | Do not remodel; move through the existing PostgreSQL approval/apply/sync/audit gate. |
...
| `passive/passive/controller_discards_card_damage_any_target_and_gain_life_v1` | `package_already_prepared` | `governance_only_pending_pg_apply` | 1 | 1 | Do not remodel; move through the existing PostgreSQL approval/apply/sync/audit gate. |
...
| `passive/passive/opponent_discards_card_damage_that_player_v1` | `package_already_prepared` | `governance_only_pending_pg_apply` | 1 | 1 | Do not remodel; move through the existing PostgreSQL approval/apply/sync/audit gate. |
