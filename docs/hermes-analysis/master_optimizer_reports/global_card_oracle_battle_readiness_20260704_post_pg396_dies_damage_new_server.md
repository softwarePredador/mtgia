...
- Generated at: `2026-07-04T09:15:38.096387+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5242 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3968 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4103 | 250 |
| `battle_family_mapper_required` | 29727 | 100 |
...
| `damage_or_life_total_change` | 3909 |
...
| `battle_family::damage_or_life_total_change` | 3909 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
