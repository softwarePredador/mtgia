...
- Generated at: `2026-06-26T17:59:59.926705+00:00`
...
| 2 | VARIANT Lorehold Variant 10 - Rafael Paste 2026-06-24 (`deck_615`) | spell-copy-big-spells-variant | 134.9 | 97.2 | 34 | 100.0% | Big-spells shell that leans on Lorehold's miracle discount to cast expensive effects ahead of curve. | removal_role, recursion_role, tutor_role |
...
| 5 | VARIANT Lorehold Variant 08 - Rafael Paste 2026-06-24 (`deck_613`) | spell-copy-control-variant | 121.4 | 86.1 | 32 | 100.0% | Spell-copy control shell that tries to trade resources, protect a window, then convert copied spells into a win. | land_role, removal_role, recursion_role |
| 6 | VARIANT Lorehold Variant 04 - Rafael Paste 2026-06-24 (`deck_609`) | battle-variant | 120.2 | 89.9 | 30 | 100.0% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | land_role, protection_role, recursion_role, low_land_count |
| 7 | VARIANT Lorehold Variant 11 - Rafael Paste 2026-06-24 (`deck_616`) | burn-dragon-control-variant | 117.7 | 87.6 | 29 | 85.7% | Burn/dragon-control shell that tries to survive long enough for high-impact threats and damage finishers. | graveyard_recursion, land_role, ramp_role, recursion_role, tutor_role, battle_rule_readiness, low_land_count |
| 8 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 116.6 | 83.0 | 33 | 100.0% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | wincon_role |
...
| 10 | VARIANT Lorehold Variant 06 - Rafael Paste 2026-06-24 (`deck_611`) | big-spells-variant | 108.1 | 79.5 | 34 | 100.0% | Big-spells shell that leans on Lorehold's miracle discount to cast expensive effects ahead of curve. | protection_window, removal_role, protection_role, recursion_role |
...
## 8. Runtime Lorehold Learned 19e93de3cca (`deck_6`)
