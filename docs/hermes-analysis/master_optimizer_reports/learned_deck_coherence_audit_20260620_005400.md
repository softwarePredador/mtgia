...
- Generated at: `2026-06-20T00:53:57.869651+00:00`
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| edhrec | 7 | 14 | 3 | 5 | 1 | 1 | 0 | 1 | 0 | 0 |
| hermes | 1 | 1 | 0 | 1 | 0 | 0 | 0 | 0 | 0 | 0 |
| pg_meta_decks | 52 | 158 | 18 | 52 | 0 | 0 | 9 | 4 | 8 | 0 |

## Manual Off-Color Review

| Commander | Source | Classification | Cards | Decision |
| --- | --- | --- | --- | --- |
| Inalla, Archmage Ritualist | learned_deck:126 | identity_bridge_misresolution | Vendetta | fix_card_identity_bridge_mapping |
| K-9, Mark I | learned_deck:116 | combined_commander_identity_not_modeled | K-9, Mark I, The Fourteenth Doctor | move_to_combined_commander_identity_modeling |
| Kinnan, Bonder Prodigy | learned_deck:3 | identity_bridge_misresolution | Endurance | fix_card_identity_bridge_mapping |
| Lumra, Bellow of the Woods | learned_deck:131 | identity_bridge_misresolution | Endurance | fix_card_identity_bridge_mapping |
| Rowan, Scion of War | learned_deck:114 | identity_bridge_misresolution | Vendetta | fix_card_identity_bridge_mapping |

## Off-Color Resolution Plan

- Status: `ready_for_review`
- DB mutations: `False`
- Apply requires explicit approval: `True`

| Commander | Source | Classification | Raw card | Quantity | Resolved as | Expected colors | Current colors | Decision |
| --- | --- | --- | --- | ---: | --- | --- | --- | --- |
| Inalla, Archmage Ritualist | learned_deck:126 | identity_bridge_misresolution | Vendetta | 1 | Vengeance | B | W | fix_card_identity_bridge_mapping |
| K-9, Mark I | learned_deck:116 | combined_commander_identity_not_modeled | K-9, Mark I | 1 | K-9, Mark I |  | U | move_to_combined_commander_identity_modeling |
| K-9, Mark I | learned_deck:116 | combined_commander_identity_not_modeled | The Fourteenth Doctor | 1 | The Fourteenth Doctor |  | G, R, U, W | move_to_combined_commander_identity_modeling |
| Kinnan, Bonder Prodigy | learned_deck:3 | identity_bridge_misresolution | Endurance | 1 | Endure | G | W | fix_card_identity_bridge_mapping |
| Lumra, Bellow of the Woods | learned_deck:131 | identity_bridge_misresolution | Endurance | 1 | Endure | G | W | fix_card_identity_bridge_mapping |
| Rowan, Scion of War | learned_deck:114 | identity_bridge_misresolution | Vendetta | 1 | Vengeance | B | W | fix_card_identity_bridge_mapping |
...
| K-9, Mark I | learned_deck:116 | combined_identity_manual_review | GRUW | K-9, Mark I, The Fourteenth Doctor |
