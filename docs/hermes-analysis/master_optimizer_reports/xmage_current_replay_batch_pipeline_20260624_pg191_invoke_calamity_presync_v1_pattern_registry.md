...
- `proposal_count`: `364`
- `pattern_count`: `45`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 260, "package_ready_unprepared": 1, "runtime_family_backlog": 24, "split_scope_backlog": 75}`
...
| --- | --- | --- | ---: | ---: | --- |
| `free_cast/free_cast/cast_up_to_two_instant_sorcery_hand_graveyard_total_mv_lte_6_exile_replacement_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### free_cast / free_cast / cast_up_to_two_instant_sorcery_hand_graveyard_total_mv_lte_6_exile_replacement_v1

- Pattern id: `xmage_pattern:246cefe69a732911bcc2`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Invoke Calamity)
- Subpatterns: `1`
