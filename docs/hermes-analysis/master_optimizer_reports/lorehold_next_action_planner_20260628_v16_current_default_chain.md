...
- Generated at: `2026-06-28T09:44:19Z`
...
| 6 | `resolve_inconclusive_package_exposures` | `diagnostic_low_exposure_recorded_no_strategy_block` | `battle_gate_evidence_quality` | Mana Vault | Arcane Signet | Some package gates reached deck-level results without proving that the added card was actually drawn, accessed, cast, activated, or otherwise used. |
...
- `inconclusive_low_exposure_is_not_card_proof`: A package with low added-card exposure cannot be promoted or rejected as card-level evidence until the added card is actually accessed or used.
