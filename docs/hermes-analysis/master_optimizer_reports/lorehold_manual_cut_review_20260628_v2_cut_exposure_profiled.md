...
- Generated at: `2026-06-28T08:20:22Z`
...
- Cut evidence status counts: `{"blocked_by_cut_safety": 8, "blocked_by_prior_rejection": 21, "measured_cut_exposure_needs_same_lane_benchmark": 2, "measured_high_cut_exposure": 7, "never_cut": 29, "same_lane_only": 2, "structural_dependency": 25}`
...
| Stroke of Midnight | `measured_cut_exposure_needs_same_lane_benchmark` | `manual_same_lane_only` | 61 | spot_removal | Replay profile measured 61 deduplicated exposures, so this is not a blind low-use cut.; Measured role is spot_removal.; Exposure signals: miracle_hit, paid_cast_exposure, spot_removal. |
