...
- `proposal_count`: `127`
- `pattern_count`: `20`
- `lane_counts`: `{"manual_mapper_backlog": 61, "split_scope_backlog": 66}`
...
- `card_counts_by_pattern_status`: `{"candidate_template_requires_review_tests": 13, "manual_model_observation_only": 61, "requires_subpattern_split_before_promotion": 53}`
