...
- `proposal_count`: `297`
- `pattern_count`: `19`
- `lane_counts`: `{"blocked_missing_xmage_source": 2, "manual_mapper_backlog": 268, "package_already_prepared": 1, "package_ready_unprepared": 1, "runtime_family_backlog": 3, "split_scope_backlog": 22}`
...
| `targeted_interaction/direct_damage/damage_target_attacking_or_blocking_creature_or_tapped_white_land_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
| `targeted_interaction/direct_damage/targeted_damage_variant_v1` | `split_scope_backlog` | `requires_subpattern_split_before_promotion` | 8 | 7 | Split by ability kind, target constraints, triggers, costs, and secondary effects before promotion. |
...
### targeted_interaction / direct_damage / damage_target_attacking_or_blocking_creature_or_tapped_white_land_v1

- Pattern id: `xmage_pattern:de9f92fb438dd4525c22`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Razorgrass Ambush // Razorgrass Field)
- Subpatterns: `1`
...
- Cards: `8` (Balefire Liege, Boros Reckoner, Eiganjo, Seat of the Empire, Firesong and Sunspeaker, Repercussion, Terror of the Peaks, Toralf, God of Fury // Toralf's Hammer, Valakut, the Molten Pinnacle)
- Subpatterns: `7`
