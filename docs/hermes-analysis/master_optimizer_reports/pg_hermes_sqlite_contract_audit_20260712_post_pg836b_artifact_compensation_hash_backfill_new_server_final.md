...
- Generated at: `2026-07-12T18:25:40.060153+00:00`
- Status: `pass`
...
| `sqlite_rows.card_oracle_cache` | `pass` | rows=8662 |
...
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=8662 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=8662 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=8662 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6749 pg_runtime_keys=9830 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=10520 |
