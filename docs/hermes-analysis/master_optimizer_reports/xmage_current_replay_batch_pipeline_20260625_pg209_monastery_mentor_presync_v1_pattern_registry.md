...
- `proposal_count`: `430`
- `pattern_count`: `43`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 333, "package_ready_unprepared": 1, "runtime_family_backlog": 18, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 15, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 10, "runtime_observation_requires_taxonomy": 1, "runtime_template_candidate_requires_executor_tests": 1}`
...
| --- | --- | --- | ---: | ---: | --- |
| `token_maker/token_maker/noncreature_spell_cast_create_1_1_white_monk_prowess_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### token_maker / token_maker / noncreature_spell_cast_create_1_1_white_monk_prowess_v1

- Pattern id: `xmage_pattern:bc345635f2a8c407b80a`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Monastery Mentor)
- Subpatterns: `1`
