...
- `proposal_count`: `385`
- `pattern_count`: `28`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 316, "package_already_prepared": 1, "package_ready_unprepared": 1, "runtime_family_backlog": 4, "split_scope_backlog": 59}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 3, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 316, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 49, "runtime_observation_requires_taxonomy": 1}`
...
| `damage_prevention_shield/damage_prevention_shield/activated_put_card_from_hand_on_top_library_prevent_next_damage_from_chosen_black_or_red_source_to_you_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 315 | 52 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### damage_prevention_shield / damage_prevention_shield / activated_put_card_from_hand_on_top_library_prevent_next_damage_from_chosen_black_or_red_source_to_you_v1

- Pattern id: `xmage_pattern:2924b9bcfb4ac61ed7cb`
