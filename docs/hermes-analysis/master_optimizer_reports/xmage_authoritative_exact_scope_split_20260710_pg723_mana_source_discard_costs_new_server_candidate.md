...
| `Izzet Keyrune` | `xmage_simple_mana_source_with_unmodeled_auxiliary` | `xmage_simple_tap_mana_source_permanent_v1` | `ramp_permanent` | `battle_rule_v1:397302a8d184a991cf7dc87dde6e2094` |
| `Network Terminal` | `xmage_simple_mana_source_with_unmodeled_auxiliary` | `xmage_simple_tap_mana_source_permanent_v1` | `ramp_permanent` | `battle_rule_v1:e86ddd864393b9f9383252deee30dc58` |
| `Skirge Familiar` | `xmage_simple_mana_source_permanent` | `xmage_simple_tap_mana_source_permanent_v1` | `ramp_permanent` | `battle_rule_v1:bca1b1499151165d4343361df4396b23` |
| `Starting Column` | `xmage_simple_mana_source_with_unmodeled_auxiliary` | `xmage_simple_tap_mana_source_permanent_v1` | `ramp_permanent` | `battle_rule_v1:3a94c90daa02788d3e091ac74885910d` |
