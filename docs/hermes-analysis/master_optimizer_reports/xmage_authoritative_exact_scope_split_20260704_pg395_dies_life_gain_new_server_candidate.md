...
- `mana_source_auxiliary_ability_not_supported`: `["Abzan Banner", "Aetheric Amplifier", "Agility Bobblehead", "All-Fates Scroll", "Altar of the Pantheon", "Ancient Cornucopia", "Arc Reactor", "Arcum's Astrolabe", "Arixmethes, Slumbering Isle", "Armored Scrapgorger", "Ashaya, Soul of the Wild", "Astral Cornucopia"]`
...
- `target_player_draw_spell_count_not_fixed`: `["Overflowing Insight"]`
