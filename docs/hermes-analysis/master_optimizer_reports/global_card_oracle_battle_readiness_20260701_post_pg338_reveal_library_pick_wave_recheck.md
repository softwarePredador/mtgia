...
- Generated at: `2026-07-01T23:36:45.895439+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4848 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3538 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2390 | 394 |
| `battle_family_mapper_required` | 30157 | 225 |
...
| `battle_family::recursion_or_bounce` | 510 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
