...
- Generated at: `2026-07-01T09:49:18.754653+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4231 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 2889 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1741 | 389 |
| `battle_family_mapper_required` | 30806 | 230 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7537 |
| `damage_or_life_total_change` | 4043 |
...
| `battle_family::manual_model_review` | 7537 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
| `battle_family::damage_or_life_total_change` | 4043 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Acceptable Losses` |
