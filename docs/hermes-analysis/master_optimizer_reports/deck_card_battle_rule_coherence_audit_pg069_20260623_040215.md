...
Generated at: `2026-06-23T04:02:57+00:00`
...
- `trusted_rule_without_oracle_hash`: `68`
- `generic_effect_without_model_scope`: `32`
- `no_trusted_executable_rule`: `26`
- `review_only_or_needs_review_rule`: `26`
- `no_active_battle_rule`: `7`

## Top 80 Actionable Cards
...
| `high` | `battle_critical` | 7051 | `Faithless Looting` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards` |
...
| `high` | `battle_critical` | 7051 | `Gamble` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
...
| `medium` | `battle_support` | 4153 | `Ruby Medallion` | 3 | 3 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_engine` |
...
| `medium` | `battle_support` | 4102 | `Lotus Petal` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_ritual` |
