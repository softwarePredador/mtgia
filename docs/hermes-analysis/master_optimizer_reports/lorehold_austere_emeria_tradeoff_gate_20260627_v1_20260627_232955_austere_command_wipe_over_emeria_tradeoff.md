...
| 2 |  | Lorehold synergy package: austere_command_wipe_over_emeria_tradeoff (`synergy_austere_command_wipe_over_emeria_tradeoff`) | synergy-package | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 3 | 7 | 0 | unattributed: events=7, restricted=7, tax=0 | none |
...
**Strategic event counts:** lorehold_cost_paid=23, lorehold_spell_cast=20, lorehold_upkeep_rummage=6, thor_cost_paid=1, thor_spell_cast=1, miracle_cast=3

**Lorehold attack restriction telemetry:** events=7, attackers_before=22, attackers_after=15, attackers_restricted=7, tax_paid=0, sources=unattributed: events=7, restricted=7, tax=0
