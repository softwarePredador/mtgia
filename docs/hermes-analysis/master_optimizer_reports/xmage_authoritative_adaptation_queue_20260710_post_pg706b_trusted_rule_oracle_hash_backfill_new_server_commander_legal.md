...
- Generated at: `2026-07-10T15:20:40+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24721 |
| `xmage_authoritative_source_count` | 24408 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24408 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24408 |
...
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1068 |
...
| `draw_cards::xmage_draw_card_variant_review_v1` | 557 |
| `removal_destroy::targeted_destroy_variant_v1` | 482 |
| `add_counters::targeted_add_counters_variant_v1` | 435 |
| `board_wipe::xmage_mass_removal_or_sacrifice_variant_review_v1` | 365 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11097 |
| `token_maker` | 2287 |
| `recursion` | 1792 |
| `draw_engine` | 1572 |
| `add_counters` | 1206 |
| `grant_protection_from_chosen_color` | 1074 |
| `direct_damage` | 758 |
| `life_gain` | 663 |
| `tutor` | 578 |
| `draw_cards` | 557 |
...
| --- | ---: |
| `targeting` | 13077 |
| `triggered_ability` | 11428 |
| `static_ability` | 5302 |
| `activated_ability` | 5109 |
| `counter` | 3718 |
| `condition` | 3255 |
| `token` | 2334 |
| `draw` | 2055 |
