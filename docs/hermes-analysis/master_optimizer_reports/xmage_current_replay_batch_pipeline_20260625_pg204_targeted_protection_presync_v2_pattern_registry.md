...
- `proposal_count`: `438`
- `pattern_count`: `42`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 340, "package_ready_unprepared": 2, "runtime_family_backlog": 20, "split_scope_backlog": 72}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 10, "runtime_template_candidate_requires_executor_tests": 2}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 340, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `targeted_protection/grant_protection_from_chosen_color/target_creature_you_control_protection_from_chosen_color_until_eot_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 2 | 1 | Generate a PG package before any runtime work. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 339 | 54 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### targeted_protection / grant_protection_from_chosen_color / target_creature_you_control_protection_from_chosen_color_until_eot_v1

- Pattern id: `xmage_pattern:179a1725a510715cc516`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `2` (Gods Willing, Sejiri Shelter // Sejiri Glacier)
- Subpatterns: `1`
