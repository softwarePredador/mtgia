...
- Generated at: `2026-07-10T20:14:37+00:00`
...
| `xmage_authoritative_source_count` | 24350 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24350 |
| `manual_semantic_decision_units_remaining` | 313 |
| `authoritative_source_coverage_ratio` | 0.9873 |
| `adapter_work_unit_count` | 11304 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24350 |
...
| `draw_engine::xmage_draw_card_variant_review_v1` | 1572 |
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1065 |
| `add_counters::source_add_counters_variant_v1` | 771 |
| `direct_damage::targeted_damage_variant_v1` | 753 |
| `life_gain::xmage_life_gain_variant_review_v1` | 653 |
| `tutor::xmage_library_search_variant_review_v1` | 567 |
| `draw_cards::xmage_draw_card_variant_review_v1` | 552 |
| `removal_destroy::targeted_destroy_variant_v1` | 482 |
| `add_counters::targeted_add_counters_variant_v1` | 426 |
| `board_wipe::xmage_mass_removal_or_sacrifice_variant_review_v1` | 358 |
| `parser_gap::unknown_superclass::no_signal` | 313 |
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 268 |
| `free_cast::xmage_cast_or_play_from_alternate_zone_variant_review_v1` | 245 |
| `bounce::targeted_return_to_hand_variant_v1` | 220 |
| `untap_target::xmage_targeted_untap_variant_review_v1` | 208 |
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 126 |
| `removal_exile::targeted_exile_variant_v1` | 122 |
| `counter_spell::counter_target_stack_object_variant_v1` | 120 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11086 |
| `token_maker` | 2277 |
| `recursion` | 1792 |
| `draw_engine` | 1572 |
| `add_counters` | 1197 |
| `grant_protection_from_chosen_color` | 1071 |
| `direct_damage` | 758 |
| `life_gain` | 653 |
| `tutor` | 578 |
| `draw_cards` | 552 |
...
| --- | ---: |
| `targeting` | 13062 |
| `triggered_ability` | 11394 |
| `static_ability` | 5302 |
| `activated_ability` | 5108 |
| `counter` | 3709 |
| `condition` | 3255 |
| `token` | 2324 |
| `draw` | 2050 |
