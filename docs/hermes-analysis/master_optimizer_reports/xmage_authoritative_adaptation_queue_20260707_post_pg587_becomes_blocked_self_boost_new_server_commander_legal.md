...
- Generated at: `2026-07-07T02:44:29+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 25263 |
| `xmage_authoritative_source_count` | 24949 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24949 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.9876 |
| `adapter_work_unit_count` | 11341 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24949 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11273 |
| `token_maker` | 2306 |
| `recursion` | 1795 |
| `draw_engine` | 1588 |
| `add_counters` | 1211 |
...
| --- | ---: |
| `targeting` | 13420 |
| `triggered_ability` | 11497 |
| `static_ability` | 5375 |
| `activated_ability` | 5196 |
| `counter` | 3768 |
| `condition` | 3260 |
| `token` | 2354 |
| `draw` | 2083 |
