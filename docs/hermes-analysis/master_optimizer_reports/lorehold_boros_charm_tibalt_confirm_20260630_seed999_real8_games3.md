...
- generated_at: `2026-06-30T03:28:52Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_boros_charm_tibalt_confirm_20260630_seed999_real8_games3_game_checkpoint.json`
...
| 2 | 1 | Lorehold 607 + Boros Charm over Tibalt Trickery v1 (`candidate_607_boros_charm_tibalts_trickery_v1`) | 607-boros-charm-tibalts-trickery | 24 | 5 | 19 | 0 | 20.83% | 18.60 | 16 | 6 | 6 | 0 | 0 | 0 | 0 | 16 | 0 | 0 | none | recursion_role, tutor_role |
...
| Opponent | W | L | S | WR | Avg Win Turn | Reasons |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Thrasios, Triton Hero #76 (real) | 1 | 2 | 0 | 33.33% | 20.00 | approach=1 |
| Rograkh, Son of Rohgahh #95 (real) | 1 | 2 | 0 | 33.33% | 16.00 | elimination=1 |
...
| Kinnan, Bonder Prodigy #72 (real) | 1 | 2 | 0 | 33.33% | 21.00 | elimination=1 |
| Kefka, Court Mage #112 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |
| Kraum, Ludevic's Opus #81 (real) | 2 | 1 | 0 | 66.67% | 18.00 | approach=1, elimination=1 |

**Strategic event counts:** discard_to_top_replacement=26, lorehold_cost_paid=216, lorehold_rummage_discard_to_top=23, lorehold_spell_cast=179, lorehold_spell_rummage=9, lorehold_spell_rummage_discard_to_top=3, lorehold_upkeep_rummage=65, miracle_cast=41, static_cost_reduction_casts=21, static_cost_reduction_total=49, topdeck_manipulation_activated=26
