...
- generated_at: `2026-06-28T21:57:19Z`
...
- runtime_rule_gap: `584`
- xmage_mapping_gap: `1324`

## Action Queue

1. `critical` `runtime_rule_gap` `coherence_critical_high_findings` count=580 next=`prioritize_cards_with_no_active_or_no_trusted_rules_in_current_deck_scope`
   - coherence audit has critical=1, high=392 [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/deck_card_battle_rule_coherence_audit_current_explicit_20260628_123905.json]
     ...
     top_lorehold_runtime_missing: `Unstable Glyphbridge // Sandswirl Wanderglyph, Toralf, God of Fury // Toralf's Hammer, Single Combat, Screaming Nemesis, Sawhorn Nemesis`
