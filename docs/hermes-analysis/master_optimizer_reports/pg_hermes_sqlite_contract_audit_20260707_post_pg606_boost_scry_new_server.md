...
- Generated at: `2026-07-07T09:27:46.999125+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=6673 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=6673 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=7783 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=7783 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=7783 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=5761 pg_runtime_keys=8273 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9436 |
...
| `pg_rows.deck_cards` | `pass` | rows=56074 |
