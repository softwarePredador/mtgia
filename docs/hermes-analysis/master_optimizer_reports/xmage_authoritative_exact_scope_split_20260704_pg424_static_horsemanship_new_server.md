...
| `Shu Cavalry` | `xmage_static_self_horsemanship_creature` | `xmage_static_self_horsemanship_creature_v1` | `creature` | `battle_rule_v1:7d208ac6a5625631cd5f858097f64cdd` |
| `Shu Elite Companions` | `xmage_static_self_horsemanship_creature` | `xmage_static_self_horsemanship_creature_v1` | `creature` | `battle_rule_v1:7d208ac6a5625631cd5f858097f64cdd` |
| `Wei Elite Companions` | `xmage_static_self_horsemanship_creature` | `xmage_static_self_horsemanship_creature_v1` | `creature` | `battle_rule_v1:7d208ac6a5625631cd5f858097f64cdd` |
| `Wei Scout` | `xmage_static_self_horsemanship_creature` | `xmage_static_self_horsemanship_creature_v1` | `creature` | `battle_rule_v1:7d208ac6a5625631cd5f858097f64cdd` |
| `Wei Strike Force` | `xmage_static_self_horsemanship_creature` | `xmage_static_self_horsemanship_creature_v1` | `creature` | `battle_rule_v1:7d208ac6a5625631cd5f858097f64cdd` |
| `Wu Elite Cavalry` | `xmage_static_self_horsemanship_creature` | `xmage_static_self_horsemanship_creature_v1` | `creature` | `battle_rule_v1:7d208ac6a5625631cd5f858097f64cdd` |
| `Wu Light Cavalry` | `xmage_static_self_horsemanship_creature` | `xmage_static_self_horsemanship_creature_v1` | `creature` | `battle_rule_v1:7d208ac6a5625631cd5f858097f64cdd` |
