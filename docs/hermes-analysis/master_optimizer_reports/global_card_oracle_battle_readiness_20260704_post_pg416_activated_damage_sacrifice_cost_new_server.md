...
- Generated at: `2026-07-04T17:05:48.767746+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5468 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4204 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4382 | 265 |
| `battle_family_mapper_required` | 29491 | 98 |
...
| `battle_family::tutor_search_library` | 783 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A.I.M. Scientists`, `Aang's Journey`, `Absorb Vis`, `Abzan Monument`, `Academy Rector`, `Aerial Surveyor`, `Agency Outfitter`, `Ainok Guide`, `Ajani's Aid`, `Alabaster Host Intercessor` |
