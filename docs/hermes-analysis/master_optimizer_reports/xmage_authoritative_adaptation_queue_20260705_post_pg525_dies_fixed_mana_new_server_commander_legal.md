...
- Generated at: `2026-07-05T19:24:16+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 25955 |
| `xmage_authoritative_source_count` | 25641 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 25641 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 25641 |
...
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 332 |
| `parser_gap::unknown_superclass::no_signal` | 314 |
| `untap_target::xmage_targeted_untap_variant_review_v1` | 260 |
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 248 |
...
| `token_maker::xmage_signature::CreateTokenEffect::no_ability_class::no_target_class::no_condition_class::token` | 32 |

## Top Effects

| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11568 |
| `token_maker` | 2386 |
| `recursion` | 1799 |
| `draw_engine` | 1593 |
| `add_counters` | 1211 |
...
| --- | ---: |
| `targeting` | 13628 |
| `triggered_ability` | 11692 |
| `static_ability` | 5508 |
| `activated_ability` | 5417 |
| `counter` | 3800 |
| `condition` | 3287 |
| `token` | 2438 |
| `draw` | 2113 |
