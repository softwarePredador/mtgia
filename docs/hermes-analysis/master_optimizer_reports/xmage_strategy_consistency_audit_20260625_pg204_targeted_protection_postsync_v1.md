...
| `benchmark.ranking_first` | `pass` | {"cards_per_work_unit": 20.0, "decision_score": 72.73, "strategy_id": "exact_scope_cluster_first", "verdict": "use_as_next_modeling_lane"} |
...
| `docs/hermes-analysis/master_optimizer_reports/xmage_pattern_registry_20260624_expanded_608_619_real_v1_schema_proposal.sql` | `pass` | contains=['CREATE TABLE IF NOT EXISTS public.xmage_pattern_registry', "promotion_status <> 'shadow_only'", 'can_execute_in_battle = FALSE', 'can_auto_promote_to_card_battle_rules = FALSE'] |
