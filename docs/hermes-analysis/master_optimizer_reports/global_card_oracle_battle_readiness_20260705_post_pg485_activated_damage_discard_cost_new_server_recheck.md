...
- Generated at: `2026-07-05T05:58:42.016691+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5774 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4517 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4695 | 265 |
| `battle_family_mapper_required` | 29178 | 98 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7045 |
| `triggered_or_static_ability` | 3883 |
| `damage_or_life_total_change` | 3829 |
| `token_creation` | 3609 |
...
| `battle_family::manual_model_review` | 7045 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3829 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
