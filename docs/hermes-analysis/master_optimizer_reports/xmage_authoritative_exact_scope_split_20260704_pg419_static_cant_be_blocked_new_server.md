...
| `Metathran Soldier` | `xmage_static_self_cant_be_blocked_creature` | `xmage_static_self_cant_be_blocked_creature_v1` | `creature` | `battle_rule_v1:64d421fc72d2c17b726ec9a68c4e0039` |
| `Mist-Cloaked Herald` | `xmage_static_self_cant_be_blocked_creature` | `xmage_static_self_cant_be_blocked_creature_v1` | `creature` | `battle_rule_v1:64d421fc72d2c17b726ec9a68c4e0039` |
| `Phantom Ninja` | `xmage_static_self_cant_be_blocked_creature` | `xmage_static_self_cant_be_blocked_creature_v1` | `creature` | `battle_rule_v1:64d421fc72d2c17b726ec9a68c4e0039` |
| `Phantom Warrior` | `xmage_static_self_cant_be_blocked_creature` | `xmage_static_self_cant_be_blocked_creature_v1` | `creature` | `battle_rule_v1:64d421fc72d2c17b726ec9a68c4e0039` |
| `Slither Blade` | `xmage_static_self_cant_be_blocked_creature` | `xmage_static_self_cant_be_blocked_creature_v1` | `creature` | `battle_rule_v1:64d421fc72d2c17b726ec9a68c4e0039` |
| `Talas Warrior` | `xmage_static_self_cant_be_blocked_creature` | `xmage_static_self_cant_be_blocked_creature_v1` | `creature` | `battle_rule_v1:64d421fc72d2c17b726ec9a68c4e0039` |
| `Tidal Kraken` | `xmage_static_self_cant_be_blocked_creature` | `xmage_static_self_cant_be_blocked_creature_v1` | `creature` | `battle_rule_v1:64d421fc72d2c17b726ec9a68c4e0039` |
| `Triton Shorestalker` | `xmage_static_self_cant_be_blocked_creature` | `xmage_static_self_cant_be_blocked_creature_v1` | `creature` | `battle_rule_v1:64d421fc72d2c17b726ec9a68c4e0039` |
