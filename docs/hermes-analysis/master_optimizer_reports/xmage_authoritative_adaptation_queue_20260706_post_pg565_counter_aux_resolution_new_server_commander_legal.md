...
- Generated at: `2026-07-06T12:14:19+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 25412 |
| `xmage_authoritative_source_count` | 25098 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 25098 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.9876 |
| `adapter_work_unit_count` | 11343 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 25098 |
...
| `life_gain::xmage_life_gain_variant_review_v1` | 689 |
...
| `ramp_permanent::xmage_creature_mana_source_variant_review_v1` | 284 |
...
| `ramp_permanent::xmage_artifact_mana_source_variant_review_v1` | 148 |
| `counter_spell::counter_target_stack_object_variant_v1` | 142 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11316 |
| `token_maker` | 2306 |
| `recursion` | 1799 |
| `draw_engine` | 1593 |
| `add_counters` | 1211 |
...
| --- | ---: |
| `targeting` | 13495 |
| `triggered_ability` | 11550 |
| `static_ability` | 5384 |
| `activated_ability` | 5228 |
| `counter` | 3773 |
| `condition` | 3262 |
| `token` | 2354 |
| `draw` | 2100 |
