...
- Generated at: `2026-07-01T16:47:19+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 30270 |
| `xmage_authoritative_source_count` | 27334 |
| `xmage_missing_source_exception_count` | 2936 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 27334 |
| `manual_semantic_decision_units_remaining` | 2936 |
| `authoritative_source_coverage_ratio` | 0.903 |
...
| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 27334 |
...
| `draw_engine::xmage_draw_card_variant_review_v1` | 1673 |
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1169 |
| `direct_damage::targeted_damage_variant_v1` | 935 |
| `add_counters::source_add_counters_variant_v1` | 803 |
| `life_gain::xmage_life_gain_variant_review_v1` | 755 |
| `draw_cards::xmage_draw_card_variant_review_v1` | 682 |
| `removal_destroy::targeted_destroy_variant_v1` | 637 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 12103 |
| `unparsed` | 2936 |
| `token_maker` | 2471 |
| `recursion` | 1995 |
| `draw_engine` | 1673 |
...
| --- | ---: |
| `targeting` | 14391 |
| `triggered_ability` | 12093 |
| `activated_ability` | 5790 |
| `static_ability` | 5653 |
| `counter` | 3919 |
| `condition` | 3326 |
| `token` | 2523 |
