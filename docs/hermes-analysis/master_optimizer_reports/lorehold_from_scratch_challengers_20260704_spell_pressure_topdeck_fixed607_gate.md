...
- generated_at: `2026-07-04T22:44:19Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_from_scratch_challengers_20260704_spell_pressure_topdeck_fixed607_gate_game_checkpoint.json`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | 2 | Lorehold From-Scratch Spell Pressure Topdeck v1 (`challenger_lorehold_spell_pressure_topdeck_v1`) | from-scratch-spell-pressure-topdeck | 4 | 1 | 3 | 0 | 25.00% | 17.00 | 1 | 1 | 1 | 0 | 0 | 0 | 0 | 1 | 0 | 0 | none | recursion_role, tutor_role |
...
### 1. Lorehold From-Scratch Spell Pressure Topdeck v1 (`challenger_lorehold_spell_pressure_topdeck_v1`)

- objective: Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains.
- result: `1W/3L/0S`, WR `25.00%`
- construction_valid: `True`
- deck shape: size `100`, lands `34`, ramp `17`, removal `15`

| Opponent | W | L | S | WR | Avg Win Turn | Reasons |
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Fixed Lorehold deck 607 | 0 | 1 | 0 | 0.00% | 0.00 |  |
| Vivi Ornitier #99 (real) | 0 | 1 | 0 | 0.00% | 0.00 |  |
| Sisay, Weatherlight Captain #61 (real) | 1 | 0 | 0 | 100.00% | 17.00 | elimination=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 1 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** discard_to_top_replacement=12, lorehold_cost_paid=33, lorehold_rummage_discard_to_top=12, lorehold_spell_cast=29, lorehold_upkeep_rummage=12, miracle_cast=5, scarlet_static_cost_reduction_casts=1, scarlet_static_cost_reduction_total=2, static_cost_reduction_casts=1, static_cost_reduction_total=2, topdeck_manipulation_activated=8
