...
- generated_at: `2026-06-27T17:25:52Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: core_challenge_dance_over_storm (`synergy_core_challenge_dance_over_storm`) | synergy-package | 9 | 3 | 6 | 0 | 33.33% | 14.33 | 6 | 4 | 1 | 1 | 1 | 0 | 7 | none |
...
| Winota, Joiner of Forces #39 (real) | 2 | 1 | 0 | 66.67% | 12.50 | elimination=2 |

**Strategic event counts:** lorehold_cost_paid=109, lorehold_spell_cast=88, lorehold_upkeep_rummage=31, miracle_cast=24, topdeck_manipulation_activated=24, thor_cost_paid=1, thor_spell_cast=1, squee_to_graveyard=2, graveyard_upkeep_return_self_to_hand=1, squee_upkeep_return=1, squee_return_after_known_graveyard_entry=1, lorehold_spell_rummage=7
