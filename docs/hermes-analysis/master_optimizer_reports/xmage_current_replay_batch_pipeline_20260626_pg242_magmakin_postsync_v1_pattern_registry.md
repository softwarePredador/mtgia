...
- `proposal_count`: `383`
- `pattern_count`: `27`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 315, "package_already_prepared": 1, "runtime_family_backlog": 4, "split_scope_backlog": 59}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 3, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 315, "requires_subpattern_split_before_promotion": 49, "runtime_observation_requires_taxonomy": 1}`
