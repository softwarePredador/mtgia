...
- generated_at: `2026-06-28T05:02:15Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_failure_access_package_gate_20260628_seed20260625_penance_runtime_v1_penance_runtime_topdeck_cut_promise_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: penance_runtime_topdeck_cut_promise (`synergy_penance_runtime_topdeck_cut_promise`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 22.00 | 2 | 1 | 0 | 2 | 2 | 2 | 0 | 2 | 0 | 0 | none | none |
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Vivi Ornitier #99 (real) | 0 | 1 | 0 | 0.00% | 0.00 |  |
| Sisay, Weatherlight Captain #61 (real) | 1 | 0 | 0 | 100.00% | 22.00 | elimination=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 1 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** graveyard_upkeep_return_self_to_hand=2, lorehold_cost_paid=31, lorehold_rummage_discards_squee=2, lorehold_spell_cast=25, lorehold_upkeep_rummage=13, miracle_cast=3, squee_return_after_known_graveyard_entry=2, squee_to_graveyard=4, squee_upkeep_return=2, thor_cost_paid=1, thor_spell_cast=1, topdeck_manipulation_activated=2
