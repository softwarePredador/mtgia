...
- Generated at: `2026-07-07T15:55:17.339466+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6955 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5750 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5919 | 271 |
| `battle_family_mapper_required` | 27954 | 92 |
...
| `battle_family::manual_model_review` | 6576 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3726 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::targeted_removal` | 941 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aftershock`, `Against All Odds`, `Agate Assault`, `Agent of Erebos` |
