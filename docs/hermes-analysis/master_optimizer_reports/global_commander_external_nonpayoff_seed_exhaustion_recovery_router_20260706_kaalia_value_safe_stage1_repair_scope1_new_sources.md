...
- generated_at: `2026-07-06T02:21:00.872353+00:00`
...
| --- | --- | ---: | ---: | ---: | ---: | --- |
| `haste_protection_silence` | `seed_exhaustion_role_needs_broader_external_seed_research` | 8 | 0 | 0 | 0 | `expand_external_nonpayoff_source_candidate_pool_for_exhausted_role` |
| `mana_acceleration` | `seed_exhaustion_role_needs_broader_external_seed_research` | 7 | 0 | 0 | 0 | `expand_external_nonpayoff_source_candidate_pool_for_exhausted_role` |
