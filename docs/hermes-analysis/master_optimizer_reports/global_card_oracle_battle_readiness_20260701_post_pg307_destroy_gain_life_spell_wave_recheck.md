...
- Generated at: `2026-07-01T13:14:31.498560+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4478 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3148 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2000 | 389 |
| `battle_family_mapper_required` | 30547 | 230 |
...
| `battle_family::targeted_removal` | 1122 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Acid Web Spider`, `Acidic Slime`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock` |
