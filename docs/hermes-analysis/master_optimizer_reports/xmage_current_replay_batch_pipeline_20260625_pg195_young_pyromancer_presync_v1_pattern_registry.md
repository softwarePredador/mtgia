...
- `proposal_count`: `448`
- `pattern_count`: `44`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 347, "package_ready_unprepared": 1, "runtime_family_backlog": 22, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 18, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 10, "runtime_template_candidate_requires_executor_tests": 2}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 18, "manual_model_observation_only": 347, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 64, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `token_maker/token_maker/instant_sorcery_cast_create_1_1_red_elemental_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `targeted_interaction/draw_cards/source_controller_draw_variant_v1` | `split_scope_backlog` | `requires_subpattern_split_before_promotion` | 15 | 5 | Split by ability kind, target constraints, triggers, costs, and secondary effects before promotion. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 346 | 54 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### token_maker / token_maker / instant_sorcery_cast_create_1_1_red_elemental_v1

- Pattern id: `xmage_pattern:d8d574ccca7faf69e7e5`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Young Pyromancer)
- Subpatterns: `1`
...
- Lane: `split_scope_backlog`
- Status: `requires_subpattern_split_before_promotion`
- Cards: `15` (Arcane Denial, Archivist of Oghma, Bedlam Reveler, Blood Sun, Kefka, Court Mage // Kefka, Ruler of Ruin, Morbid Opportunist, Phyrexian Arena, Psychic Frog, Puresteel Paladin, Solemn Simulacrum)
- Subpatterns: `5`
- Required evidence: `["subpattern split", "focused ManaLoom tests per subpattern", "package generation only for exact supported subpatterns"]`
