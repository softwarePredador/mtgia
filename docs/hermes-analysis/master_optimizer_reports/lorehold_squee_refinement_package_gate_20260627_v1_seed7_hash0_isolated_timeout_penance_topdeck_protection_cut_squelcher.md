...
- generated_at: `2026-06-27T16:10:01Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 4 | 1 | 0 | 0 | 0 | 0 | 9 | wincon_role |
| 2 |  | Lorehold synergy package: penance_topdeck_protection_cut_squelcher (`synergy_penance_topdeck_protection_cut_squelcher`) | synergy-package | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 4 | 2 | 0 | 0 | 0 | 0 | 9 | none |
...
### 2. Lorehold synergy package: penance_topdeck_protection_cut_squelcher (`synergy_penance_topdeck_protection_cut_squelcher`)
...
**Strategic event counts:** lorehold_cost_paid=77, lorehold_spell_cast=63, lorehold_upkeep_rummage=36, lorehold_spell_rummage=2, miracle_cast=10, topdeck_manipulation_activated=7
