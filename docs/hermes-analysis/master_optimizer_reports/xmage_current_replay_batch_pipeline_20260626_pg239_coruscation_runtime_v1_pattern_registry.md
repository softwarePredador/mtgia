...
- `proposal_count`: `391`
- `pattern_count`: `30`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 318, "package_already_prepared": 1, "package_ready_unprepared": 5, "runtime_family_backlog": 4, "split_scope_backlog": 59}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 3, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 318, "ready_for_pg_package_generation": 5, "requires_subpattern_split_before_promotion": 49, "runtime_observation_requires_taxonomy": 1}`
...
| `spell_cast_damage_engine/creature/noncreature_spell_cast_damage_each_opponent_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 3 | 3 | Generate a PG package before any runtime work. |
| `spell_cast_damage_engine/passive/instant_sorcery_cast_damage_each_opponent_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
| `spell_cast_damage_engine/creature/spell_cast_damage_each_opponent_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### spell_cast_damage_engine / creature / noncreature_spell_cast_damage_each_opponent_v1

- Pattern id: `xmage_pattern:bd9b704dbf6c469487f1`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `3` (Coruscation Mage, Longshot, Rebel Bowman, Vivi Ornitier)
- Subpatterns: `3`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`

### spell_cast_damage_engine / passive / instant_sorcery_cast_damage_each_opponent_v1

- Pattern id: `xmage_pattern:6a1e5bafe6694875bacc`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Fiery Inscription)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`

### spell_cast_damage_engine / creature / spell_cast_damage_each_opponent_v1

- Pattern id: `xmage_pattern:ccd2ec0e3c5fa4d1bccf`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Guttersnipe)
- Subpatterns: `1`
