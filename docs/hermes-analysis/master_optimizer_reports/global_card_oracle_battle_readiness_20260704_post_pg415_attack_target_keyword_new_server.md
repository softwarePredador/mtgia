...
- Generated at: `2026-07-04T16:45:28.784746+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5454 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4190 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4368 | 265 |
| `battle_family_mapper_required` | 29505 | 98 |
...
| `damage_or_life_total_change` | 3856 |
| `token_creation` | 3609 |
...
| `battle_family::damage_or_life_total_change` | 3856 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
