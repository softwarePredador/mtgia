...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pg030_boros_charm_battle_rule_20260622_193818') IS NULL THEN
    RAISE EXCEPTION 'PG030 rollback backup table is missing';
  END IF;
END $$;
...
WHERE normalized_name = 'boros charm'
  AND (
    ...
    OR logical_rule_key IN (
      ...
      FROM manaloom_deploy_audit.pg030_boros_charm_battle_rule_20260622_193818
...
SELECT
  'pg030_rollback_result' AS check_name,
  card_name,
  logical_rule_key,
  effect_json,
  source,
