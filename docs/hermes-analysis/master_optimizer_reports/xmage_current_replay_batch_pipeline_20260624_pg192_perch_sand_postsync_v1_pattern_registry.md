...
- `proposal_count`: `361`
- `pattern_count`: `42`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 260, "runtime_family_backlog": 22, "split_scope_backlog": 75}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 18, "manual_model_observation_only": 260, "requires_subpattern_split_before_promotion": 66, "runtime_template_candidate_requires_executor_tests": 4}`
