...
- generated_at: `2026-06-28T19:42:22Z`
...
| --- | --- | --- | --- | --- | --- |
| `candidate_607_birgi_v1` | P1 | `needs_more_evidence_candidate_unobserved` | `birgi_v1` | candidate card was not accessed in the gate; do not score or promote this swap: Birgi, God of Storytelling // Harnfel, Horn of Bounty | `rerun_with_forced_focus_access_or_larger_natural_sample_until_candidate_accessed` |
