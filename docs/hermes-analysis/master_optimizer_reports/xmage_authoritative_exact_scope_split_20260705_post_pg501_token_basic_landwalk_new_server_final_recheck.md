...
- `dies_token_oracle_not_simple`: `["Deathknell Berserker", "Tuktuk the Explorer"]`
...
- `token_description_keyword_not_supported`: `["Birthing Boughs", "Carrier Thrall", "Carrion Call", "Dance with Devils", "Deathpact Angel", "Devils' Playground", "Dragon Egg", "Dread Drone", "Emrakul's Hatcher", "Errand of Duty", "Goblin Wizardry", "Goldmeadow Lookout"]`
