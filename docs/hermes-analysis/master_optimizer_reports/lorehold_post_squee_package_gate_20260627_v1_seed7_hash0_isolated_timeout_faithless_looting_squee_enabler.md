...
- generated_at: `2026-06-27T15:56:38Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: faithless_looting_squee_enabler (`synergy_faithless_looting_squee_enabler`) | synergy-package | 9 | 1 | 8 | 0 | 11.11% | 8.00 | 4 | 3 | 0 | 0 | 0 | 0 | 5 | none |
...
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 8.00 | approach=1 |

**Strategic event counts:** lorehold_cost_paid=69, lorehold_spell_cast=64, lorehold_upkeep_rummage=26, lorehold_spell_rummage=3, topdeck_manipulation_activated=6, miracle_cast=6
