...
- Generated at: `2026-07-04T16:04:23.619413+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5411 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4147 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4325 | 265 |
| `battle_family_mapper_required` | 29548 | 98 |
...
| `battle_family::protection_prevention` | 542 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abbey Gargoyles`, `Absolute Grace`, `Absolute Law`, `Adept Watershaper`, `Aegis of the Gods`, `Agent Frank Horrigan`, `Agent of the Shadow Thieves`, `Airtight Alibi`, `Akroma's Memorial`, `Akroma, Angel of Fury` |
