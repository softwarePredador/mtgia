...
- Generated at: `2026-07-06T12:10:41.522039+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6583 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5360 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5538 | 269 |
| `battle_family_mapper_required` | 28335 | 94 |
...
| `counterspell_or_stack_interaction` | 366 |
...
| `battle_family::counterspell_or_stack_interaction` | 366 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abjure`, `Abstruse Interference`, `Access Denied`, `Admiral's Order`, `Adric, Mathematical Genius`, `Amazing Acrobatics`, `Anticognition`, `Archmage's Charm`, `Arenson's Aura`, `Artistic Refusal` |
