...
- `review_only_or_needs_review_rule`: `53`
- `trusted_rule_without_oracle_hash`: `26`
...
| --- | --- | ---: | --- | ---: | ---: | --- | --- |
| `high` | `battle_critical` | 7070 | `Dragon's Approach` | 1 | 20 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `dragons_approach`, `draw_cards` |
...
| `high` | `support_or_passive` | 7051 | `Thrumming Stone` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `ripple_engine` |
