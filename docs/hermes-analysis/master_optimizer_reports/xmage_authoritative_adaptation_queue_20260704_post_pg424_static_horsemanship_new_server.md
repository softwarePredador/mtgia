...
- Generated at: `2026-07-04T19:25:41+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 26406 |
| `xmage_authoritative_source_count` | 26092 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 26092 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.9881 |
| `adapter_work_unit_count` | 11412 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 26092 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11727 |
| `token_maker` | 2411 |
| `recursion` | 1799 |
| `draw_engine` | 1610 |
| `add_counters` | 1254 |
