...
- Generated at: `2026-07-02T07:28:27.213161+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4953 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3657 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2509 | 183 |
| `battle_family_mapper_required` | 30038 | 100 |
...
| `graveyard_recursion` | 1913 |
| `targeted_removal` | 1063 |
...
| `battle_family::graveyard_recursion` | 1913 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Abhorrent Oculus`, `Abomination of Llanowar`, `Aboshan's Desire` |
| `battle_family::targeted_removal` | 1063 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Acid Web Spider`, `Acidic Slime`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock` |
...
| `battle_family::recursion_or_bounce` | 502 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
