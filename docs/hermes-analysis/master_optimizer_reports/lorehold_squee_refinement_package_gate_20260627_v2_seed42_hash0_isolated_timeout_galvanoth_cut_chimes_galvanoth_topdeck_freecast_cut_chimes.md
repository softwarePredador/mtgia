...
| 2 |  | Lorehold synergy package: galvanoth_topdeck_freecast_cut_chimes (`synergy_galvanoth_topdeck_freecast_cut_chimes`) | synergy-package | 9 | 3 | 6 | 0 | 33.33% | 18.33 | 5 | 5 | 2 | 2 | 2 | 0 | 7 | none |
...
### 2. Lorehold synergy package: galvanoth_topdeck_freecast_cut_chimes (`synergy_galvanoth_topdeck_freecast_cut_chimes`)
...
**Strategic event counts:** lorehold_cost_paid=114, lorehold_spell_cast=85, lorehold_upkeep_rummage=46, miracle_cast=22, lorehold_spell_rummage=23, topdeck_manipulation_activated=24, squee_to_graveyard=4, graveyard_upkeep_return_self_to_hand=3, squee_upkeep_return=3, squee_return_after_known_graveyard_entry=3
