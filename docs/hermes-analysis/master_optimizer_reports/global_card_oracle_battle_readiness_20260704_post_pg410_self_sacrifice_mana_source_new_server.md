...
- Generated at: `2026-07-04T14:52:35.401870+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5385 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4121 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4299 | 265 |
| `battle_family_mapper_required` | 29574 | 98 |
...
| `damage_or_life_total_change` | 3864 |
| `token_creation` | 3609 |
...
| `battle_family::damage_or_life_total_change` | 3864 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::recursion_or_bounce` | 489 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
