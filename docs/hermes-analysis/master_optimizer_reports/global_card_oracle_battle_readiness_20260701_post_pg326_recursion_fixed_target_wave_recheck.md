...
- Generated at: `2026-07-01T19:58:09.251160+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4796 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3483 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2335 | 394 |
| `battle_family_mapper_required` | 30212 | 225 |
...
| `battle_family::recursion_or_bounce` | 531 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Aid the Fallen` |
