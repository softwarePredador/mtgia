...
- Generated at: `2026-07-07T06:57:06.893735+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6830 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5615 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5793 | 270 |
| `battle_family_mapper_required` | 28080 | 93 |
...
| `battle_family::manual_model_review` | 6634 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
