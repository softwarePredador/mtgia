...
- `proposal_count`: `450`
- `pattern_count`: `45`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 347, "package_ready_unprepared": 1, "runtime_family_backlog": 23, "split_scope_backlog": 75}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 19, "manual_model_observation_only": 347, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 65, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `creature/creature/sun_titan_etb_attack_return_permanent_mv_lte_3_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### creature / creature / sun_titan_etb_attack_return_permanent_mv_lte_3_v1

- Pattern id: `xmage_pattern:045d247cff6f3fd6a12b`
