...
- generated_at: `2026-06-28T18:25:57Z`
...
- evidence_gap: `10`
- postgres_sync_gap: `1`
- runtime_or_test_failure: `5`
- runtime_rule_gap: `47`
- xmage_mapping_gap: `22`

## Action Queue

1. `critical` `runtime_rule_gap` `coherence_critical_high_findings` count=45 next=`prioritize_cards_with_no_active_or_no_trusted_rules_in_current_deck_scope`
   - coherence audit has critical=1, high=392 [docs/hermes-analysis/master_optimizer_reports/deck_card_battle_rule_coherence_audit_current_explicit_20260628_123905.json]
     ...
     top_lorehold_runtime_missing: `Verge Rangers, Twinflame Tyrant, Terror of the Peaks, Goliath Daydreamer, Taunt from the Rampart`
   ...
   - coherence audit has critical=0, high=379 [docs/hermes-analysis/master_optimizer_reports/deck_card_battle_rule_coherence_audit_20260628_182456.json]
     top_lorehold_cards: `Chrome Mox, Lion's Eye Diamond, Verge Rangers, Twinflame Tyrant, Terror of the Peaks`
     top_lorehold_runtime_missing: `Verge Rangers, Twinflame Tyrant, Terror of the Peaks, Goliath Daydreamer, Taunt from the Rampart`
     top_finding_codes: `review_only_or_needs_review_rule=201, no_active_battle_rule=172, no_trusted_executable_rule=98, generic_effect_without_model_scope=51, missing_oracle_text=1`
...
3. `high` `blocked_workflow` `text_blocked` count=30 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
...
11. `medium` `runtime_or_test_failure` `text_warning` count=5 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
