...
- Status: `ready`
- Proposal report: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg209_monastery_mentor_postsync_v1_proposals.json`
- Package manifests scanned: `87`
- Cards covered by package manifests: `210`
...
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 18 cards. Top reusable exact scope cluster: damage_all_variant_v1 (2). Largest raw family is token_maker (15 cards across 15 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
