...
- Generated at: `2026-06-30T13:30:29.934781+00:00`
- Status: `pass`
- Summary: `{"active_file_count": 24, "check_count": 29, "status_counts": {"pass": 29}}`
...
| `sqlite.active_knowledge_db_exists` | `pass` | docs/hermes-analysis/manaloom-knowledge/scripts/knowledge.db size=15355904 |
| `sqlite.no_stale_sibling_knowledge_db` | `pass` | absent |
| `query_consumers.no_unsafe_direct_1n_card_joins` | `pass` | no unsafe joins |
| `query_consumers.card_intelligence_snapshot_identity_joins` | `pass` | canonical_card_id_joins=4 compatibility_id_alias_joins=6 |
