...
- Generated at: `2026-07-02T06:07:16.962348+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4943 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3646 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2498 | 183 |
| `battle_family_mapper_required` | 30049 | 100 |
...
| `battle_family::recursion_or_bounce` | 503 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
