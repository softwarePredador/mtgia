...
- Generated at: `2026-06-28T00:09:00Z`
...
| Artist's Talent | 94 | `draw_filter_value` | `review_required` | draw_filter_value, paid_cast_exposure | permanent_moved_from_battlefield=2, spell_cast=5, spell_resolved=5, trigger_resolved=11, cost_paid:Artist's Talent=235 |
...
| Esper Sentinel | 612 | `draw_filter_value` | `review_required` | draw_filter_value, paid_cast_exposure, tutor_target | cast_announced=12, cost_paid=11, permanent_moved_from_battlefield=4, pg073_rule_snapshot=1, pg073_rule_summary=1, cost_paid:Esper Sentinel=839 |
