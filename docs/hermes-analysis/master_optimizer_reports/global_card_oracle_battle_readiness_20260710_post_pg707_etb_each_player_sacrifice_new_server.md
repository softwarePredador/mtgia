...
- Generated at: `2026-07-10T15:36:53.202683+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7447 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6261 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6236 | 274 |
| `battle_family_mapper_required` | 27640 | 90 |
...
| --- | ---: | --- | --- |
| `battle_family::manual_model_review` | 6425 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::draw_selection_topdeck` | 3293 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
