...
- generated_at: `2026-06-28T01:07:14Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 8 | 1 | 0 | 88.89% | 15.12 | 8 | 5 | 3 | 4 | 2 | 2 | 0 | 7 | 0 | 0 | none | wincon_role |
| 2 |  | Lorehold synergy package: plateau_timing_upgrade_cut_turbulent_steppe (`synergy_plateau_timing_upgrade_cut_turbulent_steppe`) | synergy-package | 9 | 3 | 6 | 0 | 33.33% | 12.00 | 5 | 3 | 0 | 2 | 2 | 2 | 0 | 7 | 0 | 0 | none | none |
...
### 2. Lorehold synergy package: plateau_timing_upgrade_cut_turbulent_steppe (`synergy_plateau_timing_upgrade_cut_turbulent_steppe`)
...
| Sisay, Weatherlight Captain #61 (real) | 3 | 0 | 0 | 100.00% | 12.00 | approach=2, elimination=1 |
| Winota, Joiner of Forces #39 (real) | 0 | 3 | 0 | 0.00% | 0.00 |  |

**Strategic event counts:** lorehold_cost_paid=93, lorehold_spell_cast=70, lorehold_upkeep_rummage=39, miracle_cast=21, topdeck_manipulation_activated=10, squee_to_graveyard=3, graveyard_upkeep_return_self_to_hand=3, squee_upkeep_return=3, squee_return_after_known_graveyard_entry=3, lorehold_spell_rummage=2
