...
- Generated at: `2026-06-28T00:54:43Z`
...
- Evaluations: `84`
- Status counts: `{"blocked": 65, "mana_model_observed_no_auto_swap": 5, "manual_review_required": 11, "preflight_land_swap_ready": 3}`
- Ready swaps: `3`
- Recommended next action: `run_mana_base_validated_preflight`
- Recommended swap: `{"candidate": "Plateau", "cut": "Radiant Summit", "score": 24, "why": "preserves_R_source, preserves_W_source, improves_timing"}`

## Ready Swaps

| Score | Candidate | Cut | Deltas | Gained | Lost |
| ---: | --- | --- | --- | --- | --- |
| 24 | Plateau | Radiant Summit | `{"active_rule_delta": 0, "boros_source_delta": 0, "etb_score_delta": 2, "red_source_delta": 0, "white_source_delta": 0}` | - | - |
...
- `Clifftop Retreat` over `Ancient Tomb`: blockers `would_cut_fast_colorless_acceleration, would_reduce_mana_timing`.
