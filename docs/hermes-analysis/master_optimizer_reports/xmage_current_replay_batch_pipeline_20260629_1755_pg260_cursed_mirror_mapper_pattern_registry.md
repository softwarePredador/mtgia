...
- `proposal_count`: `140`
- `pattern_count`: `22`
- `lane_counts`: `{"manual_mapper_backlog": 63, "package_ready_unprepared": 1, "split_scope_backlog": 76}`
- `pattern_status_counts`: `{"candidate_template_requires_review_tests": 8, "manual_model_observation_only": 1, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 12}`
- `card_counts_by_pattern_status`: `{"candidate_template_requires_review_tests": 11, "manual_model_observation_only": 63, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 65}`
...
| --- | --- | --- | ---: | ---: | --- |
| `ramp_permanent/ramp_permanent/red_mana_rock_etb_copy_creature_haste_annotation_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### ramp_permanent / ramp_permanent / red_mana_rock_etb_copy_creature_haste_annotation_v1

- Pattern id: `xmage_pattern:e8c539ec99192cce041b`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Cursed Mirror)
- Subpatterns: `1`
