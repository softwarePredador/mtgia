...
- Generated at: `2026-07-05T15:09:10.522118+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6019 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4771 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4949 | 266 |
| `battle_family_mapper_required` | 28924 | 97 |
...
| `battle_family::draw_selection_topdeck` | 3386 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
