...
- Generated at: `2026-06-30T13:30:58.953622+00:00`
- Status: `pass`
- PostgreSQL target: `143.198.230.247:5433/halder`
- SQLite DB: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/manaloom-knowledge/scripts/knowledge.db`
- Summary: `{"check_count": 51, "status_counts": {"pass": 50, "warn": 1}}`
...
| `sqlite_rows.battle_card_rules` | `pass` | rows=5382 |
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=5382 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=5382 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=5690 |
...
| `pg_integrity.card_intelligence_snapshot_id_alias_parity` | `pass` | id_card_id_mismatch_rows=0 |
| `pg_integrity.card_intelligence_snapshot_name_alias_parity` | `pass` | name_card_name_mismatch_rows=0 |
