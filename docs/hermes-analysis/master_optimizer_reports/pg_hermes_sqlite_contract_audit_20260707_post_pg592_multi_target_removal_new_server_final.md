...
- Generated at: `2026-07-07T04:15:24.593516+00:00`
- Status: `fail`
- PostgreSQL target: `127.0.0.1:15432/halder`
- SQLite DB: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/manaloom-knowledge/scripts/knowledge.db`
- Summary: `{"check_count": 51, "status_counts": {"fail": 1, "pass": 50}}`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=9092 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=9092 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=7690 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=7690 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=7690 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=8182 pg_runtime_keys=8179 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9340 |
...
| `pg_rows.deck_cards` | `pass` | rows=54453 |
...
| `pg_integrity.battle_rules_trusted_oracle_hash_coverage` | `fail` | trusted_executable_rules_missing_oracle_hash=44 |
