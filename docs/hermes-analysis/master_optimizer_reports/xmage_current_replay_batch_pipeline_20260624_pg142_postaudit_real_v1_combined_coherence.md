...
Generated at: `2026-06-24T04:30:23+00:00`
...
- `review_only_or_needs_review_rule`: `148`
- `trusted_rule_without_oracle_hash`: `148`
- `generic_effect_without_model_scope`: `93`
- `no_active_battle_rule`: `83`
...
| `high` | `battle_critical` | 7306 | `Demonic Tutor` | 6 | 6 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
...
| `high` | `battle_critical` | 7255 | `Vampiric Tutor` | 5 | 5 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `tutor` |
...
| `high` | `battle_critical` | 7204 | `Imperial Seal` | 4 | 4 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `tutor` |
...
| `high` | `battle_critical` | 7153 | `Brain Freeze` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `finisher` |
| `high` | `battle_critical` | 7153 | `Chain of Vapor` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
...
| `high` | `battle_critical` | 7153 | `Diabolic Intent` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
...
| `high` | `battle_critical` | 7153 | `Final Fortune` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `extra_turn` |
| `high` | `battle_critical` | 7153 | `Noxious Revival` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `recursion` |
...
| `high` | `battle_critical` | 7102 | `Cabal Ritual` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `ramp_ritual` |
...
| `high` | `battle_critical` | 7102 | `Culling the Weak` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `ramp_ritual` |
| `high` | `battle_critical` | 7102 | `Dark Ritual` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `ramp_ritual` |
...
| `high` | `battle_critical` | 7102 | `Mystical Tutor` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
...
| `high` | `battle_critical` | 7051 | `Beseech the Mirror` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
...
| `high` | `battle_critical` | 7051 | `Copy Enchantment` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `draw_engine`, `passive` |
...
| `high` | `battle_critical` | 7051 | `Miscast` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
...
| `high` | `battle_support` | 7561 | `Sol Ring` | 11 | 11 | `review_only_or_needs_review_rule` | `ramp_permanent` |
...
| `high` | `battle_support` | 7408 | `Birds of Paradise` | 8 | 8 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `ramp_permanent` |
...
| `high` | `battle_support` | 7357 | `Lion's Eye Diamond` | 7 | 7 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_ritual` |
...
| `high` | `battle_support` | 7102 | `Elves of Deep Shadow` | 2 | 2 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `ramp_permanent` |
| `high` | `battle_support` | 7102 | `Faeburrow Elder` | 2 | 2 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `ramp_ritual` |
| `high` | `battle_support` | 7102 | `Noble Hierarch` | 2 | 2 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `ramp_permanent` |
