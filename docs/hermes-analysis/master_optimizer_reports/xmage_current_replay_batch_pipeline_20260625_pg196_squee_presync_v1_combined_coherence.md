...
Generated at: `2026-06-25T00:37:27+00:00`
...
- `review_only_or_needs_review_rule`: `259`
- `no_active_battle_rule`: `166`
- `no_trusted_executable_rule`: `120`
- `trusted_rule_without_oracle_hash`: `118`
- `generic_effect_without_model_scope`: `73`
...
| `high` | `battle_critical` | 7102 | `Touch the Spirit Realm` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
