...
- Generated at: `2026-07-04T21:19:34.113492+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5205 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3921 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4099 | 263 |
| `battle_family_mapper_required` | 29774 | 100 |
...
| `damage_or_life_total_change` | 3921 |
...
| `battle_family::damage_or_life_total_change` | 3921 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Acceptable Losses` |
