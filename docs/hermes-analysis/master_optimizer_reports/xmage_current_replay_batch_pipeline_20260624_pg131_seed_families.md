...
- Summary: `{"batch_metadata_candidate_count": 3, "card_count": 295, "family_count": 3, "family_counts": {"manual_model": 254, "targeted_interaction": 16, "token_maker": 25}, "manual_or_blocked_count": 267, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 3, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 247, "runtime_family_implementation_required": 25, "split_family_scope_review_required": 16}, "runtime_family_required_count": 25}`
...
| `targeted_interaction` | 16 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 16}` | target legality, resolution, zone transition, and event provenance |
...
- Family tests: `[]`
- Cards: `["Orcish Bowmasters", "Deathrite Shaman", "Agatha's Soul Cauldron", "Into the Flood Maw", "Necropotence", "Archdruid's Charm", "Sink into Stupor", "Snap"]`
