...
- Generated at: `2026-07-04T15:46:22.743747+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5392 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4128 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4306 | 265 |
| `battle_family_mapper_required` | 29567 | 98 |
...
| `damage_or_life_total_change` | 3859 |
| `token_creation` | 3609 |
...
| `battle_family::damage_or_life_total_change` | 3859 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
