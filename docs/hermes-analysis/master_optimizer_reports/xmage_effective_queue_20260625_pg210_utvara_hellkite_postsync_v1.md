...
- Generated at: `2026-06-25T08:13:48+00:00`
- Status: `ready`
...
- Package manifests scanned: `88`
- Cards covered by package manifests: `211`
...
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 17 cards. Top reusable exact scope cluster: damage_all_variant_v1 (2). Largest raw family is token_maker (14 cards across 14 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
