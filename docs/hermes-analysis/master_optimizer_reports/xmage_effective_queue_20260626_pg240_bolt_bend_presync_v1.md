...
- Generated at: `2026-06-26T10:40:50+00:00`
- Status: `ready`
...
- Package manifests scanned: `113`
- Cards covered by package manifests: `254`
...
- `P0` Exhaust the unpackaged PG-ready residual before opening new runtime work. Reason: 1 cards are immediately packageable. Top exact cluster: single_target_spell_or_ability_redirect_costs_three_less_if_control_power_four_v1 (1)
...
- `P2` Keep the manual mapper lane last. Reason: 317 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `1`
- Top scope clusters:
  - `targeted_interaction` / `redirect_removal` / `single_target_spell_or_ability_redirect_costs_three_less_if_control_power_four_v1`: `1` cards (Bolt Bend)
...
- Count: `317`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `316` cards ("Name Sticker" Goblin, Ad Nauseam, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury, Amphibian Downpour)
