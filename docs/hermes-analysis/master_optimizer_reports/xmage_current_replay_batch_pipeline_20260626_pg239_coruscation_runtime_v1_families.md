...
- Summary: `{"batch_metadata_candidate_count": 5, "card_count": 391, "family_count": 11, "family_counts": {"board_wipe_choice": 1, "controlled_creature_etb_damage_engine": 1, "creature": 3, "manual_model": 321, "mill_spell": 1, "modal_spell": 1, "recursion": 2, "spell_cast_damage_engine": 5, "targeted_interaction": 48, "token_maker": 4, "tutor": 4}, "manual_or_blocked_count": 382, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 5, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 318, "runtime_family_implementation_required": 4, "split_family_scope_review_required": 60}, "runtime_family_required_count": 4}`
...
| `spell_cast_damage_engine` | 5 | `runtime_supported_family` | `{"batch_metadata_candidate_requires_pg_precheck": 5}` | battlefield trigger on spell, noncreature-spell, or instant-sorcery casts that damages each live opponent |
...
- Support: `runtime_supported_family`
- Batch strategy: `metadata_batch_after_pg_precheck`
- Family tests: `["test_pg239_coruscation_mage_damages_each_opponent_only_on_noncreature_spell_cast"]`
- Cards: `["Longshot, Rebel Bowman", "Guttersnipe", "Coruscation Mage", "Fiery Inscription", "Vivi Ornitier"]`
