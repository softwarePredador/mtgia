...
- Generated at: `2026-07-05T20:59:51.400270+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6131 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4890 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5068 | 266 |
| `battle_family_mapper_required` | 28805 | 97 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6875 |
| `triggered_or_static_ability` | 3883 |
| `damage_or_life_total_change` | 3793 |
| `token_creation` | 3577 |
...
| `battle_family::manual_model_review` | 6875 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3793 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
