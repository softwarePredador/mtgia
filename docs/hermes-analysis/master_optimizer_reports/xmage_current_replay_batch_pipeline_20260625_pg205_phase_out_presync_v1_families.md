...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 436, "family_count": 11, "family_counts": {"board_wipe_choice": 4, "creature": 4, "manual_model": 342, "mill_spell": 1, "modal_spell": 1, "phase_out_protection": 1, "recursion": 2, "static_cost_reducer": 2, "targeted_interaction": 58, "token_maker": 17, "tutor": 4}, "manual_or_blocked_count": 415, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 339, "runtime_family_implementation_required": 20, "split_family_scope_review_required": 72}, "runtime_family_required_count": 20}`
...
| `phase_out_protection` | 1 | `runtime_supported_family` | `{"batch_metadata_candidate_requires_pg_precheck": 1}` | phase-out protection for controlled permanents with land inclusion/exclusion flags |
...
- Family tests: `["test_pg205_clever_concealment_phases_controlled_nonland_permanents_only"]`
- Cards: `["Clever Concealment"]`
