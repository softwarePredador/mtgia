...
- Summary: `{"batch_metadata_candidate_count": 3, "card_count": 303, "family_count": 10, "family_counts": {"board_wipe_choice": 1, "controlled_creature_etb_damage_engine": 1, "creature": 1, "manual_model": 269, "mill_spell": 1, "modal_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 22, "token_maker": 2, "tutor": 3}, "manual_or_blocked_count": 297, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 3, "mapper_metadata_or_test_scenario_required": 269, "runtime_family_implementation_required": 3, "split_family_scope_review_required": 28}, "runtime_family_required_count": 3}`
...
| `creature` | 1 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 1}` | creature permanents with exact-scope ETB, death, combat, and activated behavior |
| `manual_model` | 269 | `manual_model_required` | `{"mapper_metadata_or_test_scenario_required": 269}` | manual Oracle/reference review |
...
| `targeted_interaction` | 22 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 3, "split_family_scope_review_required": 19}` | target legality, resolution, zone transition, and event provenance |
...
- Batch strategy: `split_by_scope_before_metadata_batch`
- Family tests: `[]`
- Cards: `["Flusterstorm", "Chain of Vapor", "Reprieve", "Tezzeret, Cruel Captain", "Vandalblast", "Abrade", "Archivist of Oghma", "Erode"]`
