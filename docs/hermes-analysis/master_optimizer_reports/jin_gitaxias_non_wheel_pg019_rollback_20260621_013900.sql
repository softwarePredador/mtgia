...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pg019_jin_gitaxias_non_wheel_20260621_013900') IS NULL THEN
    RAISE EXCEPTION 'PG019 rollback backup table is missing';
  END IF;
END $$;
...
FROM manaloom_deploy_audit.pg019_jin_gitaxias_non_wheel_20260621_013900
