...
- Generated at: `2026-06-30T11:46:38Z`
...
- Promotion lanes: `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 15}`
...
| 8 | `mill_spell` | 1 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 1}` | `{"batch_metadata_candidate_requires_pg_precheck": 1}` | target-player library milling, storm copy counting, and activated mill engines |
