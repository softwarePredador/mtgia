...
- Generated at: `2026-07-04T02:33:50.435430+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=7273 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=7273 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=5952 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=5952 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=5952 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6564 pg_runtime_keys=6561 unresolved=0 |
| `pg_sqlite_parity.protected_deck_607_pg_snapshot` | `warn` | deck_id_607_has_no_pg_deck_id_note |
...
| `pg_rows.card_battle_rules` | `pass` | rows=7579 |
