...
- Generated at: `2026-07-09T08:21:38.930389+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7428 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6241 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6216 | 274 |
| `battle_family_mapper_required` | 27660 | 90 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6436 |
| `triggered_or_static_ability` | 3841 |
| `damage_or_life_total_change` | 3682 |
| `token_creation` | 3472 |
...
| `battle_family::damage_or_life_total_change` | 3682 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
