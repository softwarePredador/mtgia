...
- Generated at: `2026-06-30T13:42:35Z`
...
- Filtered current verified/auto rules: `2`
- Blocked runtime cards: `59`
- Candidate lanes: `{"contextual": 35, "early_mana": 7, "finisher_or_big_spell": 6, "hand_filter": 8, "pressure_absorber_or_protection": 2, "protection_window": 1}`
- Promotion lanes: `{"batch_metadata_candidate_requires_pg_precheck": 19, "mapper_metadata_or_test_scenario_required": 16, "split_family_scope_review_required": 24}`
...
| 8 | `passive` | 2 | `runtime_family_partially_supported_review_required` | `split_by_scope_before_metadata_batch` | `{"contextual": 1, "early_mana": 1}` | `{"split_family_scope_review_required": 2}` | static battlefield annotation and passive support execution |
...
| 15 | `static_cost_reducer` | 1 | `runtime_supported_family` | `metadata_batch_after_pg_precheck` | `{"early_mana": 1}` | `{"batch_metadata_candidate_requires_pg_precheck": 1}` | battle cost-locking / affordability / payment reducer |
