...
- Generated at: `2026-06-30T11:31:30Z`
- Runtime queue: `docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg276_manual_mapper_wave.json`
...
- Cards reviewed: `21`
- Status counts: `{"pg_package_applied_synced": 2, "review_required": 3, "split_scope_review_required": 16}`
- Promotion lanes: `{"access_density_candidate": 5, "split_family_scope_review_required": 16}`
...
| 6 | `Ghoulcaller's Bell` | `split_scope_review_required` | `mill_spell` | `split_family_scope_review_required` | `mill_engine` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 7 | `Karn's Sylex` | `split_scope_review_required` | `board_wipe_choice` | `split_family_scope_review_required` | `board_wipe` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 8 | `Karn, the Great Creator` | `split_scope_review_required` | `passive` | `split_family_scope_review_required` | `passive` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 9 | `Kayla's Music Box` | `split_scope_review_required` | `free_cast` | `split_family_scope_review_required` | `free_cast` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 10 | `Lantern of Insight` | `split_scope_review_required` | `topdeck_play` | `split_family_scope_review_required` | `topdeck_play` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 11 | `Leyline Dowser` | `split_scope_review_required` | `recursion` | `split_family_scope_review_required` | `recursion` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 12 | `Naktamun Lorespinner // Wheel of Fortune` | `split_scope_review_required` | `draw_engine` | `split_family_scope_review_required` | `draw_engine` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 13 | `Orcish Spy` | `split_scope_review_required` | `topdeck_play` | `split_family_scope_review_required` | `topdeck_play` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 14 | `Possibility Storm` | `split_scope_review_required` | `free_cast` | `split_family_scope_review_required` | `free_cast` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 15 | `Prototype Portal` | `split_scope_review_required` | `token_maker` | `split_family_scope_review_required` | `token_maker` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
| 16 | `Pyxis of Pandemonium` | `split_scope_review_required` | `free_cast` | `split_family_scope_review_required` | `free_cast` | 0 | Split the family scope and write focused runtime tests before creating a metadata package. |
