...
Generated at: `2026-06-23T04:57:10+00:00`
...
- `trusted_rule_without_oracle_hash`: `64`
- `generic_effect_without_model_scope`: `28`
- `no_trusted_executable_rule`: `26`
- `review_only_or_needs_review_rule`: `26`
- `no_active_battle_rule`: `7`

## Top 97 Actionable Cards
...
| `high` | `battle_critical` | 7102 | `Esper Sentinel` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine` |
...
| `high` | `battle_critical` | 7051 | `Pyroblast` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
...
| `high` | `battle_critical` | 7051 | `Wheel of Misfortune` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards` |
