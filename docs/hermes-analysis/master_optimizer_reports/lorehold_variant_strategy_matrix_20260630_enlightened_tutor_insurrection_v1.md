...
- Generated at: `2026-06-30T03:09:15.971263+00:00`
- Strategy profile: `lorehold_strategy_profile_v3_2026_06_26`
- Scope: decks `607, 615` plus candidate v7 when available.
- Best structural deck before equal battle gate: `candidate_607_enlightened_tutor_insurrection_v1`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| 1 | Lorehold 607 + Enlightened Tutor over Insurrection v1 (`candidate_607_enlightened_tutor_insurrection_v1`) | 607-enlightened-tutor-insurrection | 141.4 | 100.0 | 34 | 97.9% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | recursion_role, tutor_role |
...
## 1. Lorehold 607 + Enlightened Tutor over Insurrection v1 (`candidate_607_enlightened_tutor_insurrection_v1`)
...
**Evidence:** spell_chain_conversion=43; topdeck_miracle_setup=12; pressure_absorber=19; wincon_roles=8; key_cards=Flawless Maneuver, Mother of Runes, Giver of Runes, Boros Signet

**Strengths:**
- combat pressure absorber passes (19/4)
- spell-chain conversion passes (43/12)
- hand filtering passes (15/7)
- early setup/mana passes (37/18)
