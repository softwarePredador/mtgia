...
- Generated at: `2026-07-05T11:38:16Z`
...
| `verified_auto_rule_ready_count` | `2` |
...
| --- | --- | --- | --- | ---: | --- |
| Brain in a Jar | `runtime_or_manual_review` | `topdeck_miracle_access` | `single_card_runtime_contract_then_cut_safety` | `1` | named_safe_cut_missing |
