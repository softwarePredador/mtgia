...
- Generated at: `2026-07-04T19:37:57.309859+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5662 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4399 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4577 | 265 |
| `battle_family_mapper_required` | 29296 | 98 |
...
| `damage_or_life_total_change` | 3839 |
| `token_creation` | 3609 |
...
| `battle_family::damage_or_life_total_change` | 3839 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
