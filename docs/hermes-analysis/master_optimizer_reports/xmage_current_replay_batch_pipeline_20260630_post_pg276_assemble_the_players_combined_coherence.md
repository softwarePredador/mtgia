...
- `shadow_rule_preserved_for_history`: `81`
- `trusted_rule_without_oracle_hash`: `69`
- `no_active_battle_rule`: `68`
- `generic_effect_without_model_scope`: `41`
...
| `high` | `support_or_passive` | 7051 | `Lim-Dul's Vault` | 1 | 1 | `no_active_battle_rule` | - |
...
| `medium` | `battle_critical` | 4051 | `Freed from the Real` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine`, `ramp_engine` |
| `medium` | `battle_critical` | 4051 | `Oswald Fiddlebender` | 1 | 1 | `trusted_rule_without_oracle_hash` | `creature`, `tutor` |
| `medium` | `battle_critical` | 4051 | `Squee, the Immortal` | 1 | 1 | `trusted_rule_without_oracle_hash` | `creature`, `recursion` |
| `medium` | `battle_critical` | 4051 | `Sylvan Library` | 1 | 1 | `trusted_rule_without_oracle_hash` | `draw_engine`, `passive` |
| `medium` | `battle_support` | 4459 | `Lion's Eye Diamond` | 9 | 9 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_ritual` |
| `medium` | `battle_support` | 4153 | `Helm of Awakening` | 3 | 3 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_engine`, `ramp_permanent` |
| `medium` | `battle_support` | 4102 | `Thousand-Year Elixir` | 2 | 2 | `trusted_rule_without_oracle_hash` | `passive`, `ramp_permanent` |
| `medium` | `battle_support` | 4102 | `Unwinding Clock` | 2 | 2 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_engine`, `ramp_permanent` |
...
| `medium` | `battle_support` | 4051 | `Manifold Key` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_engine`, `ramp_permanent` |
