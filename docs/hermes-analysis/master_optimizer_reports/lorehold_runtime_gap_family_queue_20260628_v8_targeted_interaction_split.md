...
- Generated at: `2026-06-28T10:41:53Z`
...
- Targeted interaction subfamily statuses: `{"runtime_family_implementation_required": 6}`
- Family count: `5`
...
| Card | Score | Variant decks | Lane | Promotion | Subfamily | Next step | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- | --- | --- |
| `Repercussion` | -10 | `612` | `contextual` | `split_family_scope_review_required` | `creature_damage_controller_reflect_global` | implement Repercussion-style global creature damage reflection, then gate sweeper synergy | `direct_damage` | `targeted_damage_variant_v1` | `Repercussion` |
