...
- Generated at: `2026-07-05T00:58:10+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 26433 |
| `xmage_authoritative_source_count` | 26119 |
...
| `adapter_work_unit_count` | 11397 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 26119 |
...
| `direct_damage::targeted_damage_variant_v1` | 814 |
| `add_counters::source_add_counters_variant_v1` | 795 |
| `life_gain::xmage_life_gain_variant_review_v1` | 735 |
| `draw_cards::xmage_draw_card_variant_review_v1` | 616 |
| `removal_destroy::targeted_destroy_variant_v1` | 616 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11681 |
| `token_maker` | 2411 |
| `recursion` | 1819 |
| `draw_engine` | 1619 |
| `add_counters` | 1254 |
