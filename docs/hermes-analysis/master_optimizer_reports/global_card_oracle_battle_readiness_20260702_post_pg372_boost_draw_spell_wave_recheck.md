...
- Generated at: `2026-07-02T10:55:42.955637+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5008 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3715 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2567 | 183 |
| `battle_family_mapper_required` | 29980 | 100 |
...
| `battle_family::draw_selection_topdeck` | 3512 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
