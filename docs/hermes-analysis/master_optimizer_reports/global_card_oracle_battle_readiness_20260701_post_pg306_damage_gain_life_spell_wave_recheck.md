...
- Generated at: `2026-07-01T13:02:06.311426+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4465 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3135 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1987 | 389 |
| `battle_family_mapper_required` | 30560 | 230 |
...
| `damage_or_life_total_change` | 4016 |
...
| `battle_family::damage_or_life_total_change` | 4016 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Acceptable Losses` |
