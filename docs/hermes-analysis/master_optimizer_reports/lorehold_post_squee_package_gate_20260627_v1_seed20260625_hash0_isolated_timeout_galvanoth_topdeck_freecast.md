...
- generated_at: `2026-06-27T15:57:00Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: galvanoth_topdeck_freecast (`synergy_galvanoth_topdeck_freecast`) | synergy-package | 9 | 4 | 5 | 0 | 44.44% | 18.00 | 6 | 4 | 3 | 2 | 2 | 0 | 5 | none |
...
| Sisay, Weatherlight Captain #61 (real) | 1 | 2 | 0 | 33.33% | 28.00 | elimination=1 |
| Winota, Joiner of Forces #39 (real) | 3 | 0 | 0 | 100.00% | 14.67 | elimination=3 |

**Strategic event counts:** lorehold_cost_paid=112, lorehold_spell_cast=86, topdeck_manipulation_activated=14, lorehold_upkeep_rummage=17, miracle_cast=21, squee_to_graveyard=5, graveyard_upkeep_return_self_to_hand=2, squee_upkeep_return=2, squee_return_after_known_graveyard_entry=2, lorehold_spell_rummage=17
