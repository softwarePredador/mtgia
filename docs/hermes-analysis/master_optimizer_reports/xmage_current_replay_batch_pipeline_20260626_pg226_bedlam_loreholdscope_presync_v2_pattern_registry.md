...
- Generated at: `2026-06-26T05:13:33+00:00`
- Status: `ready`
- Mutations performed: `[]`
...
- `proposal_count`: `298`
- `pattern_count`: `19`
- `lane_counts`: `{"blocked_missing_xmage_source": 2, "manual_mapper_backlog": 268, "package_already_prepared": 1, "package_ready_unprepared": 1, "runtime_family_backlog": 3, "split_scope_backlog": 23}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 7, "fragmented_runtime_observation_only": 2, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 1, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 5, "runtime_observation_requires_taxonomy": 1}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 2, "candidate_template_requires_review_tests": 7, "fragmented_runtime_observation_only": 2, "governance_only_pending_pg_apply": 1, "manual_model_observation_only": 268, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 16, "runtime_observation_requires_taxonomy": 1}`
...
| `creature/creature/front_creature_prowess_etb_discard_hand_draw_three_self_instant_sorcery_graveyard_cost_reduction_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `targeted_interaction/draw_cards/source_controller_draw_variant_v1` | `split_scope_backlog` | `requires_subpattern_split_before_promotion` | 2 | 1 | Split by ability kind, target constraints, triggers, costs, and secondary effects before promotion. |
...
### creature / creature / front_creature_prowess_etb_discard_hand_draw_three_self_instant_sorcery_graveyard_cost_reduction_v1

- Pattern id: `xmage_pattern:d094ff3f6c3572649cc3`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Bedlam Reveler)
- Subpatterns: `1`
...
- Lane: `split_scope_backlog`
- Status: `requires_subpattern_split_before_promotion`
- Cards: `2` (Archivist of Oghma, Blood Sun)
- Subpatterns: `1`
- Required evidence: `["subpattern split", "focused ManaLoom tests per subpattern", "package generation only for exact supported subpatterns"]`
