...
- Generated at: `2026-07-10T15:53:22.609744+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7450 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6264 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6239 | 274 |
| `battle_family_mapper_required` | 27637 | 90 |
...
| --- | ---: | --- | --- |
| `battle_family::manual_model_review` | 6422 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
