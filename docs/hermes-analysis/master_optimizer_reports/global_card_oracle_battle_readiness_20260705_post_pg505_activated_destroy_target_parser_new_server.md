...
- Generated at: `2026-07-05T12:29:22.907243+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5982 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4734 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4912 | 266 |
| `battle_family_mapper_required` | 28961 | 97 |
...
| `damage_or_life_total_change` | 3815 |
| `token_creation` | 3591 |
| `draw_selection_topdeck` | 3389 |
| `graveyard_recursion` | 1896 |
| `targeted_removal` | 1010 |
...
| `battle_family::damage_or_life_total_change` | 3815 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::targeted_removal` | 1010 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock`, `Against All Odds`, `Agate Assault` |
