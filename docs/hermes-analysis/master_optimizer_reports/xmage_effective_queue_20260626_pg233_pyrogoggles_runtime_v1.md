...
- Generated at: `2026-06-26T08:05:39+00:00`
- Status: `ready`
- Proposal report: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg233_pyrogoggles_runtime_v1_proposals.json`
...
- `P0` Exhaust the unpackaged PG-ready residual before opening new runtime work. Reason: 5 cards are immediately packageable. Top exact cluster: activated_remove_counter_plains_tutor_battlefield_tapped_if_behind_else_hand_v1 (1)
...
- `P2` Keep the manual mapper lane last. Reason: 326 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `5`
- Top scope clusters:
  - `creature` / `creature` / `activated_remove_counter_plains_tutor_battlefield_tapped_if_behind_else_hand_v1`: `1` cards (Scholar of New Horizons)
  ...
  - `ramp_permanent` / `ramp_permanent` / `red_mana_rock_red_instant_sorcery_mana_spent_copy_spell_v1`: `1` cards (Pyromancer's Goggles)
...
- Count: `326`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `325` cards ("Name Sticker" Goblin, Ad Nauseam, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury, Amphibian Downpour)
