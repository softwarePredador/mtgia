...
- Generated at: `2026-06-25T10:20:53+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg215_discard_counter_bat_postsync_v1_proposals.json`
- Package manifests scanned: `93`
- Cards covered by package manifests: `218`
...
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 10 cards. Top reusable exact scope cluster: damage_all_variant_v1 (1). Largest raw family is token_maker (9 cards across 9 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
...
- Top scope clusters:
  ...
  - `token_maker` / `token_maker` / `xmage_create_token_variant_davrosdalekcreator_v1`: `1` cards (Davros, Dalek Creator)
  - `token_maker` / `token_maker` / `xmage_create_token_variant_fableofthemirrorbreaker_v1`: `1` cards (Fable of the Mirror-Breaker // Reflection of Kiki-Jiki)
