...
- `proposal_count`: `440`
- `pattern_count`: `43`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 342, "package_ready_unprepared": 2, "runtime_family_backlog": 20, "split_scope_backlog": 72}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 10, "runtime_template_candidate_requires_executor_tests": 2}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 342, "ready_for_pg_package_generation": 2, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `recursion/recursion/return_all_artifact_cards_from_graveyard_to_battlefield_haste_eot_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
| `recursion/recursion/return_all_artifact_enchantment_cards_from_graveyard_to_battlefield_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 341 | 54 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### recursion / recursion / return_all_artifact_cards_from_graveyard_to_battlefield_haste_eot_v1

- Pattern id: `xmage_pattern:89ca22577bc8f2ff1cab`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Wake the Past)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`

### recursion / recursion / return_all_artifact_enchantment_cards_from_graveyard_to_battlefield_v1

- Pattern id: `xmage_pattern:d10c324a1bb8b98e44e8`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Brilliant Restoration)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`
