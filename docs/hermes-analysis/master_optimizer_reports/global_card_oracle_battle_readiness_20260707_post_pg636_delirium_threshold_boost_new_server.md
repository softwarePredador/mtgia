...
- Generated at: `2026-07-07T20:17:24.041105+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7191 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5983 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5909 | 258 |
| `battle_family_mapper_required` | 27921 | 92 |
...
| `battle_family::targeted_removal` | 931 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aftershock`, `Against All Odds`, `Agate Assault`, `Agent of Erebos` |
