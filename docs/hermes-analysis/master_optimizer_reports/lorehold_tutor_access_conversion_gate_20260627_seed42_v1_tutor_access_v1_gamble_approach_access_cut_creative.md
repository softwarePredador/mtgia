...
- generated_at: `2026-06-27T18:39:52Z`
...
| 2 |  | Lorehold synergy package: gamble_approach_access_cut_creative (`synergy_gamble_approach_access_cut_creative`) | synergy-package | 9 | 4 | 5 | 0 | 44.44% | 10.50 | 6 | 4 | 0 | 1 | 1 | 1 | 0 | 4 | none |
...
### 2. Lorehold synergy package: gamble_approach_access_cut_creative (`synergy_gamble_approach_access_cut_creative`)
...
| Sisay, Weatherlight Captain #61 (real) | 2 | 1 | 0 | 66.67% | 13.50 | elimination=2 |
| Winota, Joiner of Forces #39 (real) | 2 | 1 | 0 | 66.67% | 7.50 | approach=2 |

**Strategic event counts:** lorehold_cost_paid=99, lorehold_spell_cast=78, lorehold_upkeep_rummage=17, miracle_cast=20, lorehold_spell_rummage=9, topdeck_manipulation_activated=9, squee_to_graveyard=1, graveyard_upkeep_return_self_to_hand=1, squee_upkeep_return=1, squee_return_after_known_graveyard_entry=1
