...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: one_ring_protection_draw_cut_squelcher (`synergy_one_ring_protection_draw_cut_squelcher`) | synergy-package | 9 | 3 | 6 | 0 | 33.33% | 17.00 | 6 | 3 | 0 | 0 | 0 | 0 | 0 | 5 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 2 | 1 | 3 | 0 | 0 | 0 | 0 | 8 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: one_ring_protection_draw_cut_squelcher (`synergy_one_ring_protection_draw_cut_squelcher`)
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Vivi Ornitier #99 (real) | 1 | 2 | 0 | 33.33% | 18.00 | elimination=1 |
...
**Strategic event counts:** lorehold_cost_paid=96, lorehold_spell_cast=84, lorehold_upkeep_rummage=14, thor_cost_paid=2, thor_spell_cast=2, topdeck_manipulation_activated=4, miracle_cast=13, lorehold_spell_rummage=8
