...
- generated_at: `2026-06-27T15:56:28Z`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 1 |  | Lorehold synergy package: brainstone_topdeck_miracle (`synergy_brainstone_topdeck_miracle`) | synergy-package | 9 | 1 | 8 | 0 | 11.11% | 21.00 | 5 | 1 | 2 | 2 | 2 | 1 | 5 | none |
| 2 | 2 | Runtime Lorehold Learned 19e93de3cca (`deck_6`) | unknown | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 2 | 1 | 0 | 0 | 0 | 0 | 8 | wincon_role |

## Deck Detail

### 1. Lorehold synergy package: brainstone_topdeck_miracle (`synergy_brainstone_topdeck_miracle`)
...
**Strategic event counts:** lorehold_cost_paid=77, lorehold_spell_cast=61, lorehold_upkeep_rummage=27, miracle_cast=7, squee_to_graveyard=2, graveyard_upkeep_return_self_to_hand=3, squee_upkeep_return=3, squee_return_after_known_graveyard_entry=2, squee_return_without_known_graveyard_entry=1, topdeck_manipulation_activated=1
