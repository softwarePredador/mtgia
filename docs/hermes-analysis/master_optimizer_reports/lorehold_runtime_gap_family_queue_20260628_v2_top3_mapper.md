...
- Generated at: `2026-06-28T01:23:56Z`
...
- Promotion lanes: `{"mapper_metadata_or_test_scenario_required": 52, "runtime_family_implementation_required": 2, "split_family_scope_review_required": 7}`
- Family count: `5`
...
| 5 | `topdeck_play` | 1 | `runtime_family_required` | `implement_family_before_metadata_batch` | `{"hand_filter": 1}` | `{"runtime_family_implementation_required": 1}` | top-of-library visibility and permission to play cards from library under board-state conditions |
...
| Card | Score | Variant decks | Lane | Promotion | Effect | Scope | XMage class |
| --- | ---: | --- | --- | --- | --- | --- | --- |
| `Verge Rangers` | 10 | `609, 611, 613` | `hand_filter` | `runtime_family_implementation_required` | `topdeck_play` | `look_top_library_play_lands_from_top_if_opponent_more_lands_v1` | `VergeRangers` |
