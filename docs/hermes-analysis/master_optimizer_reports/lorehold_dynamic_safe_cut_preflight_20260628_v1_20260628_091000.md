...
- generated_at: `2026-06-28T07:39:09.541382+00:00`
...
| --- | --- | --- | --- | --- | --- | --- | ---: | --- | --- |
| gods_willing_commander_shield_cut_avatar_wrath | targeted_commander_protection | Gods Willing | Avatar's Wrath | `clear;blocked_prior_reject` | - | - | +0.00 | - | skipped_prior_evidence |

## Package Notes

### gods_willing_commander_shield_cut_avatar_wrath

- family: targeted_commander_protection
- hypothesis: Gods Willing had a positive targeted-protection signal when measured over Promise of Loyalty, but Promise is registry-protected. This safe-cut follow-up preserves Promise and tests Gods Willing over Avatar's Wrath, a slower protection/pressure slot already used as the non-protected benchmark in other protection packages.
- status: `skipped_prior_evidence`
- cut_safety: `{"cuts": [], "reason": "no proposed cut has previous blocker evidence", "status": "clear"}`
- prior_evidence: `{"matches": [{"adds": ["Gods Willing"], "adds_signature": ["gods willing"], "baseline": {}, "candidate": {}, "cuts": ["Avatar's Wrath"], "cuts_signature": ["avatar's wrath"], "decision": "reject_or_rework", "delta_pp": null, "family": "registry_rejected", "gate_json": null, "gate_markdown": null, "gate_returncode": null, "package_key": "registry:leader_watchlist_probes:1:gods willing", "registry_learning": "The champion shell strongly preferred Avatar's Wrath over the first protection watchlist package. None of those swaps preserved the pressure-defense profile.", "registry_result": "Gods Willing 1W/2L/0S, WR 33.33%; Angel's Grace 1W/2L/0S, WR 33.33%; Sejiri Shelter 1W/2L/0S, WR 33.33%; Commander's Plate 1W/2L/0S, WR 33.33%; Clever Concealment 0W/3L/0S", "registry_section": "leader_watchlist_probes", "registry_status": "rejected_probe_batch", "source_report": "/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_candidate_hypothesis_registry_20260626.json", "strategic_delta": {}}], "reason": "exact package already produced `reject_or_rework`", "status": "blocked_prior_reject"}`
