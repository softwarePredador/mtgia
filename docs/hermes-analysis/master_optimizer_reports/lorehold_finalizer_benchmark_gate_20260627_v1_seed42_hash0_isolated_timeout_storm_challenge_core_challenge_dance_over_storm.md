...
| 2 |  | Lorehold synergy package: core_challenge_dance_over_storm (`synergy_core_challenge_dance_over_storm`) | synergy-package | 9 | 0 | 9 | 0 | 0.00% | 0.00 | 5 | 4 | 0 | 0 | 0 | 0 | 7 | none |
...
**Strategic event counts:** lorehold_cost_paid=66, lorehold_spell_cast=55, lorehold_upkeep_rummage=44, miracle_cast=11, topdeck_manipulation_activated=9, lorehold_spell_rummage=5
