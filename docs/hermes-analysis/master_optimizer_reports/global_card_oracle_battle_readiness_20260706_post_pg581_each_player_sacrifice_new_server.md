...
- Generated at: `2026-07-06T23:54:50.276551+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6664 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5445 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5623 | 269 |
| `battle_family_mapper_required` | 28250 | 94 |
...
| `battle_family::manual_model_review` | 6691 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::draw_selection_topdeck` | 3344 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
...
| `battle_family::mana_generation_or_ritual` | 683 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon` |
