...
- Generated at: `2026-06-25T10:47:56+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg216_phase_watchers_postsync_v1_proposals.json`
- Package manifests scanned: `94`
- Cards covered by package manifests: `221`
...
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 7 cards. Top reusable exact scope cluster: damage_all_variant_v1 (1). Largest raw family is token_maker (6 cards across 6 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
...
- Top scope clusters:
  ...
  - `token_maker` / `token_maker` / `xmage_create_token_variant_thelocustgod_v1`: `1` cards (The Locust God)
