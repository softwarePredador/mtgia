-- PG783B trusted rule oracle_hash backfill rollback.
...
SET oracle_hash = backup.oracle_hash,
    notes = backup.notes,
    updated_at = NOW()
FROM manaloom_deploy_audit.pg783b_trusted_rule_oracle_hash_backfill_new_server_20260711 backup
...
FROM manaloom_deploy_audit.pg783b_trusted_rule_oracle_hash_backfill_new_server_20260711;
