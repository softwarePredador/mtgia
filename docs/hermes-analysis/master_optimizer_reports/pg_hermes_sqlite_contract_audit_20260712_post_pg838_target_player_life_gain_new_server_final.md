...
- Generated at: `2026-07-12T19:10:20.538249+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=7209 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=7209 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=8663 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=8663 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=8663 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6753 pg_runtime_keys=9834 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=10524 |
