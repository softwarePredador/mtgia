...
- generated_at: `2026-06-27T20:53:17Z`
...
| 2 |  | Lorehold synergy package: guttersnipe_spell_payoff_cut_prismari (`synergy_guttersnipe_spell_payoff_cut_prismari`) | synergy-package | 3 | 0 | 3 | 0 | 0.00% | 0.00 | 2 | 0 | 0 | 0 | 0 | 0 | 0 | 3 | none |
...
### 2. Lorehold synergy package: guttersnipe_spell_payoff_cut_prismari (`synergy_guttersnipe_spell_payoff_cut_prismari`)
...
**Strategic event counts:** lorehold_cost_paid=22, lorehold_spell_cast=16, lorehold_upkeep_rummage=15, lorehold_spell_rummage=2, miracle_cast=4
