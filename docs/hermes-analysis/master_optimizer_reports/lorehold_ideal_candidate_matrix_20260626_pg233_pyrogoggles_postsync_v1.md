...
- Generated at: `2026-06-26T08:08:16.694119+00:00`
- Status: `ready`
- Active deck id: `6`
- Lorehold deck ids: `[6, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616]`
- Proposal report: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg233_pyrogoggles_postsync_v1_proposals.json`
...
- Rows: `395`
- Recommendation lanes: `{"active_low_confidence_review": 13, "core_keep": 87, "low_priority": 90, "needs_rule_before_strategy": 38, "policy_blocked": 2, "priority_benchmark_candidate": 44, "watchlist_candidate": 121}`
- Rule statuses: `{"battle_ready": 316, "no_rule_signal": 38, "package_already_prepared": 41}`
...
| --- | ---: | --- | --- | --- | --- |
| Scholar of New Horizons | 17.0 | tutor | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Molecule Man | 16.5 | draw | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Deathbellow War Cry | 14.0 | tutor | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Millikin | 13.5 | ramp | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Blood Sun | 11.5 | draw | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Thor, God of Thunder | 6.0 | removal | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Wild Ricochet | 6.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Unstable Glyphbridge // Sandswirl Wanderglyph | 5.0 | board_wipe | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
...
| The Warring Triad | -3.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Assemble the Players | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Boros Reckoner | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Eight-and-a-Half-Tails | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Ghoulcaller's Bell | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Kayla's Music Box | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Lantern of Insight | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Orcish Spy | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Pyxis of Pandemonium | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Radiant Performer | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Slickshot Show-Off | -4.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
| Stuffy Doll | -5.5 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
...
| Rem Karolus, Stalwart Slayer | -6.0 | unknown | no_rule_signal | - | map_or_verify_rule_before_strategy_scoring |
