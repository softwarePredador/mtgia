...
- Generated at: `2026-06-30T05:32:55Z`
...
- Promotion lanes: `{"mapper_metadata_or_test_scenario_required": 14, "split_family_scope_review_required": 13}`
...
| ---: | --- | ---: | --- | --- | --- | --- | --- |
| 1 | `manual_model` | 14 | `manual_model_required` | `not_batch_safe` | `{"contextual": 9, "early_mana": 1, "finisher_or_big_spell": 2, "hand_filter": 2}` | `{"mapper_metadata_or_test_scenario_required": 14}` | manual Oracle/reference review |
...
| 8 | `targeted_protection` | 1 | `runtime_supported_family` | `metadata_batch_after_pg_precheck` | `{"contextual": 1}` | `{"split_family_scope_review_required": 1}` | targeted own-creature protection grant and cleanup-aware target legality |
| 9 | `topdeck_play` | 1 | `runtime_supported_family` | `metadata_batch_after_pg_precheck` | `{"hand_filter": 1}` | `{"split_family_scope_review_required": 1}` | top-of-library visibility and permission to play cards from library under board-state conditions |
