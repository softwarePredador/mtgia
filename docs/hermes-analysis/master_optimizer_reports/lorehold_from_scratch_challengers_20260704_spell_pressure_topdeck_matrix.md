...
- Generated at: `2026-07-04T22:43:45.905440+00:00`
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | --- | --- |
| 1 | VARIANT Lorehold Variant 02 - Rafael Paste 2026-06-23 (`deck_607`) | battle-variant | 139.0 | 99.5 | 34 | 97.9% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | draw_role, recursion_role, tutor_role |
| 2 | Lorehold From-Scratch Spell Pressure Topdeck v1 (`challenger_lorehold_spell_pressure_topdeck_v1`) | from-scratch-spell-pressure-topdeck | 135.8 | 98.2 | 34 | 97.9% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | recursion_role, tutor_role |
...
| 5 | VARIANT Lorehold Variant 08 - Rafael Paste 2026-06-24 (`deck_613`) | spell-copy-control-variant | 121.3 | 86.1 | 32 | 97.8% | Spell-copy control shell that tries to trade resources, protect a window, then convert copied spells into a win. | land_role, removal_role, recursion_role |
| 6 | VARIANT Lorehold Variant 04 - Rafael Paste 2026-06-24 (`deck_609`) | battle-variant | 120.0 | 89.9 | 30 | 97.8% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | land_role, protection_role, recursion_role, low_land_count |
| 7 | VARIANT Lorehold Variant 11 - Rafael Paste 2026-06-24 (`deck_616`) | burn-dragon-control-variant | 118.4 | 87.6 | 29 | 97.6% | Burn/dragon-control shell that tries to survive long enough for high-impact threats and damage finishers. | graveyard_recursion, land_role, ramp_role, recursion_role, tutor_role, low_land_count |
| 8 | VARIANT Lorehold Variant 06 - Rafael Paste 2026-06-24 (`deck_611`) | big-spells-variant | 107.9 | 79.5 | 34 | 97.8% | Big-spells shell that leans on Lorehold's miracle discount to cast expensive effects ahead of curve. | protection_window, removal_role, protection_role, recursion_role |
| 9 | VARIANT Lorehold Variant 05 - Rafael Paste 2026-06-24 (`deck_610`) | artifact-control-variant | 95.6 | 72.1 | 30 | 97.9% | Artifact-control shell that tries to slow combat, build mana/artifact advantage, then win through compact spell or artifact payoff lines. | protection_window, deterministic_finisher, land_role, draw_role, removal_role, protection_role, recursion_role, wincon_role |
| 10 | VARIANT Lorehold Variant 07 - Rafael Paste 2026-06-24 (`deck_612`) | spell-copy-combo-variant | 92.7 | 72.9 | 27 | 98.0% | Spell-copy combo shell that prioritizes copy effects and burst mana to assemble deterministic spell-chain wins. | protection_window, land_role, draw_role, removal_role, protection_role, recursion_role, tutor_role, low_land_count |
| 11 | VARIANT Lorehold Variant 03 - Rafael Paste 2026-06-23 (`deck_608`) | battle-variant | 85.4 | 66.9 | 31 | 97.1% | Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains. | protection_window, deterministic_finisher, land_role, removal_role, protection_role, recursion_role, board_wipe_role, wincon_role |
...
## 2. Lorehold From-Scratch Spell Pressure Topdeck v1 (`challenger_lorehold_spell_pressure_topdeck_v1`)

**Objective:** Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains.

**Commander intent alignment:** score `98.2`, status `needs_battle_proof`.

**Intent risks:** package_topdeck_miracle_setup_overfilled, package_hand_filter_overfilled, package_spell_chain_conversion_overfilled

**Evidence:** spell_chain_conversion=47; topdeck_miracle_setup=15; pressure_absorber=19; wincon_roles=9; key_cards=Flawless Maneuver, Mother of Runes, Ghostly Prison, Giver of Runes

**Strengths:**
- combat pressure absorber passes (19/4)
- spell-chain conversion passes (47/12)
- hand filtering passes (20/7)
- topdeck and miracle setup passes (15/6)
- draw density passes (18/12)
- ramp density passes (17/14)
- anchors present: Flawless Maneuver, Mother of Runes, Ghostly Prison, Giver of Runes, Wheel of Fortune
...
**Key Cards:** Flawless Maneuver, Mother of Runes, Ghostly Prison, Giver of Runes, Wheel of Fortune, Boros Signet, Monastery Mentor, Perch Protection, Rise of the Eldrazi, Talisman of Conviction
...
**Evidence:** spell_chain_conversion=44; topdeck_miracle_setup=14; pressure_absorber=10; wincon_roles=11; key_cards=Aetherflux Reservoir, Flawless Maneuver, Mother of Runes, Akroma's Will
...
## 5. VARIANT Lorehold Variant 08 - Rafael Paste 2026-06-24 (`deck_613`)
...
**Evidence:** spell_chain_conversion=46; topdeck_miracle_setup=20; pressure_absorber=9; wincon_roles=8; key_cards=Ghostly Prison, Lotus Petal, Mana Vault, Perch Protection

**Strengths:**
- spell-chain conversion passes (46/12)
...
## 7. VARIANT Lorehold Variant 11 - Rafael Paste 2026-06-24 (`deck_616`)
...
**Evidence:** spell_chain_conversion=38; topdeck_miracle_setup=8; pressure_absorber=19; wincon_roles=10; key_cards=Ghostly Prison, Wheel of Fortune, Monastery Mentor, Rise of the Eldrazi
...
- anchors present: Ghostly Prison, Wheel of Fortune, Monastery Mentor, Rise of the Eldrazi, Worldfire
...
**Key Cards:** Ghostly Prison, Wheel of Fortune, Monastery Mentor, Rise of the Eldrazi, Worldfire, Young Pyromancer, Arcane Signet, Chaos Warp, Soulfire Eruption, Coruscation Mage
...
**Evidence:** spell_chain_conversion=45; topdeck_miracle_setup=17; pressure_absorber=8; wincon_roles=10; key_cards=Boros Signet, Perch Protection, Rise of the Eldrazi, Talisman of Conviction
...
## 9. VARIANT Lorehold Variant 05 - Rafael Paste 2026-06-24 (`deck_610`)
...
## 10. VARIANT Lorehold Variant 07 - Rafael Paste 2026-06-24 (`deck_612`)

**Objective:** Spell-copy combo shell that prioritizes copy effects and burst mana to assemble deterministic spell-chain wins.

**Commander intent alignment:** score `72.9`, status `needs_battle_proof`.
...
**Evidence:** spell_chain_conversion=44; topdeck_miracle_setup=6; pressure_absorber=7; wincon_roles=13; key_cards=Birgi, God of Storytelling // Harnfel, Horn of Bounty, Wheel of Fortune, Mana Vault, Purphoros, God of the Forge

**Strengths:**
- spell-chain conversion passes (44/12)
- deterministic finisher passes (15/6)
- early setup/mana passes (42/18)
- graveyard recursion passes (11/5)
- ramp density passes (22/14)
- wincon density passes (13/6)
- anchors present: Birgi, God of Storytelling // Harnfel, Horn of Bounty, Wheel of Fortune, Mana Vault, Purphoros, God of the Forge, Young Pyromancer
...
**Key Cards:** Birgi, God of Storytelling // Harnfel, Horn of Bounty, Wheel of Fortune, Mana Vault, Purphoros, God of the Forge, Young Pyromancer, Arcane Signet, Ruby Medallion, Seething Song, Call Forth the Tempest, Agate Instigator

## 11. VARIANT Lorehold Variant 03 - Rafael Paste 2026-06-23 (`deck_608`)

**Objective:** Miracle spellslinger shell that uses topdeck setup and hand filtering to turn Lorehold's commander text into discounted spell chains.

**Commander intent alignment:** score `66.9`, status `needs_battle_proof`.
...
**Evidence:** spell_chain_conversion=26; topdeck_miracle_setup=9; pressure_absorber=5; wincon_roles=2; key_cards=Birgi, God of Storytelling // Harnfel, Horn of Bounty, Wheel of Fortune, Lotus Petal, Angel's Grace

**Strengths:**
- spell-chain conversion passes (26/12)
