...
- Planner: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_next_action_planner_20260630_after_profiled_gate.json`
- Trace audit: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_failure_targeted_trace_audit_20260628_v3_focus_access.json`
- Miner report: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_variant_gap_miner_20260628_v4_all_candidates_runtime_queue.json`
- Design contract: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_focus_access_package_design_20260628_v1.md`
- Squee probe: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_squee_graveyard_entry_probe_20260628_v1.json`
...
- Runtime gap queue: `docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_agent3_runtime_finisher_draw_recursion.json`
- Hand-filter cut model: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_hand_filter_cut_model_20260630_post_pg270_expanded607_search.json`
...
| ---: | --- | ---: | ---: | ---: | --- | --- |
| 1 | `runtime_rule_gap_batch` | 286 | 0 | 61 | `false` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_runtime_gap_family_queue.py --output-prefix docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg280_kayla_music_box` |
...
- Evidence inputs: `docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_agent3_runtime_finisher_draw_recursion.json`
...
- Runtime families:
  - `manual_model`: 16 cards, support `manual_model_required`, samples `Ancient Copper Dragon, Beacon of Immortality, Invincible Hymn, Planetarium of Wan Shi Tong, Semblance Anvil, Taunt from the Rampart`
  - `targeted_interaction`: 8 cards, support `runtime_family_partially_supported_review_required`, samples `Toralf, God of Fury // Toralf's Hammer, Boros Reckoner, Terror of the Peaks, Balefire Liege, Firesong and Sunspeaker, Ephemerate`
  - `free_cast`: 6 cards, support `runtime_family_partially_supported_review_required`, samples `Goliath Daydreamer, Assemble the Players, Chaos Wand, Kayla's Music Box, Possibility Storm, Pyxis of Pandemonium`
  - `recursion`: 6 cards, support `runtime_family_partially_supported_review_required`, samples `Charmbreaker Devils, Codex Shredder, Leyline Dowser, Perpetual Timepiece, The Warring Triad, Wand of Vertebrae`
  - `board_wipe_choice`: 4 cards, support `runtime_family_required`, samples `Chandra's Ignition, Karn's Sylex, Single Combat, Unstable Glyphbridge // Sandswirl Wanderglyph`
...
- Evidence inputs: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_access_cut_model_20260630_post_pg276_lane_core_blocked.json, /Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_squee_graveyard_entry_probe_20260628_v1.json`
...
- Evidence inputs: `/Users/desenvolvimentomobile/.codex/worktrees/lorehold-agent3-runtime-finisher-draw-recursion/docs/hermes-analysis/master_optimizer_reports/lorehold_hand_filter_cut_model_20260630_post_pg270_expanded607_search.json`
