...
- `proposal_count`: `442`
- `pattern_count`: `42`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 345, "package_ready_unprepared": 1, "runtime_family_backlog": 20, "split_scope_backlog": 72}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 345, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `damage_prevention_reflect/damage_prevention_reflect/prevent_next_damage_from_chosen_source_to_you_reflect_to_controller_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### damage_prevention_reflect / damage_prevention_reflect / prevent_next_damage_from_chosen_source_to_you_reflect_to_controller_v1

- Pattern id: `xmage_pattern:6509f93afc2d8f71b46f`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Deflecting Palm)
- Subpatterns: `1`
