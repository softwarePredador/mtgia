...
- `proposal_count`: `365`
- `pattern_count`: `44`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 261, "runtime_family_backlog": 24, "split_scope_backlog": 76}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 20, "manual_model_observation_only": 261, "requires_subpattern_split_before_promotion": 67, "runtime_template_candidate_requires_executor_tests": 4}`
