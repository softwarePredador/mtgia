...
- generated_at: `2026-06-27T18:30:04Z`
...
| 2 |  | Lorehold synergy package: primal_amulet_spell_engine (`synergy_primal_amulet_spell_engine`) | synergy-package | 9 | 4 | 5 | 0 | 44.44% | 13.50 | 8 | 3 | 1 | 1 | 0 | 0 | 0 | 7 | none |
...
### 2. Lorehold synergy package: primal_amulet_spell_engine (`synergy_primal_amulet_spell_engine`)
...
| Sisay, Weatherlight Captain #61 (real) | 2 | 1 | 0 | 66.67% | 14.00 | elimination=2 |
| Winota, Joiner of Forces #39 (real) | 1 | 2 | 0 | 33.33% | 14.00 | elimination=1 |

**Strategic event counts:** lorehold_cost_paid=115, lorehold_spell_cast=90, lorehold_upkeep_rummage=32, lorehold_spell_rummage=5, topdeck_manipulation_activated=13, miracle_cast=19, thor_cost_paid=1, thor_spell_cast=1, discard_to_top_replacement=2, lorehold_spell_rummage_discard_to_top=1, lorehold_rummage_discard_to_top=1, squee_to_graveyard=1
