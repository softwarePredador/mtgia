...
- Generated at: `2026-07-09T07:49:16.904033+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7425 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6238 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6213 | 274 |
| `battle_family_mapper_required` | 27663 | 90 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6438 |
| `triggered_or_static_ability` | 3841 |
| `damage_or_life_total_change` | 3683 |
| `token_creation` | 3472 |
...
| --- | ---: | --- | --- |
| `battle_family::manual_model_review` | 6438 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3683 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
