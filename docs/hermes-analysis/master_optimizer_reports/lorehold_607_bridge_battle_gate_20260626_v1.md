...
- generated_at: `2026-06-26T16:49:54Z`
...
| 2 |  | Lorehold 607 Bridge Candidate v1 (`candidate_607_bridge_v1`) | 607-bridge-strategy-candidate | 9 | 1 | 8 | 0 | 11.11% | 15.00 | 6 | 2 | none |
...
### 2. Lorehold 607 Bridge Candidate v1 (`candidate_607_bridge_v1`)

- objective: not available in structural matrix
- result: `1W/8L/0S`, WR `11.11%`
- construction_valid: `True`
- deck shape: size `100`, lands `34`, ramp `18`, removal `17`
...
**Strategic event counts:** lorehold_cost_paid=70, lorehold_spell_cast=62, miracle_cast=9, topdeck_manipulation_activated=5
