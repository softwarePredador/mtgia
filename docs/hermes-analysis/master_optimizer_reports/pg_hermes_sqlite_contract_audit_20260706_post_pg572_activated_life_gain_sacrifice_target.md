...
- Generated at: `2026-07-06T20:58:16.507491+00:00`
- Status: `pass`
...
| `sqlite_rows.battle_card_rules` | `pass` | rows=8827 |
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=8827 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=8827 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=8007 pg_runtime_keys=8025 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9172 |
...
| `pg_rows.deck_cards` | `pass` | rows=51219 |
