...
DO $$
BEGIN
  IF to_regclass('manaloom_deploy_audit.pgc063_pain_mana_source_cost_runtime_20260629') IS NULL THEN
    RAISE EXCEPTION 'PGC063 backup table is missing';
  END IF;
END $$;
...
FROM manaloom_deploy_audit.pgc063_pain_mana_source_cost_runtime_20260629 backup
