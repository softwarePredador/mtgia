...
- Generated at: `2026-07-05T11:45:02.089031+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5964 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4716 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4894 | 266 |
| `battle_family_mapper_required` | 28979 | 97 |
...
| `damage_or_life_total_change` | 3824 |
| `token_creation` | 3591 |
| `draw_selection_topdeck` | 3389 |
| `graveyard_recursion` | 1896 |
| `targeted_removal` | 1019 |
...
| `battle_family::damage_or_life_total_change` | 3824 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::targeted_removal` | 1019 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock`, `Against All Odds`, `Agate Assault` |
