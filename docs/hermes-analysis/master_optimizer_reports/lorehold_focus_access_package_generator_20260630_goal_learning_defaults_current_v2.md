...
- Generated at: `2026-06-30T20:28:28Z`
- Planner: `docs/hermes-analysis/master_optimizer_reports/lorehold_next_action_planner_20260630_goal_learning_defaults_current.json`
...
- Squee probe: `docs/hermes-analysis/master_optimizer_reports/lorehold_squee_graveyard_entry_probe_20260630_goal_learning_defaults_current.json`
- Access model: `docs/hermes-analysis/master_optimizer_reports/lorehold_access_cut_model_20260630_goal_learning_defaults_current.json`
...
- Top operational work: `contextual_tutor_cut_model`
...
| ---: | --- | ---: | ---: | ---: | --- | --- |
| 1 | `contextual_tutor_cut_model` | 39 | 2 | 0 | `false` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_tutor_cut_model.py --stem lorehold_tutor_cut_model_20260630_after_profiled_gate` |
| 2 | `squee_access_density_model` | 25 | 0 | 0 | `false` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_access_cut_model.py --stem lorehold_access_cut_model_20260630_after_profiled_gate` |
...
- Evidence inputs: `docs/hermes-analysis/master_optimizer_reports/lorehold_access_cut_model_20260630_goal_learning_defaults_current.json, docs/hermes-analysis/master_optimizer_reports/lorehold_squee_graveyard_entry_probe_20260630_goal_learning_defaults_current.json`
