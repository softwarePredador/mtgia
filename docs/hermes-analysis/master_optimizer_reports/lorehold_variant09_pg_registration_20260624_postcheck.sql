\pset pager off
-- PG register postcheck for Lorehold Variant 09.
SELECT
  'pg_lorehold_variant09_deck' AS check_name,
...
FROM decks d
WHERE d.id = 'b51c8f24-fa8b-50ee-8200-d78fe9908ffa'::uuid;

SELECT
  'pg_lorehold_variant09_deck_cards' AS check_name,
  COUNT(*) AS rows,
...
FROM deck_cards
WHERE deck_id = 'b51c8f24-fa8b-50ee-8200-d78fe9908ffa'::uuid;

SELECT
  'pg_lorehold_variant09_learned' AS check_name,
...
SELECT
  'pg_lorehold_variant09_missing_card_rows' AS check_name,
  COUNT(*) AS missing_card_rows
FROM deck_cards dc
LEFT JOIN cards c ON c.id = dc.card_id
WHERE dc.deck_id = 'b51c8f24-fa8b-50ee-8200-d78fe9908ffa'::uuid
  AND c.id IS NULL;
