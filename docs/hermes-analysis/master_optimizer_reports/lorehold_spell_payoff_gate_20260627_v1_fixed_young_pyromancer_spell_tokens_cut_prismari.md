...
- generated_at: `2026-06-27T20:53:29Z`
...
| 2 |  | Lorehold synergy package: young_pyromancer_spell_tokens_cut_prismari (`synergy_young_pyromancer_spell_tokens_cut_prismari`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 15.00 | 3 | 1 | 1 | 0 | 0 | 0 | 0 | 3 | none |
...
### 2. Lorehold synergy package: young_pyromancer_spell_tokens_cut_prismari (`synergy_young_pyromancer_spell_tokens_cut_prismari`)
...
**Strategic event counts:** lorehold_cost_paid=26, lorehold_spell_cast=18, lorehold_upkeep_rummage=19, miracle_cast=7, discard_to_top_replacement=3, lorehold_rummage_discard_to_top=3, thor_cost_paid=1, thor_spell_cast=1, topdeck_manipulation_activated=4
