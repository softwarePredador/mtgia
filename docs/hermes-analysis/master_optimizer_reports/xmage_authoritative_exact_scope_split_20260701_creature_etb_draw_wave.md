...
- Generated at: `2026-07-01T10:13:09+00:00`
- Status: `ready`
- Mutations performed: `[]`

## Summary

`{"adapter_work_unit_counts": {"draw_engine::xmage_draw_card_variant_review_v1": 28}, "blocked_reason_counts": {"add_counters_ability_class_not_simple": 4, "add_counters_counter_not_fixed": 8, "add_counters_effect_class_not_pure": 63, "add_counters_oracle_not_simple": 1, "add_counters_target_not_supported": 2, "additional_cost_detected": 144, "board_wipe_ability_class_not_simple": 67, "board_wipe_damage_amount_not_fixed": 9, "board_wipe_damage_scope_not_supported": 13, "board_wipe_destroy_scope_not_supported": 38, "board_wipe_effect_class_not_supported": 83, "board_wipe_oracle_not_simple": 38, "boost_target_source_not_single_fixed": 35, "bounce_ability_class_not_simple": 28, "bounce_effect_class_not_pure": 44, "bounce_target_not_supported": 20, "counter_ability_class_not_simple": 19, "counter_effect_class_not_pure": 35, "counter_oracle_not_simple": 2, "counter_target_not_supported": 23, "damage_amount_not_fixed": 45, "damage_effect_class_not_pure": 123, "damage_target_not_supported": 24, "destroy_effect_class_not_pure": 138, "destroy_target_not_supported": 74, "draw_effect_class_not_pure": 562, "etb_draw_count_not_fixed": 13, "etb_life_gain_amount_not_fixed": 12, "exile_effect_class_not_pure": 42, "exile_oracle_not_simple": 8, "exile_target_not_supported": 30, "life_gain_amount_not_fixed": 19, "life_gain_effect_class_not_pure": 166, "life_gain_oracle_not_simple": 11, "mana_source_effect_class_not_simple": 307, "mana_source_oracle_not_simple": 121, "mana_source_safe_ability_missing": 133, "mana_source_spell_not_supported": 1, "mana_source_unsafe_ability_class": 135, "not_instant_or_sorcery_spell": 4041, "not_one_shot_spell_ability": 250, "recursion_ability_class_not_simple": 13, "recursion_effect_class_not_pure": 461, "recursion_oracle_not_simple": 12, "recursion_target_not_supported": 8, "static_keyword_not_creature": 2}, "considered_supported_work_unit_rows": 7455, "family_counts": {"xmage_creature_etb_draw_cards": 28}, "proposal_count": 28, "proposal_status_counts": {"batch_pg_candidate_after_precheck": 28}, "safe_for_batch_pg_package_count": 28, "scope_counts": {"xmage_creature_etb_draw_cards_v1": 28}}`

## Selected Proposals

| Card | Family | Scope | Effect | Logical rule key |
| --- | --- | --- | --- | --- |
| `Baleful Strix` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:0790f7ac47d9086d6df56c127961707f` |
| `Carven Caryatid` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:1e3a09021614ea7db95f25b2e8126482` |
| `Cloudkin Seer` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:7855ca82bae5f996be6c4b51ebb09245` |
| `Council of Advisors` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Elvish Visionary` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Gallant Citizen` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Generous Stray` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Gryff Vanguard` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:7855ca82bae5f996be6c4b51ebb09245` |
| `Helpful Hunter` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Joraga Visionary` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Jungle Barrier` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:1e3a09021614ea7db95f25b2e8126482` |
| `Kavu Climber` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Kindly Customer` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Merchant of Secrets` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Messenger Falcons` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:7855ca82bae5f996be6c4b51ebb09245` |
| `Muse Drake` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:7855ca82bae5f996be6c4b51ebb09245` |
| `Nimble Innovator` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Owlbear` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:0038699bc4ef5d7f9310514f6bdbfcd7` |
| `Pond Prophet` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Rhox Oracle` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Roving Harper` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Shaman of Spring` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Skyscanner` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:7855ca82bae5f996be6c4b51ebb09245` |
| `Spirited Companion` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Striped Bears` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
| `Tome Raider` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:7855ca82bae5f996be6c4b51ebb09245` |
| `Wall of Blossoms` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:1e3a09021614ea7db95f25b2e8126482` |
| `Wistful Selkie` | `xmage_creature_etb_draw_cards` | `xmage_creature_etb_draw_cards_v1` | `creature` | `battle_rule_v1:50ef87a68c15784e7bc1b1e31085c03d` |
