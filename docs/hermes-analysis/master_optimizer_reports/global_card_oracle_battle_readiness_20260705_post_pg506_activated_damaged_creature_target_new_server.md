...
- Generated at: `2026-07-05T12:46:56.007123+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5985 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4737 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4915 | 266 |
| `battle_family_mapper_required` | 28958 | 97 |
...
| `battle_family::targeted_removal` | 1008 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock`, `Against All Odds`, `Agate Assault` |
