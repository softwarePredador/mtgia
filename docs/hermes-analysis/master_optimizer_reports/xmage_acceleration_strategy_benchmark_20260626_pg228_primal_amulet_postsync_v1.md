...
- Generated at: `2026-06-26T06:17:40+00:00`
- Status: `ready`
- Mutations performed: `[]`

## Sources

- `proposal_report`: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg228_primal_amulet_postsync_v1_proposals.json`
- `effective_queue_report`: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_effective_queue_20260626_pg228_primal_amulet_postsync_v1.json`
...
- Recommended score: `67.16`

## Ranking

| Rank | Strategy | Verdict | Score | Cards/unit |
| --- | --- | --- | ---: | ---: |
| 1 | `exact_scope_cluster_first` | `use_as_next_modeling_lane` | 72.27 | 19.0 |
| 2 | `hybrid_effective_queue_pattern_registry` | `recommended` | 67.16 | 5.25 |
| 3 | `package_manifest_first` | `use_immediately_with_pg_approval` | 49.44 | 1.0 |
| 4 | `full_xmage_first` | `reject_as_primary` | 45.56 | 0.013 |
| 5 | `pattern_registry_first` | `use_as_shadow_infrastructure` | 43.72 | 0.023 |
...
- Evidence:
  ...
  - `current_queue_cards`: 401
  - `work_multiplier_vs_current_queue`: 79.07
...
- Evidence:
  - `effect_files`: 802
  - `test_files`: 2009
  - `candidate_cards_for_pattern_learning`: 66
...
- Evidence:
  - `current_queue_cards`: 401
  - `proposal_status_counts`: {"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 330, "partial_batch_pg_candidate_preserve_shadow_rows_after_precheck": 1, "runtime_family_implementation_required": 4, "split_family_scope_review_required": 62}
