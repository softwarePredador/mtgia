...
- Generated at: `2026-07-01T20:09:31.641523+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4803 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3490 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2342 | 394 |
| `battle_family_mapper_required` | 30205 | 225 |
...
| `battle_family::recursion_or_bounce` | 524 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
