...
CREATE TABLE IF NOT EXISTS manaloom_deploy_audit.pg742_trusted_rule_oracle_hash_backfill_20260711 AS
SELECT *
...
WITH updated AS (
  ...
  SET
    ...
    notes = concat_ws(
      E'\n',
      nullif(r.notes, ''),
      'PG742 contract backfill: oracle_hash restored from cards.oracle_text for trusted executable rule.'
    )
  FROM public.cards c
