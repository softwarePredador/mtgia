...
- Generated at: `2026-06-26T09:33:03+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg237_magus_runtime_v3_proposals.json`
- Package manifests scanned: `110`
- Cards covered by package manifests: `246`
...
- `P0` Exhaust the unpackaged PG-ready residual before opening new runtime work. Reason: 1 cards are immediately packageable. Top exact cluster: activated_tap_sacrifice_self_each_player_discards_hand_draws_seven_v1 (1)
- `P1` After the PG-ready lane shrinks, batch the biggest split-scope cluster. Reason: The partially supported backlog is 59 cards. Top exact cluster: targeted_damage_variant_v1 (18)
...
- `P2` Keep the manual mapper lane last. Reason: 322 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `1`
- Top scope clusters:
  - `creature` / `creature` / `activated_tap_sacrifice_self_each_player_discards_hand_draws_seven_v1`: `1` cards (Magus of the Wheel)

### split_scope_backlog

- Count: `59`
- Top scope clusters:
  - `targeted_interaction` / `direct_damage` / `targeted_damage_variant_v1`: `18` cards (Balefire Liege, Boros Reckoner, Brash Taunter, Cemetery Gatekeeper, Eiganjo, Seat of the Empire, Firesong and Sunspeaker, Gleeful Arsonist, Harsh Mentor)
...
- Count: `322`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `321` cards ("Name Sticker" Goblin, Ad Nauseam, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury, Amphibian Downpour)
