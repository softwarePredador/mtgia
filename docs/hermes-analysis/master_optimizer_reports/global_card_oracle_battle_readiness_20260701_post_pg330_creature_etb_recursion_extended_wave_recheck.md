...
- Generated at: `2026-07-01T20:46:25.988296+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 4818 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3505 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 2357 | 394 |
| `battle_family_mapper_required` | 30190 | 225 |
...
| `battle_family::recursion_or_bounce` | 513 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe`, `Alchemist's Retrieval` |
