...
- Generated at: `2026-06-28T10:31:20Z`
...
- Runtime gap queue: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260628_v6_current_miner.json`
...
| ---: | --- | ---: | ---: | ---: | --- | --- |
| 1 | `runtime_rule_gap_batch` | 106 | 0 | 61 | `false` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_runtime_gap_family_queue.py --output-prefix docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260628_v7_operational_queue` |
| 2 | `hand_filter_non_core_cut_search` | 66 | 23 | 0 | `false` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_hand_filter_cut_model.py --stem lorehold_hand_filter_cut_model_20260628_v5_operational_queue` |
| 3 | `contextual_tutor_cut_model` | 39 | 2 | 0 | `false` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_tutor_cut_model.py --stem lorehold_tutor_cut_model_20260628_v3_operational_queue` |
| 4 | `squee_access_density_model` | 35 | 9 | 0 | `true` | `python3 docs/hermes-analysis/manaloom-knowledge/scripts/lorehold_access_cut_model.py --stem lorehold_access_cut_model_20260628_v4_operational_queue` |
...
- Evidence inputs: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260628_v6_current_miner.json`
...
- Runtime families:
  - `manual_model`: 52 cards, support `manual_model_required`, samples `Ancient Copper Dragon, Beacon of Immortality, Heroes Remembered, Invincible Hymn, Planetarium of Wan Shi Tong, Semblance Anvil`
  - `targeted_interaction`: 6 cards, support `runtime_family_partially_supported_review_required`, samples `Boros Reckoner, Terror of the Peaks, Balefire Liege, Firesong and Sunspeaker, Repercussion, Toralf, God of Fury // Toralf's Hammer`
  - `free_cast`: 1 cards, support `runtime_family_partially_supported_review_required`, samples `Goliath Daydreamer`
  - `static_damage_modifier`: 1 cards, support `runtime_supported_family`, samples `Twinflame Tyrant`
  - `topdeck_play`: 1 cards, support `runtime_supported_family`, samples `Verge Rangers`
