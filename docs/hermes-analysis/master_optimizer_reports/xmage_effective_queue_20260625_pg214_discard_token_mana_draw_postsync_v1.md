...
- Generated at: `2026-06-25T09:55:13+00:00`
- Status: `ready`
- Proposal report: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg214_discard_token_mana_draw_postsync_v1_proposals.json`
- Package manifests scanned: `92`
- Cards covered by package manifests: `216`
...
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 12 cards. Top reusable exact scope cluster: damage_all_variant_v1 (1). Largest raw family is token_maker (11 cards across 11 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
...
- Top scope clusters:
  ...
  - `token_maker` / `token_maker` / `xmage_create_token_variant_greengoblinnemesis_v1`: `1` cards (Green Goblin, Nemesis)
