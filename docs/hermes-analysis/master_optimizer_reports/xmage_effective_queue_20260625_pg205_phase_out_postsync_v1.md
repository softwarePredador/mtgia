...
- Generated at: `2026-06-25T06:15:08+00:00`
- Status: `ready`
...
- Package manifests scanned: `83`
- Cards covered by package manifests: `204`
...
- `P2` Keep the manual mapper lane last. Reason: 339 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `339`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `338` cards ("Name Sticker" Goblin, Ad Nauseam, Agate Instigator, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury)
