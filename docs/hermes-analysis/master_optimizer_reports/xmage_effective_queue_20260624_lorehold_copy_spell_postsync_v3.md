...
- Generated at: `2026-06-24T20:23:22+00:00`
- Status: `ready`
...
- Package manifests scanned: `64`
- Cards covered by package manifests: `183`

## Effective Lanes

- `package_already_prepared`: `0`
- `package_ready_unprepared`: `0`
- `split_scope_backlog`: `80`
...
- `P1` After the PG-ready lane shrinks, batch the biggest split-scope cluster. Reason: The partially supported backlog is 80 cards. Top exact cluster: targeted_damage_variant_v1 (22)
...
- `P2` Keep the manual mapper lane last. Reason: 261 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Count: `80`
- Top scope clusters:
  - `targeted_interaction` / `direct_damage` / `targeted_damage_variant_v1`: `22` cards (Balefire Liege, Boros Reckoner, Brash Taunter, Caldera Pyremaw, Cemetery Gatekeeper, Eiganjo, Seat of the Empire, Firesong and Sunspeaker, Gleeful Arsonist)
...
- Count: `261`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `260` cards ("Name Sticker" Goblin, Ad Nauseam, Agate Instigator, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Ancient Copper Dragon)
