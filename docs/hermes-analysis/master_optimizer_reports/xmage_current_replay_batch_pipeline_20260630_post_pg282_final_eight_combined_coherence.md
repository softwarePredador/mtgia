...
| `medium` | `battle_support` | 4051 | `Mirage Mirror` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_engine`, `ramp_permanent` |
| `medium` | `battle_support` | 4051 | `Open the Omenpaths` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `pump_all`, `ramp_ritual` |
...
| `medium` | `battle_support` | 4051 | `Sculpting Steel` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_permanent` |
| `medium` | `battle_support` | 4051 | `Voltaic Key` | 1 | 1 | `trusted_rule_without_oracle_hash` | `passive`, `ramp_permanent` |
