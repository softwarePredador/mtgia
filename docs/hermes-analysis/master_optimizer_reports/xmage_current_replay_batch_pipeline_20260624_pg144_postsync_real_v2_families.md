...
- Summary: `{"batch_metadata_candidate_count": 0, "card_count": 242, "family_count": 3, "family_counts": {"copy_creature_token": 1, "manual_model": 234, "token_maker": 7}, "manual_or_blocked_count": 235, "promotion_lane_counts": {"blocked_missing_xmage_source": 3, "mapper_metadata_or_test_scenario_required": 231, "runtime_family_implementation_required": 7, "split_family_scope_review_required": 1}, "runtime_family_required_count": 7}`
...
| `token_maker` | 7 | `runtime_family_required` | `{"runtime_family_implementation_required": 7}` | token creation with stats, abilities, duration, and zone cleanup |
...
- Family tests: `[]`
- Cards: `["Insidious Roots", "Eldrazi Confluence", "Springheart Nantuko", "Magda, Brazen Outlaw", "Hazel's Brewmaster", "Patrol Signaler", "Treasure Vault"]`
