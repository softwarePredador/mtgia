...
- Generated at: `2026-07-07T07:52:25.471452+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6853 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5638 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5816 | 270 |
| `battle_family_mapper_required` | 28057 | 93 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6612 |
| `triggered_or_static_ability` | 3841 |
| `damage_or_life_total_change` | 3745 |
| `token_creation` | 3490 |
| `draw_selection_topdeck` | 3343 |
| `graveyard_recursion` | 1890 |
| `targeted_removal` | 960 |
| `tutor_search_library` | 744 |
| `modal_or_choice_effect` | 699 |
| `mana_generation_or_ritual` | 662 |
| `alternate_or_free_cast` | 494 |
| `protection_prevention` | 488 |
| `recursion_or_bounce` | 466 |
| `counterspell_or_stack_interaction` | 354 |
...
| `battle_family::manual_model_review` | 6612 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3745 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3343 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
| `battle_family::graveyard_recursion` | 1890 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Abhorrent Oculus`, `Abomination of Llanowar`, `Aboshan's Desire` |
| `battle_family::targeted_removal` | 960 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock`, `Against All Odds`, `Agate Assault` |
...
| `battle_family::protection_prevention` | 488 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolute Grace`, `Absolute Law`, `Adept Watershaper`, `Aegis of the Gods`, `Agent Frank Horrigan`, `Agent of the Shadow Thieves`, `Airtight Alibi`, `Akroma's Memorial`, `Akroma, Angel of Fury`, `Akroma, Vision of Ixidor` |
...
| `battle_family::counterspell_or_stack_interaction` | 354 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abjure`, `Abstruse Interference`, `Access Denied`, `Admiral's Order`, `Adric, Mathematical Genius`, `Amazing Acrobatics`, `Anticognition`, `Archmage's Charm`, `Arenson's Aura`, `Artistic Refusal` |
