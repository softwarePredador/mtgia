# Annotation Runtime Batch Probe - PGC067

- Generated UTC: `2026-06-29T11:34:37+00:00`
- Baseline input: `39` cards from `annotation_runtime_batch_probe_20260629_pgc060.json`
- Clean cards: `13`
- Residual cards: `26`
- Runtime executor value paths: `42`

## Clean Cards

`City of Brass`; `Clifftop Retreat`; `Dualcaster Mage`; `Elves of Deep Shadow`; `Erode`; `Inspiring Vantage`; `Mana Confluence`; `Reiterate`; `Reverberate`; `Sundering Eruption // Volcanic Fissure`; `Sundown Pass`; `Tarnished Citadel`; `Untimely Malfunction`
