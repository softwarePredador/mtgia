...
- Summary: `{"batch_metadata_candidate_count": 0, "card_count": 128, "family_count": 13, "family_counts": {"board_wipe_choice": 3, "copy_spell_engine": 1, "draw_engine": 2, "free_cast": 9, "life_total_change": 1, "manual_model": 61, "passive": 5, "ramp_permanent": 5, "recursion": 10, "targeted_interaction": 12, "targeted_protection": 7, "topdeck_play": 2, "tutor": 10}, "manual_or_blocked_count": 128, "promotion_lane_counts": {"mapper_metadata_or_test_scenario_required": 61, "split_family_scope_review_required": 67}, "runtime_family_required_count": 0}`
...
| `recursion` | 10 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 10}` | graveyard target selection, zone movement to hand or battlefield, and replacement-cost annotations |
...
- Cards: `["Flashback", "Worldfire", "Perpetual Timepiece", "Endurance", "Moonshadow", "Bond of Insight", "Charmbreaker Devils", "Experimental Overload"]`
