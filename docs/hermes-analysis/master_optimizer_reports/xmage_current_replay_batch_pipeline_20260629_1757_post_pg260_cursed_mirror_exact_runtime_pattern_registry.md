...
- `proposal_count`: `139`
- `pattern_count`: `21`
- `lane_counts`: `{"manual_mapper_backlog": 63, "split_scope_backlog": 76}`
- `pattern_status_counts`: `{"candidate_template_requires_review_tests": 8, "manual_model_observation_only": 1, "requires_subpattern_split_before_promotion": 12}`
- `card_counts_by_pattern_status`: `{"candidate_template_requires_review_tests": 11, "manual_model_observation_only": 63, "requires_subpattern_split_before_promotion": 65}`
...
### ramp_ritual / ramp_ritual / xmage_spell_mana_ritual_variant_review_v1

- Pattern id: `xmage_pattern:8371d134b3e32b636072`
- Lane: `split_scope_backlog`
- Status: `requires_subpattern_split_before_promotion`
- Cards: `2` (Burnt Offering, Mana Geyser)
- Subpatterns: `2`
- Required evidence: `["subpattern split", "focused ManaLoom tests per subpattern", "package generation only for exact supported subpatterns"]`
