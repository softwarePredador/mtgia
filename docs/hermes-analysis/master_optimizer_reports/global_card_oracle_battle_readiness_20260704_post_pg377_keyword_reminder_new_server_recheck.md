...
- Generated at: `2026-07-04T01:42:39.260581+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5066 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 3777 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 3912 | 250 |
| `battle_family_mapper_required` | 29918 | 100 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7280 |
| `damage_or_life_total_change` | 3941 |
...
| `battle_family::manual_model_review` | 7280 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
| `battle_family::damage_or_life_total_change` | 3941 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Acceptable Losses` |
...
| `battle_family::protection_prevention` | 562 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abbey Gargoyles`, `Absolute Grace`, `Absolute Law`, `Adept Watershaper`, `Aegis of the Gods`, `Agent Frank Horrigan`, `Agent of the Shadow Thieves`, `Airtight Alibi`, `Akroma's Memorial`, `Akroma, Angel of Fury` |
