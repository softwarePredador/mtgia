...
- Generated at: `2026-07-01T10:40:22.010632+00:00`
- Status: `pass`
...
| `sqlite_rows.battle_card_rules` | `pass` | rows=5524 |
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=5524 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=5524 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=5524 pg_runtime_keys=5818 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=6741 |
...
| `pg_rows.deck_cards` | `pass` | rows=52117 |
