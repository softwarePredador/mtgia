...
SELECT
  ...
  to_regclass('manaloom_deploy_audit.pg077_seething_song_metadata_restore_20260623_062422') IS NOT NULL AS backup_table_already_exists
FROM cards c
