...
- Generated at: `2026-07-07T06:38:56.249910+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=9135 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=9135 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=7730 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=7730 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=7730 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=8223 pg_runtime_keys=8220 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9383 |
...
| `pg_rows.deck_cards` | `pass` | rows=54547 |
