...
- Generated at: `2026-07-12T02:00:24.061512+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7801 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6644 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6537 | 268 |
| `battle_family_mapper_required` | 27261 | 87 |
| `battle_rule_verification_required` | 66 | 9 |
...
| --- | ---: | --- | --- |
| `battle_rule_verification_required` | 66 | active executable rule exists, but snapshot has no verified rule; run focused runtime/E2E proof, then promote review_status to verified via PG package | `Aetherflux Reservoir`, `Apex of Power`, `Approach of the Second Sun`, `Arcane Endeavor`, `Archaeomancer's Map`, `Austere Command`, `Basking Broodscale`, `Blind Obedience`, `Boros Charm`, `Breena, the Demagogue` |
| `battle_family::manual_model_review` | 6289 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
