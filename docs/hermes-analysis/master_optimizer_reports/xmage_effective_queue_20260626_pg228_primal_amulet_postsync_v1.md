...
- Generated at: `2026-06-26T06:17:29+00:00`
- Status: `ready`
- Proposal report: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg228_primal_amulet_postsync_v1_proposals.json`
...
- `split_scope_backlog`: `62`
- `runtime_family_backlog`: `4`
- `manual_mapper_backlog`: `330`
...
- `P1` After the PG-ready lane shrinks, batch the biggest split-scope cluster. Reason: The partially supported backlog is 62 cards. Top exact cluster: targeted_damage_variant_v1 (19)
...
- `P2` Keep the manual mapper lane last. Reason: 330 cards still need mapper/manual review; this lane should not drive executor architecture.
...
- Top scope clusters:
  ...
  - `targeted_interaction` / `add_counters` / `source_add_counters_variant_v1`: `9` cards (Bloodchief Ascension, Brallin, Skyshark Rider, Nightshade Harvester, Palantír of Orthanc, Solphim, Mayhem Dominus, Séance Board, Tezzeret, Cruel Captain, The Haunt of Hightower)
...
- Count: `330`
- Top scope clusters:
  - `manual_model` / `external_reference_required_manual_model` / `xmage_reference_requires_manual_model_review_v1`: `329` cards ("Name Sticker" Goblin, Ad Nauseam, Akroma's Will, Alhammarret's Archive, All Is Dust, Altar of Dementia, Aminatou's Augury, Amphibian Downpour)
