...
- generated_at: `2026-06-28T23:27:24Z`
...
1. `critical` `runtime_rule_gap` `coherence_critical_high_findings` count=583 next=`prioritize_cards_with_no_active_or_no_trusted_rules_in_current_deck_scope`
   - coherence audit has critical=1, high=392 [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/deck_card_battle_rule_coherence_audit_current_explicit_20260628_123905.json]
     ...
     top_lorehold_runtime_missing: `Radiant Performer, Pyxis of Pandemonium, Prototype Portal, Possibility Storm, Perpetual Timepiece`
   ...
   - coherence audit has critical=1, high=340 [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg240_bolt_bend_postsync_v1_combined_coherence.json]
     ...
     top_lorehold_runtime_missing: `Penance, Magmakin Artillerist, Thor, God of Thunder, Tablet of Discovery, Radiant Scrollwielder`
...
2. `critical` `runtime_or_test_failure` `text_runtime_traceback` count=19 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   - text log contains runtime_traceback [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc051_senseis_divining_top_generic_draw_package.md]
...
3. `critical` `runtime_or_test_failure` `text_test_failure` count=10 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   - text log contains test_failure [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc051_senseis_divining_top_generic_draw_package.md]
...
4. `critical` `runtime_or_test_failure` `top_level_status` count=7 next=`inspect_failure_and_add_focused_regression_test`
...
8. `high` `blocked_workflow` `text_blocked` count=90 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   - text log contains blocked [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/seventeenlands_battle_prior_compare_birgi_scoreability_20260628_v1.md]
...
11. `high` `evidence_gap` `candidate_unobserved` count=3 next=`do_not_score_swap_until_forced_or_natural_access_sample_exists`
   - candidate card was not observed: Birgi, God of Storytelling // Harnfel, Horn of Bounty [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/seventeenlands_battle_prior_compare_birgi_scoreability_20260628_v1.json]
...
12. `high` `evidence_gap` `top_level_status` count=3 next=`rerun_with_candidate_observation_or_min_used_sample`
   - report status is inconclusive_candidate_unobserved [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/seventeenlands_battle_prior_compare_birgi_scoreability_20260628_v1.json]
...
19. `medium` `runtime_or_test_failure` `text_warning` count=249 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains warning [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc006_formidable_speaker_annotation_only_executor_guard_package.md]
20. `medium` `battle_rhythm_gap` `prior_rhythm_flags` count=5 next=`calibrate_or_quarantine_gate_metrics_before_treating_winrate_as_strategy_signal`
   - battle prior emitted 4 rhythm flags [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/seventeenlands_battle_prior_compare_birgi_scoreability_20260628_v1.json]
