...
| 2 |  | Lorehold synergy package: one_ring_protection_draw_cut_squelcher (`synergy_one_ring_protection_draw_cut_squelcher`) | synergy-package | 9 | 1 | 8 | 0 | 11.11% | 13.00 | 5 | 2 | 0 | 2 | 2 | 2 | 0 | 8 | none |
...
**Strategic event counts:** lorehold_cost_paid=85, lorehold_spell_cast=64, lorehold_upkeep_rummage=37, miracle_cast=13, topdeck_manipulation_activated=3, squee_to_graveyard=3, graveyard_upkeep_return_self_to_hand=2, squee_upkeep_return=2, squee_return_after_known_graveyard_entry=2, lorehold_spell_rummage=12
