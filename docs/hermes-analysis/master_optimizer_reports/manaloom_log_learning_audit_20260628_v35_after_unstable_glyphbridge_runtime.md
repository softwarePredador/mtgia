...
- generated_at: `2026-06-28T23:19:39Z`
...
1. `critical` `runtime_rule_gap` `coherence_critical_high_findings` count=583 next=`prioritize_cards_with_no_active_or_no_trusted_rules_in_current_deck_scope`
   - coherence audit has critical=1, high=392 [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/deck_card_battle_rule_coherence_audit_current_explicit_20260628_123905.json]
     ...
     top_lorehold_runtime_missing: `Toralf, God of Fury // Toralf's Hammer, Radiant Performer, Pyxis of Pandemonium, Prototype Portal, Possibility Storm`
   ...
   - coherence audit has critical=1, high=340 [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260626_pg240_bolt_bend_postsync_v1_combined_coherence.json]
     ...
     top_lorehold_runtime_missing: `Penance, Magmakin Artillerist, Toralf, God of Fury // Toralf's Hammer, Thor, God of Thunder, Tablet of Discovery`
...
2. `critical` `runtime_or_test_failure` `text_runtime_traceback` count=18 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains runtime_traceback [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc050_furygale_flocking_graveyard_cost_reduction_package.md]
3. `critical` `runtime_or_test_failure` `text_test_failure` count=9 next=`inspect_text_log_and_convert_recurring_pattern_to_structured_gate_field`
   ...
   - text log contains test_failure [/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/pgc050_furygale_flocking_graveyard_cost_reduction_package.md]
