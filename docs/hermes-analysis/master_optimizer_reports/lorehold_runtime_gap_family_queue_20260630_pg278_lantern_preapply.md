...
- Generated at: `2026-06-30T12:04:57Z`
...
- Promotion lanes: `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 14}`
...
| 6 | `topdeck_play` | 2 | `runtime_supported_family` | `metadata_batch_after_pg_precheck` | `{"contextual": 2}` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 1}` | top-of-library visibility and permission to play cards from library under board-state conditions |
