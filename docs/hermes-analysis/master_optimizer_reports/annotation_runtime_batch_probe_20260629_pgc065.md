# Annotation Runtime Batch Probe - PGC065

- Generated UTC: `2026-06-29T10:50:24+00:00`
- Baseline input: `39` cards from `annotation_runtime_batch_probe_20260629_pgc060.json`
- Clean cards: `10`
- Residual cards: `29`
- Runtime executor value paths: `39`

## Clean Cards

`City of Brass`; `Clifftop Retreat`; `Dualcaster Mage`; `Elves of Deep Shadow`; `Erode`; `Inspiring Vantage`; `Mana Confluence`; `Reverberate`; `Sundown Pass`; `Tarnished Citadel`

## Residual Cards

| Card | Annotation Fields | Runtime Fields |
| --- | --- | --- |
...
| `Sundering Eruption // Volcanic Fissure` | `cant_block_mode_status` | `basic_land_compensation_status` |
...
| `Untimely Malfunction` | `cant_block_mode_status` | `redirect_target_mode_status` |
