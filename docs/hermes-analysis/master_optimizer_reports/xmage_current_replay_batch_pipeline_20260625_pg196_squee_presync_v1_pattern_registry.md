...
- `proposal_count`: `437`
- `pattern_count`: `43`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 337, "package_ready_unprepared": 1, "runtime_family_backlog": 22, "split_scope_backlog": 73}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 18, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 10, "runtime_template_candidate_requires_executor_tests": 2}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 18, "manual_model_observation_only": 337, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 64, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `creature/creature/graveyard_upkeep_return_self_to_hand_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
| `manual_model/external_reference_required_manual_model/xmage_reference_requires_manual_model_review_v1` | `manual_mapper_backlog` | `manual_model_observation_only` | 336 | 54 | Keep after package, split-scope, and homogeneous-runtime lanes. |
...
### creature / creature / graveyard_upkeep_return_self_to_hand_v1

- Pattern id: `xmage_pattern:886cff8df1b40c5c5976`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Squee, Goblin Nabob)
- Subpatterns: `1`
