...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 140, "family_count": 14, "family_counts": {"board_wipe_choice": 3, "copy_spell_engine": 1, "draw_engine": 4, "free_cast": 9, "life_total_change": 1, "manual_model": 63, "passive": 5, "ramp_permanent": 8, "ramp_ritual": 2, "recursion": 11, "targeted_interaction": 12, "targeted_protection": 8, "topdeck_play": 3, "tutor": 10}, "manual_or_blocked_count": 139, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "mapper_metadata_or_test_scenario_required": 63, "split_family_scope_review_required": 76}, "runtime_family_required_count": 0}`
...
| `ramp_permanent` | 8 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 7}` | battlefield mana artifacts and triggered resource permanents |
...
- Batch strategy: `split_by_scope_before_metadata_batch`
- Family tests: `[]`
- Cards: `["Growing Rites of Itlimoc", "Neheb, the Eternal", "Blazing Firesinger", "Ashling, Flame Dancer", "Electro, Assaulting Battery", "Lion's Eye Diamond", "\"Name Sticker\" Goblin", "Cursed Mirror"]`
