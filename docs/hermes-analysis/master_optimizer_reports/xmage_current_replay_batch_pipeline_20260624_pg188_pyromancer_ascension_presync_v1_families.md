...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 367, "family_count": 9, "family_counts": {"board_wipe_choice": 4, "copy_spell_engine": 1, "creature": 4, "manual_model": 264, "mill_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 66, "token_maker": 21, "tutor": 4}, "manual_or_blocked_count": 342, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 261, "runtime_family_implementation_required": 24, "split_family_scope_review_required": 77}, "runtime_family_required_count": 24}`
...
| `copy_spell_engine` | 1 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1}` | stack spell copying from ETB, instant responses, and spell-cast battlefield triggers |
