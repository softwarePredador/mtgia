...
- Generated at: `2026-07-05T15:26:31+00:00`
...
| `authoritative_source_coverage_ratio` | 0.9879 |
| `adapter_work_unit_count` | 11384 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 25685 |
...
| `removal_exile::targeted_exile_variant_v1` | 143 |
...
| `token_maker::xmage_signature::CreateTokenEffect::no_ability_class::no_target_class::no_condition_class::token` | 34 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11575 |
| `token_maker` | 2392 |
| `recursion` | 1799 |
| `draw_engine` | 1593 |
| `add_counters` | 1211 |
...
| --- | ---: |
| `targeting` | 13652 |
| `triggered_ability` | 11698 |
| `static_ability` | 5508 |
| `activated_ability` | 5418 |
| `counter` | 3809 |
| `condition` | 3287 |
| `token` | 2444 |
| `draw` | 2125 |
