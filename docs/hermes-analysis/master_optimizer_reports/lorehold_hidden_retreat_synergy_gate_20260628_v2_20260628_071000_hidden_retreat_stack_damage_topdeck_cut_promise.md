...
- generated_at: `2026-06-28T07:07:30Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_hidden_retreat_synergy_gate_20260628_v2_20260628_071000_hidden_retreat_stack_damage_topdeck_cut_promise_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: hidden_retreat_stack_damage_topdeck_cut_promise (`synergy_hidden_retreat_stack_damage_topdeck_cut_promise`) | synergy-package | 3 | 1 | 2 | 0 | 33.33% | 15.00 | 1 | 0 | 0 | 0 | 0 | 0 | 0 | 2 | 0 | 0 | none | none |
...
### 2. Lorehold synergy package: hidden_retreat_stack_damage_topdeck_cut_promise (`synergy_hidden_retreat_stack_damage_topdeck_cut_promise`)
...
**Strategic event counts:** lorehold_cost_paid=35, lorehold_spell_cast=26, lorehold_upkeep_rummage=6, miracle_cast=3, thor_cost_paid=1, thor_spell_cast=1
