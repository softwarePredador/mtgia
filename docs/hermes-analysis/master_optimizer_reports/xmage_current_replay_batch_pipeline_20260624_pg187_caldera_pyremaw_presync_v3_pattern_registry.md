...
- `proposal_count`: `368`
- `pattern_count`: `45`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 261, "package_ready_unprepared": 1, "runtime_family_backlog": 24, "split_scope_backlog": 78}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 20, "manual_model_observation_only": 261, "ready_for_pg_package_generation": 1, "requires_subpattern_split_before_promotion": 69, "runtime_template_candidate_requires_executor_tests": 4}`
...
| --- | --- | --- | ---: | ---: | --- |
| `creature/creature/instant_sorcery_cast_add_counter_then_power_damage_target_opponent_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### creature / creature / instant_sorcery_cast_add_counter_then_power_damage_target_opponent_v1

- Pattern id: `xmage_pattern:3b273e68ba8a9355aa2d`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Caldera Pyremaw)
- Subpatterns: `1`
