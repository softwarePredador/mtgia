...
- generated_at: `2026-06-28T06:57:39Z`
...
| Hidden Retreat | `blocked` | `topdeck_protection` | 0 | Sensei's Divining Top, Scroll Rack, Library of Leng | - | 0 | candidate_runtime_review_only |
...
- `hidden_retreat_runtime_first`: Hidden Retreat now has a focused battle runtime path and a prepared PG package, but the local candidate DB still exposes only review_only rules until apply/sync.
