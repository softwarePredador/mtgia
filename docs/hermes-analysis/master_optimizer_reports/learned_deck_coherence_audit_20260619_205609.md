...
- Generated at: `2026-06-19T20:56:07.193427+00:00`
...
| --- | --- | --- | --- | --- |
| Inalla, Archmage Ritualist | learned_deck:126 | true_off_color_card | Vengeance | review_or_replace_card_list_entry |
...
| Kinnan, Bonder Prodigy | learned_deck:3 | true_off_color_card | Endure | review_or_replace_card_list_entry |
| Lumra, Bellow of the Woods | learned_deck:131 | true_off_color_card | Endure | review_or_replace_card_list_entry |
| Rowan, Scion of War | learned_deck:114 | true_off_color_card | Vengeance | review_or_replace_card_list_entry |

## True Off-Color Cleanup Plan

- Status: `ready_for_review`
- DB mutations: `False`
- Apply requires explicit approval: `True`

| Commander | Source | Offender | Quantity | Colors | Ready candidates |
| --- | --- | --- | ---: | --- | --- |
| Inalla, Archmage Ritualist | learned_deck:126 | Vengeance | 0 | W | Feed the Swarm, Go for the Throat, Abrade, Chaos Warp |
| Kinnan, Bonder Prodigy | learned_deck:3 | Endure | 0 | W | Heroic Intervention, Tamiyo's Safekeeping, Snakeskin Veil, Tyvar's Stand |
| Lumra, Bellow of the Woods | learned_deck:131 | Endure | 0 | W | Heroic Intervention, Tamiyo's Safekeeping, Snakeskin Veil, Tyvar's Stand, Veil of Summer |
| Rowan, Scion of War | learned_deck:114 | Vengeance | 0 | W | Terminate, Feed the Swarm, Go for the Throat, Abrade, Chaos Warp |
