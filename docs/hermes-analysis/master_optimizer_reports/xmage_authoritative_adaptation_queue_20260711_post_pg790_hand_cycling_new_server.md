...
- Generated at: `2026-07-11T22:02:15+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 24369 |
| `xmage_authoritative_source_count` | 24056 |
| `xmage_missing_source_exception_count` | 313 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24056 |
| `manual_semantic_decision_units_remaining` | 313 |
| `authoritative_source_coverage_ratio` | 0.9872 |
| `adapter_work_unit_count` | 11271 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24056 |
...
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1063 |
| `add_counters::source_add_counters_variant_v1` | 768 |
| `direct_damage::targeted_damage_variant_v1` | 737 |
| `life_gain::xmage_life_gain_variant_review_v1` | 636 |
| `tutor::xmage_library_search_variant_review_v1` | 567 |
| `draw_cards::xmage_draw_card_variant_review_v1` | 531 |
...
| `removal_exile::targeted_exile_variant_v1` | 117 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 10969 |
| `token_maker` | 2266 |
| `recursion` | 1792 |
| `draw_engine` | 1553 |
| `add_counters` | 1189 |
| `grant_protection_from_chosen_color` | 1069 |
| `direct_damage` | 742 |
| `life_gain` | 636 |
| `tutor` | 578 |
| `draw_cards` | 531 |
