...
- Generated at: `2026-07-01T09:25:36.245055+00:00`
- Status: `action_required`
- Contract: `docs/hermes-analysis/XMAGE_TO_MANALOOM_DEFINITIVE_FLOW_2026-06-29.md`
- All known cards: `34331`
- Current registered-deck QA unique cards: `2479`
- Ready-product QA unique cards: `818`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 3739 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 2395 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 1251 | 389 |
| `battle_family_mapper_required` | 31300 | 230 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 7928 |
| `damage_or_life_total_change` | 4121 |
| `triggered_or_static_ability` | 3907 |
| `token_creation` | 3695 |
| `draw_selection_topdeck` | 3624 |
| `graveyard_recursion` | 2017 |
| `targeted_removal` | 1154 |
| `mana_generation_or_ritual` | 953 |
| `tutor_search_library` | 839 |
| `modal_or_choice_effect` | 699 |
| `protection_prevention` | 592 |
| `recursion_or_bounce` | 577 |
| `alternate_or_free_cast` | 525 |
| `counterspell_or_stack_interaction` | 400 |
...
| `battle_family::manual_model_review` | 7928 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
| `battle_family::damage_or_life_total_change` | 4121 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Aardvark Sloth`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide` |
...
| `battle_family::token_creation` | 3695 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A Killer Among Us`, `Aang and Katara`, `Aang, Airbending Master`, `Aatchik, Emerald Radian`, `Abby, Merciless Soldier`, `Abdel Adrian, Gorion's Ward`, `Abhorrent Overlord`, `Abyssal Harvester`, `Abzan Ascendancy`, `Academy Manufactor` |
| `battle_family::draw_selection_topdeck` | 3624 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Defense`, `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite` |
| `battle_family::graveyard_recursion` | 2017 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `"Lifetime" Pass Holder`, `A Good Day to Pie`, `Aang, A Lot to Learn`, `Abandon the Post`, `Abandoned Sarcophagus`, `Aberrant Mind Sorcerer`, `Aberrant Researcher // Perfected Form`, `Aberrant Return`, `Abhorrent Oculus`, `Abomination of Llanowar` |
| `battle_family::targeted_removal` | 1154 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Acid Web Spider`, `Acidic Slime`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock` |
| `battle_family::mana_generation_or_ritual` | 953 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Banner`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Aetheric Amplifier` |
| `battle_family::tutor_search_library` | 839 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A.I.M. Scientists`, `Aang's Journey`, `Absorb Vis`, `Abzan Monument`, `Academy Rector`, `Aerial Surveyor`, `Agency Outfitter`, `Ainok Guide`, `Ajani's Aid`, `Alabaster Host Intercessor` |
...
| `battle_family::protection_prevention` | 592 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abbey Gargoyles`, `Absolute Grace`, `Absolute Law`, `Adept Watershaper`, `Aegis of the Gods`, `Agent Frank Horrigan`, `Agent of the Shadow Thieves`, `Airtight Alibi`, `Akroma's Memorial`, `Akroma, Angel of Fury` |
| `battle_family::recursion_or_bounce` | 577 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abiding Grace`, `Absorb Identity`, `Abuelo's Awakening`, `Academy Journeymage`, `Admiral Brass, Unsinkable`, `Adun Oakenshield`, `Aerith, Last Ancient`, `Aether Adept`, `Aether Helix`, `Aethersnipe` |
| `battle_family::alternate_or_free_cast` | 525 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abundant Maw`, `Acid-Spewer Dragon`, `Adventurous Eater // Have a Bite`, `Aerie Bowmasters`, `Aether Meltdown`, `Aether Searcher`, `Aether Web`, `Affa Guard Hound`, `Ainok Tracker`, `Alley Assailant` |
| `battle_family::counterspell_or_stack_interaction` | 400 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abjure`, `Absorb`, `Abstruse Interference`, `Access Denied`, `Admiral's Order`, `Adric, Mathematical Genius`, `Amazing Acrobatics`, `Anticognition`, `Archmage's Charm`, `Arenson's Aura` |
...
| `Aardvark Sloth` | 250 | `battle_family_mapper_required` | `damage_or_life_total_change` | 0 | 18 | `available` |
...
| `Abbey Griffin` | 250 | `battle_family_mapper_required` | `manual_model_review` | 0 | 13 | `available` |
| `Abbey Matron` | 250 | `battle_family_mapper_required` | `manual_model_review` | 0 | 17 | `available` |
...
| `Aberrant Return` | 250 | `battle_family_mapper_required` | `graveyard_recursion` | 0 | 43 | `available` |
