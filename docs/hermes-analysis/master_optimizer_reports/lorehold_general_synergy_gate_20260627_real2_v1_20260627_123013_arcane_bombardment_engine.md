...
- generated_at: `2026-06-27T12:42:34Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_general_synergy_gate_20260627_real2_v1_20260627_123013_arcane_bombardment_engine_game_checkpoint.json`
...
| 2 |  | Lorehold synergy package: arcane_bombardment_engine (`synergy_arcane_bombardment_engine`) | synergy-package | 2 | 1 | 1 | 0 | 50.00% | 8.00 | 1 | 1 | none |
...
### 2. Lorehold synergy package: arcane_bombardment_engine (`synergy_arcane_bombardment_engine`)
...
| Sisay, Weatherlight Captain #61 (real) | 1 | 0 | 0 | 100.00% | 8.00 | elimination=1 |

**Strategic event counts:** lorehold_cost_paid=12, lorehold_spell_cast=10, miracle_cast=3, topdeck_manipulation_activated=3
