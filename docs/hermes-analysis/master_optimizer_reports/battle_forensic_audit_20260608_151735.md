...
| --- | --- | ---: | --- | --- | --- | --- | --- | --- | --- |
| low | seed_972 | 11 | precombat_main | Zirda, the Dawnwaker #69 (real) | spell_cast | Reprieve | remove_permanent | Runtime effect `remove_permanent` differs from registry effect `counter`. | Usually oracle normalization; review only if behavior looks wrong in replay. |
| low | seed_972 | 11 | - | Zirda, the Dawnwaker #69 (real) | spell_resolved | Reprieve | remove_permanent | Runtime effect `remove_permanent` differs from registry effect `counter`. | Usually oracle normalization; review only if behavior looks wrong in replay. |
| low | seed_972 | 6 | - | Zirda, the Dawnwaker #69 (real) | removal_resolved | - | - | Removal hit a low-power target while multiple targets were available. | - |
