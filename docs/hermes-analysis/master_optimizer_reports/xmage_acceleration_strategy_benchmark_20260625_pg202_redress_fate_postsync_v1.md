...
- `proposal_report`: `docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg202_redress_fate_postsync_v1_proposals.json`
- `effective_queue_report`: `docs/hermes-analysis/master_optimizer_reports/xmage_effective_queue_20260625_pg202_redress_fate_postsync_v1.json`
...
| 4 | `pattern_registry_first` | `use_as_shadow_infrastructure` | 44.4 | 0.033 |
...
- Evidence:
  ...
  - `current_queue_cards`: 440
  - `work_multiplier_vs_current_queue`: 72.06
...
- Evidence:
  - `current_queue_cards`: 440
  - `proposal_status_counts`: {"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 344, "runtime_family_implementation_required": 20, "split_family_scope_review_required": 72}
