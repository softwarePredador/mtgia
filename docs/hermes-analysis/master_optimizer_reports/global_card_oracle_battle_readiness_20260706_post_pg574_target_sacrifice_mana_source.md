...
- Generated at: `2026-07-06T21:34:14.872388+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6624 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 5402 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 5580 | 269 |
| `battle_family_mapper_required` | 28293 | 94 |
...
| `battle_family::damage_or_life_total_change` | 3767 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::mana_generation_or_ritual` | 699 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Abzan Devotee`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `All-Fates Scroll` |
