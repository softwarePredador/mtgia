...
- Generated at: `2026-07-05T14:53:06.774862+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 6015 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4767 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4945 | 266 |
| `battle_family_mapper_required` | 28928 | 97 |
...
| `battle_family::token_creation` | 3590 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `A Killer Among Us`, `Aang and Katara`, `Aang, Airbending Master`, `Aatchik, Emerald Radian`, `Abby, Merciless Soldier`, `Abdel Adrian, Gorion's Ward`, `Abhorrent Overlord`, `Abyssal Harvester`, `Abzan Ascendancy`, `Academy Manufactor` |
...
| `battle_family::targeted_removal` | 999 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock`, `Against All Odds`, `Agate Assault` |
