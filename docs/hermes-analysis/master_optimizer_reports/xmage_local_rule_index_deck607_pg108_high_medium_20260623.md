...
Generated at: `2026-06-23T17:16:13+00:00`
...
| `Bender's Waterskin` | `found` | `BendersWaterskin` | `CardImpl` | `mana, static_ability` | `external_reference_required_manual_model` |
| `Victory Chimes` | `found` | `VictoryChimes` | `CardImpl` | `targeting, mana, static_ability` | `external_reference_required_manual_model` |
| `Monument to Endurance` | `found` | `MonumentToEndurance` | `CardImpl` | `token, draw, triggered_ability` | `token_maker` |
| `Surge to Victory` | `found` | `SurgeToVictory` | `CardImpl` | `targeting, triggered_ability` | `external_reference_required_manual_model` |
...
- `bender_s_waterskin_1`: focused behavior scenario for external_reference_required_manual_model
...
- `victory_chimes_1`: focused behavior scenario for external_reference_required_manual_model
...
- Filter classes: `[]`
- Condition classes: `[]`
- Primary candidate: `{"ability_kind": "triggered", "battle_model_scope": "xmage_create_token_variant_monumenttoendurance_v1", "effect": "token_maker"}`
- Confidence reason: XMage uses token creation classes.

Suggested focused tests:

- `monument_to_endurance_1`: create expected token count and stats
- `monument_to_endurance_2`: apply duration-limited protection or indestructible effect
...
- `surge_to_victory_1`: focused behavior scenario for external_reference_required_manual_model
