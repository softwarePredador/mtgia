...
- generated_at: `2026-06-30T03:43:02Z`
...
- game_checkpoint_json: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_deflecting_palm_redirect_lightning_gate_20260630_seed20260630_real8_games3_game_checkpoint.json`
...
| ---: | ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- | --- |
| 1 | 1 | Lorehold 607 + Deflecting Palm over Redirect Lightning v1 (`candidate_607_deflecting_palm_redirect_lightning_v1`) | 607-deflecting-palm-redirect-lightning | 24 | 11 | 13 | 0 | 45.83% | 15.64 | 14 | 9 | 2 | 0 | 0 | 0 | 0 | 17 | 0 | 0 | none | recursion_role, tutor_role |
...
### 1. Lorehold 607 + Deflecting Palm over Redirect Lightning v1 (`candidate_607_deflecting_palm_redirect_lightning_v1`)
...
| --- | ---: | ---: | ---: | ---: | ---: | --- |
| Thrasios, Triton Hero #76 (real) | 2 | 1 | 0 | 66.67% | 11.00 | approach=1, elimination=1 |
| Rograkh, Son of Rohgahh #95 (real) | 1 | 2 | 0 | 33.33% | 14.00 | elimination=1 |
| K-9, Mark I #34 (real) | 1 | 2 | 0 | 33.33% | 17.00 | elimination=1 |
| Winota, Joiner of Forces #73 (real) | 1 | 2 | 0 | 33.33% | 14.00 | elimination=1 |
| Thrasios, Triton Hero #101 (real) | 2 | 1 | 0 | 66.67% | 16.50 | elimination=2 |
| Kinnan, Bonder Prodigy #72 (real) | 2 | 1 | 0 | 66.67% | 16.50 | elimination=2 |
| Kefka, Court Mage #112 (real) | 1 | 2 | 0 | 33.33% | 29.00 | elimination=1 |
| Kraum, Ludevic's Opus #81 (real) | 1 | 2 | 0 | 33.33% | 10.00 | elimination=1 |

**Strategic event counts:** discard_to_top_replacement=6, lorehold_cost_paid=256, lorehold_rummage_discard_to_top=2, lorehold_spell_cast=220, lorehold_spell_rummage=16, lorehold_spell_rummage_discard_to_top=4, lorehold_upkeep_rummage=60, miracle_cast=37, scarlet_static_cost_reduction_casts=7, scarlet_static_cost_reduction_total=14, static_cost_reduction_casts=40, static_cost_reduction_total=73, thor_cost_paid=4, thor_noncreature_damage=10, thor_noncreature_damage_amount=42, topdeck_manipulation_activated=33
