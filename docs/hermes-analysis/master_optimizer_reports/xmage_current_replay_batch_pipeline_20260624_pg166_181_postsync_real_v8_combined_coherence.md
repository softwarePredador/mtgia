...
Generated at: `2026-06-24T15:32:13+00:00`
...
- `review_only_or_needs_review_rule`: `271`
- `no_active_battle_rule`: `163`
- `trusted_rule_without_oracle_hash`: `140`
- `no_trusted_executable_rule`: `125`
- `generic_effect_without_model_scope`: `78`
...
| `high` | `battle_critical` | 7204 | `Cabal Ritual` | 4 | 4 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `ramp_ritual` |
...
| `high` | `battle_critical` | 7051 | `Caldera Pyremaw` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `finisher` |
...
| `high` | `battle_critical` | 7051 | `Ephemerate` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `protect_creature`, `remove_creature` |
