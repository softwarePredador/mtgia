...
- `proposal_count`: `364`
- `pattern_count`: `44`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 261, "runtime_family_backlog": 24, "split_scope_backlog": 75}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 20, "manual_model_observation_only": 2, "requires_subpattern_split_before_promotion": 10, "runtime_template_candidate_requires_executor_tests": 2}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 9, "fragmented_runtime_observation_only": 20, "manual_model_observation_only": 261, "requires_subpattern_split_before_promotion": 66, "runtime_template_candidate_requires_executor_tests": 4}`
