...
Generated at: `2026-06-23T18:02:35+00:00`
...
- Condition classes: `[]`
- Primary candidate: `{"ability_kind": "static", "applies_to_card_types": ["instant", "sorcery"], "applies_to_controller": "source_controller", "battle_model_scope": "static_power_based_cost_reduction_for_instant_sorcery_mv4_plus_v1", "cost_reduction_amount_source": "source_power", "cost_reduction_applies_to": "instant_sorcery_spells_you_cast", "effect": "static_cost_reduction", "minimum_mana_value": 4}`
- Confidence reason: XMage custom inner effect extends CostModificationEffectImpl and reduces spell costs.

Suggested focused tests:

- `the_scarlet_witch_1`: cast mana-value-4 instant or sorcery with generic cost reduced by source power
- `the_scarlet_witch_2`: cast mana-value-3 or non-instant/sorcery spell without reduction
