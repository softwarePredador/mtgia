...
- Generated at: `2026-06-30T09:06:34Z`
...
- Runtime gap queue: `docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg271_hidden_retreat.json`
...
- `squee_access_density_model`: failure `squee_graveyard_entry_route`, seeds `7, 20260625`; Squee discard/return is modeled when accessed; Hidden Retreat is modeled and PG271-synced, but access model found 0 preflight-ready access swaps. Remaining blocker is a seed-safe cut model.
...
- Evidence inputs: `docs/hermes-analysis/master_optimizer_reports/lorehold_runtime_gap_family_queue_20260630_post_pg271_hidden_retreat.json`
...
- Reason: Squee discard/return is modeled when accessed; Hidden Retreat is modeled and PG271-synced, but access model found 0 preflight-ready access swaps. Remaining blocker is a seed-safe cut model.
