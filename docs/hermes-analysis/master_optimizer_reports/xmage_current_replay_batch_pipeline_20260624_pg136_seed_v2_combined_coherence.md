...
- `review_only_or_needs_review_rule`: `159`
- `trusted_rule_without_oracle_hash`: `154`
- `no_active_battle_rule`: `91`
- `generic_effect_without_model_scope`: `90`
...
| `high` | `battle_support` | 7612 | `Sol Ring` | 12 | 12 | `review_only_or_needs_review_rule` | `ramp_permanent` |
