...
- Generated at: `2026-06-28T01:06:26Z`
...
- Mana-base validator reports: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/lorehold_mana_base_validator_20260627_v2_plateau_rejected.json`
...
| ---: | --- | --- | --- | --- | --- | --- |
| 4 | `run_mana_base_validated_preflight` | `mana_base_preflight_ready` | `mana_base` | Plateau | Turbulent Steppe, Sacred Foundry | The mana-base validator found deterministic land upgrades that preserve Boros color access and avoid protected utility cuts. |
