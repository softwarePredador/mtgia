...
Generated at: `2026-06-23T22:19:14+00:00`
...
- `review_only_or_needs_review_rule`: `200`
- `trusted_rule_without_oracle_hash`: `197`
- `generic_effect_without_model_scope`: `117`
- `no_active_battle_rule`: `108`
- `no_trusted_executable_rule`: `7`
...
| `high` | `battle_critical` | 7357 | `Demonic Tutor` | 7 | 7 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
| `high` | `battle_critical` | 7357 | `Fierce Guardianship` | 7 | 7 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
...
| `high` | `battle_critical` | 7357 | `Force of Will` | 7 | 7 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
| `high` | `battle_critical` | 7357 | `Mindbreak Trap` | 7 | 7 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter`, `draw_cards` |
| `high` | `battle_critical` | 7357 | `Pact of Negation` | 7 | 7 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
...
| `high` | `battle_critical` | 7306 | `Mystic Remora` | 6 | 6 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine` |
| `high` | `battle_critical` | 7306 | `Nature's Rhythm` | 6 | 6 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `recursion` |
| `high` | `battle_critical` | 7306 | `Orcish Bowmasters` | 6 | 6 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `remove_creature` |
| `high` | `battle_critical` | 7306 | `Rhystic Study` | 6 | 6 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine` |
| `high` | `battle_critical` | 7306 | `Swan Song` | 6 | 6 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
| `high` | `battle_critical` | 7306 | `Vampiric Tutor` | 6 | 6 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `tutor` |
| `high` | `battle_critical` | 7255 | `Chord of Calling` | 5 | 5 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `tutor` |
| `high` | `battle_critical` | 7255 | `Deathrite Shaman` | 5 | 5 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `remove_creature` |
| `high` | `battle_critical` | 7255 | `Faerie Mastermind` | 5 | 5 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `draw_engine` |
...
| `high` | `battle_critical` | 7255 | `Imperial Seal` | 5 | 5 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `tutor` |
...
| `high` | `battle_critical` | 7255 | `Wan Shi Tong, Librarian` | 5 | 5 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine` |
| `high` | `battle_critical` | 7204 | `Agatha's Soul Cauldron` | 4 | 4 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `passive`, `remove_creature` |
...
| `high` | `battle_critical` | 7204 | `Diabolic Intent` | 4 | 4 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
...
| `high` | `battle_critical` | 7204 | `Final Fortune` | 4 | 4 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `extra_turn` |
...
| `high` | `battle_critical` | 7204 | `Sevinne's Reclamation` | 4 | 4 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `recursion` |
...
| `high` | `battle_critical` | 7153 | `An Offer You Can't Refuse` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
| `high` | `battle_critical` | 7153 | `Borne Upon a Wind` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards` |
...
| `high` | `battle_critical` | 7153 | `Culling the Weak` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `ramp_ritual` |
| `high` | `battle_critical` | 7153 | `Dark Ritual` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `ramp_ritual` |
...
| `high` | `battle_critical` | 7153 | `Into the Flood Maw` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
...
| `high` | `battle_critical` | 7153 | `Mystical Tutor` | 3 | 3 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `tutor` |
| `high` | `battle_critical` | 7153 | `Red Elemental Blast` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
...
| `high` | `battle_critical` | 7153 | `Vexing Bauble` | 3 | 3 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `draw_cards`, `hate_artifact` |
| `high` | `battle_critical` | 7153 | `Worldly Tutor` | 3 | 3 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
| `high` | `battle_critical` | 7102 | `Abrupt Decay` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
...
| `high` | `battle_critical` | 7102 | `Consecrated Sphinx` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine` |
...
| `high` | `battle_critical` | 7102 | `Expedition Map` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
| `high` | `battle_critical` | 7102 | `Hullbreaker Horror` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter`, `remove_permanent` |
| `high` | `battle_critical` | 7102 | `Insidious Roots` | 2 | 2 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `passive`, `token_maker` |
...
| `high` | `battle_critical` | 7102 | `Moonsilver Key` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
| `high` | `battle_critical` | 7102 | `Necropotence` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine` |
| `high` | `battle_critical` | 7102 | `Nezahal, Primal Tide` | 2 | 2 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `creature`, `draw_engine` |
...
| `high` | `battle_critical` | 7051 | `Archdruid's Charm` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
| `high` | `battle_critical` | 7051 | `Aura of Silence` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `remove_permanent` |
...
| `high` | `battle_critical` | 7051 | `Counterspell` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
| `high` | `battle_critical` | 7051 | `Cyclonic Rift` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
| `high` | `battle_critical` | 7051 | `Deadly Rollick` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_creature` |
...
| `high` | `battle_critical` | 7051 | `Eldrazi Confluence` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
| `high` | `battle_critical` | 7051 | `Electroduplicate` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `copy_creature_token`, `token_maker` |
| `high` | `battle_critical` | 7051 | `Entomb` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `draw_cards`, `tutor` |
...
| `high` | `battle_critical` | 7051 | `Force of Vigor` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `remove_permanent` |
...
| `high` | `battle_critical` | 7051 | `Goblin Bombardment` | 1 | 1 | `review_only_or_needs_review_rule` | `passive`, `remove_creature` |
...
| `high` | `battle_critical` | 7051 | `Hedron Archive` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_cards`, `ramp_permanent` |
| `high` | `battle_critical` | 7051 | `Jaxis, the Troublemaker` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `token_maker` |
...
| `high` | `battle_critical` | 7051 | `Knuckles the Echidna` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `finisher` |
| `high` | `battle_critical` | 7051 | `Last Chance` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `extra_turn` |
| `high` | `battle_critical` | 7051 | `Laughing Mad` | 1 | 1 | `review_only_or_needs_review_rule` | `draw_cards` |
| `high` | `battle_critical` | 7051 | `Lightning Bolt` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `deal_damage`, `remove_creature` |
...
| `high` | `battle_critical` | 7051 | `Mana Leak` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
| `high` | `battle_critical` | 7051 | `Mind Stone` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `draw_cards`, `ramp_permanent` |
...
| `high` | `battle_critical` | 7051 | `Nature's Claim` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
| `high` | `battle_critical` | 7051 | `Negate` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `counter` |
...
| `high` | `battle_critical` | 7051 | `Refute` | 1 | 1 | `no_trusted_executable_rule`, `review_only_or_needs_review_rule` | `counter` |
| `high` | `battle_critical` | 7051 | `Rionya, Fire Dancer` | 1 | 1 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `token_maker` |
...
| `high` | `battle_critical` | 7051 | `Sink into Stupor` | 1 | 1 | `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `remove_permanent` |
