...
- Generated at: `2026-07-12T22:07:43.014462+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 8003 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6853 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6746 | 265 |
| `battle_family_mapper_required` | 27048 | 86 |
...
| `battle_family::mana_generation_or_ritual` | 594 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon`, `Altar of Shadows` |
