...
- Generated at: `2026-07-10T20:15:49.723349+00:00`
- Status: `fail`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=7186 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=7186 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=8177 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=8177 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=8177 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6236 pg_runtime_keys=8681 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=9897 |
...
| `pg_integrity.battle_rules_trusted_oracle_hash_coverage` | `fail` | trusted_executable_rules_missing_oracle_hash=55 |
