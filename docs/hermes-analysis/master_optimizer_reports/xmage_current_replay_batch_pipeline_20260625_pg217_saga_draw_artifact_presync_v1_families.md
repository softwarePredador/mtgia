...
- Summary: `{"batch_metadata_candidate_count": 3, "card_count": 418, "family_count": 11, "family_counts": {"board_wipe_choice": 1, "controlled_creature_etb_damage_engine": 2, "creature": 5, "manual_model": 336, "mill_spell": 1, "modal_spell": 1, "recursion": 2, "static_cost_reducer": 2, "targeted_interaction": 58, "token_maker": 6, "tutor": 4}, "manual_or_blocked_count": 411, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 3, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 333, "runtime_family_implementation_required": 4, "split_family_scope_review_required": 74}, "runtime_family_required_count": 4}`
...
| `token_maker` | 6 | `runtime_family_required` | `{"batch_metadata_candidate_requires_pg_precheck": 2, "mapper_metadata_or_test_scenario_required": 1, "runtime_family_implementation_required": 3}` | token creation with stats, abilities, duration, and zone cleanup |
...
- Family tests: `[]`
- Cards: `["Razaketh, the Foulblooded", "Rune-Scarred Demon", "The Locust God", "Blood Artist", "Starfield Shepherd"]`
...
- Batch strategy: `implement_family_before_metadata_batch`
- Family tests: `[]`
- Cards: `["Maskwood Nexus", "Spiked Corridor // Torture Pit", "Fable of the Mirror-Breaker // Reflection of Kiki-Jiki", "Biotransference", "Hazel's Brewmaster", "Adagia, Windswept Bastion"]`
