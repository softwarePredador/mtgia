...
| `Prying Eyes` | `xmage_fixed_draw_discard_spell` | `xmage_fixed_draw_discard_spell_v1` | `draw_cards` | `battle_rule_v1:7807f21b39fea1cfb17ed8edf4ed891a` |
| `Rain of Revelation` | `xmage_fixed_draw_discard_spell` | `xmage_fixed_draw_discard_spell_v1` | `draw_cards` | `battle_rule_v1:23c289099aa3f2dabbfeb727d7d654f2` |
| `Romantic Rendezvous` | `xmage_fixed_draw_discard_spell` | `xmage_fixed_draw_discard_spell_v1` | `draw_cards` | `battle_rule_v1:2baba243f445a0a2e3e5983394657313` |
| `Sift` | `xmage_fixed_draw_discard_spell` | `xmage_fixed_draw_discard_spell_v1` | `draw_cards` | `battle_rule_v1:73912a4129ba131351a7d72087514070` |
| `Thoughtflare` | `xmage_fixed_draw_discard_spell` | `xmage_fixed_draw_discard_spell_v1` | `draw_cards` | `battle_rule_v1:ebc0a01d26b567480a2f083009f64ec3` |
...
- `damage_effect_class_not_pure`: `["Aggressive Sabotage", "Arc Blade", "Arrow Storm", "Barrel Down Sokenzan", "Beacon of Destruction", "Bedeck // Bedazzle", "Blastfire Bolt", "Blightning", "Blooming Blast", "Bot Bashing Time", "Brimstone Volley", "Bring Low"]`
...
- `draw_effect_class_not_pure`: `["Abeyance", "Abzan Charm", "Accelerate", "Adventure Awaits", "Afterlife Insurance", "Airbending Lesson", "Allied Strategies", "Amass the Components", "Ambition's Cost", "Ambitious Assault", "Ancestral Anger", "Ancestral Vision"]`
