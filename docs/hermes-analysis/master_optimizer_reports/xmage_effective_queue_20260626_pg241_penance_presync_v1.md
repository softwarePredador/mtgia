...
- Generated at: `2026-06-26T11:08:09+00:00`
- Status: `ready`
...
- Package manifests scanned: `114`
- Cards covered by package manifests: `255`
...
- `P0` Exhaust the unpackaged PG-ready residual before opening new runtime work. Reason: 1 cards are immediately packageable. Top exact cluster: activated_put_card_from_hand_on_top_library_prevent_next_damage_from_chosen_black_or_red_source_to_you_v1 (1)
...
- Count: `1`
- Top scope clusters:
  - `damage_prevention_shield` / `damage_prevention_shield` / `activated_put_card_from_hand_on_top_library_prevent_next_damage_from_chosen_black_or_red_source_to_you_v1`: `1` cards (Penance)
