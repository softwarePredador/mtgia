...
Generated at: `2026-06-23T22:59:32+00:00`
...
- `review_only_or_needs_review_rule`: `185`
- `trusted_rule_without_oracle_hash`: `183`
- `no_active_battle_rule`: `106`
- `generic_effect_without_model_scope`: `105`
...
| `high` | `battle_critical` | 7051 | `Training Grounds` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `draw_engine`, `ramp_engine` |
...
| `high` | `battle_critical` | 7051 | `Trophy Mage` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `tutor` |
