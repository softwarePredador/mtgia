...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 386, "family_count": 10, "family_counts": {"board_wipe_choice": 1, "controlled_creature_etb_damage_engine": 1, "creature": 3, "manual_model": 320, "mill_spell": 1, "modal_spell": 1, "recursion": 2, "targeted_interaction": 49, "token_maker": 4, "tutor": 4}, "manual_or_blocked_count": 381, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 317, "runtime_family_implementation_required": 4, "split_family_scope_review_required": 60}, "runtime_family_required_count": 4}`
...
| `manual_model` | 320 | `manual_model_required` | `{"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 316}` | manual Oracle/reference review |
...
| `targeted_interaction` | 49 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1, "split_family_scope_review_required": 48}` | target legality, resolution, zone transition, and event provenance |
...
- Batch strategy: `split_by_scope_before_metadata_batch`
- Family tests: `[]`
- Cards: `["Flusterstorm", "Chain of Vapor", "Reprieve", "Bloodchief Ascension", "Bolt Bend", "Tezzeret, Cruel Captain", "Abrade", "Arcane Denial"]`
