...
- Generated at: `2026-07-05T12:07:40.608245+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5975 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4727 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4905 | 266 |
| `battle_family_mapper_required` | 28968 | 97 |
...
| `battle_family::targeted_removal` | 1017 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock`, `Against All Odds`, `Agate Assault` |
