...
- `proposal_count`: `421`
- `pattern_count`: `35`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 333, "package_ready_unprepared": 3, "runtime_family_backlog": 7, "split_scope_backlog": 74}`
- `pattern_status_counts`: `{"blocked_missing_xmage_source": 1, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 6, "manual_model_observation_only": 2, "ready_for_pg_package_generation": 3, "requires_subpattern_split_before_promotion": 10, "runtime_observation_requires_taxonomy": 1}`
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 12, "fragmented_runtime_observation_only": 6, "manual_model_observation_only": 333, "ready_for_pg_package_generation": 3, "requires_subpattern_split_before_promotion": 62, "runtime_observation_requires_taxonomy": 1}`
...
| --- | --- | --- | ---: | ---: | --- |
| `creature/creature/controller_end_step_opponent_lost_life_dalek_villainous_choice_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
| `token_maker/token_maker/each_end_step_opponent_extra_draw_landfall_draw_treasure_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
| `token_maker/token_maker/precombat_main_choose_modes_treasure_draw_shapeshifter_life_loss_v1` | `package_ready_unprepared` | `ready_for_pg_package_generation` | 1 | 1 | Generate a PG package before any runtime work. |
...
### creature / creature / controller_end_step_opponent_lost_life_dalek_villainous_choice_v1

- Pattern id: `xmage_pattern:e25b8d7fd6284e691442`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Davros, Dalek Creator)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`

### token_maker / token_maker / each_end_step_opponent_extra_draw_landfall_draw_treasure_v1

- Pattern id: `xmage_pattern:920990850499b23e1270`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Smuggler's Share)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`

### token_maker / token_maker / precombat_main_choose_modes_treasure_draw_shapeshifter_life_loss_v1

- Pattern id: `xmage_pattern:747c632ed39ea0897351`
- Lane: `package_ready_unprepared`
- Status: `ready_for_pg_package_generation`
- Cards: `1` (Black Market Connections)
- Subpatterns: `1`
- Required evidence: `["package precheck", "approved exact PostgreSQL apply command", "postcheck", "PG -> Hermes sync"]`
