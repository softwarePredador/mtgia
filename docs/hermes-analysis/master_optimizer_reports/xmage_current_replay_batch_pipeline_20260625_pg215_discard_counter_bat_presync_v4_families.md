...
- Summary: `{"batch_metadata_candidate_count": 2, "card_count": 423, "family_count": 11, "family_counts": {"board_wipe_choice": 1, "controlled_creature_etb_damage_engine": 2, "creature": 6, "manual_model": 336, "mill_spell": 1, "modal_spell": 1, "recursion": 2, "static_cost_reducer": 2, "targeted_interaction": 58, "token_maker": 10, "tutor": 4}, "manual_or_blocked_count": 411, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 2, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 333, "runtime_family_implementation_required": 10, "split_family_scope_review_required": 74}, "runtime_family_required_count": 10}`
...
| `creature` | 6 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 2, "split_family_scope_review_required": 4}` | creature permanents with exact-scope ETB, death, combat, and activated behavior |
...
- Family tests: `[]`
- Cards: `["Razaketh, the Foulblooded", "Rune-Scarred Demon", "Aclazotz, Deepest Betrayal // Temple of the Dead", "Blood Artist", "Green Goblin, Nemesis", "Starfield Shepherd"]`
