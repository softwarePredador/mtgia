...
- Generated at: `2026-06-25T08:13:48.455953+00:00`
- Status: `ready`
- Active deck id: `6`
- Lorehold deck ids: `[6, 606, 607, 608, 609, 610, 611, 612, 613, 614, 615, 616]`
- Proposal report: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg210_utvara_hellkite_postsync_v1_proposals.json`
...
- Rows: `395`
- Recommendation lanes: `{"active_low_confidence_review": 13, "core_keep": 87, "low_priority": 44, "needs_rule_before_strategy": 96, "policy_blocked": 2, "priority_benchmark_candidate": 44, "watchlist_candidate": 109}`
- Rule statuses: `{"battle_ready": 299, "blocked_missing_xmage_source": 2, "mapper_manual": 73, "runtime_needed": 3, "split_scope": 18}`
...
| Purphoros, God of the Forge | 12.0 | wincon | split_scope | controlled_creature_enters_damage_each_opponent_v1 | split_xmage_scope_then_promote_rule_before_swap_testing |
...
| Warleader's Call | 9.5 | wincon | split_scope | controlled_creature_enters_damage_each_opponent_v1 | split_xmage_scope_then_promote_rule_before_swap_testing |
...
| Ultima | 8.0 | board_wipe | runtime_needed | destroy_all_permanents_or_creatures_variant_v1 | implement_runtime_family_with_focused_test_before_swap_testing |
| Blaze Commando | 7.5 | wincon | runtime_needed | xmage_create_token_variant_blazecommando_v1 | implement_runtime_family_with_focused_test_before_swap_testing |
