...
- Generated at: `2026-07-04T11:22:51.437329+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5289 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4017 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4152 | 250 |
| `battle_family_mapper_required` | 29678 | 100 |
...
| `damage_or_life_total_change` | 3888 |
| `token_creation` | 3609 |
| `draw_selection_topdeck` | 3407 |
| `graveyard_recursion` | 1898 |
...
| `battle_family::damage_or_life_total_change` | 3888 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
