...
- Generated at: `2026-07-02T09:57:39.035096+00:00`
- Status: `pass`
...
| `sqlite_json.battle_card_rules.deck_role_json` | `pass` | scanned=7171 |
| `sqlite_json.battle_card_rules.effect_json` | `pass` | scanned=7171 |
| `sqlite_json.card_oracle_cache.color_identity_json` | `pass` | scanned=5915 |
| `sqlite_json.card_oracle_cache.colors_json` | `pass` | scanned=5915 |
| `sqlite_json.card_oracle_cache.keywords_json` | `pass` | scanned=5915 |
...
| `sqlite_integrity.battle_rules_trusted_oracle_hash_coverage` | `warn` | trusted_executable_rules_missing_oracle_hash=16 |
...
| `pg_sqlite_parity.battle_card_rules_runtime_keys` | `pass` | sqlite_runtime_keys=6466 pg_runtime_keys=6463 unresolved=0 |
...
| `pg_rows.card_battle_rules` | `pass` | rows=7469 |
