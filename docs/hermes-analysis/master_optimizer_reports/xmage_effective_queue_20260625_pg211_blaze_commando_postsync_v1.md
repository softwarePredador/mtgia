...
- Generated at: `2026-06-25T08:32:01+00:00`
- Status: `ready`
- Proposal report: `/Users/desenvolvimentomobile/Documents/rafa/mtg/mtgia/docs/hermes-analysis/master_optimizer_reports/xmage_current_replay_batch_pipeline_20260625_pg211_blaze_commando_postsync_v1_proposals.json`
- Package manifests scanned: `89`
- Cards covered by package manifests: `212`
...
- `P1` Open new runtime only on the most reusable family remaining. Reason: Runtime-only backlog is 16 cards. Top reusable exact scope cluster: damage_all_variant_v1 (2). Largest raw family is token_maker (13 cards across 13 scopes), so it should wait for taxonomy/test-miner support instead of leading the queue.
