...
- Generated at: `2026-07-05T08:27:11.202928+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 5907 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 4650 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 4828 | 265 |
| `battle_family_mapper_required` | 29045 | 98 |
...
| `battle_family::targeted_removal` | 1032 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Acid Web Spider`, `Acidic Slime`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Aerial Predation`, `Aftershock` |
