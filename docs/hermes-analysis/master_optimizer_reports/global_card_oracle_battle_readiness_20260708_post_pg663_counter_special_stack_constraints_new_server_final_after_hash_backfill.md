...
- Generated at: `2026-07-08T15:27:28.635604+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7264 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6061 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6033 | 272 |
| `battle_family_mapper_required` | 27843 | 92 |
...
| `counterspell_or_stack_interaction` | 340 |
...
| `battle_family::counterspell_or_stack_interaction` | 340 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Abjure`, `Abstruse Interference`, `Access Denied`, `Admiral's Order`, `Adric, Mathematical Genius`, `Amazing Acrobatics`, `Anticognition`, `Archmage's Charm`, `Arenson's Aura`, `Artistic Refusal` |
