...
- Generated at: `2026-07-11T05:29:48.148307+00:00`
...
| `card_intelligence_snapshot` | `snapshot_has_any_rule` | 7599 |
| `card_intelligence_snapshot` | `snapshot_has_verified_rule` | 6430 |
...
| --- | ---: | ---: |
| `battle_and_oracle_ready` | 6405 | 275 |
| `battle_family_mapper_required` | 27471 | 89 |
...
| Family | Cards |
| --- | ---: |
| `manual_model_review` | 6351 |
| `triggered_or_static_ability` | 3831 |
| `damage_or_life_total_change` | 3668 |
| `token_creation` | 3458 |
| `draw_selection_topdeck` | 3265 |
| `graveyard_recursion` | 1887 |
| `targeted_removal` | 909 |
| `tutor_search_library` | 742 |
| `modal_or_choice_effect` | 699 |
| `mana_generation_or_ritual` | 633 |
| `alternate_or_free_cast` | 494 |
| `protection_prevention` | 479 |
...
| --- | ---: | --- | --- |
| `battle_family::manual_model_review` | 6351 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `+2 Mace`, `_____ _____ _____ Trespasser`, `_____ Bird Gets the Worm`, `_____-o-saurus`, `A Little Chat`, `A Tale for the Ages`, `Aang, Air Nomad`, `Aang, Swift Savior // Aang and La, Ocean's Fury`, `Aarakocra Sneak`, `Abaddon the Despoiler` |
...
| `battle_family::damage_or_life_total_change` | 3668 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `_____ Balls of Fire`, `Abandon Reason`, `Abattoir Ghoul`, `Absolute Virtue`, `Abuna Acolyte`, `Abuna's Chant`, `Abyssal Hunter`, `Abyssal Specter`, `Abzan Guide`, `Achilles Davenport` |
...
| `battle_family::draw_selection_topdeck` | 3265 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Aang's Iceberg`, `Aberrant`, `Abeyance`, `Abomination of Gudul`, `Abundance`, `Abzan Beastmaster`, `Abzan Charm`, `Academic Dispute`, `Academy Elite`, `Academy Loremaster` |
...
| `battle_family::targeted_removal` | 909 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolver Thrull`, `Abstruse Appropriation`, `Act of Authority`, `Active Volcano`, `Admonition Angel`, `Aerial Assault`, `Against All Odds`, `Agate Assault`, `Agent of Erebos`, `Agonizing Demise` |
...
| `battle_family::mana_generation_or_ritual` | 633 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `________ Goblin`, `A Realm Reborn`, `Abstract Paintmage`, `Abundant Growth`, `Accomplished Alchemist`, `Adarkar Unicorn`, `Advanced Reconstruction`, `Alena, Kessig Trapper`, `Alpine Moon`, `Altar of Shadows` |
...
| `battle_family::protection_prevention` | 479 | XMage source review -> exact ManaLoom scope -> focused tests -> PG package -> Hermes sync | `Absolute Grace`, `Absolute Law`, `Adept Watershaper`, `Aegis of the Gods`, `Agent Frank Horrigan`, `Agent of the Shadow Thieves`, `Airtight Alibi`, `Akroma's Memorial`, `Akroma, Angel of Fury`, `Akroma, Vision of Ixidor` |
