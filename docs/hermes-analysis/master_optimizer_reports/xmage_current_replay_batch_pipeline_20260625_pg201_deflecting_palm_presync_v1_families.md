...
- Summary: `{"batch_metadata_candidate_count": 1, "card_count": 442, "family_count": 10, "family_counts": {"board_wipe_choice": 4, "creature": 4, "damage_prevention_reflect": 1, "manual_model": 348, "mill_spell": 1, "modal_spell": 1, "static_cost_reducer": 2, "targeted_interaction": 60, "token_maker": 17, "tutor": 4}, "manual_or_blocked_count": 421, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 1, "blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 345, "runtime_family_implementation_required": 20, "split_family_scope_review_required": 72}, "runtime_family_required_count": 20}`
...
| `damage_prevention_reflect` | 1 | `runtime_supported_family` | `{"batch_metadata_candidate_requires_pg_precheck": 1}` | source-specific damage prevention shield plus reflected damage to the chosen source controller |
| `manual_model` | 348 | `manual_model_required` | `{"blocked_missing_xmage_source": 4, "mapper_metadata_or_test_scenario_required": 344}` | manual Oracle/reference review |
...
| `targeted_interaction` | 60 | `runtime_family_partially_supported_review_required` | `{"split_family_scope_review_required": 60}` | target legality, resolution, zone transition, and event provenance |
...
- Family tests: `["test_pg201_deflecting_palm_prevents_chosen_source_and_reflects_damage", "test_pg201_deflecting_palm_combat_window_chooses_largest_lethal_source"]`
- Cards: `["Deflecting Palm"]`
