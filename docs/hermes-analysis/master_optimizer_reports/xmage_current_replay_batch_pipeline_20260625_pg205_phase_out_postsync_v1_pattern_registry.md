...
- `proposal_count`: `435`
- `pattern_count`: `41`
- `lane_counts`: `{"blocked_missing_xmage_source": 4, "manual_mapper_backlog": 339, "runtime_family_backlog": 20, "split_scope_backlog": 72}`
...
- `card_counts_by_pattern_status`: `{"blocked_missing_xmage_source": 4, "candidate_template_requires_review_tests": 10, "fragmented_runtime_observation_only": 16, "manual_model_observation_only": 339, "requires_subpattern_split_before_promotion": 62, "runtime_template_candidate_requires_executor_tests": 4}`
