...
Generated at: `2026-06-24T06:17:49+00:00`
...
- `review_only_or_needs_review_rule`: `144`
- `generic_effect_without_model_scope`: `93`
- `no_active_battle_rule`: `82`
...
| `high` | `battle_support` | 7102 | `Avacyn's Pilgrim` | 2 | 2 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `ramp_permanent` |
...
| `high` | `battle_support` | 7102 | `Fyndhorn Elves` | 2 | 2 | `review_only_or_needs_review_rule`, `trusted_rule_without_oracle_hash` | `creature`, `ramp_permanent` |
...
| `high` | `battle_support` | 7051 | `Desperate Ritual` | 1 | 1 | `review_only_or_needs_review_rule`, `generic_effect_without_model_scope`, `trusted_rule_without_oracle_hash` | `ramp_ritual` |
