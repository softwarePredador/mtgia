...
- generated_at: `2026-07-06T06:23:00.951999+00:00`
- status: `cross_commander_role_axis_learning_pivot_ready_after_role_axis_exhaustion_no_deck_action`
- axis_count: `10`
- top_axis_role: `land`
- top_axis_status: `cross_commander_role_axis_ready_no_deck_action`
- top_axis_priority_score: `294`
- source_cycle_axis_count: `4`
- engine_axis_exhausted_axis_count: `1`
- engine_axis_suppressed_axis_count: `1`
- role_axis_exhausted_axis_count: `1`
- role_axis_suppressed_axis_count: `1`
- benchmark_only_excluded_from_action_count: `5`
- candidate_copy_allowed_now: `false`
- battle_gate_allowed_now: `false`
- promotion_allowed: `false`
- next_gate: `calibrate_role_floor_before_candidate_copy`
...
| `ramp` | `cross_commander_role_axis_suppressed_ramp_axis_exhausted` | -179 | 10 | 3 | 0 | 10 | `619` | `-` | `619` | `choose_next_non_exhausted_role_axis_after_ramp_axis_exhaustion` |

## Top Axis Evidence

| Deck | Commander | Direction | Count | Target | Source Cycle | Engine Axis Exhausted | Role Axis Exhausted |
| --- | --- | --- | ---: | --- | ---: | ---: | ---: |
| `VARIANT Y'shtola Variant 01 - Rafael Paste 2026-06-24 (621)` | `Y'shtola, Night's Blessed` | `below_floor` | 32 | `34-39` | false | false | false |
| `Runtime Lorehold Learned 19e93de3cca (6)` | `Lorehold, the Historian` | `below_floor` | 33 | `34-39` | false | false | false |
| `VARIANT Lorehold Variant 03 - Rafael Paste 2026-06-23 (608)` | `Lorehold, the Historian` | `below_floor` | 31 | `34-39` | false | false | false |
| `VARIANT Lorehold Variant 04 - Rafael Paste 2026-06-24 (609)` | `Lorehold, the Historian` | `below_floor` | 30 | `34-39` | false | false | false |
| `VARIANT Lorehold Variant 05 - Rafael Paste 2026-06-24 (610)` | `Lorehold, the Historian` | `below_floor` | 30 | `34-39` | false | false | false |
| `VARIANT Lorehold Variant 07 - Rafael Paste 2026-06-24 (612)` | `Lorehold, the Historian` | `below_floor` | 27 | `34-39` | false | false | false |
| `VARIANT Lorehold Variant 08 - Rafael Paste 2026-06-24 (613)` | `Lorehold, the Historian` | `below_floor` | 32 | `34-39` | false | false | false |
| `VARIANT Lorehold Variant 09 - Rafael Paste 2026-06-24 (614)` | `Lorehold, the Historian` | `below_floor` | 33 | `34-39` | false | false | false |
| `VARIANT Lorehold Variant 11 - Rafael Paste 2026-06-24 (616)` | `Lorehold, the Historian` | `below_floor` | 29 | `34-39` | false | false | false |
