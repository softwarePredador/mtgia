...
- Generated at: `2026-07-07T08:09:50+00:00`
...
| Metric | Value |
| --- | ---: |
| `target_identity_count` | 25133 |
| `xmage_authoritative_source_count` | 24819 |
| `xmage_missing_source_exception_count` | 314 |
| `xmage_authoritative_parser_gap_count` | 0 |
| `xmage_authoritative_adapter_required_count` | 24819 |
| `manual_semantic_decision_units_remaining` | 314 |
| `authoritative_source_coverage_ratio` | 0.9875 |
| `adapter_work_unit_count` | 11332 |

## Translation Lanes

| Lane | Count |
| --- | ---: |
| `xmage_authoritative_adapter_required` | 24819 |
...
| `grant_protection_from_chosen_color::xmage_targeted_protection_variant_review_v1` | 1089 |
...
| Effect | Cards |
| --- | ---: |
| `external_reference_required_manual_model` | 11205 |
| `token_maker` | 2306 |
| `recursion` | 1795 |
| `draw_engine` | 1588 |
| `add_counters` | 1211 |
| `grant_protection_from_chosen_color` | 1095 |
| `direct_damage` | 780 |
| `life_gain` | 683 |
| `draw_cards` | 579 |
| `tutor` | 578 |
