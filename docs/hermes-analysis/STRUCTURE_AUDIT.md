...
> Atualizacao local Codex: 2026-05-30 23:00 UTC
...
> Atualizacao local Codex: 2026-05-30 03:00 UTC
...
- `server/lib/ai/candidate_quality_data_support.dart` (693 linhas): card_function_tags, cards, CHECK, KEY, card_role_scores
- `server/lib/ai/commander_reference_card_stats_support.dart` (1368 linhas): normalizeCommanderReferenceCardName, findResolvedCommanderReferenceCommanderCard, commander_reference_card_stats, cards, NOW
...
- `server/lib/ai/functional_card_tags.dart` (1053 linhas): count, add, inferSemanticCardAnalysisV2, summarizeFunctionalTagsForDeck, normalizeFunctionalCardName
- `server/lib/ai/goldfish_simulator.dart` (606 linhas): simulate, inicial, compras, mana, mana
- `server/lib/ai/hate_cards_service.dart` (160 linhas): generatePromptContext, COUNT
- `server/lib/ai/optimization_functional_roles.dart` (399 linhas): looksLikeOptimizationBoardWipeText, looksLikeOptimizationRampText, looksLikeOptimizationLandSearchText, classifyOptimizationFunctionalRole, if
- `server/lib/ai/optimization_quality_gate.dart` (501 linhas): filterUnsafeOptimizeSwapsByCardData
- `server/lib/ai/optimization_validator.dart` (891 linhas): Carlo, CARLO, TEMÁTICA, OPINIÃO, COMPARISON
- `server/lib/ai/optimize_analysis_support.dart` (295 linhas): optimization_analysis_logs
- `server/lib/ai/optimize_complete_support.dart` (1560 linhas): live, calculateCompleteMaxBasicAdditions, addUnique, rebalanceCompleteDeckForLandDeficit, mergeUniqueSpells
...
- `server/lib/ai/optimize_job.dart` (358 linhas): ai_optimize_jobs
- `server/lib/ai/optimize_request_support.dart` (359 linhas): SUM, regexp_matches, m, SUM, regexp_matches
- `server/lib/ai/optimize_runtime_support.dart` (4198 linhas): normalizeOptimizeReasoning, resolveOptimizeMode, clampRequestedSwapCount, shouldUseAsyncOptimizeExecutor, resolveOptimizeIntensity
...
- `server/lib/ai_generate_job.dart` (288 linhas): ai_generate_jobs, ai_generate_jobs, users, ai_generate_jobs, ai_generate_jobs
...
- `server/lib/auth_service.dart` (297 linhas): automático, hashPassword, verifyPassword, catch, normalizeEmail
- `server/lib/card_resolution_support.dart` (123 linhas): resolveCardCandidateNames
- `server/lib/card_validation_service.dart` (248 linhas): LOWER, cópia, sanitizeCardName, Ring
- `server/lib/color_identity.dart` (61 linhas): incolores, isWithinCommanderIdentity
- `server/lib/database.dart` (132 linhas): connect
- `server/lib/deck_rules_service.dart` (503 linhas): gerais, cartas, cartas, cartas, cartas
...
- `server/lib/edh_bracket_policy.dart` (335 linhas): Brackets, forBracket, tagCardForBracket, applyBracketPolicyToAdditions, comuns
- `server/lib/endpoint_cache.dart` (37 linhas): set, clearExpired
- `server/lib/generated_deck_validation_service.dart` (819 linhas): addLookupName, catch, catch, catch, carta
- `server/lib/health_readiness_support.dart` (21 linhas): readinessStatusCode
- `server/lib/http_responses.dart` (39 linhas): apiError, badRequest, notFound, internalServerError, methodNotAllowed
...
- `server/lib/meta/meta_deck_reference_support.dart` (938 linhas): buildMetaDeckReferenceQueryParts, ANY, ANY, ANY, ANY
...
- `server/lib/rate_limit_middleware.dart` (402 linhas): middleware, 429, Function, Function, buildClientIdentifierFromHeaders
- `server/lib/request_metrics_service.dart` (107 linhas): add, snapshot, record
- `server/lib/request_trace.dart` (58 linhas): generateRequestId, resolveRequestId, getRequestTrace
- `server/lib/sets_catalog_contract.dart` (61 linhas): safeSetCatalogLimit, safeSetCatalogPage, resolveSetStatus
- `server/lib/sync_cards_utils.dart` (179 linhas): pares
- `server/routes/_middleware.dart` (223 linhas): middleware
- `server/routes/ai/_middleware.dart` (22 linhas): limiting, middleware
- `server/routes/ai/archetypes/index.dart` (564 linhas): consistência
- `server/routes/ai/commander-reference/index.dart` (641 linhas): LOWER, commander_reference_profiles, NOW, LOWER, commander_reference_profiles
- `server/routes/ai/explain/index.dart` (187 linhas): típicas, if, Simplificada
- `server/routes/ai/generate/index.dart` (1656 linhas): object, required, lower, lower, array_length
- `server/routes/ai/ml-status/index.dart` (180 linhas): Learning, COUNT, COUNT, COUNT, COUNT
- `server/routes/ai/optimize/index.dart` (3498 linhas): resolveOptimizeIntensity, resolveOptimizeArchetype, shouldRetryOptimizeWithAiFallback, matchesFunctionalNeed, scoreOptimizeReplacementCandidate
...
- `server/routes/ai/simulate-matchup/index.dart` (435 linhas): SUM, regexp_matches, m, partidas, deck_matchups
- `server/routes/ai/simulate/index.dart` (222 linhas): goldfish, catch, EXISTS, battle_simulations
- `server/routes/ai/weakness-analysis/index.dart` (425 linhas): SUM, regexp_matches, m, ramp, removal
...
- `server/routes/decks/[id]/cards/index.dart` (405 linhas): AND, deck_cards, COALESCE, cópia, COALESCE
- `server/routes/decks/[id]/cards/replace/index.dart` (229 linhas): catch
- `server/routes/decks/[id]/cards/set/index.dart` (250 linhas): cópia, deck_cards, catch
...
- `server/routes/decks/[id]/recommendations/index.dart` (560 linhas): SUM, regexp_matches, m, INTELIGENTE, if
- `server/routes/decks/[id]/simulate/index.dart` (187 linhas): Inicial, carta, Terreno
- `server/routes/decks/[id]/validate/index.dart` (73 linhas): catch
- `server/routes/decks/_middleware.dart` (10 linhas): middleware
- `server/routes/decks/index.dart` (430 linhas): LATERAL, LATERAL, LATERAL, LATERAL, unnest
...
- `server/routes/import/to-deck/index.dart` (302 linhas): catch, deck_cards, catch
- `server/routes/import/validate/index.dart` (221 linhas): catch, legalidades
...
- `card_function_tags`: 4 referencias
- `card_legalities`: 12 referencias
- `card_localized_names`: 1 referencias
- `card_meta_insights`: 6 referencias
- `card_role_scores`: 2 referencias
- `card_semantic_tags_v2`: 5 referencias
- `cards`: 45 referencias
...
- `optimize_candidate_quality_summary`: 1 referencias
...
- **Funcoes publicas duplicadas (mesmo nome, arquivos sem import cruzado):**
  - `AND` em: server/lib/ai/candidate_quality_data_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/routes/conversations/[id]/read.dart, server/routes/conversations/unread-count.dart, server/routes/decks/[id]/cards/index.dart, server/routes/trades/index.dart, server/routes/trades/index.dart
  ...
  - `EDHREC` em: server/lib/ai/otimizacao.dart, server/lib/ai/otimizacao.dart
  ...
  - `IN` em: server/lib/ai/optimize_runtime_support.dart, server/lib/ai/optimize_runtime_support.dart, server/lib/ml_knowledge_service.dart, server/routes/trades/[id]/status.dart, server/routes/trades/[id]/status.dart, server/routes/trades/[id]/status.dart
  ...
  - `NOW` em: server/lib/ai/commander_reference_card_stats_support.dart, server/lib/ai/commander_reference_deck_corpus_support.dart, server/lib/ai/commander_reference_deck_corpus_support.dart, server/lib/ai/commander_reference_deck_corpus_support.dart, server/lib/ai/commander_reference_deck_corpus_support.dart, server/lib/ai/commander_reference_profile_support.dart, server/routes/ai/commander-reference/index.dart
  ...
  - `commander_reference_profiles` em: server/lib/ai/commander_reference_profile_support.dart, server/lib/ai/commander_reference_profile_support.dart, server/routes/ai/commander-reference/index.dart, server/routes/ai/commander-reference/index.dart
  ...
  - `inicial` em: server/lib/ai/goldfish_simulator.dart, server/lib/edh_bracket_policy.dart
  ...
  - `ramp` em: server/routes/ai/weakness-analysis/index.dart, server/routes/decks/[id]/ai-analysis/index.dart
  ...
  - `unnest` em: server/lib/ml_knowledge_service.dart, server/lib/ml_knowledge_service.dart, server/routes/cards/resolve/batch/index.dart, server/routes/decks/index.dart
...
- **Referencias read-only a tabelas semanticas:**
  ...
  - `server/routes/ai/optimize/index.dart` referencia `semantic_tags_v2` (apenas leitura)
