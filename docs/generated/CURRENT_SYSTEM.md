...
**Digest das fontes:** `dc3fb4afdbc1d74fa17779c533eedfd71a83d818a2b25f9eebe9eff806ecb2b4`
...
| `battle_sidecar_source_files` | 32 |
| `dart_symbols` | 4658 |
...
| `database_views` | 6 |
| `migrations` | 56 |
| `scripts_and_jobs` | 657 |
| `environment_variables` | 666 |
| `tests` | 1155 |
| `flows` | 8 |
