...
**Digest das fontes:** `3e5f3f5a8db9f1e0cd20b8788f542c6dd5d77afc265082b23b0e30834a83b8e9`
...
| `semantic_resolved_call_edges` | 42801 |
| `semantic_resolved_call_sites` | 68204 |
| `semantic_resolved_type_references` | 16108 |
| `modules` | 155 |
| `app_routes` | 46 |
| `web_routes` | 11 |
| `api_routes` | 121 |
