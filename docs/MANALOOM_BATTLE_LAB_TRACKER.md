...
| BL7 | `PASS_DECISION_NO_GO` | BL6 local | Codex | spike XMage humano isolado; ADR/capability experimental | Maven, callbacks, segurança, relatório GO/NO-GO | `docs/qa/MANALOOM_BATTLE_LAB_BL7_EVIDENCE_2026-07-26.md`; sete famílias adicionais tipadas, inventário conhecido sem callback aberto; partida runtime completa e takeover humano→IA ainda bloqueiam GO; ADR 0003 |
