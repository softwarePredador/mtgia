...
| BL10 | `PARTIAL_LOCAL_RELEASE_NO_GO` | BL9 | Codex | hardening/rollout alpha | full, Battle, carga, E2E, same-SHA smoke | `docs/qa/MANALOOM_BATTLE_LAB_BL10_EVIDENCE_2026-07-27.md`; `docs/qa/MANALOOM_S8_BL10_RESILIENCE_FOLLOWUP_2026-07-29.md`; carga integrada descartável e gates locais verdes; Android físico/TalkBack/carga alvo/alertas/deploy/smoke pendentes |
