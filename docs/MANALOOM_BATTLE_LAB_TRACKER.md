...
**Estado do programa:** `M2_LOCAL_IMPLEMENTED / BL7_GO / BL8_READY / RELEASE_NO_GO`
...
7. BL8 foi desbloqueado pelo GO explícito do ADR 0004, mas permanece
   default-off e sem autoridade live.
...
| BL8 | `READY_BL7_GO` | BL7 GO | Codex | sessão/prompt/ação, visão privada, pool XMage | PostgreSQL isolado, API/security, sidecar | `docs/qa/MANALOOM_BATTLE_LAB_BL8_EVIDENCE_2026-07-26.md`; pronto para iniciar localmente/default-off |
...
BL0–BL7 possuem evidência de implementação/decisão local. BL8 foi desbloqueado
para implementação local; BL9/BL10 continuam dependentes da conclusão real dos
marcos anteriores.
