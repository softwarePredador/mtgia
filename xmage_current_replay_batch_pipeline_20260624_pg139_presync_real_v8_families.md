...
- Summary: `{"batch_metadata_candidate_count": 2, "card_count": 259, "family_count": 5, "family_counts": {"copy_creature_token": 1, "manual_model": 240, "ramp_engine": 1, "ramp_permanent": 1, "token_maker": 16}, "manual_or_blocked_count": 241, "promotion_lane_counts": {"batch_metadata_candidate_requires_pg_precheck": 2, "blocked_missing_xmage_source": 3, "mapper_metadata_or_test_scenario_required": 237, "runtime_family_implementation_required": 16, "split_family_scope_review_required": 1}, "runtime_family_required_count": 16}`
...
| `ramp_permanent` | 1 | `runtime_family_partially_supported_review_required` | `{"batch_metadata_candidate_requires_pg_precheck": 1}` | battlefield mana artifacts and triggered resource permanents |
